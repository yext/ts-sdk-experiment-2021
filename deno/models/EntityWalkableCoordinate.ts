 ...
 * ```
 * @export
 * @interface EntityWalkableCoordinate
 */
export interface EntityWalkableCoordinate {
    /**
     * Filtering Type: `float`
     * @type {number}
     * @memberof EntityWalkableCoordinate
     */
    latitude?: number;
    /**
     * Filtering Type: `float`
...
export function EntityWalkableCoordinateFromJSON(json: any): EntityWalkableCoordinate {
    return EntityWalkableCoordinateFromJSONTyped(json, false);
}

export function EntityWalkableCoordinateFromJSONTyped(json: any, ignoreDiscriminator: boolean): EntityWalkableCoordinate {
...
export function EntityWalkableCoordinateToJSON(value?: EntityWalkableCoordinate | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
