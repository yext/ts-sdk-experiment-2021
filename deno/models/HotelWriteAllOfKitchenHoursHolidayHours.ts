 ...
 * 
 * @export
 * @interface HotelWriteAllOfKitchenHoursHolidayHours
 */
export interface HotelWriteAllOfKitchenHoursHolidayHours {
    /**
     ...
     * @type {Date}
     * @memberof HotelWriteAllOfKitchenHoursHolidayHours
     */
    date: Date;
    /**
...
export function HotelWriteAllOfKitchenHoursHolidayHoursFromJSON(json: any): HotelWriteAllOfKitchenHoursHolidayHours {
    return HotelWriteAllOfKitchenHoursHolidayHoursFromJSONTyped(json, false);
}

export function HotelWriteAllOfKitchenHoursHolidayHoursFromJSONTyped(json: any, ignoreDiscriminator: boolean): HotelWriteAllOfKitchenHoursHolidayHours {
...
export function HotelWriteAllOfKitchenHoursHolidayHoursToJSON(value?: HotelWriteAllOfKitchenHoursHolidayHours | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
