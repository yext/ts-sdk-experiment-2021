 ...
 * 
 * @export
 * @interface LocationLegacyHolidayHours
 */
export interface LocationLegacyHolidayHours {
    /**
     ...
     * @type {string}
     * @memberof LocationLegacyHolidayHours
     */
    hours?: string;
    /**
...
export function LocationLegacyHolidayHoursFromJSON(json: any): LocationLegacyHolidayHours {
    return LocationLegacyHolidayHoursFromJSONTyped(json, false);
}

export function LocationLegacyHolidayHoursFromJSONTyped(json: any, ignoreDiscriminator: boolean): LocationLegacyHolidayHours {
...
export function LocationLegacyHolidayHoursToJSON(value?: LocationLegacyHolidayHours | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
