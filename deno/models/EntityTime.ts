...
export function EntityTimeFromJSON(json: any): EntityTime {
    return EntityTimeFromJSONTyped(json, false);
}

export function EntityTimeFromJSONTyped(json: any, ignoreDiscriminator: boolean): EntityTime {
...
export function EntityTimeToJSON(value?: EntityTime | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
