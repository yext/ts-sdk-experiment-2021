...
import {
    ...
    EntityWriteToJSON,
    EventWriteAllOf,
    EventWriteAllOfFromJSON,
    EventWriteAllOfFromJSONTyped,
    EventWriteAllOfToJSON,
 ...
 */
export interface EventWrite extends EntityWrite {
    /**
     * 
     ...
     * @memberof EventWrite
     */
    eventStatus?: EventWriteEventStatusEnum;
    /**
     ...
     * @memberof EventWrite
     */
    ticketAvailability?: EventWriteTicketAvailabilityEnum;
    /**
     * 
...
* @enum {string}
*/
export enum EventWriteEventStatusEnum {
    Scheduled = 'SCHEDULED',
...
* @enum {string}
*/
export enum EventWriteTicketAvailabilityEnum {
    InStock = 'IN_STOCK',
    SoldOut = 'SOLD_OUT',
    PreOrder = 'PRE_ORDER',
...
export function EventWriteFromJSON(json: any): EventWrite {
    return EventWriteFromJSONTyped(json, false);
}

export function EventWriteFromJSONTyped(json: any, ignoreDiscriminator: boolean): EventWrite {
...
export function EventWriteToJSON(value?: EventWrite | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
