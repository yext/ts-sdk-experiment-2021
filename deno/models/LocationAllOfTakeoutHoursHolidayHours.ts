 ...
 * 
 * @export
 * @interface LocationAllOfTakeoutHoursHolidayHours
 */
export interface LocationAllOfTakeoutHoursHolidayHours {
    /**
     ...
     * @type {Date}
     * @memberof LocationAllOfTakeoutHoursHolidayHours
     */
    date: Date;
    /**
...
export function LocationAllOfTakeoutHoursHolidayHoursFromJSON(json: any): LocationAllOfTakeoutHoursHolidayHours {
    return LocationAllOfTakeoutHoursHolidayHoursFromJSONTyped(json, false);
}

export function LocationAllOfTakeoutHoursHolidayHoursFromJSONTyped(json: any, ignoreDiscriminator: boolean): LocationAllOfTakeoutHoursHolidayHours {
...
export function LocationAllOfTakeoutHoursHolidayHoursToJSON(value?: LocationAllOfTakeoutHoursHolidayHours | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
