 ...
 * @export
 * @interface EntityAccessHoursSaturday
 */
export interface EntityAccessHoursSaturday {
    /**
     * Indicates if the access hours are "closed" on Saturday.
     * 
     * Filtering Type: `boolean`
     * @type {boolean}
     * @memberof EntityAccessHoursSaturday
     */
    isClosed?: boolean;
    /**
...
export function EntityAccessHoursSaturdayFromJSON(json: any): EntityAccessHoursSaturday {
    return EntityAccessHoursSaturdayFromJSONTyped(json, false);
}

export function EntityAccessHoursSaturdayFromJSONTyped(json: any, ignoreDiscriminator: boolean): EntityAccessHoursSaturday {
...
export function EntityAccessHoursSaturdayToJSON(value?: EntityAccessHoursSaturday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
