 ...
 * 
 * @export
 * @interface HealthcareFacilityAllOfPickupHoursMonday
 */
export interface HealthcareFacilityAllOfPickupHoursMonday {
    /**
     * Indicates if the pickup hours are "closed" on Monday.
     * @type {boolean}
     * @memberof HealthcareFacilityAllOfPickupHoursMonday
     */
    isClosed?: boolean;
    /**
...
export function HealthcareFacilityAllOfPickupHoursMondayFromJSON(json: any): HealthcareFacilityAllOfPickupHoursMonday {
    return HealthcareFacilityAllOfPickupHoursMondayFromJSONTyped(json, false);
}

export function HealthcareFacilityAllOfPickupHoursMondayFromJSONTyped(json: any, ignoreDiscriminator: boolean): HealthcareFacilityAllOfPickupHoursMonday {
...
export function HealthcareFacilityAllOfPickupHoursMondayToJSON(value?: HealthcareFacilityAllOfPickupHoursMonday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
