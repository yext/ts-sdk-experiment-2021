 ...
 * ```
 * @export
 * @interface EntityUberLink
 */
export interface EntityUberLink {
    /**
     ...
     * @type {string}
     * @memberof EntityUberLink
     */
    presentation: EntityUberLinkPresentationEnum;
    /**
...
* @enum {string}
*/
export enum EntityUberLinkPresentationEnum {
    Button = 'BUTTON',
    Link = 'LINK'
}

export function EntityUberLinkFromJSON(json: any): EntityUberLink {
    return EntityUberLinkFromJSONTyped(json, false);
}

export function EntityUberLinkFromJSONTyped(json: any, ignoreDiscriminator: boolean): EntityUberLink {
...
export function EntityUberLinkToJSON(value?: EntityUberLink | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
