 ...
 * @export
 * @interface EntityDeliveryHoursWednesday
 */
export interface EntityDeliveryHoursWednesday {
    /**
     * Indicates if the delivery hours are "closed" on Wednesday.
     * 
     * Filtering Type: `boolean`
     * @type {boolean}
     * @memberof EntityDeliveryHoursWednesday
     */
    isClosed?: boolean;
    /**
...
export function EntityDeliveryHoursWednesdayFromJSON(json: any): EntityDeliveryHoursWednesday {
    return EntityDeliveryHoursWednesdayFromJSONTyped(json, false);
}

export function EntityDeliveryHoursWednesdayFromJSONTyped(json: any, ignoreDiscriminator: boolean): EntityDeliveryHoursWednesday {
...
export function EntityDeliveryHoursWednesdayToJSON(value?: EntityDeliveryHoursWednesday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
