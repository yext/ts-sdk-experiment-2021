 ...
 * @export
 * @interface EntityPhotoGallery
 */
export interface EntityPhotoGallery {
    /**
     * Filtering Type: `text`
     * @type {string}
     * @memberof EntityPhotoGallery
     */
...
export function EntityPhotoGalleryFromJSON(json: any): EntityPhotoGallery {
    return EntityPhotoGalleryFromJSONTyped(json, false);
}

export function EntityPhotoGalleryFromJSONTyped(json: any, ignoreDiscriminator: boolean): EntityPhotoGallery {
    ...
    return {
        ...
        'image': EntityImageFromJSON(json['image']),
    };
}

export function EntityPhotoGalleryToJSON(value?: EntityPhotoGallery | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'image': EntityImageToJSON(value.image),
    };
}
