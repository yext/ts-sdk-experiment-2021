...
import {
    EntityDeliveryHoursFriday,
    EntityDeliveryHoursFridayFromJSON,
    EntityDeliveryHoursFridayFromJSONTyped,
    EntityDeliveryHoursFridayToJSON,
    EntityDeliveryHoursHolidayHours,
    EntityDeliveryHoursHolidayHoursFromJSON,
    EntityDeliveryHoursHolidayHoursFromJSONTyped,
    EntityDeliveryHoursHolidayHoursToJSON,
    EntityDeliveryHoursMonday,
    EntityDeliveryHoursMondayFromJSON,
    EntityDeliveryHoursMondayFromJSONTyped,
    EntityDeliveryHoursMondayToJSON,
    EntityDeliveryHoursSaturday,
    EntityDeliveryHoursSaturdayFromJSON,
    EntityDeliveryHoursSaturdayFromJSONTyped,
    EntityDeliveryHoursSaturdayToJSON,
    EntityDeliveryHoursSunday,
    EntityDeliveryHoursSundayFromJSON,
    EntityDeliveryHoursSundayFromJSONTyped,
    EntityDeliveryHoursSundayToJSON,
    EntityDeliveryHoursThursday,
    EntityDeliveryHoursThursdayFromJSON,
    EntityDeliveryHoursThursdayFromJSONTyped,
    EntityDeliveryHoursThursdayToJSON,
    EntityDeliveryHoursTuesday,
    EntityDeliveryHoursTuesdayFromJSON,
    EntityDeliveryHoursTuesdayFromJSONTyped,
    EntityDeliveryHoursTuesdayToJSON,
    EntityDeliveryHoursWednesday,
    EntityDeliveryHoursWednesdayFromJSON,
    EntityDeliveryHoursWednesdayFromJSONTyped,
    EntityDeliveryHoursWednesdayToJSON,
} from './index.ts';
 ...
 * ```
 * @export
 * @interface EntityDeliveryHours
 */
export interface EntityDeliveryHours {
    /**
     * 
     * @type {EntityDeliveryHoursFriday}
     * @memberof EntityDeliveryHours
     */
    friday?: EntityDeliveryHoursFriday;
    /**
     * 
     ...
     * @type {Set<EntityDeliveryHoursHolidayHours>}
     * @memberof EntityDeliveryHours
     */
    holidayHours?: Set<EntityDeliveryHoursHolidayHours>;
    /**
     * 
     * @type {EntityDeliveryHoursMonday}
     * @memberof EntityDeliveryHours
     */
    monday?: EntityDeliveryHoursMonday;
    /**
     * 
    ...
    /**
     * 
     * @type {EntityDeliveryHoursSaturday}
     * @memberof EntityDeliveryHours
     */
    saturday?: EntityDeliveryHoursSaturday;
    /**
     * 
     * @type {EntityDeliveryHoursSunday}
     * @memberof EntityDeliveryHours
     */
    sunday?: EntityDeliveryHoursSunday;
    /**
     * 
     * @type {EntityDeliveryHoursThursday}
     * @memberof EntityDeliveryHours
     */
    thursday?: EntityDeliveryHoursThursday;
    /**
     * 
     * @type {EntityDeliveryHoursTuesday}
     * @memberof EntityDeliveryHours
     */
    tuesday?: EntityDeliveryHoursTuesday;
    /**
     * 
     * @type {EntityDeliveryHoursWednesday}
     * @memberof EntityDeliveryHours
     */
    wednesday?: EntityDeliveryHoursWednesday;
}

export function EntityDeliveryHoursFromJSON(json: any): EntityDeliveryHours {
    return EntityDeliveryHoursFromJSONTyped(json, false);
}

export function EntityDeliveryHoursFromJSONTyped(json: any, ignoreDiscriminator: boolean): EntityDeliveryHours {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'friday': !exists(json, 'friday') ? undefined : EntityDeliveryHoursFridayFromJSON(json['friday']),
        'holidayHours': !exists(json, 'holidayHours') ? undefined : (new Set((json['holidayHours'] as Array<any>).map(EntityDeliveryHoursHolidayHoursFromJSON))),
        'monday': !exists(json, 'monday') ? undefined : EntityDeliveryHoursMondayFromJSON(json['monday']),
        'reopenDate': !exists(json, 'reopenDate') ? undefined : (new Date(json['reopenDate'])),
        'saturday': !exists(json, 'saturday') ? undefined : EntityDeliveryHoursSaturdayFromJSON(json['saturday']),
        'sunday': !exists(json, 'sunday') ? undefined : EntityDeliveryHoursSundayFromJSON(json['sunday']),
        'thursday': !exists(json, 'thursday') ? undefined : EntityDeliveryHoursThursdayFromJSON(json['thursday']),
        'tuesday': !exists(json, 'tuesday') ? undefined : EntityDeliveryHoursTuesdayFromJSON(json['tuesday']),
        'wednesday': !exists(json, 'wednesday') ? undefined : EntityDeliveryHoursWednesdayFromJSON(json['wednesday']),
    };
}

export function EntityDeliveryHoursToJSON(value?: EntityDeliveryHours | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'friday': EntityDeliveryHoursFridayToJSON(value.friday),
        'holidayHours': value.holidayHours === undefined ? undefined : (Array.from(value.holidayHours as Set<any>).map(EntityDeliveryHoursHolidayHoursToJSON)),
        'monday': EntityDeliveryHoursMondayToJSON(value.monday),
        'reopenDate': value.reopenDate === undefined ? undefined : (value.reopenDate.toISOString().substr(0,10)),
        'saturday': EntityDeliveryHoursSaturdayToJSON(value.saturday),
        'sunday': EntityDeliveryHoursSundayToJSON(value.sunday),
        'thursday': EntityDeliveryHoursThursdayToJSON(value.thursday),
        'tuesday': EntityDeliveryHoursTuesdayToJSON(value.tuesday),
        'wednesday': EntityDeliveryHoursWednesdayToJSON(value.wednesday),
    };
}
