 ...
 * 
 * @export
 * @interface LocationAllOfSeniorHoursWednesday
 */
export interface LocationAllOfSeniorHoursWednesday {
    /**
     * Indicates if the senior hours are "closed" on Wednesday.
     * @type {boolean}
     * @memberof LocationAllOfSeniorHoursWednesday
     */
    isClosed?: boolean;
    /**
...
export function LocationAllOfSeniorHoursWednesdayFromJSON(json: any): LocationAllOfSeniorHoursWednesday {
    return LocationAllOfSeniorHoursWednesdayFromJSONTyped(json, false);
}

export function LocationAllOfSeniorHoursWednesdayFromJSONTyped(json: any, ignoreDiscriminator: boolean): LocationAllOfSeniorHoursWednesday {
...
export function LocationAllOfSeniorHoursWednesdayToJSON(value?: LocationAllOfSeniorHoursWednesday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
