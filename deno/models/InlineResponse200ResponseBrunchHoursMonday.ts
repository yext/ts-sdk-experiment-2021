 ...
 * @export
 * @interface InlineResponse200ResponseBrunchHoursMonday
 */
export interface InlineResponse200ResponseBrunchHoursMonday {
    /**
     * Indicates if the brunch hours are "closed" on Monday.
     * 
     * Filtering Type: `boolean`
     * @type {boolean}
     * @memberof InlineResponse200ResponseBrunchHoursMonday
     */
    isClosed?: boolean;
    /**
...
export function InlineResponse200ResponseBrunchHoursMondayFromJSON(json: any): InlineResponse200ResponseBrunchHoursMonday {
    return InlineResponse200ResponseBrunchHoursMondayFromJSONTyped(json, false);
}

export function InlineResponse200ResponseBrunchHoursMondayFromJSONTyped(json: any, ignoreDiscriminator: boolean): InlineResponse200ResponseBrunchHoursMonday {
...
export function InlineResponse200ResponseBrunchHoursMondayToJSON(value?: InlineResponse200ResponseBrunchHoursMonday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
