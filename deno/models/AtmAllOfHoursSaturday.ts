 ...
 * 
 * @export
 * @interface AtmAllOfHoursSaturday
 */
export interface AtmAllOfHoursSaturday {
    /**
     * Indicates if the hours of operation are "closed" on Saturday.
     * @type {boolean}
     * @memberof AtmAllOfHoursSaturday
     */
    isClosed?: boolean;
    /**
...
export function AtmAllOfHoursSaturdayFromJSON(json: any): AtmAllOfHoursSaturday {
    return AtmAllOfHoursSaturdayFromJSONTyped(json, false);
}

export function AtmAllOfHoursSaturdayFromJSONTyped(json: any, ignoreDiscriminator: boolean): AtmAllOfHoursSaturday {
...
export function AtmAllOfHoursSaturdayToJSON(value?: AtmAllOfHoursSaturday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
