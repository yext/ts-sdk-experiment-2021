...
import {
    HealthcareFacilityAllOfOnlineServiceHoursFriday,
    HealthcareFacilityAllOfOnlineServiceHoursFridayFromJSON,
    HealthcareFacilityAllOfOnlineServiceHoursFridayFromJSONTyped,
    HealthcareFacilityAllOfOnlineServiceHoursFridayToJSON,
    HealthcareFacilityAllOfOnlineServiceHoursHolidayHours,
    HealthcareFacilityAllOfOnlineServiceHoursHolidayHoursFromJSON,
    HealthcareFacilityAllOfOnlineServiceHoursHolidayHoursFromJSONTyped,
    HealthcareFacilityAllOfOnlineServiceHoursHolidayHoursToJSON,
    HealthcareFacilityAllOfOnlineServiceHoursMonday,
    HealthcareFacilityAllOfOnlineServiceHoursMondayFromJSON,
    HealthcareFacilityAllOfOnlineServiceHoursMondayFromJSONTyped,
    HealthcareFacilityAllOfOnlineServiceHoursMondayToJSON,
    HealthcareFacilityAllOfOnlineServiceHoursSaturday,
    HealthcareFacilityAllOfOnlineServiceHoursSaturdayFromJSON,
    HealthcareFacilityAllOfOnlineServiceHoursSaturdayFromJSONTyped,
    HealthcareFacilityAllOfOnlineServiceHoursSaturdayToJSON,
    HealthcareFacilityAllOfOnlineServiceHoursSunday,
    HealthcareFacilityAllOfOnlineServiceHoursSundayFromJSON,
    HealthcareFacilityAllOfOnlineServiceHoursSundayFromJSONTyped,
    HealthcareFacilityAllOfOnlineServiceHoursSundayToJSON,
    HealthcareFacilityAllOfOnlineServiceHoursThursday,
    HealthcareFacilityAllOfOnlineServiceHoursThursdayFromJSON,
    HealthcareFacilityAllOfOnlineServiceHoursThursdayFromJSONTyped,
    HealthcareFacilityAllOfOnlineServiceHoursThursdayToJSON,
    HealthcareFacilityAllOfOnlineServiceHoursTuesday,
    HealthcareFacilityAllOfOnlineServiceHoursTuesdayFromJSON,
    HealthcareFacilityAllOfOnlineServiceHoursTuesdayFromJSONTyped,
    HealthcareFacilityAllOfOnlineServiceHoursTuesdayToJSON,
    HealthcareFacilityAllOfOnlineServiceHoursWednesday,
    HealthcareFacilityAllOfOnlineServiceHoursWednesdayFromJSON,
    HealthcareFacilityAllOfOnlineServiceHoursWednesdayFromJSONTyped,
    HealthcareFacilityAllOfOnlineServiceHoursWednesdayToJSON,
} from './index.ts';
 ...
 * @export
 * @interface HealthcareFacilityAllOfOnlineServiceHours
 */
export interface HealthcareFacilityAllOfOnlineServiceHours {
    /**
     * 
     * @type {HealthcareFacilityAllOfOnlineServiceHoursFriday}
     * @memberof HealthcareFacilityAllOfOnlineServiceHours
     */
    friday?: HealthcareFacilityAllOfOnlineServiceHoursFriday;
    /**
     * 
     ...
     * @type {Set<HealthcareFacilityAllOfOnlineServiceHoursHolidayHours>}
     * @memberof HealthcareFacilityAllOfOnlineServiceHours
     */
    holidayHours?: Set<HealthcareFacilityAllOfOnlineServiceHoursHolidayHours>;
    /**
     * 
     * @type {HealthcareFacilityAllOfOnlineServiceHoursMonday}
     * @memberof HealthcareFacilityAllOfOnlineServiceHours
     */
    monday?: HealthcareFacilityAllOfOnlineServiceHoursMonday;
    /**
     * 
    ...
    /**
     * 
     * @type {HealthcareFacilityAllOfOnlineServiceHoursSaturday}
     * @memberof HealthcareFacilityAllOfOnlineServiceHours
     */
    saturday?: HealthcareFacilityAllOfOnlineServiceHoursSaturday;
    /**
     * 
     * @type {HealthcareFacilityAllOfOnlineServiceHoursSunday}
     * @memberof HealthcareFacilityAllOfOnlineServiceHours
     */
    sunday?: HealthcareFacilityAllOfOnlineServiceHoursSunday;
    /**
     * 
     * @type {HealthcareFacilityAllOfOnlineServiceHoursThursday}
     * @memberof HealthcareFacilityAllOfOnlineServiceHours
     */
    thursday?: HealthcareFacilityAllOfOnlineServiceHoursThursday;
    /**
     * 
     * @type {HealthcareFacilityAllOfOnlineServiceHoursTuesday}
     * @memberof HealthcareFacilityAllOfOnlineServiceHours
     */
    tuesday?: HealthcareFacilityAllOfOnlineServiceHoursTuesday;
    /**
     * 
     * @type {HealthcareFacilityAllOfOnlineServiceHoursWednesday}
     * @memberof HealthcareFacilityAllOfOnlineServiceHours
     */
    wednesday?: HealthcareFacilityAllOfOnlineServiceHoursWednesday;
}

export function HealthcareFacilityAllOfOnlineServiceHoursFromJSON(json: any): HealthcareFacilityAllOfOnlineServiceHours {
    return HealthcareFacilityAllOfOnlineServiceHoursFromJSONTyped(json, false);
}

export function HealthcareFacilityAllOfOnlineServiceHoursFromJSONTyped(json: any, ignoreDiscriminator: boolean): HealthcareFacilityAllOfOnlineServiceHours {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'friday': !exists(json, 'friday') ? undefined : HealthcareFacilityAllOfOnlineServiceHoursFridayFromJSON(json['friday']),
        'holidayHours': !exists(json, 'holidayHours') ? undefined : (new Set((json['holidayHours'] as Array<any>).map(HealthcareFacilityAllOfOnlineServiceHoursHolidayHoursFromJSON))),
        'monday': !exists(json, 'monday') ? undefined : HealthcareFacilityAllOfOnlineServiceHoursMondayFromJSON(json['monday']),
        'reopenDate': !exists(json, 'reopenDate') ? undefined : (new Date(json['reopenDate'])),
        'saturday': !exists(json, 'saturday') ? undefined : HealthcareFacilityAllOfOnlineServiceHoursSaturdayFromJSON(json['saturday']),
        'sunday': !exists(json, 'sunday') ? undefined : HealthcareFacilityAllOfOnlineServiceHoursSundayFromJSON(json['sunday']),
        'thursday': !exists(json, 'thursday') ? undefined : HealthcareFacilityAllOfOnlineServiceHoursThursdayFromJSON(json['thursday']),
        'tuesday': !exists(json, 'tuesday') ? undefined : HealthcareFacilityAllOfOnlineServiceHoursTuesdayFromJSON(json['tuesday']),
        'wednesday': !exists(json, 'wednesday') ? undefined : HealthcareFacilityAllOfOnlineServiceHoursWednesdayFromJSON(json['wednesday']),
    };
}

export function HealthcareFacilityAllOfOnlineServiceHoursToJSON(value?: HealthcareFacilityAllOfOnlineServiceHours | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'friday': HealthcareFacilityAllOfOnlineServiceHoursFridayToJSON(value.friday),
        'holidayHours': value.holidayHours === undefined ? undefined : (Array.from(value.holidayHours as Set<any>).map(HealthcareFacilityAllOfOnlineServiceHoursHolidayHoursToJSON)),
        'monday': HealthcareFacilityAllOfOnlineServiceHoursMondayToJSON(value.monday),
        'reopenDate': value.reopenDate === undefined ? undefined : (value.reopenDate.toISOString().substr(0,10)),
        'saturday': HealthcareFacilityAllOfOnlineServiceHoursSaturdayToJSON(value.saturday),
        'sunday': HealthcareFacilityAllOfOnlineServiceHoursSundayToJSON(value.sunday),
        'thursday': HealthcareFacilityAllOfOnlineServiceHoursThursdayToJSON(value.thursday),
        'tuesday': HealthcareFacilityAllOfOnlineServiceHoursTuesdayToJSON(value.tuesday),
        'wednesday': HealthcareFacilityAllOfOnlineServiceHoursWednesdayToJSON(value.wednesday),
    };
}
