 ...
 * @export
 * @interface EntityPickupHoursThursday
 */
export interface EntityPickupHoursThursday {
    /**
     * Indicates if the pickup hours are "closed" on Thursday.
     * 
     * Filtering Type: `boolean`
     * @type {boolean}
     * @memberof EntityPickupHoursThursday
     */
    isClosed?: boolean;
    /**
...
export function EntityPickupHoursThursdayFromJSON(json: any): EntityPickupHoursThursday {
    return EntityPickupHoursThursdayFromJSONTyped(json, false);
}

export function EntityPickupHoursThursdayFromJSONTyped(json: any, ignoreDiscriminator: boolean): EntityPickupHoursThursday {
...
export function EntityPickupHoursThursdayToJSON(value?: EntityPickupHoursThursday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
