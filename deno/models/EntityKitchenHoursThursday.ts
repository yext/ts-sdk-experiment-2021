 ...
 * @export
 * @interface EntityKitchenHoursThursday
 */
export interface EntityKitchenHoursThursday {
    /**
     * Indicates if the kitchen hours are "closed" on Thursday.
     * 
     * Filtering Type: `boolean`
     * @type {boolean}
     * @memberof EntityKitchenHoursThursday
     */
    isClosed?: boolean;
    /**
...
export function EntityKitchenHoursThursdayFromJSON(json: any): EntityKitchenHoursThursday {
    return EntityKitchenHoursThursdayFromJSONTyped(json, false);
}

export function EntityKitchenHoursThursdayFromJSONTyped(json: any, ignoreDiscriminator: boolean): EntityKitchenHoursThursday {
...
export function EntityKitchenHoursThursdayToJSON(value?: EntityKitchenHoursThursday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
