...
export function CustomTranslationFromJSON(json: any): CustomTranslation {
    return CustomTranslationFromJSONTyped(json, false);
}

export function CustomTranslationFromJSONTyped(json: any, ignoreDiscriminator: boolean): CustomTranslation {
...
export function CustomTranslationToJSON(value?: CustomTranslation | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
