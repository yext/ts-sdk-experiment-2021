 ...
 * @export
 * @interface InlineResponse200ResponseSeniorHoursFriday
 */
export interface InlineResponse200ResponseSeniorHoursFriday {
    /**
     * Indicates if the senior hours are "closed" on Friday.
     * 
     * Filtering Type: `boolean`
     * @type {boolean}
     * @memberof InlineResponse200ResponseSeniorHoursFriday
     */
    isClosed?: boolean;
    /**
...
export function InlineResponse200ResponseSeniorHoursFridayFromJSON(json: any): InlineResponse200ResponseSeniorHoursFriday {
    return InlineResponse200ResponseSeniorHoursFridayFromJSONTyped(json, false);
}

export function InlineResponse200ResponseSeniorHoursFridayFromJSONTyped(json: any, ignoreDiscriminator: boolean): InlineResponse200ResponseSeniorHoursFriday {
...
export function InlineResponse200ResponseSeniorHoursFridayToJSON(value?: InlineResponse200ResponseSeniorHoursFriday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
