 ...
 * @export
 * @interface EntitySeniorHoursMonday
 */
export interface EntitySeniorHoursMonday {
    /**
     * Indicates if the senior hours are "closed" on Monday.
     * 
     * Filtering Type: `boolean`
     * @type {boolean}
     * @memberof EntitySeniorHoursMonday
     */
    isClosed?: boolean;
    /**
...
export function EntitySeniorHoursMondayFromJSON(json: any): EntitySeniorHoursMonday {
    return EntitySeniorHoursMondayFromJSONTyped(json, false);
}

export function EntitySeniorHoursMondayFromJSONTyped(json: any, ignoreDiscriminator: boolean): EntitySeniorHoursMonday {
...
export function EntitySeniorHoursMondayToJSON(value?: EntitySeniorHoursMonday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
