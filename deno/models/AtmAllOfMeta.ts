...
export function AtmAllOfMetaFromJSON(json: any): AtmAllOfMeta {
    return AtmAllOfMetaFromJSONTyped(json, false);
}

export function AtmAllOfMetaFromJSONTyped(json: any, ignoreDiscriminator: boolean): AtmAllOfMeta {
...
export function AtmAllOfMetaToJSON(value?: AtmAllOfMeta | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
