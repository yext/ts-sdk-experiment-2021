 ...
 * 
 * @export
 * @interface HealthcareFacilityAllOfPickupHoursWednesday
 */
export interface HealthcareFacilityAllOfPickupHoursWednesday {
    /**
     * Indicates if the pickup hours are "closed" on Wednesday.
     * @type {boolean}
     * @memberof HealthcareFacilityAllOfPickupHoursWednesday
     */
    isClosed?: boolean;
    /**
...
export function HealthcareFacilityAllOfPickupHoursWednesdayFromJSON(json: any): HealthcareFacilityAllOfPickupHoursWednesday {
    return HealthcareFacilityAllOfPickupHoursWednesdayFromJSONTyped(json, false);
}

export function HealthcareFacilityAllOfPickupHoursWednesdayFromJSONTyped(json: any, ignoreDiscriminator: boolean): HealthcareFacilityAllOfPickupHoursWednesday {
...
export function HealthcareFacilityAllOfPickupHoursWednesdayToJSON(value?: HealthcareFacilityAllOfPickupHoursWednesday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
