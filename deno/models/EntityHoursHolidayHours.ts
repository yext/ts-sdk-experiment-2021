 ...
 * @export
 * @interface EntityHoursHolidayHours
 */
export interface EntityHoursHolidayHours {
    /**
     ...
     * Filtering Type: `date`
     * @type {Date}
     * @memberof EntityHoursHolidayHours
     */
    date: Date;
    /**
...
export function EntityHoursHolidayHoursFromJSON(json: any): EntityHoursHolidayHours {
    return EntityHoursHolidayHoursFromJSONTyped(json, false);
}

export function EntityHoursHolidayHoursFromJSONTyped(json: any, ignoreDiscriminator: boolean): EntityHoursHolidayHours {
...
export function EntityHoursHolidayHoursToJSON(value?: EntityHoursHolidayHours | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
