 ...
 * 
 * @export
 * @interface AtmAllOfAccessHoursSaturday
 */
export interface AtmAllOfAccessHoursSaturday {
    /**
     * Indicates if the access hours are "closed" on Saturday.
     * @type {boolean}
     * @memberof AtmAllOfAccessHoursSaturday
     */
    isClosed?: boolean;
    /**
...
export function AtmAllOfAccessHoursSaturdayFromJSON(json: any): AtmAllOfAccessHoursSaturday {
    return AtmAllOfAccessHoursSaturdayFromJSONTyped(json, false);
}

export function AtmAllOfAccessHoursSaturdayFromJSONTyped(json: any, ignoreDiscriminator: boolean): AtmAllOfAccessHoursSaturday {
...
export function AtmAllOfAccessHoursSaturdayToJSON(value?: AtmAllOfAccessHoursSaturday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
