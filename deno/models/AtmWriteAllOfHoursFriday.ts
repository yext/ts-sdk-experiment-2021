 ...
 * 
 * @export
 * @interface AtmWriteAllOfHoursFriday
 */
export interface AtmWriteAllOfHoursFriday {
    /**
     * Indicates if the hours of operation are "closed" on Friday.
     * @type {boolean}
     * @memberof AtmWriteAllOfHoursFriday
     */
    isClosed?: boolean;
    /**
...
export function AtmWriteAllOfHoursFridayFromJSON(json: any): AtmWriteAllOfHoursFriday {
    return AtmWriteAllOfHoursFridayFromJSONTyped(json, false);
}

export function AtmWriteAllOfHoursFridayFromJSONTyped(json: any, ignoreDiscriminator: boolean): AtmWriteAllOfHoursFriday {
...
export function AtmWriteAllOfHoursFridayToJSON(value?: AtmWriteAllOfHoursFriday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
