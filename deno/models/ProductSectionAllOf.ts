 ...
 * 
 * @export
 * @interface ProductSectionAllOf
 */
export interface ProductSectionAllOf {
    /**
     * Section Items.
     * @type {Array<ProductItem>}
     * @memberof ProductSectionAllOf
     */
    items?: Array<ProductItem>;
}

export function ProductSectionAllOfFromJSON(json: any): ProductSectionAllOf {
    return ProductSectionAllOfFromJSONTyped(json, false);
}

export function ProductSectionAllOfFromJSONTyped(json: any, ignoreDiscriminator: boolean): ProductSectionAllOf {
...
export function ProductSectionAllOfToJSON(value?: ProductSectionAllOf | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
