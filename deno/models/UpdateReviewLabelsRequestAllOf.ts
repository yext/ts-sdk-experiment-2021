 ...
 * 
 * @export
 * @interface UpdateReviewLabelsRequestAllOf
 */
export interface UpdateReviewLabelsRequestAllOf {
    /**
     * The IDs of the review labels added to the review.
     * @type {Array<number>}
     * @memberof UpdateReviewLabelsRequestAllOf
     */
    labelIds?: Array<number>;
}

export function UpdateReviewLabelsRequestAllOfFromJSON(json: any): UpdateReviewLabelsRequestAllOf {
    return UpdateReviewLabelsRequestAllOfFromJSONTyped(json, false);
}

export function UpdateReviewLabelsRequestAllOfFromJSONTyped(json: any, ignoreDiscriminator: boolean): UpdateReviewLabelsRequestAllOf {
...
export function UpdateReviewLabelsRequestAllOfToJSON(value?: UpdateReviewLabelsRequestAllOf | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
