 ...
 * 
 * @export
 * @interface HotelAllOfBrunchHoursMonday
 */
export interface HotelAllOfBrunchHoursMonday {
    /**
     * Indicates if the brunch hours are "closed" on Monday.
     * @type {boolean}
     * @memberof HotelAllOfBrunchHoursMonday
     */
    isClosed?: boolean;
    /**
...
export function HotelAllOfBrunchHoursMondayFromJSON(json: any): HotelAllOfBrunchHoursMonday {
    return HotelAllOfBrunchHoursMondayFromJSONTyped(json, false);
}

export function HotelAllOfBrunchHoursMondayFromJSONTyped(json: any, ignoreDiscriminator: boolean): HotelAllOfBrunchHoursMonday {
...
export function HotelAllOfBrunchHoursMondayToJSON(value?: HotelAllOfBrunchHoursMonday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
