 ...
 * 
 * @export
 * @interface HealthcareFacilityWriteAllOfPickupHoursHolidayHours
 */
export interface HealthcareFacilityWriteAllOfPickupHoursHolidayHours {
    /**
     ...
     * @type {Date}
     * @memberof HealthcareFacilityWriteAllOfPickupHoursHolidayHours
     */
    date: Date;
    /**
...
export function HealthcareFacilityWriteAllOfPickupHoursHolidayHoursFromJSON(json: any): HealthcareFacilityWriteAllOfPickupHoursHolidayHours {
    return HealthcareFacilityWriteAllOfPickupHoursHolidayHoursFromJSONTyped(json, false);
}

export function HealthcareFacilityWriteAllOfPickupHoursHolidayHoursFromJSONTyped(json: any, ignoreDiscriminator: boolean): HealthcareFacilityWriteAllOfPickupHoursHolidayHours {
...
export function HealthcareFacilityWriteAllOfPickupHoursHolidayHoursToJSON(value?: HealthcareFacilityWriteAllOfPickupHoursHolidayHours | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
