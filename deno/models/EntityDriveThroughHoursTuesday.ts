 ...
 * @export
 * @interface EntityDriveThroughHoursTuesday
 */
export interface EntityDriveThroughHoursTuesday {
    /**
     * Indicates if the drive-through hours are "closed" on Tuesday.
     * 
     * Filtering Type: `boolean`
     * @type {boolean}
     * @memberof EntityDriveThroughHoursTuesday
     */
    isClosed?: boolean;
    /**
...
export function EntityDriveThroughHoursTuesdayFromJSON(json: any): EntityDriveThroughHoursTuesday {
    return EntityDriveThroughHoursTuesdayFromJSONTyped(json, false);
}

export function EntityDriveThroughHoursTuesdayFromJSONTyped(json: any, ignoreDiscriminator: boolean): EntityDriveThroughHoursTuesday {
...
export function EntityDriveThroughHoursTuesdayToJSON(value?: EntityDriveThroughHoursTuesday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
