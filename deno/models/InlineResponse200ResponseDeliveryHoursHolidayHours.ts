 ...
 * @export
 * @interface InlineResponse200ResponseDeliveryHoursHolidayHours
 */
export interface InlineResponse200ResponseDeliveryHoursHolidayHours {
    /**
     ...
     * Filtering Type: `date`
     * @type {Date}
     * @memberof InlineResponse200ResponseDeliveryHoursHolidayHours
     */
    date: Date;
    /**
...
export function InlineResponse200ResponseDeliveryHoursHolidayHoursFromJSON(json: any): InlineResponse200ResponseDeliveryHoursHolidayHours {
    return InlineResponse200ResponseDeliveryHoursHolidayHoursFromJSONTyped(json, false);
}

export function InlineResponse200ResponseDeliveryHoursHolidayHoursFromJSONTyped(json: any, ignoreDiscriminator: boolean): InlineResponse200ResponseDeliveryHoursHolidayHours {
...
export function InlineResponse200ResponseDeliveryHoursHolidayHoursToJSON(value?: InlineResponse200ResponseDeliveryHoursHolidayHours | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
