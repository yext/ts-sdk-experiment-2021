 ...
 * 
 * @export
 * @interface AtmWriteAllOfAccessHoursFriday
 */
export interface AtmWriteAllOfAccessHoursFriday {
    /**
     * Indicates if the access hours are "closed" on Friday.
     * @type {boolean}
     * @memberof AtmWriteAllOfAccessHoursFriday
     */
    isClosed?: boolean;
    /**
...
export function AtmWriteAllOfAccessHoursFridayFromJSON(json: any): AtmWriteAllOfAccessHoursFriday {
    return AtmWriteAllOfAccessHoursFridayFromJSONTyped(json, false);
}

export function AtmWriteAllOfAccessHoursFridayFromJSONTyped(json: any, ignoreDiscriminator: boolean): AtmWriteAllOfAccessHoursFriday {
...
export function AtmWriteAllOfAccessHoursFridayToJSON(value?: AtmWriteAllOfAccessHoursFriday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
