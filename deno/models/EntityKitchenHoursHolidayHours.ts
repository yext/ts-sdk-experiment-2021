 ...
 * @export
 * @interface EntityKitchenHoursHolidayHours
 */
export interface EntityKitchenHoursHolidayHours {
    /**
     ...
     * Filtering Type: `date`
     * @type {Date}
     * @memberof EntityKitchenHoursHolidayHours
     */
    date: Date;
    /**
...
export function EntityKitchenHoursHolidayHoursFromJSON(json: any): EntityKitchenHoursHolidayHours {
    return EntityKitchenHoursHolidayHoursFromJSONTyped(json, false);
}

export function EntityKitchenHoursHolidayHoursFromJSONTyped(json: any, ignoreDiscriminator: boolean): EntityKitchenHoursHolidayHours {
...
export function EntityKitchenHoursHolidayHoursToJSON(value?: EntityKitchenHoursHolidayHours | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
