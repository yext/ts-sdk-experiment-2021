 ...
 * 
 * @export
 * @interface HealthcareFacilityAllOfPickupHoursHolidayHours
 */
export interface HealthcareFacilityAllOfPickupHoursHolidayHours {
    /**
     ...
     * @type {Date}
     * @memberof HealthcareFacilityAllOfPickupHoursHolidayHours
     */
    date: Date;
    /**
...
export function HealthcareFacilityAllOfPickupHoursHolidayHoursFromJSON(json: any): HealthcareFacilityAllOfPickupHoursHolidayHours {
    return HealthcareFacilityAllOfPickupHoursHolidayHoursFromJSONTyped(json, false);
}

export function HealthcareFacilityAllOfPickupHoursHolidayHoursFromJSONTyped(json: any, ignoreDiscriminator: boolean): HealthcareFacilityAllOfPickupHoursHolidayHours {
...
export function HealthcareFacilityAllOfPickupHoursHolidayHoursToJSON(value?: HealthcareFacilityAllOfPickupHoursHolidayHours | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
