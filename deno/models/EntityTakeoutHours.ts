...
import {
    EntityTakeoutHoursFriday,
    EntityTakeoutHoursFridayFromJSON,
    EntityTakeoutHoursFridayFromJSONTyped,
    EntityTakeoutHoursFridayToJSON,
    EntityTakeoutHoursHolidayHours,
    EntityTakeoutHoursHolidayHoursFromJSON,
    EntityTakeoutHoursHolidayHoursFromJSONTyped,
    EntityTakeoutHoursHolidayHoursToJSON,
    EntityTakeoutHoursMonday,
    EntityTakeoutHoursMondayFromJSON,
    EntityTakeoutHoursMondayFromJSONTyped,
    EntityTakeoutHoursMondayToJSON,
    EntityTakeoutHoursSaturday,
    EntityTakeoutHoursSaturdayFromJSON,
    EntityTakeoutHoursSaturdayFromJSONTyped,
    EntityTakeoutHoursSaturdayToJSON,
    EntityTakeoutHoursSunday,
    EntityTakeoutHoursSundayFromJSON,
    EntityTakeoutHoursSundayFromJSONTyped,
    EntityTakeoutHoursSundayToJSON,
    EntityTakeoutHoursThursday,
    EntityTakeoutHoursThursdayFromJSON,
    EntityTakeoutHoursThursdayFromJSONTyped,
    EntityTakeoutHoursThursdayToJSON,
    EntityTakeoutHoursTuesday,
    EntityTakeoutHoursTuesdayFromJSON,
    EntityTakeoutHoursTuesdayFromJSONTyped,
    EntityTakeoutHoursTuesdayToJSON,
    EntityTakeoutHoursWednesday,
    EntityTakeoutHoursWednesdayFromJSON,
    EntityTakeoutHoursWednesdayFromJSONTyped,
    EntityTakeoutHoursWednesdayToJSON,
} from './index.ts';
 ...
 * ```
 * @export
 * @interface EntityTakeoutHours
 */
export interface EntityTakeoutHours {
    /**
     * 
     * @type {EntityTakeoutHoursFriday}
     * @memberof EntityTakeoutHours
     */
    friday?: EntityTakeoutHoursFriday;
    /**
     * 
     ...
     * @type {Set<EntityTakeoutHoursHolidayHours>}
     * @memberof EntityTakeoutHours
     */
    holidayHours?: Set<EntityTakeoutHoursHolidayHours>;
    /**
     * 
     * @type {EntityTakeoutHoursMonday}
     * @memberof EntityTakeoutHours
     */
    monday?: EntityTakeoutHoursMonday;
    /**
     * 
    ...
    /**
     * 
     * @type {EntityTakeoutHoursSaturday}
     * @memberof EntityTakeoutHours
     */
    saturday?: EntityTakeoutHoursSaturday;
    /**
     * 
     * @type {EntityTakeoutHoursSunday}
     * @memberof EntityTakeoutHours
     */
    sunday?: EntityTakeoutHoursSunday;
    /**
     * 
     * @type {EntityTakeoutHoursThursday}
     * @memberof EntityTakeoutHours
     */
    thursday?: EntityTakeoutHoursThursday;
    /**
     * 
     * @type {EntityTakeoutHoursTuesday}
     * @memberof EntityTakeoutHours
     */
    tuesday?: EntityTakeoutHoursTuesday;
    /**
     * 
     * @type {EntityTakeoutHoursWednesday}
     * @memberof EntityTakeoutHours
     */
    wednesday?: EntityTakeoutHoursWednesday;
}

export function EntityTakeoutHoursFromJSON(json: any): EntityTakeoutHours {
    return EntityTakeoutHoursFromJSONTyped(json, false);
}

export function EntityTakeoutHoursFromJSONTyped(json: any, ignoreDiscriminator: boolean): EntityTakeoutHours {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'friday': !exists(json, 'friday') ? undefined : EntityTakeoutHoursFridayFromJSON(json['friday']),
        'holidayHours': !exists(json, 'holidayHours') ? undefined : (new Set((json['holidayHours'] as Array<any>).map(EntityTakeoutHoursHolidayHoursFromJSON))),
        'monday': !exists(json, 'monday') ? undefined : EntityTakeoutHoursMondayFromJSON(json['monday']),
        'reopenDate': !exists(json, 'reopenDate') ? undefined : (new Date(json['reopenDate'])),
        'saturday': !exists(json, 'saturday') ? undefined : EntityTakeoutHoursSaturdayFromJSON(json['saturday']),
        'sunday': !exists(json, 'sunday') ? undefined : EntityTakeoutHoursSundayFromJSON(json['sunday']),
        'thursday': !exists(json, 'thursday') ? undefined : EntityTakeoutHoursThursdayFromJSON(json['thursday']),
        'tuesday': !exists(json, 'tuesday') ? undefined : EntityTakeoutHoursTuesdayFromJSON(json['tuesday']),
        'wednesday': !exists(json, 'wednesday') ? undefined : EntityTakeoutHoursWednesdayFromJSON(json['wednesday']),
    };
}

export function EntityTakeoutHoursToJSON(value?: EntityTakeoutHours | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'friday': EntityTakeoutHoursFridayToJSON(value.friday),
        'holidayHours': value.holidayHours === undefined ? undefined : (Array.from(value.holidayHours as Set<any>).map(EntityTakeoutHoursHolidayHoursToJSON)),
        'monday': EntityTakeoutHoursMondayToJSON(value.monday),
        'reopenDate': value.reopenDate === undefined ? undefined : (value.reopenDate.toISOString().substr(0,10)),
        'saturday': EntityTakeoutHoursSaturdayToJSON(value.saturday),
        'sunday': EntityTakeoutHoursSundayToJSON(value.sunday),
        'thursday': EntityTakeoutHoursThursdayToJSON(value.thursday),
        'tuesday': EntityTakeoutHoursTuesdayToJSON(value.tuesday),
        'wednesday': EntityTakeoutHoursWednesdayToJSON(value.wednesday),
    };
}
