 ...
 * @export
 * @interface EntityBrunchHoursWednesday
 */
export interface EntityBrunchHoursWednesday {
    /**
     * Indicates if the brunch hours are "closed" on Wednesday.
     * 
     * Filtering Type: `boolean`
     * @type {boolean}
     * @memberof EntityBrunchHoursWednesday
     */
    isClosed?: boolean;
    /**
...
export function EntityBrunchHoursWednesdayFromJSON(json: any): EntityBrunchHoursWednesday {
    return EntityBrunchHoursWednesdayFromJSONTyped(json, false);
}

export function EntityBrunchHoursWednesdayFromJSONTyped(json: any, ignoreDiscriminator: boolean): EntityBrunchHoursWednesday {
...
export function EntityBrunchHoursWednesdayToJSON(value?: EntityBrunchHoursWednesday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
