 ...
 * @export
 * @interface InlineResponse200ResponseDeliveryHoursMonday
 */
export interface InlineResponse200ResponseDeliveryHoursMonday {
    /**
     * Indicates if the delivery hours are "closed" on Monday.
     * 
     * Filtering Type: `boolean`
     * @type {boolean}
     * @memberof InlineResponse200ResponseDeliveryHoursMonday
     */
    isClosed?: boolean;
    /**
...
export function InlineResponse200ResponseDeliveryHoursMondayFromJSON(json: any): InlineResponse200ResponseDeliveryHoursMonday {
    return InlineResponse200ResponseDeliveryHoursMondayFromJSONTyped(json, false);
}

export function InlineResponse200ResponseDeliveryHoursMondayFromJSONTyped(json: any, ignoreDiscriminator: boolean): InlineResponse200ResponseDeliveryHoursMonday {
...
export function InlineResponse200ResponseDeliveryHoursMondayToJSON(value?: InlineResponse200ResponseDeliveryHoursMonday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
