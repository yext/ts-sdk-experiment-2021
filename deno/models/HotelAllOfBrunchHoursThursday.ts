 ...
 * 
 * @export
 * @interface HotelAllOfBrunchHoursThursday
 */
export interface HotelAllOfBrunchHoursThursday {
    /**
     * Indicates if the brunch hours are "closed" on Thursday.
     * @type {boolean}
     * @memberof HotelAllOfBrunchHoursThursday
     */
    isClosed?: boolean;
    /**
...
export function HotelAllOfBrunchHoursThursdayFromJSON(json: any): HotelAllOfBrunchHoursThursday {
    return HotelAllOfBrunchHoursThursdayFromJSONTyped(json, false);
}

export function HotelAllOfBrunchHoursThursdayFromJSONTyped(json: any, ignoreDiscriminator: boolean): HotelAllOfBrunchHoursThursday {
...
export function HotelAllOfBrunchHoursThursdayToJSON(value?: HotelAllOfBrunchHoursThursday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
