...
import {
    ...
    BaseEclToJSON,
    EventLegacyAllOf,
    EventLegacyAllOfFromJSON,
    EventLegacyAllOfFromJSONTyped,
    EventLegacyAllOfToJSON,
    EventSection,
    EventSectionFromJSON,
    EventSectionFromJSONTyped,
    EventSectionToJSON,
} from './index.ts';
...
export interface EventLegacy {
     ...
     * @memberof EventLegacy
     */
    sections?: Array<EventSection>;
}

export function EventLegacyFromJSON(json: any): EventLegacy {
    return EventLegacyFromJSONTyped(json, false);
}

export function EventLegacyFromJSONTyped(json: any, ignoreDiscriminator: boolean): EventLegacy {
    ...
    return {
        ...
        'sections': !exists(json, 'sections') ? undefined : ((json['sections'] as Array<any>).map(EventSectionFromJSON)),
    };
}

export function EventLegacyToJSON(value?: EventLegacy | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'sections': value.sections === undefined ? undefined : ((value.sections as Array<any>).map(EventSectionToJSON)),
    };
}
