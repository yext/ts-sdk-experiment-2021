 ...
 * @export
 * @interface EntityHappyHoursTuesday
 */
export interface EntityHappyHoursTuesday {
    /**
     * Indicates if the happy hours are "closed" on Tuesday.
     * 
     * Filtering Type: `boolean`
     * @type {boolean}
     * @memberof EntityHappyHoursTuesday
     */
    isClosed?: boolean;
    /**
...
export function EntityHappyHoursTuesdayFromJSON(json: any): EntityHappyHoursTuesday {
    return EntityHappyHoursTuesdayFromJSONTyped(json, false);
}

export function EntityHappyHoursTuesdayFromJSONTyped(json: any, ignoreDiscriminator: boolean): EntityHappyHoursTuesday {
...
export function EntityHappyHoursTuesdayToJSON(value?: EntityHappyHoursTuesday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
