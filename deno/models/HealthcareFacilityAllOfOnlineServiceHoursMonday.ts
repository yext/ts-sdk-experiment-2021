 ...
 * 
 * @export
 * @interface HealthcareFacilityAllOfOnlineServiceHoursMonday
 */
export interface HealthcareFacilityAllOfOnlineServiceHoursMonday {
    /**
     * Indicates if the online service hours are "closed" on Monday.
     * @type {boolean}
     * @memberof HealthcareFacilityAllOfOnlineServiceHoursMonday
     */
    isClosed?: boolean;
    /**
...
export function HealthcareFacilityAllOfOnlineServiceHoursMondayFromJSON(json: any): HealthcareFacilityAllOfOnlineServiceHoursMonday {
    return HealthcareFacilityAllOfOnlineServiceHoursMondayFromJSONTyped(json, false);
}

export function HealthcareFacilityAllOfOnlineServiceHoursMondayFromJSONTyped(json: any, ignoreDiscriminator: boolean): HealthcareFacilityAllOfOnlineServiceHoursMonday {
...
export function HealthcareFacilityAllOfOnlineServiceHoursMondayToJSON(value?: HealthcareFacilityAllOfOnlineServiceHoursMonday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
