 ...
 * ```
 * @export
 * @interface EntityFacebookProfilePhoto
 */
export interface EntityFacebookProfilePhoto {
    /**
     * Filtering Type: `text`
     * @type {string}
     * @memberof EntityFacebookProfilePhoto
     */
...
export function EntityFacebookProfilePhotoFromJSON(json: any): EntityFacebookProfilePhoto {
    return EntityFacebookProfilePhotoFromJSONTyped(json, false);
}

export function EntityFacebookProfilePhotoFromJSONTyped(json: any, ignoreDiscriminator: boolean): EntityFacebookProfilePhoto {
...
export function EntityFacebookProfilePhotoToJSON(value?: EntityFacebookProfilePhoto | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
