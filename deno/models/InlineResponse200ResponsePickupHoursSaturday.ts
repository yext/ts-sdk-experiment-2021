 ...
 * @export
 * @interface InlineResponse200ResponsePickupHoursSaturday
 */
export interface InlineResponse200ResponsePickupHoursSaturday {
    /**
     * Indicates if the pickup hours are "closed" on Saturday.
     * 
     * Filtering Type: `boolean`
     * @type {boolean}
     * @memberof InlineResponse200ResponsePickupHoursSaturday
     */
    isClosed?: boolean;
    /**
...
export function InlineResponse200ResponsePickupHoursSaturdayFromJSON(json: any): InlineResponse200ResponsePickupHoursSaturday {
    return InlineResponse200ResponsePickupHoursSaturdayFromJSONTyped(json, false);
}

export function InlineResponse200ResponsePickupHoursSaturdayFromJSONTyped(json: any, ignoreDiscriminator: boolean): InlineResponse200ResponsePickupHoursSaturday {
...
export function InlineResponse200ResponsePickupHoursSaturdayToJSON(value?: InlineResponse200ResponsePickupHoursSaturday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
