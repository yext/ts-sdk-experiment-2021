 ...
 * @export
 * @interface EntityTakeoutHoursHolidayHours
 */
export interface EntityTakeoutHoursHolidayHours {
    /**
     ...
     * Filtering Type: `date`
     * @type {Date}
     * @memberof EntityTakeoutHoursHolidayHours
     */
    date: Date;
    /**
...
export function EntityTakeoutHoursHolidayHoursFromJSON(json: any): EntityTakeoutHoursHolidayHours {
    return EntityTakeoutHoursHolidayHoursFromJSONTyped(json, false);
}

export function EntityTakeoutHoursHolidayHoursFromJSONTyped(json: any, ignoreDiscriminator: boolean): EntityTakeoutHoursHolidayHours {
...
export function EntityTakeoutHoursHolidayHoursToJSON(value?: EntityTakeoutHoursHolidayHours | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
