 ...
 * @export
 * @interface InlineResponse200ResponseDriveThroughHoursThursday
 */
export interface InlineResponse200ResponseDriveThroughHoursThursday {
    /**
     * Indicates if the drive-through hours are "closed" on Thursday.
     * 
     * Filtering Type: `boolean`
     * @type {boolean}
     * @memberof InlineResponse200ResponseDriveThroughHoursThursday
     */
    isClosed?: boolean;
    /**
...
export function InlineResponse200ResponseDriveThroughHoursThursdayFromJSON(json: any): InlineResponse200ResponseDriveThroughHoursThursday {
    return InlineResponse200ResponseDriveThroughHoursThursdayFromJSONTyped(json, false);
}

export function InlineResponse200ResponseDriveThroughHoursThursdayFromJSONTyped(json: any, ignoreDiscriminator: boolean): InlineResponse200ResponseDriveThroughHoursThursday {
...
export function InlineResponse200ResponseDriveThroughHoursThursdayToJSON(value?: InlineResponse200ResponseDriveThroughHoursThursday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
