 ...
 * @export
 * @interface EntityBrunchHoursTuesday
 */
export interface EntityBrunchHoursTuesday {
    /**
     * Indicates if the brunch hours are "closed" on Tuesday.
     * 
     * Filtering Type: `boolean`
     * @type {boolean}
     * @memberof EntityBrunchHoursTuesday
     */
    isClosed?: boolean;
    /**
...
export function EntityBrunchHoursTuesdayFromJSON(json: any): EntityBrunchHoursTuesday {
    return EntityBrunchHoursTuesdayFromJSONTyped(json, false);
}

export function EntityBrunchHoursTuesdayFromJSONTyped(json: any, ignoreDiscriminator: boolean): EntityBrunchHoursTuesday {
...
export function EntityBrunchHoursTuesdayToJSON(value?: EntityBrunchHoursTuesday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
