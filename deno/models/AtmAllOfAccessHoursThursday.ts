 ...
 * 
 * @export
 * @interface AtmAllOfAccessHoursThursday
 */
export interface AtmAllOfAccessHoursThursday {
    /**
     * Indicates if the access hours are "closed" on Thursday.
     * @type {boolean}
     * @memberof AtmAllOfAccessHoursThursday
     */
    isClosed?: boolean;
    /**
...
export function AtmAllOfAccessHoursThursdayFromJSON(json: any): AtmAllOfAccessHoursThursday {
    return AtmAllOfAccessHoursThursdayFromJSONTyped(json, false);
}

export function AtmAllOfAccessHoursThursdayFromJSONTyped(json: any, ignoreDiscriminator: boolean): AtmAllOfAccessHoursThursday {
...
export function AtmAllOfAccessHoursThursdayToJSON(value?: AtmAllOfAccessHoursThursday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
