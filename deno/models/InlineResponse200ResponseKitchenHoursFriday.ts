 ...
 * @export
 * @interface InlineResponse200ResponseKitchenHoursFriday
 */
export interface InlineResponse200ResponseKitchenHoursFriday {
    /**
     * Indicates if the kitchen hours are "closed" on Friday.
     * 
     * Filtering Type: `boolean`
     * @type {boolean}
     * @memberof InlineResponse200ResponseKitchenHoursFriday
     */
    isClosed?: boolean;
    /**
...
export function InlineResponse200ResponseKitchenHoursFridayFromJSON(json: any): InlineResponse200ResponseKitchenHoursFriday {
    return InlineResponse200ResponseKitchenHoursFridayFromJSONTyped(json, false);
}

export function InlineResponse200ResponseKitchenHoursFridayFromJSONTyped(json: any, ignoreDiscriminator: boolean): InlineResponse200ResponseKitchenHoursFriday {
...
export function InlineResponse200ResponseKitchenHoursFridayToJSON(value?: InlineResponse200ResponseKitchenHoursFriday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
