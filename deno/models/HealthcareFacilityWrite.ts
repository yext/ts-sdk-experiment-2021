...
import {
    ...
    HealthcareFacilityWriteAllOf,
    HealthcareFacilityWriteAllOfFromJSON,
    HealthcareFacilityWriteAllOfFromJSONTyped,
    HealthcareFacilityWriteAllOfToJSON,
 ...
 * 
 * @export
 * @interface HealthcareFacilityWrite
 */
export interface HealthcareFacilityWrite extends EntityWrite {
    /**
     * 
     * @type {AtmWriteAllOfMeta}
     * @memberof HealthcareFacilityWrite
     */
     ...
     * @memberof HealthcareFacilityWrite
     */
    locationType?: HealthcareFacilityWriteLocationTypeEnum;
    /**
     * 
     ...
     * @memberof HealthcareFacilityWrite
     */
    paymentOptions?: Set<HealthcareFacilityWritePaymentOptionsEnum>;
    /**
     * 
     ...
     * @memberof HealthcareFacilityWrite
     */
    priceRange?: HealthcareFacilityWritePriceRangeEnum;
    /**
     ...
     * @memberof HealthcareFacilityWrite
     */
    rankTrackingFrequency?: HealthcareFacilityWriteRankTrackingFrequencyEnum;
    /**
     ...
     * @memberof HealthcareFacilityWrite
     */
    rankTrackingQueryTemplates?: Set<HealthcareFacilityWriteRankTrackingQueryTemplatesEnum>;
    /**
     * The search engines that we will use to track your performance
     * @type {Set<string>}
     * @memberof HealthcareFacilityWrite
     */
    rankTrackingSites?: Set<HealthcareFacilityWriteRankTrackingSitesEnum>;
    /**
     * 
...
* @enum {string}
*/
export enum HealthcareFacilityWriteLocationTypeEnum {
    Location = 'LOCATION',
...
* @enum {string}
*/
export enum HealthcareFacilityWritePaymentOptionsEnum {
    Alipay = 'ALIPAY',
...
* @enum {string}
*/
export enum HealthcareFacilityWritePriceRangeEnum {
...
* @enum {string}
*/
export enum HealthcareFacilityWriteRankTrackingFrequencyEnum {
    Weekly = 'WEEKLY',
    Monthly = 'MONTHLY',
    Quarterly = 'QUARTERLY'
}/**
...
* @enum {string}
*/
export enum HealthcareFacilityWriteRankTrackingQueryTemplatesEnum {
    Keyword = 'KEYWORD',
...
* @enum {string}
*/
export enum HealthcareFacilityWriteRankTrackingSitesEnum {
...
export function HealthcareFacilityWriteFromJSON(json: any): HealthcareFacilityWrite {
    return HealthcareFacilityWriteFromJSONTyped(json, false);
}

export function HealthcareFacilityWriteFromJSONTyped(json: any, ignoreDiscriminator: boolean): HealthcareFacilityWrite {
...
export function HealthcareFacilityWriteToJSON(value?: HealthcareFacilityWrite | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
