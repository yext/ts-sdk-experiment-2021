 ...
 * ```
 * @export
 * @interface EntityFeaturedMessage
 */
export interface EntityFeaturedMessage {
    /**
     ...
     * Filtering Type: `text`
     * @type {string}
     * @memberof EntityFeaturedMessage
     */
    description?: string;
    /**
...
export function EntityFeaturedMessageFromJSON(json: any): EntityFeaturedMessage {
    return EntityFeaturedMessageFromJSONTyped(json, false);
}

export function EntityFeaturedMessageFromJSONTyped(json: any, ignoreDiscriminator: boolean): EntityFeaturedMessage {
...
export function EntityFeaturedMessageToJSON(value?: EntityFeaturedMessage | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
