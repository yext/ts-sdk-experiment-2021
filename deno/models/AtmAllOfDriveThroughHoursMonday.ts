 ...
 * 
 * @export
 * @interface AtmAllOfDriveThroughHoursMonday
 */
export interface AtmAllOfDriveThroughHoursMonday {
    /**
     * Indicates if the drive-through hours are "closed" on Monday.
     * @type {boolean}
     * @memberof AtmAllOfDriveThroughHoursMonday
     */
    isClosed?: boolean;
    /**
...
export function AtmAllOfDriveThroughHoursMondayFromJSON(json: any): AtmAllOfDriveThroughHoursMonday {
    return AtmAllOfDriveThroughHoursMondayFromJSONTyped(json, false);
}

export function AtmAllOfDriveThroughHoursMondayFromJSONTyped(json: any, ignoreDiscriminator: boolean): AtmAllOfDriveThroughHoursMonday {
...
export function AtmAllOfDriveThroughHoursMondayToJSON(value?: AtmAllOfDriveThroughHoursMonday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
