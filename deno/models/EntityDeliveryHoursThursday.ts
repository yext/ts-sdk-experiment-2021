 ...
 * @export
 * @interface EntityDeliveryHoursThursday
 */
export interface EntityDeliveryHoursThursday {
    /**
     * Indicates if the delivery hours are "closed" on Thursday.
     * 
     * Filtering Type: `boolean`
     * @type {boolean}
     * @memberof EntityDeliveryHoursThursday
     */
    isClosed?: boolean;
    /**
...
export function EntityDeliveryHoursThursdayFromJSON(json: any): EntityDeliveryHoursThursday {
    return EntityDeliveryHoursThursdayFromJSONTyped(json, false);
}

export function EntityDeliveryHoursThursdayFromJSONTyped(json: any, ignoreDiscriminator: boolean): EntityDeliveryHoursThursday {
...
export function EntityDeliveryHoursThursdayToJSON(value?: EntityDeliveryHoursThursday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
