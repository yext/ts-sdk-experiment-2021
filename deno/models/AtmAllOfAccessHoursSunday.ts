 ...
 * 
 * @export
 * @interface AtmAllOfAccessHoursSunday
 */
export interface AtmAllOfAccessHoursSunday {
    /**
     * Indicates if the access hours are "closed" on Sunday.
     * @type {boolean}
     * @memberof AtmAllOfAccessHoursSunday
     */
    isClosed?: boolean;
    /**
...
export function AtmAllOfAccessHoursSundayFromJSON(json: any): AtmAllOfAccessHoursSunday {
    return AtmAllOfAccessHoursSundayFromJSONTyped(json, false);
}

export function AtmAllOfAccessHoursSundayFromJSONTyped(json: any, ignoreDiscriminator: boolean): AtmAllOfAccessHoursSunday {
...
export function AtmAllOfAccessHoursSundayToJSON(value?: AtmAllOfAccessHoursSunday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
