 ...
 * @export
 * @interface LocationLegacyServiceArea
 */
export interface LocationLegacyServiceArea {
    /**
     ...
     * @type {number}
     * @memberof LocationLegacyServiceArea
     */
    radius?: number;
    /**
...
export function LocationLegacyServiceAreaFromJSON(json: any): LocationLegacyServiceArea {
    return LocationLegacyServiceAreaFromJSONTyped(json, false);
}

export function LocationLegacyServiceAreaFromJSONTyped(json: any, ignoreDiscriminator: boolean): LocationLegacyServiceArea {
...
export function LocationLegacyServiceAreaToJSON(value?: LocationLegacyServiceArea | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
