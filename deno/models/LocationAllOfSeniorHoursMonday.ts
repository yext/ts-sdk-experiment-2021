 ...
 * 
 * @export
 * @interface LocationAllOfSeniorHoursMonday
 */
export interface LocationAllOfSeniorHoursMonday {
    /**
     * Indicates if the senior hours are "closed" on Monday.
     * @type {boolean}
     * @memberof LocationAllOfSeniorHoursMonday
     */
    isClosed?: boolean;
    /**
...
export function LocationAllOfSeniorHoursMondayFromJSON(json: any): LocationAllOfSeniorHoursMonday {
    return LocationAllOfSeniorHoursMondayFromJSONTyped(json, false);
}

export function LocationAllOfSeniorHoursMondayFromJSONTyped(json: any, ignoreDiscriminator: boolean): LocationAllOfSeniorHoursMonday {
...
export function LocationAllOfSeniorHoursMondayToJSON(value?: LocationAllOfSeniorHoursMonday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
