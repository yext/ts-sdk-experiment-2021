...
import {
    EntityAccessHoursFriday,
    EntityAccessHoursFridayFromJSON,
    EntityAccessHoursFridayFromJSONTyped,
    EntityAccessHoursFridayToJSON,
    EntityAccessHoursHolidayHours,
    EntityAccessHoursHolidayHoursFromJSON,
    EntityAccessHoursHolidayHoursFromJSONTyped,
    EntityAccessHoursHolidayHoursToJSON,
    EntityAccessHoursMonday,
    EntityAccessHoursMondayFromJSON,
    EntityAccessHoursMondayFromJSONTyped,
    EntityAccessHoursMondayToJSON,
    EntityAccessHoursSaturday,
    EntityAccessHoursSaturdayFromJSON,
    EntityAccessHoursSaturdayFromJSONTyped,
    EntityAccessHoursSaturdayToJSON,
    EntityAccessHoursSunday,
    EntityAccessHoursSundayFromJSON,
    EntityAccessHoursSundayFromJSONTyped,
    EntityAccessHoursSundayToJSON,
    EntityAccessHoursThursday,
    EntityAccessHoursThursdayFromJSON,
    EntityAccessHoursThursdayFromJSONTyped,
    EntityAccessHoursThursdayToJSON,
    EntityAccessHoursTuesday,
    EntityAccessHoursTuesdayFromJSON,
    EntityAccessHoursTuesdayFromJSONTyped,
    EntityAccessHoursTuesdayToJSON,
    EntityAccessHoursWednesday,
    EntityAccessHoursWednesdayFromJSON,
    EntityAccessHoursWednesdayFromJSONTyped,
    EntityAccessHoursWednesdayToJSON,
} from './index.ts';
 ...
 * ```
 * @export
 * @interface EntityAccessHours
 */
export interface EntityAccessHours {
    /**
     * 
     * @type {EntityAccessHoursFriday}
     * @memberof EntityAccessHours
     */
    friday?: EntityAccessHoursFriday;
    /**
     * 
     ...
     * @type {Set<EntityAccessHoursHolidayHours>}
     * @memberof EntityAccessHours
     */
    holidayHours?: Set<EntityAccessHoursHolidayHours>;
    /**
     * 
     * @type {EntityAccessHoursMonday}
     * @memberof EntityAccessHours
     */
    monday?: EntityAccessHoursMonday;
    /**
     * 
    ...
    /**
     * 
     * @type {EntityAccessHoursSaturday}
     * @memberof EntityAccessHours
     */
    saturday?: EntityAccessHoursSaturday;
    /**
     * 
     * @type {EntityAccessHoursSunday}
     * @memberof EntityAccessHours
     */
    sunday?: EntityAccessHoursSunday;
    /**
     * 
     * @type {EntityAccessHoursThursday}
     * @memberof EntityAccessHours
     */
    thursday?: EntityAccessHoursThursday;
    /**
     * 
     * @type {EntityAccessHoursTuesday}
     * @memberof EntityAccessHours
     */
    tuesday?: EntityAccessHoursTuesday;
    /**
     * 
     * @type {EntityAccessHoursWednesday}
     * @memberof EntityAccessHours
     */
    wednesday?: EntityAccessHoursWednesday;
}

export function EntityAccessHoursFromJSON(json: any): EntityAccessHours {
    return EntityAccessHoursFromJSONTyped(json, false);
}

export function EntityAccessHoursFromJSONTyped(json: any, ignoreDiscriminator: boolean): EntityAccessHours {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'friday': !exists(json, 'friday') ? undefined : EntityAccessHoursFridayFromJSON(json['friday']),
        'holidayHours': !exists(json, 'holidayHours') ? undefined : (new Set((json['holidayHours'] as Array<any>).map(EntityAccessHoursHolidayHoursFromJSON))),
        'monday': !exists(json, 'monday') ? undefined : EntityAccessHoursMondayFromJSON(json['monday']),
        'reopenDate': !exists(json, 'reopenDate') ? undefined : (new Date(json['reopenDate'])),
        'saturday': !exists(json, 'saturday') ? undefined : EntityAccessHoursSaturdayFromJSON(json['saturday']),
        'sunday': !exists(json, 'sunday') ? undefined : EntityAccessHoursSundayFromJSON(json['sunday']),
        'thursday': !exists(json, 'thursday') ? undefined : EntityAccessHoursThursdayFromJSON(json['thursday']),
        'tuesday': !exists(json, 'tuesday') ? undefined : EntityAccessHoursTuesdayFromJSON(json['tuesday']),
        'wednesday': !exists(json, 'wednesday') ? undefined : EntityAccessHoursWednesdayFromJSON(json['wednesday']),
    };
}

export function EntityAccessHoursToJSON(value?: EntityAccessHours | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'friday': EntityAccessHoursFridayToJSON(value.friday),
        'holidayHours': value.holidayHours === undefined ? undefined : (Array.from(value.holidayHours as Set<any>).map(EntityAccessHoursHolidayHoursToJSON)),
        'monday': EntityAccessHoursMondayToJSON(value.monday),
        'reopenDate': value.reopenDate === undefined ? undefined : (value.reopenDate.toISOString().substr(0,10)),
        'saturday': EntityAccessHoursSaturdayToJSON(value.saturday),
        'sunday': EntityAccessHoursSundayToJSON(value.sunday),
        'thursday': EntityAccessHoursThursdayToJSON(value.thursday),
        'tuesday': EntityAccessHoursTuesdayToJSON(value.tuesday),
        'wednesday': EntityAccessHoursWednesdayToJSON(value.wednesday),
    };
}
