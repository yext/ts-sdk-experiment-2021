 ...
 * @export
 * @interface EntityKitchenHoursTuesday
 */
export interface EntityKitchenHoursTuesday {
    /**
     * Indicates if the kitchen hours are "closed" on Tuesday.
     * 
     * Filtering Type: `boolean`
     * @type {boolean}
     * @memberof EntityKitchenHoursTuesday
     */
    isClosed?: boolean;
    /**
...
export function EntityKitchenHoursTuesdayFromJSON(json: any): EntityKitchenHoursTuesday {
    return EntityKitchenHoursTuesdayFromJSONTyped(json, false);
}

export function EntityKitchenHoursTuesdayFromJSONTyped(json: any, ignoreDiscriminator: boolean): EntityKitchenHoursTuesday {
...
export function EntityKitchenHoursTuesdayToJSON(value?: EntityKitchenHoursTuesday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
