 ...
 * @export
 * @interface InlineResponse200ResponseHoursTuesday
 */
export interface InlineResponse200ResponseHoursTuesday {
    /**
     * Indicates if the hours of operation are "closed" on Tuesday.
     * 
     * Filtering Type: `boolean`
     * @type {boolean}
     * @memberof InlineResponse200ResponseHoursTuesday
     */
    isClosed?: boolean;
    /**
...
export function InlineResponse200ResponseHoursTuesdayFromJSON(json: any): InlineResponse200ResponseHoursTuesday {
    return InlineResponse200ResponseHoursTuesdayFromJSONTyped(json, false);
}

export function InlineResponse200ResponseHoursTuesdayFromJSONTyped(json: any, ignoreDiscriminator: boolean): InlineResponse200ResponseHoursTuesday {
...
export function InlineResponse200ResponseHoursTuesdayToJSON(value?: InlineResponse200ResponseHoursTuesday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
