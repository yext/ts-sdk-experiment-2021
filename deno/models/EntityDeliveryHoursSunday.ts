 ...
 * @export
 * @interface EntityDeliveryHoursSunday
 */
export interface EntityDeliveryHoursSunday {
    /**
     * Indicates if the delivery hours are "closed" on Sunday.
     * 
     * Filtering Type: `boolean`
     * @type {boolean}
     * @memberof EntityDeliveryHoursSunday
     */
    isClosed?: boolean;
    /**
...
export function EntityDeliveryHoursSundayFromJSON(json: any): EntityDeliveryHoursSunday {
    return EntityDeliveryHoursSundayFromJSONTyped(json, false);
}

export function EntityDeliveryHoursSundayFromJSONTyped(json: any, ignoreDiscriminator: boolean): EntityDeliveryHoursSunday {
...
export function EntityDeliveryHoursSundayToJSON(value?: EntityDeliveryHoursSunday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
