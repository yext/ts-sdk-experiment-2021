...
import {
    EntityLogoImage,
    EntityLogoImageFromJSON,
    EntityLogoImageFromJSONTyped,
    EntityLogoImageToJSON,
} from './index.ts';
...
export interface EntityLogo {
     ...
     * @memberof EntityLogo
     */
    image: EntityLogoImage;
}

export function EntityLogoFromJSON(json: any): EntityLogo {
    return EntityLogoFromJSONTyped(json, false);
}

export function EntityLogoFromJSONTyped(json: any, ignoreDiscriminator: boolean): EntityLogo {
    ...
    return {
        ...
        'image': EntityLogoImageFromJSON(json['image']),
    };
}

export function EntityLogoToJSON(value?: EntityLogo | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'image': EntityLogoImageToJSON(value.image),
    };
}
