 ...
 * 
 * @export
 * @interface LocationAllOfTakeoutHoursMonday
 */
export interface LocationAllOfTakeoutHoursMonday {
    /**
     * Indicates if the takeout hours are "closed" on Monday.
     * @type {boolean}
     * @memberof LocationAllOfTakeoutHoursMonday
     */
    isClosed?: boolean;
    /**
...
export function LocationAllOfTakeoutHoursMondayFromJSON(json: any): LocationAllOfTakeoutHoursMonday {
    return LocationAllOfTakeoutHoursMondayFromJSONTyped(json, false);
}

export function LocationAllOfTakeoutHoursMondayFromJSONTyped(json: any, ignoreDiscriminator: boolean): LocationAllOfTakeoutHoursMonday {
...
export function LocationAllOfTakeoutHoursMondayToJSON(value?: LocationAllOfTakeoutHoursMonday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
