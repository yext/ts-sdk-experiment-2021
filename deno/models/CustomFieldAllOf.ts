 ...
 * 
 * @export
 * @interface CustomFieldAllOf
 */
export interface CustomFieldAllOf {
    /**
     * 
...
* @enum {string}
*/
export enum CustomFieldAllOfTypeEnum {
    Boolean = 'BOOLEAN',
    Cta = 'CTA',
...
export function CustomFieldAllOfFromJSON(json: any): CustomFieldAllOf {
    return CustomFieldAllOfFromJSONTyped(json, false);
}

export function CustomFieldAllOfFromJSONTyped(json: any, ignoreDiscriminator: boolean): CustomFieldAllOf {
...
export function CustomFieldAllOfToJSON(value?: CustomFieldAllOf | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
