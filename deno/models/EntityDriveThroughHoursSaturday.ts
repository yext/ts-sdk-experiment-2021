 ...
 * @export
 * @interface EntityDriveThroughHoursSaturday
 */
export interface EntityDriveThroughHoursSaturday {
    /**
     * Indicates if the drive-through hours are "closed" on Saturday.
     * 
     * Filtering Type: `boolean`
     * @type {boolean}
     * @memberof EntityDriveThroughHoursSaturday
     */
    isClosed?: boolean;
    /**
...
export function EntityDriveThroughHoursSaturdayFromJSON(json: any): EntityDriveThroughHoursSaturday {
    return EntityDriveThroughHoursSaturdayFromJSONTyped(json, false);
}

export function EntityDriveThroughHoursSaturdayFromJSONTyped(json: any, ignoreDiscriminator: boolean): EntityDriveThroughHoursSaturday {
...
export function EntityDriveThroughHoursSaturdayToJSON(value?: EntityDriveThroughHoursSaturday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
