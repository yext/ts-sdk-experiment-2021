 ...
 * @export
 * @interface EntityTakeoutHoursFriday
 */
export interface EntityTakeoutHoursFriday {
    /**
     * Indicates if the takeout hours are "closed" on Friday.
     * 
     * Filtering Type: `boolean`
     * @type {boolean}
     * @memberof EntityTakeoutHoursFriday
     */
    isClosed?: boolean;
    /**
...
export function EntityTakeoutHoursFridayFromJSON(json: any): EntityTakeoutHoursFriday {
    return EntityTakeoutHoursFridayFromJSONTyped(json, false);
}

export function EntityTakeoutHoursFridayFromJSONTyped(json: any, ignoreDiscriminator: boolean): EntityTakeoutHoursFriday {
...
export function EntityTakeoutHoursFridayToJSON(value?: EntityTakeoutHoursFriday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
