 ...
 * 
 * @export
 * @interface HotelAllOfHappyHoursWednesday
 */
export interface HotelAllOfHappyHoursWednesday {
    /**
     * Indicates if the happy hours are "closed" on Wednesday.
     * @type {boolean}
     * @memberof HotelAllOfHappyHoursWednesday
     */
    isClosed?: boolean;
    /**
...
export function HotelAllOfHappyHoursWednesdayFromJSON(json: any): HotelAllOfHappyHoursWednesday {
    return HotelAllOfHappyHoursWednesdayFromJSONTyped(json, false);
}

export function HotelAllOfHappyHoursWednesdayFromJSONTyped(json: any, ignoreDiscriminator: boolean): HotelAllOfHappyHoursWednesday {
...
export function HotelAllOfHappyHoursWednesdayToJSON(value?: HotelAllOfHappyHoursWednesday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
