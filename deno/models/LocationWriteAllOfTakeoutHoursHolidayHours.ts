 ...
 * 
 * @export
 * @interface LocationWriteAllOfTakeoutHoursHolidayHours
 */
export interface LocationWriteAllOfTakeoutHoursHolidayHours {
    /**
     ...
     * @type {Date}
     * @memberof LocationWriteAllOfTakeoutHoursHolidayHours
     */
    date: Date;
    /**
...
export function LocationWriteAllOfTakeoutHoursHolidayHoursFromJSON(json: any): LocationWriteAllOfTakeoutHoursHolidayHours {
    return LocationWriteAllOfTakeoutHoursHolidayHoursFromJSONTyped(json, false);
}

export function LocationWriteAllOfTakeoutHoursHolidayHoursFromJSONTyped(json: any, ignoreDiscriminator: boolean): LocationWriteAllOfTakeoutHoursHolidayHours {
...
export function LocationWriteAllOfTakeoutHoursHolidayHoursToJSON(value?: LocationWriteAllOfTakeoutHoursHolidayHours | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
