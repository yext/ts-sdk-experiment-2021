 ...
 * @export
 * @interface EntityTakeoutHoursWednesday
 */
export interface EntityTakeoutHoursWednesday {
    /**
     * Indicates if the takeout hours are "closed" on Wednesday.
     * 
     * Filtering Type: `boolean`
     * @type {boolean}
     * @memberof EntityTakeoutHoursWednesday
     */
    isClosed?: boolean;
    /**
...
export function EntityTakeoutHoursWednesdayFromJSON(json: any): EntityTakeoutHoursWednesday {
    return EntityTakeoutHoursWednesdayFromJSONTyped(json, false);
}

export function EntityTakeoutHoursWednesdayFromJSONTyped(json: any, ignoreDiscriminator: boolean): EntityTakeoutHoursWednesday {
...
export function EntityTakeoutHoursWednesdayToJSON(value?: EntityTakeoutHoursWednesday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
