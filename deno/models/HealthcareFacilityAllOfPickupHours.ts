...
import {
    HealthcareFacilityAllOfPickupHoursFriday,
    HealthcareFacilityAllOfPickupHoursFridayFromJSON,
    HealthcareFacilityAllOfPickupHoursFridayFromJSONTyped,
    HealthcareFacilityAllOfPickupHoursFridayToJSON,
    HealthcareFacilityAllOfPickupHoursHolidayHours,
    HealthcareFacilityAllOfPickupHoursHolidayHoursFromJSON,
    HealthcareFacilityAllOfPickupHoursHolidayHoursFromJSONTyped,
    HealthcareFacilityAllOfPickupHoursHolidayHoursToJSON,
    HealthcareFacilityAllOfPickupHoursMonday,
    HealthcareFacilityAllOfPickupHoursMondayFromJSON,
    HealthcareFacilityAllOfPickupHoursMondayFromJSONTyped,
    HealthcareFacilityAllOfPickupHoursMondayToJSON,
    HealthcareFacilityAllOfPickupHoursSaturday,
    HealthcareFacilityAllOfPickupHoursSaturdayFromJSON,
    HealthcareFacilityAllOfPickupHoursSaturdayFromJSONTyped,
    HealthcareFacilityAllOfPickupHoursSaturdayToJSON,
    HealthcareFacilityAllOfPickupHoursSunday,
    HealthcareFacilityAllOfPickupHoursSundayFromJSON,
    HealthcareFacilityAllOfPickupHoursSundayFromJSONTyped,
    HealthcareFacilityAllOfPickupHoursSundayToJSON,
    HealthcareFacilityAllOfPickupHoursThursday,
    HealthcareFacilityAllOfPickupHoursThursdayFromJSON,
    HealthcareFacilityAllOfPickupHoursThursdayFromJSONTyped,
    HealthcareFacilityAllOfPickupHoursThursdayToJSON,
    HealthcareFacilityAllOfPickupHoursTuesday,
    HealthcareFacilityAllOfPickupHoursTuesdayFromJSON,
    HealthcareFacilityAllOfPickupHoursTuesdayFromJSONTyped,
    HealthcareFacilityAllOfPickupHoursTuesdayToJSON,
    HealthcareFacilityAllOfPickupHoursWednesday,
    HealthcareFacilityAllOfPickupHoursWednesdayFromJSON,
    HealthcareFacilityAllOfPickupHoursWednesdayFromJSONTyped,
    HealthcareFacilityAllOfPickupHoursWednesdayToJSON,
} from './index.ts';
 ...
 * @export
 * @interface HealthcareFacilityAllOfPickupHours
 */
export interface HealthcareFacilityAllOfPickupHours {
    /**
     * 
     * @type {HealthcareFacilityAllOfPickupHoursFriday}
     * @memberof HealthcareFacilityAllOfPickupHours
     */
    friday?: HealthcareFacilityAllOfPickupHoursFriday;
    /**
     * 
     ...
     * @type {Set<HealthcareFacilityAllOfPickupHoursHolidayHours>}
     * @memberof HealthcareFacilityAllOfPickupHours
     */
    holidayHours?: Set<HealthcareFacilityAllOfPickupHoursHolidayHours>;
    /**
     * 
     * @type {HealthcareFacilityAllOfPickupHoursMonday}
     * @memberof HealthcareFacilityAllOfPickupHours
     */
    monday?: HealthcareFacilityAllOfPickupHoursMonday;
    /**
     * 
    ...
    /**
     * 
     * @type {HealthcareFacilityAllOfPickupHoursSaturday}
     * @memberof HealthcareFacilityAllOfPickupHours
     */
    saturday?: HealthcareFacilityAllOfPickupHoursSaturday;
    /**
     * 
     * @type {HealthcareFacilityAllOfPickupHoursSunday}
     * @memberof HealthcareFacilityAllOfPickupHours
     */
    sunday?: HealthcareFacilityAllOfPickupHoursSunday;
    /**
     * 
     * @type {HealthcareFacilityAllOfPickupHoursThursday}
     * @memberof HealthcareFacilityAllOfPickupHours
     */
    thursday?: HealthcareFacilityAllOfPickupHoursThursday;
    /**
     * 
     * @type {HealthcareFacilityAllOfPickupHoursTuesday}
     * @memberof HealthcareFacilityAllOfPickupHours
     */
    tuesday?: HealthcareFacilityAllOfPickupHoursTuesday;
    /**
     * 
     * @type {HealthcareFacilityAllOfPickupHoursWednesday}
     * @memberof HealthcareFacilityAllOfPickupHours
     */
    wednesday?: HealthcareFacilityAllOfPickupHoursWednesday;
}

export function HealthcareFacilityAllOfPickupHoursFromJSON(json: any): HealthcareFacilityAllOfPickupHours {
    return HealthcareFacilityAllOfPickupHoursFromJSONTyped(json, false);
}

export function HealthcareFacilityAllOfPickupHoursFromJSONTyped(json: any, ignoreDiscriminator: boolean): HealthcareFacilityAllOfPickupHours {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'friday': !exists(json, 'friday') ? undefined : HealthcareFacilityAllOfPickupHoursFridayFromJSON(json['friday']),
        'holidayHours': !exists(json, 'holidayHours') ? undefined : (new Set((json['holidayHours'] as Array<any>).map(HealthcareFacilityAllOfPickupHoursHolidayHoursFromJSON))),
        'monday': !exists(json, 'monday') ? undefined : HealthcareFacilityAllOfPickupHoursMondayFromJSON(json['monday']),
        'reopenDate': !exists(json, 'reopenDate') ? undefined : (new Date(json['reopenDate'])),
        'saturday': !exists(json, 'saturday') ? undefined : HealthcareFacilityAllOfPickupHoursSaturdayFromJSON(json['saturday']),
        'sunday': !exists(json, 'sunday') ? undefined : HealthcareFacilityAllOfPickupHoursSundayFromJSON(json['sunday']),
        'thursday': !exists(json, 'thursday') ? undefined : HealthcareFacilityAllOfPickupHoursThursdayFromJSON(json['thursday']),
        'tuesday': !exists(json, 'tuesday') ? undefined : HealthcareFacilityAllOfPickupHoursTuesdayFromJSON(json['tuesday']),
        'wednesday': !exists(json, 'wednesday') ? undefined : HealthcareFacilityAllOfPickupHoursWednesdayFromJSON(json['wednesday']),
    };
}

export function HealthcareFacilityAllOfPickupHoursToJSON(value?: HealthcareFacilityAllOfPickupHours | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'friday': HealthcareFacilityAllOfPickupHoursFridayToJSON(value.friday),
        'holidayHours': value.holidayHours === undefined ? undefined : (Array.from(value.holidayHours as Set<any>).map(HealthcareFacilityAllOfPickupHoursHolidayHoursToJSON)),
        'monday': HealthcareFacilityAllOfPickupHoursMondayToJSON(value.monday),
        'reopenDate': value.reopenDate === undefined ? undefined : (value.reopenDate.toISOString().substr(0,10)),
        'saturday': HealthcareFacilityAllOfPickupHoursSaturdayToJSON(value.saturday),
        'sunday': HealthcareFacilityAllOfPickupHoursSundayToJSON(value.sunday),
        'thursday': HealthcareFacilityAllOfPickupHoursThursdayToJSON(value.thursday),
        'tuesday': HealthcareFacilityAllOfPickupHoursTuesdayToJSON(value.tuesday),
        'wednesday': HealthcareFacilityAllOfPickupHoursWednesdayToJSON(value.wednesday),
    };
}
