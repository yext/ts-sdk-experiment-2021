 ...
 * 
 * @export
 * @interface LocationAllOfTakeoutHoursSaturday
 */
export interface LocationAllOfTakeoutHoursSaturday {
    /**
     * Indicates if the takeout hours are "closed" on Saturday.
     * @type {boolean}
     * @memberof LocationAllOfTakeoutHoursSaturday
     */
    isClosed?: boolean;
    /**
...
export function LocationAllOfTakeoutHoursSaturdayFromJSON(json: any): LocationAllOfTakeoutHoursSaturday {
    return LocationAllOfTakeoutHoursSaturdayFromJSONTyped(json, false);
}

export function LocationAllOfTakeoutHoursSaturdayFromJSONTyped(json: any, ignoreDiscriminator: boolean): LocationAllOfTakeoutHoursSaturday {
...
export function LocationAllOfTakeoutHoursSaturdayToJSON(value?: LocationAllOfTakeoutHoursSaturday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
