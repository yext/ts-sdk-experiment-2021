...
export interface EntityDistance {
     ...
     * External entity ID
     * @type {string}
     * @memberof EntityDistance
     */
    id?: string;
    /**
     * 
     * Distance in miles between the entity and the coordinate specified in the Geo object.
     * @type {number}
     * @memberof EntityDistance
     */
    ...
    /**
     * 
     * Distance in kilometers between the entity and the coordinate specified in the Geo object.
     * @type {number}
     * @memberof EntityDistance
     */
...
export function EntityDistanceFromJSON(json: any): EntityDistance {
    return EntityDistanceFromJSONTyped(json, false);
}

export function EntityDistanceFromJSONTyped(json: any, ignoreDiscriminator: boolean): EntityDistance {
    ...
    return {
        ...
        'distanceKilometers': !exists(json, 'distanceKilometers') ? undefined : json['distanceKilometers'],
    };
}

export function EntityDistanceToJSON(value?: EntityDistance | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
