 ...
 * ```
 * @export
 * @interface EntityWebsiteUrl
 */
export interface EntityWebsiteUrl {
    /**
...
export function EntityWebsiteUrlFromJSON(json: any): EntityWebsiteUrl {
    return EntityWebsiteUrlFromJSONTyped(json, false);
}

export function EntityWebsiteUrlFromJSONTyped(json: any, ignoreDiscriminator: boolean): EntityWebsiteUrl {
...
export function EntityWebsiteUrlToJSON(value?: EntityWebsiteUrl | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
