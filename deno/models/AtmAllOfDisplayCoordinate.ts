 ...
 * @export
 * @interface AtmAllOfDisplayCoordinate
 */
export interface AtmAllOfDisplayCoordinate {
    /**
     * 
     * @type {number}
     * @memberof AtmAllOfDisplayCoordinate
     */
    latitude?: number;
    /**
     * 
...
export function AtmAllOfDisplayCoordinateFromJSON(json: any): AtmAllOfDisplayCoordinate {
    return AtmAllOfDisplayCoordinateFromJSONTyped(json, false);
}

export function AtmAllOfDisplayCoordinateFromJSONTyped(json: any, ignoreDiscriminator: boolean): AtmAllOfDisplayCoordinate {
...
export function AtmAllOfDisplayCoordinateToJSON(value?: AtmAllOfDisplayCoordinate | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
