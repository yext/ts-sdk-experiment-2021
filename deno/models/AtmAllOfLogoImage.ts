 ...
 * @export
 * @interface AtmAllOfLogoImage
 */
export interface AtmAllOfLogoImage {
    /**
     * 
     * @type {string}
     * @memberof AtmAllOfLogoImage
     */
...
export function AtmAllOfLogoImageFromJSON(json: any): AtmAllOfLogoImage {
    return AtmAllOfLogoImageFromJSONTyped(json, false);
}

export function AtmAllOfLogoImageFromJSONTyped(json: any, ignoreDiscriminator: boolean): AtmAllOfLogoImage {
...
export function AtmAllOfLogoImageToJSON(value?: AtmAllOfLogoImage | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
