 ...
 * 
 * @export
 * @interface LocationAllOfDeliveryHoursThursday
 */
export interface LocationAllOfDeliveryHoursThursday {
    /**
     * Indicates if the delivery hours are "closed" on Thursday.
     * @type {boolean}
     * @memberof LocationAllOfDeliveryHoursThursday
     */
    isClosed?: boolean;
    /**
...
export function LocationAllOfDeliveryHoursThursdayFromJSON(json: any): LocationAllOfDeliveryHoursThursday {
    return LocationAllOfDeliveryHoursThursdayFromJSONTyped(json, false);
}

export function LocationAllOfDeliveryHoursThursdayFromJSONTyped(json: any, ignoreDiscriminator: boolean): LocationAllOfDeliveryHoursThursday {
...
export function LocationAllOfDeliveryHoursThursdayToJSON(value?: LocationAllOfDeliveryHoursThursday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
