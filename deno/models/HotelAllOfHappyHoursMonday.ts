 ...
 * 
 * @export
 * @interface HotelAllOfHappyHoursMonday
 */
export interface HotelAllOfHappyHoursMonday {
    /**
     * Indicates if the happy hours are "closed" on Monday.
     * @type {boolean}
     * @memberof HotelAllOfHappyHoursMonday
     */
    isClosed?: boolean;
    /**
...
export function HotelAllOfHappyHoursMondayFromJSON(json: any): HotelAllOfHappyHoursMonday {
    return HotelAllOfHappyHoursMondayFromJSONTyped(json, false);
}

export function HotelAllOfHappyHoursMondayFromJSONTyped(json: any, ignoreDiscriminator: boolean): HotelAllOfHappyHoursMonday {
...
export function HotelAllOfHappyHoursMondayToJSON(value?: HotelAllOfHappyHoursMonday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
