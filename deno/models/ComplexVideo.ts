...
import {
    ...
    AssetUsageToJSON,
    ComplexVideoAllOf,
    ComplexVideoAllOfFromJSON,
    ComplexVideoAllOfFromJSONTyped,
    ComplexVideoAllOfToJSON,
    ComplexVideoValue,
 ...
 * 
 * @export
 * @interface ComplexVideo
 */
export interface ComplexVideo extends Asset {
    /**
     * 
     * @type {ComplexVideoValue}
     * @memberof ComplexVideo
     */
    value?: ComplexVideoValue;
}

export function ComplexVideoFromJSON(json: any): ComplexVideo {
    return ComplexVideoFromJSONTyped(json, false);
}

export function ComplexVideoFromJSONTyped(json: any, ignoreDiscriminator: boolean): ComplexVideo {
...
export function ComplexVideoToJSON(value?: ComplexVideo | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
