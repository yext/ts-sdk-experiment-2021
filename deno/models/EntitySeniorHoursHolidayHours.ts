 ...
 * @export
 * @interface EntitySeniorHoursHolidayHours
 */
export interface EntitySeniorHoursHolidayHours {
    /**
     ...
     * Filtering Type: `date`
     * @type {Date}
     * @memberof EntitySeniorHoursHolidayHours
     */
    date: Date;
    /**
...
export function EntitySeniorHoursHolidayHoursFromJSON(json: any): EntitySeniorHoursHolidayHours {
    return EntitySeniorHoursHolidayHoursFromJSONTyped(json, false);
}

export function EntitySeniorHoursHolidayHoursFromJSONTyped(json: any, ignoreDiscriminator: boolean): EntitySeniorHoursHolidayHours {
...
export function EntitySeniorHoursHolidayHoursToJSON(value?: EntitySeniorHoursHolidayHours | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
