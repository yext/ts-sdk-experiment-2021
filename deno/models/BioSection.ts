...
import {
    ...
    BioItemToJSON,
    BioSectionAllOf,
    BioSectionAllOfFromJSON,
    BioSectionAllOfFromJSONTyped,
    BioSectionAllOfToJSON,
} from './index.ts';
...
export function BioSectionFromJSON(json: any): BioSection {
    return BioSectionFromJSONTyped(json, false);
}

export function BioSectionFromJSONTyped(json: any, ignoreDiscriminator: boolean): BioSection {
...
export function BioSectionToJSON(value?: BioSection | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
