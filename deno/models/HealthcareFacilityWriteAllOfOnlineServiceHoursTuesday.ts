 ...
 * 
 * @export
 * @interface HealthcareFacilityWriteAllOfOnlineServiceHoursTuesday
 */
export interface HealthcareFacilityWriteAllOfOnlineServiceHoursTuesday {
    /**
     * Indicates if the online service hours are "closed" on Tuesday.
     * @type {boolean}
     * @memberof HealthcareFacilityWriteAllOfOnlineServiceHoursTuesday
     */
    isClosed?: boolean;
    /**
...
export function HealthcareFacilityWriteAllOfOnlineServiceHoursTuesdayFromJSON(json: any): HealthcareFacilityWriteAllOfOnlineServiceHoursTuesday {
    return HealthcareFacilityWriteAllOfOnlineServiceHoursTuesdayFromJSONTyped(json, false);
}

export function HealthcareFacilityWriteAllOfOnlineServiceHoursTuesdayFromJSONTyped(json: any, ignoreDiscriminator: boolean): HealthcareFacilityWriteAllOfOnlineServiceHoursTuesday {
...
export function HealthcareFacilityWriteAllOfOnlineServiceHoursTuesdayToJSON(value?: HealthcareFacilityWriteAllOfOnlineServiceHoursTuesday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
