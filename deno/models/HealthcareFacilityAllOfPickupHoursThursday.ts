 ...
 * 
 * @export
 * @interface HealthcareFacilityAllOfPickupHoursThursday
 */
export interface HealthcareFacilityAllOfPickupHoursThursday {
    /**
     * Indicates if the pickup hours are "closed" on Thursday.
     * @type {boolean}
     * @memberof HealthcareFacilityAllOfPickupHoursThursday
     */
    isClosed?: boolean;
    /**
...
export function HealthcareFacilityAllOfPickupHoursThursdayFromJSON(json: any): HealthcareFacilityAllOfPickupHoursThursday {
    return HealthcareFacilityAllOfPickupHoursThursdayFromJSONTyped(json, false);
}

export function HealthcareFacilityAllOfPickupHoursThursdayFromJSONTyped(json: any, ignoreDiscriminator: boolean): HealthcareFacilityAllOfPickupHoursThursday {
...
export function HealthcareFacilityAllOfPickupHoursThursdayToJSON(value?: HealthcareFacilityAllOfPickupHoursThursday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
