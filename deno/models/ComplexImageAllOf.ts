 ...
 * 
 * @export
 * @interface ComplexImageAllOf
 */
export interface ComplexImageAllOf {
    /**
     * 
     * @type {ComplexImageValue}
     * @memberof ComplexImageAllOf
     */
    value?: ComplexImageValue;
}

export function ComplexImageAllOfFromJSON(json: any): ComplexImageAllOf {
    return ComplexImageAllOfFromJSONTyped(json, false);
}

export function ComplexImageAllOfFromJSONTyped(json: any, ignoreDiscriminator: boolean): ComplexImageAllOf {
...
export function ComplexImageAllOfToJSON(value?: ComplexImageAllOf | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
