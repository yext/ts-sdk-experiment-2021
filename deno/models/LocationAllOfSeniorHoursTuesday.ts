 ...
 * 
 * @export
 * @interface LocationAllOfSeniorHoursTuesday
 */
export interface LocationAllOfSeniorHoursTuesday {
    /**
     * Indicates if the senior hours are "closed" on Tuesday.
     * @type {boolean}
     * @memberof LocationAllOfSeniorHoursTuesday
     */
    isClosed?: boolean;
    /**
...
export function LocationAllOfSeniorHoursTuesdayFromJSON(json: any): LocationAllOfSeniorHoursTuesday {
    return LocationAllOfSeniorHoursTuesdayFromJSONTyped(json, false);
}

export function LocationAllOfSeniorHoursTuesdayFromJSONTyped(json: any, ignoreDiscriminator: boolean): LocationAllOfSeniorHoursTuesday {
...
export function LocationAllOfSeniorHoursTuesdayToJSON(value?: LocationAllOfSeniorHoursTuesday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
