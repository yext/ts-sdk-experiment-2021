 ...
 * 
 * @export
 * @interface LocationAllOfDeliveryHoursSunday
 */
export interface LocationAllOfDeliveryHoursSunday {
    /**
     * Indicates if the delivery hours are "closed" on Sunday.
     * @type {boolean}
     * @memberof LocationAllOfDeliveryHoursSunday
     */
    isClosed?: boolean;
    /**
...
export function LocationAllOfDeliveryHoursSundayFromJSON(json: any): LocationAllOfDeliveryHoursSunday {
    return LocationAllOfDeliveryHoursSundayFromJSONTyped(json, false);
}

export function LocationAllOfDeliveryHoursSundayFromJSONTyped(json: any, ignoreDiscriminator: boolean): LocationAllOfDeliveryHoursSunday {
...
export function LocationAllOfDeliveryHoursSundayToJSON(value?: LocationAllOfDeliveryHoursSunday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
