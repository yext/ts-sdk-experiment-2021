 ...
 * ```
 * @export
 * @interface EntityYextWalkableCoordinate
 */
export interface EntityYextWalkableCoordinate {
    /**
     * Filtering Type: `float`
     * @type {number}
     * @memberof EntityYextWalkableCoordinate
     */
    latitude?: number;
    /**
     * Filtering Type: `float`
...
export function EntityYextWalkableCoordinateFromJSON(json: any): EntityYextWalkableCoordinate {
    return EntityYextWalkableCoordinateFromJSONTyped(json, false);
}

export function EntityYextWalkableCoordinateFromJSONTyped(json: any, ignoreDiscriminator: boolean): EntityYextWalkableCoordinate {
...
export function EntityYextWalkableCoordinateToJSON(value?: EntityYextWalkableCoordinate | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
