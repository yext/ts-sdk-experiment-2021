 ...
 * @export
 * @interface InlineResponse200ResponseDriveThroughHoursSaturday
 */
export interface InlineResponse200ResponseDriveThroughHoursSaturday {
    /**
     * Indicates if the drive-through hours are "closed" on Saturday.
     * 
     * Filtering Type: `boolean`
     * @type {boolean}
     * @memberof InlineResponse200ResponseDriveThroughHoursSaturday
     */
    isClosed?: boolean;
    /**
...
export function InlineResponse200ResponseDriveThroughHoursSaturdayFromJSON(json: any): InlineResponse200ResponseDriveThroughHoursSaturday {
    return InlineResponse200ResponseDriveThroughHoursSaturdayFromJSONTyped(json, false);
}

export function InlineResponse200ResponseDriveThroughHoursSaturdayFromJSONTyped(json: any, ignoreDiscriminator: boolean): InlineResponse200ResponseDriveThroughHoursSaturday {
...
export function InlineResponse200ResponseDriveThroughHoursSaturdayToJSON(value?: InlineResponse200ResponseDriveThroughHoursSaturday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
