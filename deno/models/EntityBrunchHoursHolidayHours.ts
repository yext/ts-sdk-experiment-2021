 ...
 * @export
 * @interface EntityBrunchHoursHolidayHours
 */
export interface EntityBrunchHoursHolidayHours {
    /**
     ...
     * Filtering Type: `date`
     * @type {Date}
     * @memberof EntityBrunchHoursHolidayHours
     */
    date: Date;
    /**
...
export function EntityBrunchHoursHolidayHoursFromJSON(json: any): EntityBrunchHoursHolidayHours {
    return EntityBrunchHoursHolidayHoursFromJSONTyped(json, false);
}

export function EntityBrunchHoursHolidayHoursFromJSONTyped(json: any, ignoreDiscriminator: boolean): EntityBrunchHoursHolidayHours {
...
export function EntityBrunchHoursHolidayHoursToJSON(value?: EntityBrunchHoursHolidayHours | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
