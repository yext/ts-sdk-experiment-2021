 ...
 * 
 * @export
 * @interface HotelAllOfHappyHoursThursday
 */
export interface HotelAllOfHappyHoursThursday {
    /**
     * Indicates if the happy hours are "closed" on Thursday.
     * @type {boolean}
     * @memberof HotelAllOfHappyHoursThursday
     */
    isClosed?: boolean;
    /**
...
export function HotelAllOfHappyHoursThursdayFromJSON(json: any): HotelAllOfHappyHoursThursday {
    return HotelAllOfHappyHoursThursdayFromJSONTyped(json, false);
}

export function HotelAllOfHappyHoursThursdayFromJSONTyped(json: any, ignoreDiscriminator: boolean): HotelAllOfHappyHoursThursday {
...
export function HotelAllOfHappyHoursThursdayToJSON(value?: HotelAllOfHappyHoursThursday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
