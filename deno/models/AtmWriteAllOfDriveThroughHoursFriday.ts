 ...
 * 
 * @export
 * @interface AtmWriteAllOfDriveThroughHoursFriday
 */
export interface AtmWriteAllOfDriveThroughHoursFriday {
    /**
     * Indicates if the drive-through hours are "closed" on Friday.
     * @type {boolean}
     * @memberof AtmWriteAllOfDriveThroughHoursFriday
     */
    isClosed?: boolean;
    /**
...
export function AtmWriteAllOfDriveThroughHoursFridayFromJSON(json: any): AtmWriteAllOfDriveThroughHoursFriday {
    return AtmWriteAllOfDriveThroughHoursFridayFromJSONTyped(json, false);
}

export function AtmWriteAllOfDriveThroughHoursFridayFromJSONTyped(json: any, ignoreDiscriminator: boolean): AtmWriteAllOfDriveThroughHoursFriday {
...
export function AtmWriteAllOfDriveThroughHoursFridayToJSON(value?: AtmWriteAllOfDriveThroughHoursFriday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
