 ...
 * 
 * @export
 * @interface HotelAllOfKitchenHoursSaturday
 */
export interface HotelAllOfKitchenHoursSaturday {
    /**
     * Indicates if the kitchen hours are "closed" on Saturday.
     * @type {boolean}
     * @memberof HotelAllOfKitchenHoursSaturday
     */
    isClosed?: boolean;
    /**
...
export function HotelAllOfKitchenHoursSaturdayFromJSON(json: any): HotelAllOfKitchenHoursSaturday {
    return HotelAllOfKitchenHoursSaturdayFromJSONTyped(json, false);
}

export function HotelAllOfKitchenHoursSaturdayFromJSONTyped(json: any, ignoreDiscriminator: boolean): HotelAllOfKitchenHoursSaturday {
...
export function HotelAllOfKitchenHoursSaturdayToJSON(value?: HotelAllOfKitchenHoursSaturday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
