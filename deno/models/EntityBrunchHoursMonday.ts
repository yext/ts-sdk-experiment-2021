 ...
 * @export
 * @interface EntityBrunchHoursMonday
 */
export interface EntityBrunchHoursMonday {
    /**
     * Indicates if the brunch hours are "closed" on Monday.
     * 
     * Filtering Type: `boolean`
     * @type {boolean}
     * @memberof EntityBrunchHoursMonday
     */
    isClosed?: boolean;
    /**
...
export function EntityBrunchHoursMondayFromJSON(json: any): EntityBrunchHoursMonday {
    return EntityBrunchHoursMondayFromJSONTyped(json, false);
}

export function EntityBrunchHoursMondayFromJSONTyped(json: any, ignoreDiscriminator: boolean): EntityBrunchHoursMonday {
...
export function EntityBrunchHoursMondayToJSON(value?: EntityBrunchHoursMonday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
