 ...
 * @export
 * @interface HealthcareFacilityAllOfUberLink
 */
export interface HealthcareFacilityAllOfUberLink {
    /**
     ...
     * @type {string}
     * @memberof HealthcareFacilityAllOfUberLink
     */
    presentation: HealthcareFacilityAllOfUberLinkPresentationEnum;
    /**
...
* @enum {string}
*/
export enum HealthcareFacilityAllOfUberLinkPresentationEnum {
    Button = 'BUTTON',
    Link = 'LINK'
}

export function HealthcareFacilityAllOfUberLinkFromJSON(json: any): HealthcareFacilityAllOfUberLink {
    return HealthcareFacilityAllOfUberLinkFromJSONTyped(json, false);
}

export function HealthcareFacilityAllOfUberLinkFromJSONTyped(json: any, ignoreDiscriminator: boolean): HealthcareFacilityAllOfUberLink {
...
export function HealthcareFacilityAllOfUberLinkToJSON(value?: HealthcareFacilityAllOfUberLink | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
