 ...
 * 
 * @export
 * @interface AtmAllOfRankTrackingCompetitors
 */
export interface AtmAllOfRankTrackingCompetitors {
    /**
     ...
     * * HTML markup
     * @type {string}
     * @memberof AtmAllOfRankTrackingCompetitors
     */
    name: string;
    /**
...
export function AtmAllOfRankTrackingCompetitorsFromJSON(json: any): AtmAllOfRankTrackingCompetitors {
    return AtmAllOfRankTrackingCompetitorsFromJSONTyped(json, false);
}

export function AtmAllOfRankTrackingCompetitorsFromJSONTyped(json: any, ignoreDiscriminator: boolean): AtmAllOfRankTrackingCompetitors {
...
export function AtmAllOfRankTrackingCompetitorsToJSON(value?: AtmAllOfRankTrackingCompetitors | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
