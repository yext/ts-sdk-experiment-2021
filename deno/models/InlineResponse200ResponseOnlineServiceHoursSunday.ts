 ...
 * @export
 * @interface InlineResponse200ResponseOnlineServiceHoursSunday
 */
export interface InlineResponse200ResponseOnlineServiceHoursSunday {
    /**
     * Indicates if the online service hours are "closed" on Sunday.
     * 
     * Filtering Type: `boolean`
     * @type {boolean}
     * @memberof InlineResponse200ResponseOnlineServiceHoursSunday
     */
    isClosed?: boolean;
    /**
...
export function InlineResponse200ResponseOnlineServiceHoursSundayFromJSON(json: any): InlineResponse200ResponseOnlineServiceHoursSunday {
    return InlineResponse200ResponseOnlineServiceHoursSundayFromJSONTyped(json, false);
}

export function InlineResponse200ResponseOnlineServiceHoursSundayFromJSONTyped(json: any, ignoreDiscriminator: boolean): InlineResponse200ResponseOnlineServiceHoursSunday {
...
export function InlineResponse200ResponseOnlineServiceHoursSundayToJSON(value?: InlineResponse200ResponseOnlineServiceHoursSunday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
