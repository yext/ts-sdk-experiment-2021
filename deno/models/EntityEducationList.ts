 ...
 * @export
 * @interface EntityEducationList
 */
export interface EntityEducationList {
    /**
     * Filtering Type: `text`
     * @type {string}
     * @memberof EntityEducationList
     */
     ...
     * @memberof EntityEducationList
     */
    type: EntityEducationListTypeEnum;
    /**
...
* @enum {string}
*/
export enum EntityEducationListTypeEnum {
...
export function EntityEducationListFromJSON(json: any): EntityEducationList {
    return EntityEducationListFromJSONTyped(json, false);
}

export function EntityEducationListFromJSONTyped(json: any, ignoreDiscriminator: boolean): EntityEducationList {
...
export function EntityEducationListToJSON(value?: EntityEducationList | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
