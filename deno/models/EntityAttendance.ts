 ...
 * ```
 * @export
 * @interface EntityAttendance
 */
export interface EntityAttendance {
    /**
     * Filtering Type: `option`
     * @type {string}
     * @memberof EntityAttendance
     */
    attendanceMode: EntityAttendanceAttendanceModeEnum;
    /**
     * Filtering Type: `text`
     * @type {string}
     * @memberof EntityAttendance
...
* @enum {string}
*/
export enum EntityAttendanceAttendanceModeEnum {
    Offline = 'OFFLINE',
    Online = 'ONLINE',
    Mixed = 'MIXED'
}

export function EntityAttendanceFromJSON(json: any): EntityAttendance {
    return EntityAttendanceFromJSONTyped(json, false);
}

export function EntityAttendanceFromJSONTyped(json: any, ignoreDiscriminator: boolean): EntityAttendance {
...
export function EntityAttendanceToJSON(value?: EntityAttendance | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
