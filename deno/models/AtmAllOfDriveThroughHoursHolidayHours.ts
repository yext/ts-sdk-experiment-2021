 ...
 * 
 * @export
 * @interface AtmAllOfDriveThroughHoursHolidayHours
 */
export interface AtmAllOfDriveThroughHoursHolidayHours {
    /**
     ...
     * @type {Date}
     * @memberof AtmAllOfDriveThroughHoursHolidayHours
     */
    date: Date;
    /**
...
export function AtmAllOfDriveThroughHoursHolidayHoursFromJSON(json: any): AtmAllOfDriveThroughHoursHolidayHours {
    return AtmAllOfDriveThroughHoursHolidayHoursFromJSONTyped(json, false);
}

export function AtmAllOfDriveThroughHoursHolidayHoursFromJSONTyped(json: any, ignoreDiscriminator: boolean): AtmAllOfDriveThroughHoursHolidayHours {
...
export function AtmAllOfDriveThroughHoursHolidayHoursToJSON(value?: AtmAllOfDriveThroughHoursHolidayHours | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
