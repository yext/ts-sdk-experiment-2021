 ...
 * 
 * @export
 * @interface HotelAllOfBrunchHoursHolidayHours
 */
export interface HotelAllOfBrunchHoursHolidayHours {
    /**
     ...
     * @type {Date}
     * @memberof HotelAllOfBrunchHoursHolidayHours
     */
    date: Date;
    /**
...
export function HotelAllOfBrunchHoursHolidayHoursFromJSON(json: any): HotelAllOfBrunchHoursHolidayHours {
    return HotelAllOfBrunchHoursHolidayHoursFromJSONTyped(json, false);
}

export function HotelAllOfBrunchHoursHolidayHoursFromJSONTyped(json: any, ignoreDiscriminator: boolean): HotelAllOfBrunchHoursHolidayHours {
...
export function HotelAllOfBrunchHoursHolidayHoursToJSON(value?: HotelAllOfBrunchHoursHolidayHours | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
