 ...
 * 
 * @export
 * @interface HotelAllOfKitchenHoursTuesday
 */
export interface HotelAllOfKitchenHoursTuesday {
    /**
     * Indicates if the kitchen hours are "closed" on Tuesday.
     * @type {boolean}
     * @memberof HotelAllOfKitchenHoursTuesday
     */
    isClosed?: boolean;
    /**
...
export function HotelAllOfKitchenHoursTuesdayFromJSON(json: any): HotelAllOfKitchenHoursTuesday {
    return HotelAllOfKitchenHoursTuesdayFromJSONTyped(json, false);
}

export function HotelAllOfKitchenHoursTuesdayFromJSONTyped(json: any, ignoreDiscriminator: boolean): HotelAllOfKitchenHoursTuesday {
...
export function HotelAllOfKitchenHoursTuesdayToJSON(value?: HotelAllOfKitchenHoursTuesday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
