...
export interface Geo {
    /**
     * Latitude as returned by geocoder. If no value, returns ""
     * @type {string}
     * @memberof Geo
     */
    latitude: string;
    /**
     * Longitude as returned by geocoder. If no value, returns ""
     * @type {string}
     * @memberof Geo
     */
    longitude: string;
    /**
     * Address field as returned by geocoder. If no value, returns ""
     * @type {string}
     * @memberof Geo
     */
    address: string;
    /**
     * Address2 field as returned by geocoder. If no value, returns ""
     * @type {string}
     * @memberof Geo
     */
    address2: string;
    /**
     * Locality (city) field as returned by geocoder. If no value, returns ""
     * @type {string}
     * @memberof Geo
     */
    locality: string;
    /**
     * Region (state) field as returned by geocoder. If no value, returns ""
     * @type {string}
     * @memberof Geo
     */
    region: string;
    /**
     * PostalCode (ZIP) field as returned by geocoder. If no value, returns ""
     * @type {string}
     * @memberof Geo
     */
    postalCode: string;
    /**
     * Country field as returned by geocoder. If no value, returns ""
     * @type {string}
     * @memberof Geo
     */
    country: string;
     ...
     * @memberof Geo
     */
    granularity: GeoGranularityEnum;
}
...
* @enum {string}
*/
export enum GeoGranularityEnum {
    Point = 'POINT',
    Address = 'ADDRESS',
    Street = 'STREET',
