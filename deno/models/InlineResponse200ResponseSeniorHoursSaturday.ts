 ...
 * @export
 * @interface InlineResponse200ResponseSeniorHoursSaturday
 */
export interface InlineResponse200ResponseSeniorHoursSaturday {
    /**
     * Indicates if the senior hours are "closed" on Saturday.
     * 
     * Filtering Type: `boolean`
     * @type {boolean}
     * @memberof InlineResponse200ResponseSeniorHoursSaturday
     */
    isClosed?: boolean;
    /**
...
export function InlineResponse200ResponseSeniorHoursSaturdayFromJSON(json: any): InlineResponse200ResponseSeniorHoursSaturday {
    return InlineResponse200ResponseSeniorHoursSaturdayFromJSONTyped(json, false);
}

export function InlineResponse200ResponseSeniorHoursSaturdayFromJSONTyped(json: any, ignoreDiscriminator: boolean): InlineResponse200ResponseSeniorHoursSaturday {
...
export function InlineResponse200ResponseSeniorHoursSaturdayToJSON(value?: InlineResponse200ResponseSeniorHoursSaturday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
