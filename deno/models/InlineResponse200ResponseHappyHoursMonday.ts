 ...
 * @export
 * @interface InlineResponse200ResponseHappyHoursMonday
 */
export interface InlineResponse200ResponseHappyHoursMonday {
    /**
     * Indicates if the happy hours are "closed" on Monday.
     * 
     * Filtering Type: `boolean`
     * @type {boolean}
     * @memberof InlineResponse200ResponseHappyHoursMonday
     */
    isClosed?: boolean;
    /**
...
export function InlineResponse200ResponseHappyHoursMondayFromJSON(json: any): InlineResponse200ResponseHappyHoursMonday {
    return InlineResponse200ResponseHappyHoursMondayFromJSONTyped(json, false);
}

export function InlineResponse200ResponseHappyHoursMondayFromJSONTyped(json: any, ignoreDiscriminator: boolean): InlineResponse200ResponseHappyHoursMonday {
...
export function InlineResponse200ResponseHappyHoursMondayToJSON(value?: InlineResponse200ResponseHappyHoursMonday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
