 ...
 * 
 * @export
 * @interface LocationAllOfSeniorHoursThursday
 */
export interface LocationAllOfSeniorHoursThursday {
    /**
     * Indicates if the senior hours are "closed" on Thursday.
     * @type {boolean}
     * @memberof LocationAllOfSeniorHoursThursday
     */
    isClosed?: boolean;
    /**
...
export function LocationAllOfSeniorHoursThursdayFromJSON(json: any): LocationAllOfSeniorHoursThursday {
    return LocationAllOfSeniorHoursThursdayFromJSONTyped(json, false);
}

export function LocationAllOfSeniorHoursThursdayFromJSONTyped(json: any, ignoreDiscriminator: boolean): LocationAllOfSeniorHoursThursday {
...
export function LocationAllOfSeniorHoursThursdayToJSON(value?: LocationAllOfSeniorHoursThursday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
