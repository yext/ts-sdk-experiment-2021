...
export interface EventAllOf {
     ...
     * @memberof EventAllOf
     */
    eventStatus?: EventAllOfEventStatusEnum;
    /**
     ...
     * @memberof EventAllOf
     */
    ticketAvailability?: EventAllOfTicketAvailabilityEnum;
    /**
     * 
...
* @enum {string}
*/
export enum EventAllOfEventStatusEnum {
    Scheduled = 'SCHEDULED',
...
* @enum {string}
*/
export enum EventAllOfTicketAvailabilityEnum {
    InStock = 'IN_STOCK',
    SoldOut = 'SOLD_OUT',
    PreOrder = 'PRE_ORDER',
