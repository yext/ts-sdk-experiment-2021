...
import {
    ...
    LocationPhotoDerivativesFromJSON,
    LocationPhotoDerivativesFromJSONTyped,
    LocationPhotoDerivativesToJSON,
} from './index.ts';
...
export interface LocationPhoto {
    ...
    /**
     * 
     * @type {Array<LocationPhotoDerivatives>}
     * @memberof LocationPhoto
     */
    readonly derivatives?: Array<LocationPhotoDerivatives>;
}

export function LocationPhotoFromJSON(json: any): LocationPhoto {
    return LocationPhotoFromJSONTyped(json, false);
}

export function LocationPhotoFromJSONTyped(json: any, ignoreDiscriminator: boolean): LocationPhoto {
    ...
    return {
        ...
        'derivatives': !exists(json, 'derivatives') ? undefined : ((json['derivatives'] as Array<any>).map(LocationPhotoDerivativesFromJSON)),
    };
}

export function LocationPhotoToJSON(value?: LocationPhoto | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
