 ...
 * ```
 * @export
 * @interface EntityGoogleCoverPhoto
 */
export interface EntityGoogleCoverPhoto {
    /**
     * Filtering Type: `text`
     * @type {string}
     * @memberof EntityGoogleCoverPhoto
     */
...
export function EntityGoogleCoverPhotoFromJSON(json: any): EntityGoogleCoverPhoto {
    return EntityGoogleCoverPhotoFromJSONTyped(json, false);
}

export function EntityGoogleCoverPhotoFromJSONTyped(json: any, ignoreDiscriminator: boolean): EntityGoogleCoverPhoto {
...
export function EntityGoogleCoverPhotoToJSON(value?: EntityGoogleCoverPhoto | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
