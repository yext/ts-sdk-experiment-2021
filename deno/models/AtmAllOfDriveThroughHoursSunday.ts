 ...
 * 
 * @export
 * @interface AtmAllOfDriveThroughHoursSunday
 */
export interface AtmAllOfDriveThroughHoursSunday {
    /**
     * Indicates if the drive-through hours are "closed" on Sunday.
     * @type {boolean}
     * @memberof AtmAllOfDriveThroughHoursSunday
     */
    isClosed?: boolean;
    /**
...
export function AtmAllOfDriveThroughHoursSundayFromJSON(json: any): AtmAllOfDriveThroughHoursSunday {
    return AtmAllOfDriveThroughHoursSundayFromJSONTyped(json, false);
}

export function AtmAllOfDriveThroughHoursSundayFromJSONTyped(json: any, ignoreDiscriminator: boolean): AtmAllOfDriveThroughHoursSunday {
...
export function AtmAllOfDriveThroughHoursSundayToJSON(value?: AtmAllOfDriveThroughHoursSunday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
