...
import {
    ...
    EventItemToJSON,
    EventSectionAllOf,
    EventSectionAllOfFromJSON,
    EventSectionAllOfFromJSONTyped,
    EventSectionAllOfToJSON,
} from './index.ts';
...
export function EventSectionFromJSON(json: any): EventSection {
    return EventSectionFromJSONTyped(json, false);
}

export function EventSectionFromJSONTyped(json: any, ignoreDiscriminator: boolean): EventSection {
...
export function EventSectionToJSON(value?: EventSection | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
