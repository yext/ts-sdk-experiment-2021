 ...
 * @export
 * @interface HealthcareFacilityAllOfUberTripBranding
 */
export interface HealthcareFacilityAllOfUberTripBranding {
    /**
     ...
     * @type {string}
     * @memberof HealthcareFacilityAllOfUberTripBranding
     */
    description: string;
    /**
...
export function HealthcareFacilityAllOfUberTripBrandingFromJSON(json: any): HealthcareFacilityAllOfUberTripBranding {
    return HealthcareFacilityAllOfUberTripBrandingFromJSONTyped(json, false);
}

export function HealthcareFacilityAllOfUberTripBrandingFromJSONTyped(json: any, ignoreDiscriminator: boolean): HealthcareFacilityAllOfUberTripBranding {
...
export function HealthcareFacilityAllOfUberTripBrandingToJSON(value?: HealthcareFacilityAllOfUberTripBranding | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
