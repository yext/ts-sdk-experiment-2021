 ...
 * @export
 * @interface EntitySeniorHoursSaturday
 */
export interface EntitySeniorHoursSaturday {
    /**
     * Indicates if the senior hours are "closed" on Saturday.
     * 
     * Filtering Type: `boolean`
     * @type {boolean}
     * @memberof EntitySeniorHoursSaturday
     */
    isClosed?: boolean;
    /**
...
export function EntitySeniorHoursSaturdayFromJSON(json: any): EntitySeniorHoursSaturday {
    return EntitySeniorHoursSaturdayFromJSONTyped(json, false);
}

export function EntitySeniorHoursSaturdayFromJSONTyped(json: any, ignoreDiscriminator: boolean): EntitySeniorHoursSaturday {
...
export function EntitySeniorHoursSaturdayToJSON(value?: EntitySeniorHoursSaturday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
