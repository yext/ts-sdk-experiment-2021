 ...
 * 
 * @export
 * @interface LocationAllOfSeniorHoursSaturday
 */
export interface LocationAllOfSeniorHoursSaturday {
    /**
     * Indicates if the senior hours are "closed" on Saturday.
     * @type {boolean}
     * @memberof LocationAllOfSeniorHoursSaturday
     */
    isClosed?: boolean;
    /**
...
export function LocationAllOfSeniorHoursSaturdayFromJSON(json: any): LocationAllOfSeniorHoursSaturday {
    return LocationAllOfSeniorHoursSaturdayFromJSONTyped(json, false);
}

export function LocationAllOfSeniorHoursSaturdayFromJSONTyped(json: any, ignoreDiscriminator: boolean): LocationAllOfSeniorHoursSaturday {
...
export function LocationAllOfSeniorHoursSaturdayToJSON(value?: LocationAllOfSeniorHoursSaturday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
