 ...
 * @export
 * @interface AtmAllOfPickupCoordinate
 */
export interface AtmAllOfPickupCoordinate {
    /**
     * 
     * @type {number}
     * @memberof AtmAllOfPickupCoordinate
     */
    latitude?: number;
    /**
     * 
...
export function AtmAllOfPickupCoordinateFromJSON(json: any): AtmAllOfPickupCoordinate {
    return AtmAllOfPickupCoordinateFromJSONTyped(json, false);
}

export function AtmAllOfPickupCoordinateFromJSONTyped(json: any, ignoreDiscriminator: boolean): AtmAllOfPickupCoordinate {
...
export function AtmAllOfPickupCoordinateToJSON(value?: AtmAllOfPickupCoordinate | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
