 ...
 * 
 * @export
 * @interface AtmAllOfDriveThroughHoursWednesday
 */
export interface AtmAllOfDriveThroughHoursWednesday {
    /**
     * Indicates if the drive-through hours are "closed" on Wednesday.
     * @type {boolean}
     * @memberof AtmAllOfDriveThroughHoursWednesday
     */
    isClosed?: boolean;
    /**
...
export function AtmAllOfDriveThroughHoursWednesdayFromJSON(json: any): AtmAllOfDriveThroughHoursWednesday {
    return AtmAllOfDriveThroughHoursWednesdayFromJSONTyped(json, false);
}

export function AtmAllOfDriveThroughHoursWednesdayFromJSONTyped(json: any, ignoreDiscriminator: boolean): AtmAllOfDriveThroughHoursWednesday {
...
export function AtmAllOfDriveThroughHoursWednesdayToJSON(value?: AtmAllOfDriveThroughHoursWednesday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
