 ...
 * 
 * @export
 * @interface ComplexVideoAllOf
 */
export interface ComplexVideoAllOf {
    /**
     * 
     * @type {ComplexVideoValue}
     * @memberof ComplexVideoAllOf
     */
    value?: ComplexVideoValue;
}

export function ComplexVideoAllOfFromJSON(json: any): ComplexVideoAllOf {
    return ComplexVideoAllOfFromJSONTyped(json, false);
}

export function ComplexVideoAllOfFromJSONTyped(json: any, ignoreDiscriminator: boolean): ComplexVideoAllOf {
...
export function ComplexVideoAllOfToJSON(value?: ComplexVideoAllOf | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
