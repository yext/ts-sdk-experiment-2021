 ...
 * 
 * @export
 * @interface LocationAllOfDeliveryHoursMonday
 */
export interface LocationAllOfDeliveryHoursMonday {
    /**
     * Indicates if the delivery hours are "closed" on Monday.
     * @type {boolean}
     * @memberof LocationAllOfDeliveryHoursMonday
     */
    isClosed?: boolean;
    /**
...
export function LocationAllOfDeliveryHoursMondayFromJSON(json: any): LocationAllOfDeliveryHoursMonday {
    return LocationAllOfDeliveryHoursMondayFromJSONTyped(json, false);
}

export function LocationAllOfDeliveryHoursMondayFromJSONTyped(json: any, ignoreDiscriminator: boolean): LocationAllOfDeliveryHoursMonday {
...
export function LocationAllOfDeliveryHoursMondayToJSON(value?: LocationAllOfDeliveryHoursMonday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
