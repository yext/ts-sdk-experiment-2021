 ...
 * @export
 * @interface AtmAllOfFacebookCallToAction
 */
export interface AtmAllOfFacebookCallToAction {
    /**
     * The action the consumer is being prompted to take by the button's text
     * @type {string}
     * @memberof AtmAllOfFacebookCallToAction
     */
    type: AtmAllOfFacebookCallToActionTypeEnum;
    /**
...
* @enum {string}
*/
export enum AtmAllOfFacebookCallToActionTypeEnum {
    None = 'NONE',
    BookNow = 'BOOK_NOW',
    CallNow = 'CALL_NOW',
...
export function AtmAllOfFacebookCallToActionFromJSON(json: any): AtmAllOfFacebookCallToAction {
    return AtmAllOfFacebookCallToActionFromJSONTyped(json, false);
}

export function AtmAllOfFacebookCallToActionFromJSONTyped(json: any, ignoreDiscriminator: boolean): AtmAllOfFacebookCallToAction {
...
export function AtmAllOfFacebookCallToActionToJSON(value?: AtmAllOfFacebookCallToAction | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
