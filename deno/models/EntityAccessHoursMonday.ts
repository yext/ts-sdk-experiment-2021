 ...
 * @export
 * @interface EntityAccessHoursMonday
 */
export interface EntityAccessHoursMonday {
    /**
     * Indicates if the access hours are "closed" on Monday.
     * 
     * Filtering Type: `boolean`
     * @type {boolean}
     * @memberof EntityAccessHoursMonday
     */
    isClosed?: boolean;
    /**
...
export function EntityAccessHoursMondayFromJSON(json: any): EntityAccessHoursMonday {
    return EntityAccessHoursMondayFromJSONTyped(json, false);
}

export function EntityAccessHoursMondayFromJSONTyped(json: any, ignoreDiscriminator: boolean): EntityAccessHoursMonday {
...
export function EntityAccessHoursMondayToJSON(value?: EntityAccessHoursMonday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
