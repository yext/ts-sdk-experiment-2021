 ...
 * 
 * @export
 * @interface HealthcareProfessionalAllOfEducationList
 */
export interface HealthcareProfessionalAllOfEducationList {
    /**
     * 
     * @type {string}
     * @memberof HealthcareProfessionalAllOfEducationList
     */
     ...
     * @memberof HealthcareProfessionalAllOfEducationList
     */
    type: HealthcareProfessionalAllOfEducationListTypeEnum;
    /**
     * 
     * @type {number}
     * @memberof HealthcareProfessionalAllOfEducationList
...
* @enum {string}
*/
export enum HealthcareProfessionalAllOfEducationListTypeEnum {
...
export function HealthcareProfessionalAllOfEducationListFromJSON(json: any): HealthcareProfessionalAllOfEducationList {
    return HealthcareProfessionalAllOfEducationListFromJSONTyped(json, false);
}

export function HealthcareProfessionalAllOfEducationListFromJSONTyped(json: any, ignoreDiscriminator: boolean): HealthcareProfessionalAllOfEducationList {
...
export function HealthcareProfessionalAllOfEducationListToJSON(value?: HealthcareProfessionalAllOfEducationList | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
