 ...
 * 
 * @export
 * @interface HotelAllOfBrunchHoursSunday
 */
export interface HotelAllOfBrunchHoursSunday {
    /**
     * Indicates if the brunch hours are "closed" on Sunday.
     * @type {boolean}
     * @memberof HotelAllOfBrunchHoursSunday
     */
    isClosed?: boolean;
    /**
...
export function HotelAllOfBrunchHoursSundayFromJSON(json: any): HotelAllOfBrunchHoursSunday {
    return HotelAllOfBrunchHoursSundayFromJSONTyped(json, false);
}

export function HotelAllOfBrunchHoursSundayFromJSONTyped(json: any, ignoreDiscriminator: boolean): HotelAllOfBrunchHoursSunday {
...
export function HotelAllOfBrunchHoursSundayToJSON(value?: HotelAllOfBrunchHoursSunday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
