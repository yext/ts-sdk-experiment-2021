 ...
 * @export
 * @interface EntitySeniorHoursTuesday
 */
export interface EntitySeniorHoursTuesday {
    /**
     * Indicates if the senior hours are "closed" on Tuesday.
     * 
     * Filtering Type: `boolean`
     * @type {boolean}
     * @memberof EntitySeniorHoursTuesday
     */
    isClosed?: boolean;
    /**
...
export function EntitySeniorHoursTuesdayFromJSON(json: any): EntitySeniorHoursTuesday {
    return EntitySeniorHoursTuesdayFromJSONTyped(json, false);
}

export function EntitySeniorHoursTuesdayFromJSONTyped(json: any, ignoreDiscriminator: boolean): EntitySeniorHoursTuesday {
...
export function EntitySeniorHoursTuesdayToJSON(value?: EntitySeniorHoursTuesday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
