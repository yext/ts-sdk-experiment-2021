 ...
 * @export
 * @interface EntityOnlineServiceHoursMonday
 */
export interface EntityOnlineServiceHoursMonday {
    /**
     * Indicates if the online service hours are "closed" on Monday.
     * 
     * Filtering Type: `boolean`
     * @type {boolean}
     * @memberof EntityOnlineServiceHoursMonday
     */
    isClosed?: boolean;
    /**
...
export function EntityOnlineServiceHoursMondayFromJSON(json: any): EntityOnlineServiceHoursMonday {
    return EntityOnlineServiceHoursMondayFromJSONTyped(json, false);
}

export function EntityOnlineServiceHoursMondayFromJSONTyped(json: any, ignoreDiscriminator: boolean): EntityOnlineServiceHoursMonday {
...
export function EntityOnlineServiceHoursMondayToJSON(value?: EntityOnlineServiceHoursMonday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
