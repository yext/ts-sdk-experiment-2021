 ...
 * 
 * @export
 * @interface AtmAllOfFrequentlyAskedQuestions
 */
export interface AtmAllOfFrequentlyAskedQuestions {
    /**
     * 
     * @type {string}
     * @memberof AtmAllOfFrequentlyAskedQuestions
     */
    answer?: string;
    /**
     * 
...
export function AtmAllOfFrequentlyAskedQuestionsFromJSON(json: any): AtmAllOfFrequentlyAskedQuestions {
    return AtmAllOfFrequentlyAskedQuestionsFromJSONTyped(json, false);
}

export function AtmAllOfFrequentlyAskedQuestionsFromJSONTyped(json: any, ignoreDiscriminator: boolean): AtmAllOfFrequentlyAskedQuestions {
...
export function AtmAllOfFrequentlyAskedQuestionsToJSON(value?: AtmAllOfFrequentlyAskedQuestions | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
