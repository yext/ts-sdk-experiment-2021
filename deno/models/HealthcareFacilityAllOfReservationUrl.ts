 ...
 * @export
 * @interface HealthcareFacilityAllOfReservationUrl
 */
export interface HealthcareFacilityAllOfReservationUrl {
    /**
     ...
     * @type {string}
     * @memberof HealthcareFacilityAllOfReservationUrl
     */
    displayUrl?: string;
    /**
...
export function HealthcareFacilityAllOfReservationUrlFromJSON(json: any): HealthcareFacilityAllOfReservationUrl {
    return HealthcareFacilityAllOfReservationUrlFromJSONTyped(json, false);
}

export function HealthcareFacilityAllOfReservationUrlFromJSONTyped(json: any, ignoreDiscriminator: boolean): HealthcareFacilityAllOfReservationUrl {
...
export function HealthcareFacilityAllOfReservationUrlToJSON(value?: HealthcareFacilityAllOfReservationUrl | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
