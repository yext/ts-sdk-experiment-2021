 ...
 * 
 * @export
 * @interface AtmAllOfAccessHoursMonday
 */
export interface AtmAllOfAccessHoursMonday {
    /**
     * Indicates if the access hours are "closed" on Monday.
     * @type {boolean}
     * @memberof AtmAllOfAccessHoursMonday
     */
    isClosed?: boolean;
    /**
...
export function AtmAllOfAccessHoursMondayFromJSON(json: any): AtmAllOfAccessHoursMonday {
    return AtmAllOfAccessHoursMondayFromJSONTyped(json, false);
}

export function AtmAllOfAccessHoursMondayFromJSONTyped(json: any, ignoreDiscriminator: boolean): AtmAllOfAccessHoursMonday {
...
export function AtmAllOfAccessHoursMondayToJSON(value?: AtmAllOfAccessHoursMonday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
