 ...
 * 
 * @export
 * @interface ContentListPhoto
 */
export interface ContentListPhoto {
    /**
     * URL of photo.
     * @type {string}
     * @memberof ContentListPhoto
     */
    url?: string;
    /**
     * Dimension in pixels.
...
export function ContentListPhotoFromJSON(json: any): ContentListPhoto {
    return ContentListPhotoFromJSONTyped(json, false);
}

export function ContentListPhotoFromJSONTyped(json: any, ignoreDiscriminator: boolean): ContentListPhoto {
...
export function ContentListPhotoToJSON(value?: ContentListPhoto | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
