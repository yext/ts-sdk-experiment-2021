 ...
 * 
 * @export
 * @interface VerificationAdminInvite
 */
export interface VerificationAdminInvite {
    /**
     * ID of the entity that the admin will be associated with.
     * @type {string}
     * @memberof VerificationAdminInvite
     */
    entityId?: string;
    /**
...
export function VerificationAdminInviteFromJSON(json: any): VerificationAdminInvite {
    return VerificationAdminInviteFromJSONTyped(json, false);
}

export function VerificationAdminInviteFromJSONTyped(json: any, ignoreDiscriminator: boolean): VerificationAdminInvite {
...
export function VerificationAdminInviteToJSON(value?: VerificationAdminInvite | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
