 ...
 * @export
 * @interface EntitySeniorHoursSunday
 */
export interface EntitySeniorHoursSunday {
    /**
     * Indicates if the senior hours are "closed" on Sunday.
     * 
     * Filtering Type: `boolean`
     * @type {boolean}
     * @memberof EntitySeniorHoursSunday
     */
    isClosed?: boolean;
    /**
...
export function EntitySeniorHoursSundayFromJSON(json: any): EntitySeniorHoursSunday {
    return EntitySeniorHoursSundayFromJSONTyped(json, false);
}

export function EntitySeniorHoursSundayFromJSONTyped(json: any, ignoreDiscriminator: boolean): EntitySeniorHoursSunday {
...
export function EntitySeniorHoursSundayToJSON(value?: EntitySeniorHoursSunday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
