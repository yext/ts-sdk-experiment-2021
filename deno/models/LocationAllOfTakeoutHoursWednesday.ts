 ...
 * 
 * @export
 * @interface LocationAllOfTakeoutHoursWednesday
 */
export interface LocationAllOfTakeoutHoursWednesday {
    /**
     * Indicates if the takeout hours are "closed" on Wednesday.
     * @type {boolean}
     * @memberof LocationAllOfTakeoutHoursWednesday
     */
    isClosed?: boolean;
    /**
...
export function LocationAllOfTakeoutHoursWednesdayFromJSON(json: any): LocationAllOfTakeoutHoursWednesday {
    return LocationAllOfTakeoutHoursWednesdayFromJSONTyped(json, false);
}

export function LocationAllOfTakeoutHoursWednesdayFromJSONTyped(json: any, ignoreDiscriminator: boolean): LocationAllOfTakeoutHoursWednesday {
...
export function LocationAllOfTakeoutHoursWednesdayToJSON(value?: LocationAllOfTakeoutHoursWednesday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
