 ...
 * 
 * @export
 * @interface LocationAllOfDeliveryHoursFriday
 */
export interface LocationAllOfDeliveryHoursFriday {
    /**
     * Indicates if the delivery hours are "closed" on Friday.
     * @type {boolean}
     * @memberof LocationAllOfDeliveryHoursFriday
     */
    isClosed?: boolean;
    /**
...
export function LocationAllOfDeliveryHoursFridayFromJSON(json: any): LocationAllOfDeliveryHoursFriday {
    return LocationAllOfDeliveryHoursFridayFromJSONTyped(json, false);
}

export function LocationAllOfDeliveryHoursFridayFromJSONTyped(json: any, ignoreDiscriminator: boolean): LocationAllOfDeliveryHoursFriday {
...
export function LocationAllOfDeliveryHoursFridayToJSON(value?: LocationAllOfDeliveryHoursFriday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
