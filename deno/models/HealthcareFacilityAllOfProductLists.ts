 ...
 * @export
 * @interface HealthcareFacilityAllOfProductLists
 */
export interface HealthcareFacilityAllOfProductLists {
    /**
     ...
     * @type {Set<string>}
     * @memberof HealthcareFacilityAllOfProductLists
     */
    ids?: Set<string>;
    /**
...
export function HealthcareFacilityAllOfProductListsFromJSON(json: any): HealthcareFacilityAllOfProductLists {
    return HealthcareFacilityAllOfProductListsFromJSONTyped(json, false);
}

export function HealthcareFacilityAllOfProductListsFromJSONTyped(json: any, ignoreDiscriminator: boolean): HealthcareFacilityAllOfProductLists {
...
export function HealthcareFacilityAllOfProductListsToJSON(value?: HealthcareFacilityAllOfProductLists | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
