 ...
 * 
 * @export
 * @interface AtmWriteAllOfAccessHoursSaturday
 */
export interface AtmWriteAllOfAccessHoursSaturday {
    /**
     * Indicates if the access hours are "closed" on Saturday.
     * @type {boolean}
     * @memberof AtmWriteAllOfAccessHoursSaturday
     */
    isClosed?: boolean;
    /**
...
export function AtmWriteAllOfAccessHoursSaturdayFromJSON(json: any): AtmWriteAllOfAccessHoursSaturday {
    return AtmWriteAllOfAccessHoursSaturdayFromJSONTyped(json, false);
}

export function AtmWriteAllOfAccessHoursSaturdayFromJSONTyped(json: any, ignoreDiscriminator: boolean): AtmWriteAllOfAccessHoursSaturday {
...
export function AtmWriteAllOfAccessHoursSaturdayToJSON(value?: AtmWriteAllOfAccessHoursSaturday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
