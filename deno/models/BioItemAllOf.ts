...
export interface BioItemAllOf {
    /**
     * 
     * @type {ContentListPhoto}
     * @memberof BioItemAllOf
     */
    photo?: ContentListPhoto;
    /**
     * Person's title.
     * @type {string}
     * @memberof BioItemAllOf
...
export function BioItemAllOfFromJSONTyped(json: any, ignoreDiscriminator: boolean): BioItemAllOf {
    ...
    return {
        ...
        'photo': !exists(json, 'photo') ? undefined : ContentListPhotoFromJSON(json['photo']),
...
export function BioItemAllOfToJSON(value?: BioItemAllOf | null): any {
    ...
    return {
        ...
        'photo': ContentListPhotoToJSON(value.photo),
        'title': value.title,
