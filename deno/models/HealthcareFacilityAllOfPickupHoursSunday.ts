 ...
 * 
 * @export
 * @interface HealthcareFacilityAllOfPickupHoursSunday
 */
export interface HealthcareFacilityAllOfPickupHoursSunday {
    /**
     * Indicates if the pickup hours are "closed" on Sunday.
     * @type {boolean}
     * @memberof HealthcareFacilityAllOfPickupHoursSunday
     */
    isClosed?: boolean;
    /**
...
export function HealthcareFacilityAllOfPickupHoursSundayFromJSON(json: any): HealthcareFacilityAllOfPickupHoursSunday {
    return HealthcareFacilityAllOfPickupHoursSundayFromJSONTyped(json, false);
}

export function HealthcareFacilityAllOfPickupHoursSundayFromJSONTyped(json: any, ignoreDiscriminator: boolean): HealthcareFacilityAllOfPickupHoursSunday {
...
export function HealthcareFacilityAllOfPickupHoursSundayToJSON(value?: HealthcareFacilityAllOfPickupHoursSunday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
