 ...
 * 
 * @export
 * @interface AtmWriteAllOfDriveThroughHoursThursday
 */
export interface AtmWriteAllOfDriveThroughHoursThursday {
    /**
     * Indicates if the drive-through hours are "closed" on Thursday.
     * @type {boolean}
     * @memberof AtmWriteAllOfDriveThroughHoursThursday
     */
    isClosed?: boolean;
    /**
...
export function AtmWriteAllOfDriveThroughHoursThursdayFromJSON(json: any): AtmWriteAllOfDriveThroughHoursThursday {
    return AtmWriteAllOfDriveThroughHoursThursdayFromJSONTyped(json, false);
}

export function AtmWriteAllOfDriveThroughHoursThursdayFromJSONTyped(json: any, ignoreDiscriminator: boolean): AtmWriteAllOfDriveThroughHoursThursday {
...
export function AtmWriteAllOfDriveThroughHoursThursdayToJSON(value?: AtmWriteAllOfDriveThroughHoursThursday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
