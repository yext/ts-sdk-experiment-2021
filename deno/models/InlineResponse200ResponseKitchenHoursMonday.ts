 ...
 * @export
 * @interface InlineResponse200ResponseKitchenHoursMonday
 */
export interface InlineResponse200ResponseKitchenHoursMonday {
    /**
     * Indicates if the kitchen hours are "closed" on Monday.
     * 
     * Filtering Type: `boolean`
     * @type {boolean}
     * @memberof InlineResponse200ResponseKitchenHoursMonday
     */
    isClosed?: boolean;
    /**
...
export function InlineResponse200ResponseKitchenHoursMondayFromJSON(json: any): InlineResponse200ResponseKitchenHoursMonday {
    return InlineResponse200ResponseKitchenHoursMondayFromJSONTyped(json, false);
}

export function InlineResponse200ResponseKitchenHoursMondayFromJSONTyped(json: any, ignoreDiscriminator: boolean): InlineResponse200ResponseKitchenHoursMonday {
...
export function InlineResponse200ResponseKitchenHoursMondayToJSON(value?: InlineResponse200ResponseKitchenHoursMonday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
