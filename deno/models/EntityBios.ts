 ...
 * ```
 * @export
 * @interface EntityBios
 */
export interface EntityBios {
    /**
...
export function EntityBiosFromJSON(json: any): EntityBios {
    return EntityBiosFromJSONTyped(json, false);
}

export function EntityBiosFromJSONTyped(json: any, ignoreDiscriminator: boolean): EntityBios {
...
export function EntityBiosToJSON(value?: EntityBios | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
