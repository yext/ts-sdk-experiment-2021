 ...
 * @export
 * @interface EntityHoursMonday
 */
export interface EntityHoursMonday {
    /**
     * Indicates if the hours of operation are "closed" on Monday.
     * 
     * Filtering Type: `boolean`
     * @type {boolean}
     * @memberof EntityHoursMonday
     */
    isClosed?: boolean;
    /**
...
export function EntityHoursMondayFromJSON(json: any): EntityHoursMonday {
    return EntityHoursMondayFromJSONTyped(json, false);
}

export function EntityHoursMondayFromJSONTyped(json: any, ignoreDiscriminator: boolean): EntityHoursMonday {
...
export function EntityHoursMondayToJSON(value?: EntityHoursMonday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
