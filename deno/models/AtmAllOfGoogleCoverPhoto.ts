 ...
 * @export
 * @interface AtmAllOfGoogleCoverPhoto
 */
export interface AtmAllOfGoogleCoverPhoto {
    /**
     * 
     * @type {string}
     * @memberof AtmAllOfGoogleCoverPhoto
     */
...
export function AtmAllOfGoogleCoverPhotoFromJSON(json: any): AtmAllOfGoogleCoverPhoto {
    return AtmAllOfGoogleCoverPhotoFromJSONTyped(json, false);
}

export function AtmAllOfGoogleCoverPhotoFromJSONTyped(json: any, ignoreDiscriminator: boolean): AtmAllOfGoogleCoverPhoto {
...
export function AtmAllOfGoogleCoverPhotoToJSON(value?: AtmAllOfGoogleCoverPhoto | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
