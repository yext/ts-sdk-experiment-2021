 ...
 * 
 * @export
 * @interface EventLegacyAllOf
 */
export interface EventLegacyAllOf {
    /**
     * A list of sections. However, Calendars cannot have more than one section.
     * @type {Array<EventSection>}
     * @memberof EventLegacyAllOf
     */
    sections?: Array<EventSection>;
}

export function EventLegacyAllOfFromJSON(json: any): EventLegacyAllOf {
    return EventLegacyAllOfFromJSONTyped(json, false);
}

export function EventLegacyAllOfFromJSONTyped(json: any, ignoreDiscriminator: boolean): EventLegacyAllOf {
...
export function EventLegacyAllOfToJSON(value?: EventLegacyAllOf | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
