 ...
 * 
 * @export
 * @interface LocationLegacyEducationList
 */
export interface LocationLegacyEducationList {
    /**
     * The kind of education or training completed
     * @type {string}
     * @memberof LocationLegacyEducationList
     */
    type?: LocationLegacyEducationListTypeEnum;
    /**
...
* @enum {string}
*/
export enum LocationLegacyEducationListTypeEnum {
...
export function LocationLegacyEducationListFromJSON(json: any): LocationLegacyEducationList {
    return LocationLegacyEducationListFromJSONTyped(json, false);
}

export function LocationLegacyEducationListFromJSONTyped(json: any, ignoreDiscriminator: boolean): LocationLegacyEducationList {
...
export function LocationLegacyEducationListToJSON(value?: LocationLegacyEducationList | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
