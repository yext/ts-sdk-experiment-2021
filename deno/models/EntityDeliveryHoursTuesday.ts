 ...
 * @export
 * @interface EntityDeliveryHoursTuesday
 */
export interface EntityDeliveryHoursTuesday {
    /**
     * Indicates if the delivery hours are "closed" on Tuesday.
     * 
     * Filtering Type: `boolean`
     * @type {boolean}
     * @memberof EntityDeliveryHoursTuesday
     */
    isClosed?: boolean;
    /**
...
export function EntityDeliveryHoursTuesdayFromJSON(json: any): EntityDeliveryHoursTuesday {
    return EntityDeliveryHoursTuesdayFromJSONTyped(json, false);
}

export function EntityDeliveryHoursTuesdayFromJSONTyped(json: any, ignoreDiscriminator: boolean): EntityDeliveryHoursTuesday {
...
export function EntityDeliveryHoursTuesdayToJSON(value?: EntityDeliveryHoursTuesday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
