 ...
 * ```
 * @export
 * @interface EntityDropoffCoordinate
 */
export interface EntityDropoffCoordinate {
    /**
     * Filtering Type: `float`
     * @type {number}
     * @memberof EntityDropoffCoordinate
     */
    latitude?: number;
    /**
     * Filtering Type: `float`
...
export function EntityDropoffCoordinateFromJSON(json: any): EntityDropoffCoordinate {
    return EntityDropoffCoordinateFromJSONTyped(json, false);
}

export function EntityDropoffCoordinateFromJSONTyped(json: any, ignoreDiscriminator: boolean): EntityDropoffCoordinate {
...
export function EntityDropoffCoordinateToJSON(value?: EntityDropoffCoordinate | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
