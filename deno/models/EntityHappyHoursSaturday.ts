 ...
 * @export
 * @interface EntityHappyHoursSaturday
 */
export interface EntityHappyHoursSaturday {
    /**
     * Indicates if the happy hours are "closed" on Saturday.
     * 
     * Filtering Type: `boolean`
     * @type {boolean}
     * @memberof EntityHappyHoursSaturday
     */
    isClosed?: boolean;
    /**
...
export function EntityHappyHoursSaturdayFromJSON(json: any): EntityHappyHoursSaturday {
    return EntityHappyHoursSaturdayFromJSONTyped(json, false);
}

export function EntityHappyHoursSaturdayFromJSONTyped(json: any, ignoreDiscriminator: boolean): EntityHappyHoursSaturday {
...
export function EntityHappyHoursSaturdayToJSON(value?: EntityHappyHoursSaturday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
