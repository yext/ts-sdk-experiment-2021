 ...
 * @export
 * @interface EntityRankTrackingCompetitors
 */
export interface EntityRankTrackingCompetitors {
    /**
     ...
     * Filtering Type: `text`
     * @type {string}
     * @memberof EntityRankTrackingCompetitors
     */
    name: string;
    /**
...
export function EntityRankTrackingCompetitorsFromJSON(json: any): EntityRankTrackingCompetitors {
    return EntityRankTrackingCompetitorsFromJSONTyped(json, false);
}

export function EntityRankTrackingCompetitorsFromJSONTyped(json: any, ignoreDiscriminator: boolean): EntityRankTrackingCompetitors {
...
export function EntityRankTrackingCompetitorsToJSON(value?: EntityRankTrackingCompetitors | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
