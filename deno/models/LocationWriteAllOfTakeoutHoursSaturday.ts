 ...
 * 
 * @export
 * @interface LocationWriteAllOfTakeoutHoursSaturday
 */
export interface LocationWriteAllOfTakeoutHoursSaturday {
    /**
     * Indicates if the takeout hours are "closed" on Saturday.
     * @type {boolean}
     * @memberof LocationWriteAllOfTakeoutHoursSaturday
     */
    isClosed?: boolean;
    /**
...
export function LocationWriteAllOfTakeoutHoursSaturdayFromJSON(json: any): LocationWriteAllOfTakeoutHoursSaturday {
    return LocationWriteAllOfTakeoutHoursSaturdayFromJSONTyped(json, false);
}

export function LocationWriteAllOfTakeoutHoursSaturdayFromJSONTyped(json: any, ignoreDiscriminator: boolean): LocationWriteAllOfTakeoutHoursSaturday {
...
export function LocationWriteAllOfTakeoutHoursSaturdayToJSON(value?: LocationWriteAllOfTakeoutHoursSaturday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
