...
import {
    EntityOnlineServiceHoursFriday,
    EntityOnlineServiceHoursFridayFromJSON,
    EntityOnlineServiceHoursFridayFromJSONTyped,
    EntityOnlineServiceHoursFridayToJSON,
    EntityOnlineServiceHoursHolidayHours,
    EntityOnlineServiceHoursHolidayHoursFromJSON,
    EntityOnlineServiceHoursHolidayHoursFromJSONTyped,
    EntityOnlineServiceHoursHolidayHoursToJSON,
    EntityOnlineServiceHoursMonday,
    EntityOnlineServiceHoursMondayFromJSON,
    EntityOnlineServiceHoursMondayFromJSONTyped,
    EntityOnlineServiceHoursMondayToJSON,
    EntityOnlineServiceHoursSaturday,
    EntityOnlineServiceHoursSaturdayFromJSON,
    EntityOnlineServiceHoursSaturdayFromJSONTyped,
    EntityOnlineServiceHoursSaturdayToJSON,
    EntityOnlineServiceHoursSunday,
    EntityOnlineServiceHoursSundayFromJSON,
    EntityOnlineServiceHoursSundayFromJSONTyped,
    EntityOnlineServiceHoursSundayToJSON,
    EntityOnlineServiceHoursThursday,
    EntityOnlineServiceHoursThursdayFromJSON,
    EntityOnlineServiceHoursThursdayFromJSONTyped,
    EntityOnlineServiceHoursThursdayToJSON,
    EntityOnlineServiceHoursTuesday,
    EntityOnlineServiceHoursTuesdayFromJSON,
    EntityOnlineServiceHoursTuesdayFromJSONTyped,
    EntityOnlineServiceHoursTuesdayToJSON,
    EntityOnlineServiceHoursWednesday,
    EntityOnlineServiceHoursWednesdayFromJSON,
    EntityOnlineServiceHoursWednesdayFromJSONTyped,
    EntityOnlineServiceHoursWednesdayToJSON,
} from './index.ts';
 ...
 * ```
 * @export
 * @interface EntityOnlineServiceHours
 */
export interface EntityOnlineServiceHours {
    /**
     * 
     * @type {EntityOnlineServiceHoursFriday}
     * @memberof EntityOnlineServiceHours
     */
    friday?: EntityOnlineServiceHoursFriday;
    /**
     * 
     ...
     * @type {Set<EntityOnlineServiceHoursHolidayHours>}
     * @memberof EntityOnlineServiceHours
     */
    holidayHours?: Set<EntityOnlineServiceHoursHolidayHours>;
    /**
     * 
     * @type {EntityOnlineServiceHoursMonday}
     * @memberof EntityOnlineServiceHours
     */
    monday?: EntityOnlineServiceHoursMonday;
    /**
     * 
    ...
    /**
     * 
     * @type {EntityOnlineServiceHoursSaturday}
     * @memberof EntityOnlineServiceHours
     */
    saturday?: EntityOnlineServiceHoursSaturday;
    /**
     * 
     * @type {EntityOnlineServiceHoursSunday}
     * @memberof EntityOnlineServiceHours
     */
    sunday?: EntityOnlineServiceHoursSunday;
    /**
     * 
     * @type {EntityOnlineServiceHoursThursday}
     * @memberof EntityOnlineServiceHours
     */
    thursday?: EntityOnlineServiceHoursThursday;
    /**
     * 
     * @type {EntityOnlineServiceHoursTuesday}
     * @memberof EntityOnlineServiceHours
     */
    tuesday?: EntityOnlineServiceHoursTuesday;
    /**
     * 
     * @type {EntityOnlineServiceHoursWednesday}
     * @memberof EntityOnlineServiceHours
     */
    wednesday?: EntityOnlineServiceHoursWednesday;
}

export function EntityOnlineServiceHoursFromJSON(json: any): EntityOnlineServiceHours {
    return EntityOnlineServiceHoursFromJSONTyped(json, false);
}

export function EntityOnlineServiceHoursFromJSONTyped(json: any, ignoreDiscriminator: boolean): EntityOnlineServiceHours {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'friday': !exists(json, 'friday') ? undefined : EntityOnlineServiceHoursFridayFromJSON(json['friday']),
        'holidayHours': !exists(json, 'holidayHours') ? undefined : (new Set((json['holidayHours'] as Array<any>).map(EntityOnlineServiceHoursHolidayHoursFromJSON))),
        'monday': !exists(json, 'monday') ? undefined : EntityOnlineServiceHoursMondayFromJSON(json['monday']),
        'reopenDate': !exists(json, 'reopenDate') ? undefined : (new Date(json['reopenDate'])),
        'saturday': !exists(json, 'saturday') ? undefined : EntityOnlineServiceHoursSaturdayFromJSON(json['saturday']),
        'sunday': !exists(json, 'sunday') ? undefined : EntityOnlineServiceHoursSundayFromJSON(json['sunday']),
        'thursday': !exists(json, 'thursday') ? undefined : EntityOnlineServiceHoursThursdayFromJSON(json['thursday']),
        'tuesday': !exists(json, 'tuesday') ? undefined : EntityOnlineServiceHoursTuesdayFromJSON(json['tuesday']),
        'wednesday': !exists(json, 'wednesday') ? undefined : EntityOnlineServiceHoursWednesdayFromJSON(json['wednesday']),
    };
}

export function EntityOnlineServiceHoursToJSON(value?: EntityOnlineServiceHours | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'friday': EntityOnlineServiceHoursFridayToJSON(value.friday),
        'holidayHours': value.holidayHours === undefined ? undefined : (Array.from(value.holidayHours as Set<any>).map(EntityOnlineServiceHoursHolidayHoursToJSON)),
        'monday': EntityOnlineServiceHoursMondayToJSON(value.monday),
        'reopenDate': value.reopenDate === undefined ? undefined : (value.reopenDate.toISOString().substr(0,10)),
        'saturday': EntityOnlineServiceHoursSaturdayToJSON(value.saturday),
        'sunday': EntityOnlineServiceHoursSundayToJSON(value.sunday),
        'thursday': EntityOnlineServiceHoursThursdayToJSON(value.thursday),
        'tuesday': EntityOnlineServiceHoursTuesdayToJSON(value.tuesday),
        'wednesday': EntityOnlineServiceHoursWednesdayToJSON(value.wednesday),
    };
}
