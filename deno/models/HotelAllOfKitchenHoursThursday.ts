 ...
 * 
 * @export
 * @interface HotelAllOfKitchenHoursThursday
 */
export interface HotelAllOfKitchenHoursThursday {
    /**
     * Indicates if the kitchen hours are "closed" on Thursday.
     * @type {boolean}
     * @memberof HotelAllOfKitchenHoursThursday
     */
    isClosed?: boolean;
    /**
...
export function HotelAllOfKitchenHoursThursdayFromJSON(json: any): HotelAllOfKitchenHoursThursday {
    return HotelAllOfKitchenHoursThursdayFromJSONTyped(json, false);
}

export function HotelAllOfKitchenHoursThursdayFromJSONTyped(json: any, ignoreDiscriminator: boolean): HotelAllOfKitchenHoursThursday {
...
export function HotelAllOfKitchenHoursThursdayToJSON(value?: HotelAllOfKitchenHoursThursday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
