 ...
 * @export
 * @interface EntityDeliveryHoursMonday
 */
export interface EntityDeliveryHoursMonday {
    /**
     * Indicates if the delivery hours are "closed" on Monday.
     * 
     * Filtering Type: `boolean`
     * @type {boolean}
     * @memberof EntityDeliveryHoursMonday
     */
    isClosed?: boolean;
    /**
...
export function EntityDeliveryHoursMondayFromJSON(json: any): EntityDeliveryHoursMonday {
    return EntityDeliveryHoursMondayFromJSONTyped(json, false);
}

export function EntityDeliveryHoursMondayFromJSONTyped(json: any, ignoreDiscriminator: boolean): EntityDeliveryHoursMonday {
...
export function EntityDeliveryHoursMondayToJSON(value?: EntityDeliveryHoursMonday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
