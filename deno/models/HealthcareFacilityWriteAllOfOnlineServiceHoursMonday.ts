 ...
 * 
 * @export
 * @interface HealthcareFacilityWriteAllOfOnlineServiceHoursMonday
 */
export interface HealthcareFacilityWriteAllOfOnlineServiceHoursMonday {
    /**
     * Indicates if the online service hours are "closed" on Monday.
     * @type {boolean}
     * @memberof HealthcareFacilityWriteAllOfOnlineServiceHoursMonday
     */
    isClosed?: boolean;
    /**
...
export function HealthcareFacilityWriteAllOfOnlineServiceHoursMondayFromJSON(json: any): HealthcareFacilityWriteAllOfOnlineServiceHoursMonday {
    return HealthcareFacilityWriteAllOfOnlineServiceHoursMondayFromJSONTyped(json, false);
}

export function HealthcareFacilityWriteAllOfOnlineServiceHoursMondayFromJSONTyped(json: any, ignoreDiscriminator: boolean): HealthcareFacilityWriteAllOfOnlineServiceHoursMonday {
...
export function HealthcareFacilityWriteAllOfOnlineServiceHoursMondayToJSON(value?: HealthcareFacilityWriteAllOfOnlineServiceHoursMonday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
