...
import {
    AtmAllOfDriveThroughHoursFriday,
    AtmAllOfDriveThroughHoursFridayFromJSON,
    AtmAllOfDriveThroughHoursFridayFromJSONTyped,
    AtmAllOfDriveThroughHoursFridayToJSON,
    AtmAllOfDriveThroughHoursHolidayHours,
    AtmAllOfDriveThroughHoursHolidayHoursFromJSON,
    AtmAllOfDriveThroughHoursHolidayHoursFromJSONTyped,
    AtmAllOfDriveThroughHoursHolidayHoursToJSON,
    AtmAllOfDriveThroughHoursMonday,
    AtmAllOfDriveThroughHoursMondayFromJSON,
    AtmAllOfDriveThroughHoursMondayFromJSONTyped,
    AtmAllOfDriveThroughHoursMondayToJSON,
    AtmAllOfDriveThroughHoursSaturday,
    AtmAllOfDriveThroughHoursSaturdayFromJSON,
    AtmAllOfDriveThroughHoursSaturdayFromJSONTyped,
    AtmAllOfDriveThroughHoursSaturdayToJSON,
    AtmAllOfDriveThroughHoursSunday,
    AtmAllOfDriveThroughHoursSundayFromJSON,
    AtmAllOfDriveThroughHoursSundayFromJSONTyped,
    AtmAllOfDriveThroughHoursSundayToJSON,
    AtmAllOfDriveThroughHoursThursday,
    AtmAllOfDriveThroughHoursThursdayFromJSON,
    AtmAllOfDriveThroughHoursThursdayFromJSONTyped,
    AtmAllOfDriveThroughHoursThursdayToJSON,
    AtmAllOfDriveThroughHoursTuesday,
    AtmAllOfDriveThroughHoursTuesdayFromJSON,
    AtmAllOfDriveThroughHoursTuesdayFromJSONTyped,
    AtmAllOfDriveThroughHoursTuesdayToJSON,
    AtmAllOfDriveThroughHoursWednesday,
    AtmAllOfDriveThroughHoursWednesdayFromJSON,
    AtmAllOfDriveThroughHoursWednesdayFromJSONTyped,
    AtmAllOfDriveThroughHoursWednesdayToJSON,
} from './index.ts';
 ...
 * @export
 * @interface AtmAllOfDriveThroughHours
 */
export interface AtmAllOfDriveThroughHours {
    /**
     * 
     * @type {AtmAllOfDriveThroughHoursFriday}
     * @memberof AtmAllOfDriveThroughHours
     */
    friday?: AtmAllOfDriveThroughHoursFriday;
    /**
     * 
     ...
     * @type {Set<AtmAllOfDriveThroughHoursHolidayHours>}
     * @memberof AtmAllOfDriveThroughHours
     */
    holidayHours?: Set<AtmAllOfDriveThroughHoursHolidayHours>;
    /**
     * 
     * @type {AtmAllOfDriveThroughHoursMonday}
     * @memberof AtmAllOfDriveThroughHours
     */
    monday?: AtmAllOfDriveThroughHoursMonday;
    /**
     * 
    ...
    /**
     * 
     * @type {AtmAllOfDriveThroughHoursSaturday}
     * @memberof AtmAllOfDriveThroughHours
     */
    saturday?: AtmAllOfDriveThroughHoursSaturday;
    /**
     * 
     * @type {AtmAllOfDriveThroughHoursSunday}
     * @memberof AtmAllOfDriveThroughHours
     */
    sunday?: AtmAllOfDriveThroughHoursSunday;
    /**
     * 
     * @type {AtmAllOfDriveThroughHoursThursday}
     * @memberof AtmAllOfDriveThroughHours
     */
    thursday?: AtmAllOfDriveThroughHoursThursday;
    /**
     * 
     * @type {AtmAllOfDriveThroughHoursTuesday}
     * @memberof AtmAllOfDriveThroughHours
     */
    tuesday?: AtmAllOfDriveThroughHoursTuesday;
    /**
     * 
     * @type {AtmAllOfDriveThroughHoursWednesday}
     * @memberof AtmAllOfDriveThroughHours
     */
    wednesday?: AtmAllOfDriveThroughHoursWednesday;
}

export function AtmAllOfDriveThroughHoursFromJSON(json: any): AtmAllOfDriveThroughHours {
    return AtmAllOfDriveThroughHoursFromJSONTyped(json, false);
}

export function AtmAllOfDriveThroughHoursFromJSONTyped(json: any, ignoreDiscriminator: boolean): AtmAllOfDriveThroughHours {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'friday': !exists(json, 'friday') ? undefined : AtmAllOfDriveThroughHoursFridayFromJSON(json['friday']),
        'holidayHours': !exists(json, 'holidayHours') ? undefined : (new Set((json['holidayHours'] as Array<any>).map(AtmAllOfDriveThroughHoursHolidayHoursFromJSON))),
        'monday': !exists(json, 'monday') ? undefined : AtmAllOfDriveThroughHoursMondayFromJSON(json['monday']),
        'reopenDate': !exists(json, 'reopenDate') ? undefined : (new Date(json['reopenDate'])),
        'saturday': !exists(json, 'saturday') ? undefined : AtmAllOfDriveThroughHoursSaturdayFromJSON(json['saturday']),
        'sunday': !exists(json, 'sunday') ? undefined : AtmAllOfDriveThroughHoursSundayFromJSON(json['sunday']),
        'thursday': !exists(json, 'thursday') ? undefined : AtmAllOfDriveThroughHoursThursdayFromJSON(json['thursday']),
        'tuesday': !exists(json, 'tuesday') ? undefined : AtmAllOfDriveThroughHoursTuesdayFromJSON(json['tuesday']),
        'wednesday': !exists(json, 'wednesday') ? undefined : AtmAllOfDriveThroughHoursWednesdayFromJSON(json['wednesday']),
    };
}

export function AtmAllOfDriveThroughHoursToJSON(value?: AtmAllOfDriveThroughHours | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'friday': AtmAllOfDriveThroughHoursFridayToJSON(value.friday),
        'holidayHours': value.holidayHours === undefined ? undefined : (Array.from(value.holidayHours as Set<any>).map(AtmAllOfDriveThroughHoursHolidayHoursToJSON)),
        'monday': AtmAllOfDriveThroughHoursMondayToJSON(value.monday),
        'reopenDate': value.reopenDate === undefined ? undefined : (value.reopenDate.toISOString().substr(0,10)),
        'saturday': AtmAllOfDriveThroughHoursSaturdayToJSON(value.saturday),
        'sunday': AtmAllOfDriveThroughHoursSundayToJSON(value.sunday),
        'thursday': AtmAllOfDriveThroughHoursThursdayToJSON(value.thursday),
        'tuesday': AtmAllOfDriveThroughHoursTuesdayToJSON(value.tuesday),
        'wednesday': AtmAllOfDriveThroughHoursWednesdayToJSON(value.wednesday),
    };
}
