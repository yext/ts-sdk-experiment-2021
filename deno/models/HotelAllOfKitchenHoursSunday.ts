 ...
 * 
 * @export
 * @interface HotelAllOfKitchenHoursSunday
 */
export interface HotelAllOfKitchenHoursSunday {
    /**
     * Indicates if the kitchen hours are "closed" on Sunday.
     * @type {boolean}
     * @memberof HotelAllOfKitchenHoursSunday
     */
    isClosed?: boolean;
    /**
...
export function HotelAllOfKitchenHoursSundayFromJSON(json: any): HotelAllOfKitchenHoursSunday {
    return HotelAllOfKitchenHoursSundayFromJSONTyped(json, false);
}

export function HotelAllOfKitchenHoursSundayFromJSONTyped(json: any, ignoreDiscriminator: boolean): HotelAllOfKitchenHoursSunday {
...
export function HotelAllOfKitchenHoursSundayToJSON(value?: HotelAllOfKitchenHoursSunday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
