...
import {
    ...
    AssetUsageToJSON,
    ComplexImageAllOf,
    ComplexImageAllOfFromJSON,
    ComplexImageAllOfFromJSONTyped,
    ComplexImageAllOfToJSON,
    ComplexImageValue,
 ...
 */
export interface ComplexImage extends Asset {
    /**
     * 
     * @type {ComplexImageValue}
     * @memberof ComplexImage
     */
    value?: ComplexImageValue;
}

export function ComplexImageFromJSON(json: any): ComplexImage {
    return ComplexImageFromJSONTyped(json, false);
}

export function ComplexImageFromJSONTyped(json: any, ignoreDiscriminator: boolean): ComplexImage {
...
export function ComplexImageToJSON(value?: ComplexImage | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
