 ...
 * ```
 * @export
 * @interface EntityGoogleProfilePhoto
 */
export interface EntityGoogleProfilePhoto {
    /**
     * Filtering Type: `text`
     * @type {string}
     * @memberof EntityGoogleProfilePhoto
     */
...
export function EntityGoogleProfilePhotoFromJSON(json: any): EntityGoogleProfilePhoto {
    return EntityGoogleProfilePhotoFromJSONTyped(json, false);
}

export function EntityGoogleProfilePhotoFromJSONTyped(json: any, ignoreDiscriminator: boolean): EntityGoogleProfilePhoto {
...
export function EntityGoogleProfilePhotoToJSON(value?: EntityGoogleProfilePhoto | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
