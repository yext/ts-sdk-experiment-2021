...
import {
    ...
    HealthcareProfessionalAllOf,
    HealthcareProfessionalAllOfFromJSON,
    HealthcareProfessionalAllOfFromJSONTyped,
    HealthcareProfessionalAllOfToJSON,
 ...
 */
export interface HealthcareProfessional extends EntityWrite {
    /**
     * 
     * @type {AtmAllOfMeta}
     ...
     * @memberof HealthcareProfessional
     */
    degrees?: Set<HealthcareProfessionalDegreesEnum>;
    /**
     ...
     * @memberof HealthcareProfessional
     */
    locationType?: HealthcareProfessionalLocationTypeEnum;
    /**
     * 
     * @type {AtmAllOfLogo}
     * @memberof HealthcareProfessional
     ...
     * @memberof HealthcareProfessional
     */
    paymentOptions?: Set<HealthcareProfessionalPaymentOptionsEnum>;
    /**
     * 
     ...
     * @memberof HealthcareProfessional
     */
    priceRange?: HealthcareProfessionalPriceRangeEnum;
    /**
     ...
     * @memberof HealthcareProfessional
     */
    rankTrackingFrequency?: HealthcareProfessionalRankTrackingFrequencyEnum;
    /**
     ...
     * @memberof HealthcareProfessional
     */
    rankTrackingQueryTemplates?: Set<HealthcareProfessionalRankTrackingQueryTemplatesEnum>;
    /**
     * The search engines that we will use to track your performance
     * @type {Set<string>}
     * @memberof HealthcareProfessional
     */
    rankTrackingSites?: Set<HealthcareProfessionalRankTrackingSitesEnum>;
    /**
     * 
...
* @enum {string}
*/
export enum HealthcareProfessionalDegreesEnum {
    Anp = 'ANP',
    Apn = 'APN',
    Aprn = 'APRN',
    Arnp = 'ARNP',
...
* @enum {string}
*/
export enum HealthcareProfessionalGenderEnum {
...
* @enum {string}
*/
export enum HealthcareProfessionalLocationTypeEnum {
    Location = 'LOCATION',
...
* @enum {string}
*/
export enum HealthcareProfessionalPaymentOptionsEnum {
    Alipay = 'ALIPAY',
...
* @enum {string}
*/
export enum HealthcareProfessionalPriceRangeEnum {
    Unspecified = 'UNSPECIFIED',
    One = 'ONE',
    Two = 'TWO',
    Three = 'THREE',
...
* @enum {string}
*/
export enum HealthcareProfessionalRankTrackingFrequencyEnum {
    Weekly = 'WEEKLY',
    Monthly = 'MONTHLY',
    Quarterly = 'QUARTERLY'
}/**
...
* @enum {string}
*/
export enum HealthcareProfessionalRankTrackingQueryTemplatesEnum {
    Keyword = 'KEYWORD',
...
* @enum {string}
*/
export enum HealthcareProfessionalRankTrackingSitesEnum {
...
export function HealthcareProfessionalFromJSON(json: any): HealthcareProfessional {
    return HealthcareProfessionalFromJSONTyped(json, false);
}

export function HealthcareProfessionalFromJSONTyped(json: any, ignoreDiscriminator: boolean): HealthcareProfessional {
...
export function HealthcareProfessionalToJSON(value?: HealthcareProfessional | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
