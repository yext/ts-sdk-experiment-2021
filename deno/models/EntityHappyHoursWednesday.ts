 ...
 * @export
 * @interface EntityHappyHoursWednesday
 */
export interface EntityHappyHoursWednesday {
    /**
     * Indicates if the happy hours are "closed" on Wednesday.
     * 
     * Filtering Type: `boolean`
     * @type {boolean}
     * @memberof EntityHappyHoursWednesday
     */
    isClosed?: boolean;
    /**
...
export function EntityHappyHoursWednesdayFromJSON(json: any): EntityHappyHoursWednesday {
    return EntityHappyHoursWednesdayFromJSONTyped(json, false);
}

export function EntityHappyHoursWednesdayFromJSONTyped(json: any, ignoreDiscriminator: boolean): EntityHappyHoursWednesday {
...
export function EntityHappyHoursWednesdayToJSON(value?: EntityHappyHoursWednesday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
