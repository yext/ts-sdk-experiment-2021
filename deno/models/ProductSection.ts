...
import {
    ...
    ProductItemToJSON,
    ProductSectionAllOf,
    ProductSectionAllOfFromJSON,
    ProductSectionAllOfFromJSONTyped,
    ProductSectionAllOfToJSON,
} from './index.ts';
...
export function ProductSectionFromJSON(json: any): ProductSection {
    return ProductSectionFromJSONTyped(json, false);
}

export function ProductSectionFromJSONTyped(json: any, ignoreDiscriminator: boolean): ProductSection {
...
export function ProductSectionToJSON(value?: ProductSection | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
