 ...
 * @export
 * @interface AtmAllOfDropoffCoordinate
 */
export interface AtmAllOfDropoffCoordinate {
    /**
     * 
     * @type {number}
     * @memberof AtmAllOfDropoffCoordinate
     */
    latitude?: number;
    /**
     * 
...
export function AtmAllOfDropoffCoordinateFromJSON(json: any): AtmAllOfDropoffCoordinate {
    return AtmAllOfDropoffCoordinateFromJSONTyped(json, false);
}

export function AtmAllOfDropoffCoordinateFromJSONTyped(json: any, ignoreDiscriminator: boolean): AtmAllOfDropoffCoordinate {
...
export function AtmAllOfDropoffCoordinateToJSON(value?: AtmAllOfDropoffCoordinate | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
