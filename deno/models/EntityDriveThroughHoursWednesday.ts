 ...
 * @export
 * @interface EntityDriveThroughHoursWednesday
 */
export interface EntityDriveThroughHoursWednesday {
    /**
     * Indicates if the drive-through hours are "closed" on Wednesday.
     * 
     * Filtering Type: `boolean`
     * @type {boolean}
     * @memberof EntityDriveThroughHoursWednesday
     */
    isClosed?: boolean;
    /**
...
export function EntityDriveThroughHoursWednesdayFromJSON(json: any): EntityDriveThroughHoursWednesday {
    return EntityDriveThroughHoursWednesdayFromJSONTyped(json, false);
}

export function EntityDriveThroughHoursWednesdayFromJSONTyped(json: any, ignoreDiscriminator: boolean): EntityDriveThroughHoursWednesday {
...
export function EntityDriveThroughHoursWednesdayToJSON(value?: EntityDriveThroughHoursWednesday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
