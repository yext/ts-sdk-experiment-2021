 ...
 * ```
 * @export
 * @interface EntityYextDisplayCoordinate
 */
export interface EntityYextDisplayCoordinate {
    /**
     * Filtering Type: `float`
     * @type {number}
     * @memberof EntityYextDisplayCoordinate
     */
    latitude?: number;
    /**
     * Filtering Type: `float`
...
export function EntityYextDisplayCoordinateFromJSON(json: any): EntityYextDisplayCoordinate {
    return EntityYextDisplayCoordinateFromJSONTyped(json, false);
}

export function EntityYextDisplayCoordinateFromJSONTyped(json: any, ignoreDiscriminator: boolean): EntityYextDisplayCoordinate {
...
export function EntityYextDisplayCoordinateToJSON(value?: EntityYextDisplayCoordinate | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
