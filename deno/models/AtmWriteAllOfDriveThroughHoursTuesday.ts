 ...
 * 
 * @export
 * @interface AtmWriteAllOfDriveThroughHoursTuesday
 */
export interface AtmWriteAllOfDriveThroughHoursTuesday {
    /**
     * Indicates if the drive-through hours are "closed" on Tuesday.
     * @type {boolean}
     * @memberof AtmWriteAllOfDriveThroughHoursTuesday
     */
    isClosed?: boolean;
    /**
...
export function AtmWriteAllOfDriveThroughHoursTuesdayFromJSON(json: any): AtmWriteAllOfDriveThroughHoursTuesday {
    return AtmWriteAllOfDriveThroughHoursTuesdayFromJSONTyped(json, false);
}

export function AtmWriteAllOfDriveThroughHoursTuesdayFromJSONTyped(json: any, ignoreDiscriminator: boolean): AtmWriteAllOfDriveThroughHoursTuesday {
...
export function AtmWriteAllOfDriveThroughHoursTuesdayToJSON(value?: AtmWriteAllOfDriveThroughHoursTuesday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
