 ...
 * 
 * @export
 * @interface HotelAllOfBrunchHoursWednesday
 */
export interface HotelAllOfBrunchHoursWednesday {
    /**
     * Indicates if the brunch hours are "closed" on Wednesday.
     * @type {boolean}
     * @memberof HotelAllOfBrunchHoursWednesday
     */
    isClosed?: boolean;
    /**
...
export function HotelAllOfBrunchHoursWednesdayFromJSON(json: any): HotelAllOfBrunchHoursWednesday {
    return HotelAllOfBrunchHoursWednesdayFromJSONTyped(json, false);
}

export function HotelAllOfBrunchHoursWednesdayFromJSONTyped(json: any, ignoreDiscriminator: boolean): HotelAllOfBrunchHoursWednesday {
...
export function HotelAllOfBrunchHoursWednesdayToJSON(value?: HotelAllOfBrunchHoursWednesday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
