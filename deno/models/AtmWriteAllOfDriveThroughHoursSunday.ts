 ...
 * 
 * @export
 * @interface AtmWriteAllOfDriveThroughHoursSunday
 */
export interface AtmWriteAllOfDriveThroughHoursSunday {
    /**
     * Indicates if the drive-through hours are "closed" on Sunday.
     * @type {boolean}
     * @memberof AtmWriteAllOfDriveThroughHoursSunday
     */
    isClosed?: boolean;
    /**
...
export function AtmWriteAllOfDriveThroughHoursSundayFromJSON(json: any): AtmWriteAllOfDriveThroughHoursSunday {
    return AtmWriteAllOfDriveThroughHoursSundayFromJSONTyped(json, false);
}

export function AtmWriteAllOfDriveThroughHoursSundayFromJSONTyped(json: any, ignoreDiscriminator: boolean): AtmWriteAllOfDriveThroughHoursSunday {
...
export function AtmWriteAllOfDriveThroughHoursSundayToJSON(value?: AtmWriteAllOfDriveThroughHoursSunday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
