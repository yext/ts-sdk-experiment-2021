...
export function TextAllOfFromJSON(json: any): TextAllOf {
    return TextAllOfFromJSONTyped(json, false);
}

export function TextAllOfFromJSONTyped(json: any, ignoreDiscriminator: boolean): TextAllOf {
...
export function TextAllOfToJSON(value?: TextAllOf | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
