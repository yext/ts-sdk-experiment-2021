 ...
 * 
 * @export
 * @interface HealthcareFacilityAllOfOnlineServiceHoursWednesday
 */
export interface HealthcareFacilityAllOfOnlineServiceHoursWednesday {
    /**
     * Indicates if the online service hours are "closed" on Wednesday.
     * @type {boolean}
     * @memberof HealthcareFacilityAllOfOnlineServiceHoursWednesday
     */
    isClosed?: boolean;
    /**
...
export function HealthcareFacilityAllOfOnlineServiceHoursWednesdayFromJSON(json: any): HealthcareFacilityAllOfOnlineServiceHoursWednesday {
    return HealthcareFacilityAllOfOnlineServiceHoursWednesdayFromJSONTyped(json, false);
}

export function HealthcareFacilityAllOfOnlineServiceHoursWednesdayFromJSONTyped(json: any, ignoreDiscriminator: boolean): HealthcareFacilityAllOfOnlineServiceHoursWednesday {
...
export function HealthcareFacilityAllOfOnlineServiceHoursWednesdayToJSON(value?: HealthcareFacilityAllOfOnlineServiceHoursWednesday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
