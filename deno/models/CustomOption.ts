...
export function CustomOptionFromJSON(json: any): CustomOption {
    return CustomOptionFromJSONTyped(json, false);
}

export function CustomOptionFromJSONTyped(json: any, ignoreDiscriminator: boolean): CustomOption {
...
export function CustomOptionToJSON(value?: CustomOption | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
