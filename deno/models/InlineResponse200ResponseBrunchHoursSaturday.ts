 ...
 * @export
 * @interface InlineResponse200ResponseBrunchHoursSaturday
 */
export interface InlineResponse200ResponseBrunchHoursSaturday {
    /**
     * Indicates if the brunch hours are "closed" on Saturday.
     * 
     * Filtering Type: `boolean`
     * @type {boolean}
     * @memberof InlineResponse200ResponseBrunchHoursSaturday
     */
    isClosed?: boolean;
    /**
...
export function InlineResponse200ResponseBrunchHoursSaturdayFromJSON(json: any): InlineResponse200ResponseBrunchHoursSaturday {
    return InlineResponse200ResponseBrunchHoursSaturdayFromJSONTyped(json, false);
}

export function InlineResponse200ResponseBrunchHoursSaturdayFromJSONTyped(json: any, ignoreDiscriminator: boolean): InlineResponse200ResponseBrunchHoursSaturday {
...
export function InlineResponse200ResponseBrunchHoursSaturdayToJSON(value?: InlineResponse200ResponseBrunchHoursSaturday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
