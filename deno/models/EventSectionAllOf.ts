 ...
 * 
 * @export
 * @interface EventSectionAllOf
 */
export interface EventSectionAllOf {
    /**
     * Section Items.
     * @type {Array<EventItem>}
     * @memberof EventSectionAllOf
     */
    items?: Array<EventItem>;
}

export function EventSectionAllOfFromJSON(json: any): EventSectionAllOf {
    return EventSectionAllOfFromJSONTyped(json, false);
}

export function EventSectionAllOfFromJSONTyped(json: any, ignoreDiscriminator: boolean): EventSectionAllOf {
...
export function EventSectionAllOfToJSON(value?: EventSectionAllOf | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
