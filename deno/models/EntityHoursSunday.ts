 ...
 * @export
 * @interface EntityHoursSunday
 */
export interface EntityHoursSunday {
    /**
     * Indicates if the hours of operation are "closed" on Sunday.
     * 
     * Filtering Type: `boolean`
     * @type {boolean}
     * @memberof EntityHoursSunday
     */
    isClosed?: boolean;
    /**
...
export function EntityHoursSundayFromJSON(json: any): EntityHoursSunday {
    return EntityHoursSundayFromJSONTyped(json, false);
}

export function EntityHoursSundayFromJSONTyped(json: any, ignoreDiscriminator: boolean): EntityHoursSunday {
...
export function EntityHoursSundayToJSON(value?: EntityHoursSunday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
