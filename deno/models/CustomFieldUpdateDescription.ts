...
import {
    CustomTranslation,
    CustomTranslationFromJSON,
    CustomTranslationFromJSONTyped,
    CustomTranslationToJSON,
} from './index.ts';
 ...
 * }
 * @export
 * @interface CustomFieldUpdateDescription
 */
export interface CustomFieldUpdateDescription {
    /**
     * The field's default description value.
     * @type {string}
     * @memberof CustomFieldUpdateDescription
     */
    value?: string;
    /**
     * Localized variations of **`value`**.
     * @type {Array<CustomTranslation>}
     * @memberof CustomFieldUpdateDescription
     */
    translations?: Array<CustomTranslation>;
}

export function CustomFieldUpdateDescriptionFromJSON(json: any): CustomFieldUpdateDescription {
    return CustomFieldUpdateDescriptionFromJSONTyped(json, false);
}

export function CustomFieldUpdateDescriptionFromJSONTyped(json: any, ignoreDiscriminator: boolean): CustomFieldUpdateDescription {
    ...
    return {
        ...
        'translations': !exists(json, 'translations') ? undefined : ((json['translations'] as Array<any>).map(CustomTranslationFromJSON)),
    };
}

export function CustomFieldUpdateDescriptionToJSON(value?: CustomFieldUpdateDescription | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'value': value.value,
        'translations': value.translations === undefined ? undefined : ((value.translations as Array<any>).map(CustomTranslationToJSON)),
    };
}
