 ...
 * @export
 * @interface EntityHappyHoursHolidayHours
 */
export interface EntityHappyHoursHolidayHours {
    /**
     ...
     * Filtering Type: `date`
     * @type {Date}
     * @memberof EntityHappyHoursHolidayHours
     */
    date: Date;
    /**
...
export function EntityHappyHoursHolidayHoursFromJSON(json: any): EntityHappyHoursHolidayHours {
    return EntityHappyHoursHolidayHoursFromJSONTyped(json, false);
}

export function EntityHappyHoursHolidayHoursFromJSONTyped(json: any, ignoreDiscriminator: boolean): EntityHappyHoursHolidayHours {
...
export function EntityHappyHoursHolidayHoursToJSON(value?: EntityHappyHoursHolidayHours | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
