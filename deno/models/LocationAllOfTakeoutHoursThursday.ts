 ...
 * 
 * @export
 * @interface LocationAllOfTakeoutHoursThursday
 */
export interface LocationAllOfTakeoutHoursThursday {
    /**
     * Indicates if the takeout hours are "closed" on Thursday.
     * @type {boolean}
     * @memberof LocationAllOfTakeoutHoursThursday
     */
    isClosed?: boolean;
    /**
...
export function LocationAllOfTakeoutHoursThursdayFromJSON(json: any): LocationAllOfTakeoutHoursThursday {
    return LocationAllOfTakeoutHoursThursdayFromJSONTyped(json, false);
}

export function LocationAllOfTakeoutHoursThursdayFromJSONTyped(json: any, ignoreDiscriminator: boolean): LocationAllOfTakeoutHoursThursday {
...
export function LocationAllOfTakeoutHoursThursdayToJSON(value?: LocationAllOfTakeoutHoursThursday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
