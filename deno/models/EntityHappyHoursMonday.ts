 ...
 * @export
 * @interface EntityHappyHoursMonday
 */
export interface EntityHappyHoursMonday {
    /**
     * Indicates if the happy hours are "closed" on Monday.
     * 
     * Filtering Type: `boolean`
     * @type {boolean}
     * @memberof EntityHappyHoursMonday
     */
    isClosed?: boolean;
    /**
...
export function EntityHappyHoursMondayFromJSON(json: any): EntityHappyHoursMonday {
    return EntityHappyHoursMondayFromJSONTyped(json, false);
}

export function EntityHappyHoursMondayFromJSONTyped(json: any, ignoreDiscriminator: boolean): EntityHappyHoursMonday {
...
export function EntityHappyHoursMondayToJSON(value?: EntityHappyHoursMonday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
