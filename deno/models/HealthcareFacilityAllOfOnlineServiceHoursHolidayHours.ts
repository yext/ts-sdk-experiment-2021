...
import {
    AtmAllOfAccessHoursFridayOpenIntervals,
    AtmAllOfAccessHoursFridayOpenIntervalsFromJSON,
    AtmAllOfAccessHoursFridayOpenIntervalsFromJSONTyped,
    AtmAllOfAccessHoursFridayOpenIntervalsToJSON,
} from './index.ts';

/**
 * 
 * @export
 * @interface HealthcareFacilityAllOfOnlineServiceHoursHolidayHours
 */
export interface HealthcareFacilityAllOfOnlineServiceHoursHolidayHours {
    /**
     ...
     * @type {Date}
     * @memberof HealthcareFacilityAllOfOnlineServiceHoursHolidayHours
     */
    date: Date;
    /**
     ...
     * @type {Array<AtmAllOfAccessHoursFridayOpenIntervals>}
     * @memberof HealthcareFacilityAllOfOnlineServiceHoursHolidayHours
     */
    openIntervals?: Array<AtmAllOfAccessHoursFridayOpenIntervals>;
}

export function HealthcareFacilityAllOfOnlineServiceHoursHolidayHoursFromJSON(json: any): HealthcareFacilityAllOfOnlineServiceHoursHolidayHours {
    return HealthcareFacilityAllOfOnlineServiceHoursHolidayHoursFromJSONTyped(json, false);
}

export function HealthcareFacilityAllOfOnlineServiceHoursHolidayHoursFromJSONTyped(json: any, ignoreDiscriminator: boolean): HealthcareFacilityAllOfOnlineServiceHoursHolidayHours {
    ...
    return {
        ...
        'openIntervals': !exists(json, 'openIntervals') ? undefined : ((json['openIntervals'] as Array<any>).map(AtmAllOfAccessHoursFridayOpenIntervalsFromJSON)),
    };
}

export function HealthcareFacilityAllOfOnlineServiceHoursHolidayHoursToJSON(value?: HealthcareFacilityAllOfOnlineServiceHoursHolidayHours | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'openIntervals': value.openIntervals === undefined ? undefined : ((value.openIntervals as Array<any>).map(AtmAllOfAccessHoursFridayOpenIntervalsToJSON)),
    };
}
