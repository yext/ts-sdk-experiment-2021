 ...
 * @export
 * @interface InlineResponse200ResponseHappyHoursThursday
 */
export interface InlineResponse200ResponseHappyHoursThursday {
    /**
     * Indicates if the happy hours are "closed" on Thursday.
     * 
     * Filtering Type: `boolean`
     * @type {boolean}
     * @memberof InlineResponse200ResponseHappyHoursThursday
     */
    isClosed?: boolean;
    /**
...
export function InlineResponse200ResponseHappyHoursThursdayFromJSON(json: any): InlineResponse200ResponseHappyHoursThursday {
    return InlineResponse200ResponseHappyHoursThursdayFromJSONTyped(json, false);
}

export function InlineResponse200ResponseHappyHoursThursdayFromJSONTyped(json: any, ignoreDiscriminator: boolean): InlineResponse200ResponseHappyHoursThursday {
...
export function InlineResponse200ResponseHappyHoursThursdayToJSON(value?: InlineResponse200ResponseHappyHoursThursday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
