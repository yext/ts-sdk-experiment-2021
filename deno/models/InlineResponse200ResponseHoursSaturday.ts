 ...
 * @export
 * @interface InlineResponse200ResponseHoursSaturday
 */
export interface InlineResponse200ResponseHoursSaturday {
    /**
     * Indicates if the hours of operation are "closed" on Saturday.
     * 
     * Filtering Type: `boolean`
     * @type {boolean}
     * @memberof InlineResponse200ResponseHoursSaturday
     */
    isClosed?: boolean;
    /**
...
export function InlineResponse200ResponseHoursSaturdayFromJSON(json: any): InlineResponse200ResponseHoursSaturday {
    return InlineResponse200ResponseHoursSaturdayFromJSONTyped(json, false);
}

export function InlineResponse200ResponseHoursSaturdayFromJSONTyped(json: any, ignoreDiscriminator: boolean): InlineResponse200ResponseHoursSaturday {
...
export function InlineResponse200ResponseHoursSaturdayToJSON(value?: InlineResponse200ResponseHoursSaturday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
