 ...
 * @export
 * @interface EntityTakeoutHoursSaturday
 */
export interface EntityTakeoutHoursSaturday {
    /**
     * Indicates if the takeout hours are "closed" on Saturday.
     * 
     * Filtering Type: `boolean`
     * @type {boolean}
     * @memberof EntityTakeoutHoursSaturday
     */
    isClosed?: boolean;
    /**
...
export function EntityTakeoutHoursSaturdayFromJSON(json: any): EntityTakeoutHoursSaturday {
    return EntityTakeoutHoursSaturdayFromJSONTyped(json, false);
}

export function EntityTakeoutHoursSaturdayFromJSONTyped(json: any, ignoreDiscriminator: boolean): EntityTakeoutHoursSaturday {
...
export function EntityTakeoutHoursSaturdayToJSON(value?: EntityTakeoutHoursSaturday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
