 ...
 * ```
 * @export
 * @interface EntityYextDropoffCoordinate
 */
export interface EntityYextDropoffCoordinate {
    /**
     * Filtering Type: `float`
     * @type {number}
     * @memberof EntityYextDropoffCoordinate
     */
    latitude?: number;
    /**
     * Filtering Type: `float`
...
export function EntityYextDropoffCoordinateFromJSON(json: any): EntityYextDropoffCoordinate {
    return EntityYextDropoffCoordinateFromJSONTyped(json, false);
}

export function EntityYextDropoffCoordinateFromJSONTyped(json: any, ignoreDiscriminator: boolean): EntityYextDropoffCoordinate {
...
export function EntityYextDropoffCoordinateToJSON(value?: EntityYextDropoffCoordinate | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
