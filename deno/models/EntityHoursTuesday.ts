 ...
 * @export
 * @interface EntityHoursTuesday
 */
export interface EntityHoursTuesday {
    /**
     * Indicates if the hours of operation are "closed" on Tuesday.
     * 
     * Filtering Type: `boolean`
     * @type {boolean}
     * @memberof EntityHoursTuesday
     */
    isClosed?: boolean;
    /**
...
export function EntityHoursTuesdayFromJSON(json: any): EntityHoursTuesday {
    return EntityHoursTuesdayFromJSONTyped(json, false);
}

export function EntityHoursTuesdayFromJSONTyped(json: any, ignoreDiscriminator: boolean): EntityHoursTuesday {
...
export function EntityHoursTuesdayToJSON(value?: EntityHoursTuesday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
