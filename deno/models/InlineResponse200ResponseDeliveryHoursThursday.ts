 ...
 * @export
 * @interface InlineResponse200ResponseDeliveryHoursThursday
 */
export interface InlineResponse200ResponseDeliveryHoursThursday {
    /**
     * Indicates if the delivery hours are "closed" on Thursday.
     * 
     * Filtering Type: `boolean`
     * @type {boolean}
     * @memberof InlineResponse200ResponseDeliveryHoursThursday
     */
    isClosed?: boolean;
    /**
...
export function InlineResponse200ResponseDeliveryHoursThursdayFromJSON(json: any): InlineResponse200ResponseDeliveryHoursThursday {
    return InlineResponse200ResponseDeliveryHoursThursdayFromJSONTyped(json, false);
}

export function InlineResponse200ResponseDeliveryHoursThursdayFromJSONTyped(json: any, ignoreDiscriminator: boolean): InlineResponse200ResponseDeliveryHoursThursday {
...
export function InlineResponse200ResponseDeliveryHoursThursdayToJSON(value?: InlineResponse200ResponseDeliveryHoursThursday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
