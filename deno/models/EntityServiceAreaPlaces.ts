 ...
 * @export
 * @interface EntityServiceAreaPlaces
 */
export interface EntityServiceAreaPlaces {
    /**
     * Filtering Type: `text`
     * @type {string}
     * @memberof EntityServiceAreaPlaces
     */
    name?: string;
    /**
     ...
     * @memberof EntityServiceAreaPlaces
     */
    type?: EntityServiceAreaPlacesTypeEnum;
}
...
* @enum {string}
*/
export enum EntityServiceAreaPlacesTypeEnum {
...
export function EntityServiceAreaPlacesFromJSON(json: any): EntityServiceAreaPlaces {
    return EntityServiceAreaPlacesFromJSONTyped(json, false);
}

export function EntityServiceAreaPlacesFromJSONTyped(json: any, ignoreDiscriminator: boolean): EntityServiceAreaPlaces {
...
export function EntityServiceAreaPlacesToJSON(value?: EntityServiceAreaPlaces | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
