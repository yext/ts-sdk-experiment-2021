 ...
 * @export
 * @interface InlineResponse200ResponseHoursWednesday
 */
export interface InlineResponse200ResponseHoursWednesday {
    /**
     * Indicates if the hours of operation are "closed" on Wednesday.
     * 
     * Filtering Type: `boolean`
     * @type {boolean}
     * @memberof InlineResponse200ResponseHoursWednesday
     */
    isClosed?: boolean;
    /**
...
export function InlineResponse200ResponseHoursWednesdayFromJSON(json: any): InlineResponse200ResponseHoursWednesday {
    return InlineResponse200ResponseHoursWednesdayFromJSONTyped(json, false);
}

export function InlineResponse200ResponseHoursWednesdayFromJSONTyped(json: any, ignoreDiscriminator: boolean): InlineResponse200ResponseHoursWednesday {
...
export function InlineResponse200ResponseHoursWednesdayToJSON(value?: InlineResponse200ResponseHoursWednesday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
