 ...
 * @export
 * @interface InlineResponse200ResponseBrunchHoursThursday
 */
export interface InlineResponse200ResponseBrunchHoursThursday {
    /**
     * Indicates if the brunch hours are "closed" on Thursday.
     * 
     * Filtering Type: `boolean`
     * @type {boolean}
     * @memberof InlineResponse200ResponseBrunchHoursThursday
     */
    isClosed?: boolean;
    /**
...
export function InlineResponse200ResponseBrunchHoursThursdayFromJSON(json: any): InlineResponse200ResponseBrunchHoursThursday {
    return InlineResponse200ResponseBrunchHoursThursdayFromJSONTyped(json, false);
}

export function InlineResponse200ResponseBrunchHoursThursdayFromJSONTyped(json: any, ignoreDiscriminator: boolean): InlineResponse200ResponseBrunchHoursThursday {
...
export function InlineResponse200ResponseBrunchHoursThursdayToJSON(value?: InlineResponse200ResponseBrunchHoursThursday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
