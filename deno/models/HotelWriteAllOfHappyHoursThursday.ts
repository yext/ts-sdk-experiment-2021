 ...
 * 
 * @export
 * @interface HotelWriteAllOfHappyHoursThursday
 */
export interface HotelWriteAllOfHappyHoursThursday {
    /**
     * Indicates if the happy hours are "closed" on Thursday.
     * @type {boolean}
     * @memberof HotelWriteAllOfHappyHoursThursday
     */
    isClosed?: boolean;
    /**
...
export function HotelWriteAllOfHappyHoursThursdayFromJSON(json: any): HotelWriteAllOfHappyHoursThursday {
    return HotelWriteAllOfHappyHoursThursdayFromJSONTyped(json, false);
}

export function HotelWriteAllOfHappyHoursThursdayFromJSONTyped(json: any, ignoreDiscriminator: boolean): HotelWriteAllOfHappyHoursThursday {
...
export function HotelWriteAllOfHappyHoursThursdayToJSON(value?: HotelWriteAllOfHappyHoursThursday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
