 ...
 * @export
 * @interface EntityAccessHoursTuesday
 */
export interface EntityAccessHoursTuesday {
    /**
     * Indicates if the access hours are "closed" on Tuesday.
     * 
     * Filtering Type: `boolean`
     * @type {boolean}
     * @memberof EntityAccessHoursTuesday
     */
    isClosed?: boolean;
    /**
...
export function EntityAccessHoursTuesdayFromJSON(json: any): EntityAccessHoursTuesday {
    return EntityAccessHoursTuesdayFromJSONTyped(json, false);
}

export function EntityAccessHoursTuesdayFromJSONTyped(json: any, ignoreDiscriminator: boolean): EntityAccessHoursTuesday {
...
export function EntityAccessHoursTuesdayToJSON(value?: EntityAccessHoursTuesday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
