 ...
 * 
 * @export
 * @interface HotelAllOfHappyHoursTuesday
 */
export interface HotelAllOfHappyHoursTuesday {
    /**
     * Indicates if the happy hours are "closed" on Tuesday.
     * @type {boolean}
     * @memberof HotelAllOfHappyHoursTuesday
     */
    isClosed?: boolean;
    /**
...
export function HotelAllOfHappyHoursTuesdayFromJSON(json: any): HotelAllOfHappyHoursTuesday {
    return HotelAllOfHappyHoursTuesdayFromJSONTyped(json, false);
}

export function HotelAllOfHappyHoursTuesdayFromJSONTyped(json: any, ignoreDiscriminator: boolean): HotelAllOfHappyHoursTuesday {
...
export function HotelAllOfHappyHoursTuesdayToJSON(value?: HotelAllOfHappyHoursTuesday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
