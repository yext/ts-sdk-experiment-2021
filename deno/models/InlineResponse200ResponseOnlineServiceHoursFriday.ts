 ...
 * @export
 * @interface InlineResponse200ResponseOnlineServiceHoursFriday
 */
export interface InlineResponse200ResponseOnlineServiceHoursFriday {
    /**
     * Indicates if the online service hours are "closed" on Friday.
     * 
     * Filtering Type: `boolean`
     * @type {boolean}
     * @memberof InlineResponse200ResponseOnlineServiceHoursFriday
     */
    isClosed?: boolean;
    /**
...
export function InlineResponse200ResponseOnlineServiceHoursFridayFromJSON(json: any): InlineResponse200ResponseOnlineServiceHoursFriday {
    return InlineResponse200ResponseOnlineServiceHoursFridayFromJSONTyped(json, false);
}

export function InlineResponse200ResponseOnlineServiceHoursFridayFromJSONTyped(json: any, ignoreDiscriminator: boolean): InlineResponse200ResponseOnlineServiceHoursFriday {
...
export function InlineResponse200ResponseOnlineServiceHoursFridayToJSON(value?: InlineResponse200ResponseOnlineServiceHoursFriday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
