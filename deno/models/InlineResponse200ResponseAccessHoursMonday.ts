 ...
 * @export
 * @interface InlineResponse200ResponseAccessHoursMonday
 */
export interface InlineResponse200ResponseAccessHoursMonday {
    /**
     * Indicates if the access hours are "closed" on Monday.
     * 
     * Filtering Type: `boolean`
     * @type {boolean}
     * @memberof InlineResponse200ResponseAccessHoursMonday
     */
    isClosed?: boolean;
    /**
...
export function InlineResponse200ResponseAccessHoursMondayFromJSON(json: any): InlineResponse200ResponseAccessHoursMonday {
    return InlineResponse200ResponseAccessHoursMondayFromJSONTyped(json, false);
}

export function InlineResponse200ResponseAccessHoursMondayFromJSONTyped(json: any, ignoreDiscriminator: boolean): InlineResponse200ResponseAccessHoursMonday {
...
export function InlineResponse200ResponseAccessHoursMondayToJSON(value?: InlineResponse200ResponseAccessHoursMonday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
