 ...
 * @export
 * @interface EntityHoursFriday
 */
export interface EntityHoursFriday {
    /**
     * Indicates if the hours of operation are "closed" on Friday.
     * 
     * Filtering Type: `boolean`
     * @type {boolean}
     * @memberof EntityHoursFriday
     */
    isClosed?: boolean;
    /**
...
export function EntityHoursFridayFromJSON(json: any): EntityHoursFriday {
    return EntityHoursFridayFromJSONTyped(json, false);
}

export function EntityHoursFridayFromJSONTyped(json: any, ignoreDiscriminator: boolean): EntityHoursFriday {
...
export function EntityHoursFridayToJSON(value?: EntityHoursFriday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
