 ...
 * ```
 * @export
 * @interface EntityTicketPriceRange
 */
export interface EntityTicketPriceRange {
    /**
     * Three letter currency code (ISO standard)
     * 
     * Filtering Type: `text`
     * @type {string}
     * @memberof EntityTicketPriceRange
     */
    currencyCode?: string;
    /**
...
export function EntityTicketPriceRangeFromJSON(json: any): EntityTicketPriceRange {
    return EntityTicketPriceRangeFromJSONTyped(json, false);
}

export function EntityTicketPriceRangeFromJSONTyped(json: any, ignoreDiscriminator: boolean): EntityTicketPriceRange {
...
export function EntityTicketPriceRangeToJSON(value?: EntityTicketPriceRange | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
