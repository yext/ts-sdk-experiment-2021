 ...
 * @export
 * @interface EntityDriveThroughHoursFriday
 */
export interface EntityDriveThroughHoursFriday {
    /**
     * Indicates if the drive-through hours are "closed" on Friday.
     * 
     * Filtering Type: `boolean`
     * @type {boolean}
     * @memberof EntityDriveThroughHoursFriday
     */
    isClosed?: boolean;
    /**
...
export function EntityDriveThroughHoursFridayFromJSON(json: any): EntityDriveThroughHoursFriday {
    return EntityDriveThroughHoursFridayFromJSONTyped(json, false);
}

export function EntityDriveThroughHoursFridayFromJSONTyped(json: any, ignoreDiscriminator: boolean): EntityDriveThroughHoursFriday {
...
export function EntityDriveThroughHoursFridayToJSON(value?: EntityDriveThroughHoursFriday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
