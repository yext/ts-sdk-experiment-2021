 ...
 * 
 * @export
 * @interface HotelAllOfHappyHoursSaturday
 */
export interface HotelAllOfHappyHoursSaturday {
    /**
     * Indicates if the happy hours are "closed" on Saturday.
     * @type {boolean}
     * @memberof HotelAllOfHappyHoursSaturday
     */
    isClosed?: boolean;
    /**
...
export function HotelAllOfHappyHoursSaturdayFromJSON(json: any): HotelAllOfHappyHoursSaturday {
    return HotelAllOfHappyHoursSaturdayFromJSONTyped(json, false);
}

export function HotelAllOfHappyHoursSaturdayFromJSONTyped(json: any, ignoreDiscriminator: boolean): HotelAllOfHappyHoursSaturday {
...
export function HotelAllOfHappyHoursSaturdayToJSON(value?: HotelAllOfHappyHoursSaturday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
