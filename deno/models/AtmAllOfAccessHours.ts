...
import {
    AtmAllOfAccessHoursFriday,
    AtmAllOfAccessHoursFridayFromJSON,
    AtmAllOfAccessHoursFridayFromJSONTyped,
    AtmAllOfAccessHoursFridayToJSON,
    AtmAllOfAccessHoursHolidayHours,
    AtmAllOfAccessHoursHolidayHoursFromJSON,
    AtmAllOfAccessHoursHolidayHoursFromJSONTyped,
    AtmAllOfAccessHoursHolidayHoursToJSON,
    AtmAllOfAccessHoursMonday,
    AtmAllOfAccessHoursMondayFromJSON,
    AtmAllOfAccessHoursMondayFromJSONTyped,
    AtmAllOfAccessHoursMondayToJSON,
    AtmAllOfAccessHoursSaturday,
    AtmAllOfAccessHoursSaturdayFromJSON,
    AtmAllOfAccessHoursSaturdayFromJSONTyped,
    AtmAllOfAccessHoursSaturdayToJSON,
    AtmAllOfAccessHoursSunday,
    AtmAllOfAccessHoursSundayFromJSON,
    AtmAllOfAccessHoursSundayFromJSONTyped,
    AtmAllOfAccessHoursSundayToJSON,
    AtmAllOfAccessHoursThursday,
    AtmAllOfAccessHoursThursdayFromJSON,
    AtmAllOfAccessHoursThursdayFromJSONTyped,
    AtmAllOfAccessHoursThursdayToJSON,
    AtmAllOfAccessHoursTuesday,
    AtmAllOfAccessHoursTuesdayFromJSON,
    AtmAllOfAccessHoursTuesdayFromJSONTyped,
    AtmAllOfAccessHoursTuesdayToJSON,
    AtmAllOfAccessHoursWednesday,
    AtmAllOfAccessHoursWednesdayFromJSON,
    AtmAllOfAccessHoursWednesdayFromJSONTyped,
    AtmAllOfAccessHoursWednesdayToJSON,
} from './index.ts';
 ...
 * @export
 * @interface AtmAllOfAccessHours
 */
export interface AtmAllOfAccessHours {
    /**
     * 
     * @type {AtmAllOfAccessHoursFriday}
     * @memberof AtmAllOfAccessHours
     */
    friday?: AtmAllOfAccessHoursFriday;
    /**
     * 
     ...
     * @type {Set<AtmAllOfAccessHoursHolidayHours>}
     * @memberof AtmAllOfAccessHours
     */
    holidayHours?: Set<AtmAllOfAccessHoursHolidayHours>;
    /**
     * 
     * @type {AtmAllOfAccessHoursMonday}
     * @memberof AtmAllOfAccessHours
     */
    monday?: AtmAllOfAccessHoursMonday;
    /**
     * 
    ...
    /**
     * 
     * @type {AtmAllOfAccessHoursSaturday}
     * @memberof AtmAllOfAccessHours
     */
    saturday?: AtmAllOfAccessHoursSaturday;
    /**
     * 
     * @type {AtmAllOfAccessHoursSunday}
     * @memberof AtmAllOfAccessHours
     */
    sunday?: AtmAllOfAccessHoursSunday;
    /**
     * 
     * @type {AtmAllOfAccessHoursThursday}
     * @memberof AtmAllOfAccessHours
     */
    thursday?: AtmAllOfAccessHoursThursday;
    /**
     * 
     * @type {AtmAllOfAccessHoursTuesday}
     * @memberof AtmAllOfAccessHours
     */
    tuesday?: AtmAllOfAccessHoursTuesday;
    /**
     * 
     * @type {AtmAllOfAccessHoursWednesday}
     * @memberof AtmAllOfAccessHours
     */
    wednesday?: AtmAllOfAccessHoursWednesday;
}

export function AtmAllOfAccessHoursFromJSON(json: any): AtmAllOfAccessHours {
    return AtmAllOfAccessHoursFromJSONTyped(json, false);
}

export function AtmAllOfAccessHoursFromJSONTyped(json: any, ignoreDiscriminator: boolean): AtmAllOfAccessHours {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'friday': !exists(json, 'friday') ? undefined : AtmAllOfAccessHoursFridayFromJSON(json['friday']),
        'holidayHours': !exists(json, 'holidayHours') ? undefined : (new Set((json['holidayHours'] as Array<any>).map(AtmAllOfAccessHoursHolidayHoursFromJSON))),
        'monday': !exists(json, 'monday') ? undefined : AtmAllOfAccessHoursMondayFromJSON(json['monday']),
        'reopenDate': !exists(json, 'reopenDate') ? undefined : (new Date(json['reopenDate'])),
        'saturday': !exists(json, 'saturday') ? undefined : AtmAllOfAccessHoursSaturdayFromJSON(json['saturday']),
        'sunday': !exists(json, 'sunday') ? undefined : AtmAllOfAccessHoursSundayFromJSON(json['sunday']),
        'thursday': !exists(json, 'thursday') ? undefined : AtmAllOfAccessHoursThursdayFromJSON(json['thursday']),
        'tuesday': !exists(json, 'tuesday') ? undefined : AtmAllOfAccessHoursTuesdayFromJSON(json['tuesday']),
        'wednesday': !exists(json, 'wednesday') ? undefined : AtmAllOfAccessHoursWednesdayFromJSON(json['wednesday']),
    };
}

export function AtmAllOfAccessHoursToJSON(value?: AtmAllOfAccessHours | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'friday': AtmAllOfAccessHoursFridayToJSON(value.friday),
        'holidayHours': value.holidayHours === undefined ? undefined : (Array.from(value.holidayHours as Set<any>).map(AtmAllOfAccessHoursHolidayHoursToJSON)),
        'monday': AtmAllOfAccessHoursMondayToJSON(value.monday),
        'reopenDate': value.reopenDate === undefined ? undefined : (value.reopenDate.toISOString().substr(0,10)),
        'saturday': AtmAllOfAccessHoursSaturdayToJSON(value.saturday),
        'sunday': AtmAllOfAccessHoursSundayToJSON(value.sunday),
        'thursday': AtmAllOfAccessHoursThursdayToJSON(value.thursday),
        'tuesday': AtmAllOfAccessHoursTuesdayToJSON(value.tuesday),
        'wednesday': AtmAllOfAccessHoursWednesdayToJSON(value.wednesday),
    };
}
