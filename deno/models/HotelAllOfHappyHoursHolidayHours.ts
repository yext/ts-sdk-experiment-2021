 ...
 * 
 * @export
 * @interface HotelAllOfHappyHoursHolidayHours
 */
export interface HotelAllOfHappyHoursHolidayHours {
    /**
     ...
     * @type {Date}
     * @memberof HotelAllOfHappyHoursHolidayHours
     */
    date: Date;
    /**
...
export function HotelAllOfHappyHoursHolidayHoursFromJSON(json: any): HotelAllOfHappyHoursHolidayHours {
    return HotelAllOfHappyHoursHolidayHoursFromJSONTyped(json, false);
}

export function HotelAllOfHappyHoursHolidayHoursFromJSONTyped(json: any, ignoreDiscriminator: boolean): HotelAllOfHappyHoursHolidayHours {
...
export function HotelAllOfHappyHoursHolidayHoursToJSON(value?: HotelAllOfHappyHoursHolidayHours | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
