 ...
 * @export
 * @interface EntityHappyHoursFriday
 */
export interface EntityHappyHoursFriday {
    /**
     * Indicates if the happy hours are "closed" on Friday.
     * 
     * Filtering Type: `boolean`
     * @type {boolean}
     * @memberof EntityHappyHoursFriday
     */
    isClosed?: boolean;
    /**
...
export function EntityHappyHoursFridayFromJSON(json: any): EntityHappyHoursFriday {
    return EntityHappyHoursFridayFromJSONTyped(json, false);
}

export function EntityHappyHoursFridayFromJSONTyped(json: any, ignoreDiscriminator: boolean): EntityHappyHoursFriday {
...
export function EntityHappyHoursFridayToJSON(value?: EntityHappyHoursFriday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
