 ...
 * @export
 * @interface InlineResponse200ResponseAccessHoursSaturday
 */
export interface InlineResponse200ResponseAccessHoursSaturday {
    /**
     * Indicates if the access hours are "closed" on Saturday.
     * 
     * Filtering Type: `boolean`
     * @type {boolean}
     * @memberof InlineResponse200ResponseAccessHoursSaturday
     */
    isClosed?: boolean;
    /**
...
export function InlineResponse200ResponseAccessHoursSaturdayFromJSON(json: any): InlineResponse200ResponseAccessHoursSaturday {
    return InlineResponse200ResponseAccessHoursSaturdayFromJSONTyped(json, false);
}

export function InlineResponse200ResponseAccessHoursSaturdayFromJSONTyped(json: any, ignoreDiscriminator: boolean): InlineResponse200ResponseAccessHoursSaturday {
...
export function InlineResponse200ResponseAccessHoursSaturdayToJSON(value?: InlineResponse200ResponseAccessHoursSaturday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
