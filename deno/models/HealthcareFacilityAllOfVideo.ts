 ...
 * 
 * @export
 * @interface HealthcareFacilityAllOfVideo
 */
export interface HealthcareFacilityAllOfVideo {
    /**
     * 
     * @type {string}
     * @memberof HealthcareFacilityAllOfVideo
     */
    url: string;
}

export function HealthcareFacilityAllOfVideoFromJSON(json: any): HealthcareFacilityAllOfVideo {
    return HealthcareFacilityAllOfVideoFromJSONTyped(json, false);
}

export function HealthcareFacilityAllOfVideoFromJSONTyped(json: any, ignoreDiscriminator: boolean): HealthcareFacilityAllOfVideo {
...
export function HealthcareFacilityAllOfVideoToJSON(value?: HealthcareFacilityAllOfVideo | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
