 ...
 * @export
 * @interface LocationLegacyFacebookCallToAction
 */
export interface LocationLegacyFacebookCallToAction {
    /**
     * The action the consumer is being prompted to take by the button's text
     * @type {string}
     * @memberof LocationLegacyFacebookCallToAction
     */
    type?: LocationLegacyFacebookCallToActionTypeEnum;
    /**
...
* @enum {string}
*/
export enum LocationLegacyFacebookCallToActionTypeEnum {
    None = 'NONE',
    BookNow = 'BOOK_NOW',
    CallNow = 'CALL_NOW',
...
export function LocationLegacyFacebookCallToActionFromJSON(json: any): LocationLegacyFacebookCallToAction {
    return LocationLegacyFacebookCallToActionFromJSONTyped(json, false);
}

export function LocationLegacyFacebookCallToActionFromJSONTyped(json: any, ignoreDiscriminator: boolean): LocationLegacyFacebookCallToAction {
...
export function LocationLegacyFacebookCallToActionToJSON(value?: LocationLegacyFacebookCallToAction | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
