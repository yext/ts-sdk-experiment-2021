 ...
 * @export
 * @interface EntityAccessHoursHolidayHours
 */
export interface EntityAccessHoursHolidayHours {
    /**
     ...
     * Filtering Type: `date`
     * @type {Date}
     * @memberof EntityAccessHoursHolidayHours
     */
    date: Date;
    /**
...
export function EntityAccessHoursHolidayHoursFromJSON(json: any): EntityAccessHoursHolidayHours {
    return EntityAccessHoursHolidayHoursFromJSONTyped(json, false);
}

export function EntityAccessHoursHolidayHoursFromJSONTyped(json: any, ignoreDiscriminator: boolean): EntityAccessHoursHolidayHours {
...
export function EntityAccessHoursHolidayHoursToJSON(value?: EntityAccessHoursHolidayHours | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
