...
import {
    EventAllOfImage,
    EventAllOfImageFromJSON,
    EventAllOfImageFromJSONTyped,
    EventAllOfImageToJSON,
} from './index.ts';
 ...
 * @export
 * @interface EventAllOfPhotoGallery
 */
export interface EventAllOfPhotoGallery {
    /**
     * 
     * @type {string}
     * @memberof EventAllOfPhotoGallery
     */
    ...
    /**
     * 
     * @type {EventAllOfImage}
     * @memberof EventAllOfPhotoGallery
     */
    image: EventAllOfImage;
}

export function EventAllOfPhotoGalleryFromJSON(json: any): EventAllOfPhotoGallery {
    return EventAllOfPhotoGalleryFromJSONTyped(json, false);
}

export function EventAllOfPhotoGalleryFromJSONTyped(json: any, ignoreDiscriminator: boolean): EventAllOfPhotoGallery {
    ...
    return {
        ...
        'image': EventAllOfImageFromJSON(json['image']),
    };
}

export function EventAllOfPhotoGalleryToJSON(value?: EventAllOfPhotoGallery | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'image': EventAllOfImageToJSON(value.image),
    };
}
