...
export function EntityMenusFromJSON(json: any): EntityMenus {
    return EntityMenusFromJSONTyped(json, false);
}

export function EntityMenusFromJSONTyped(json: any, ignoreDiscriminator: boolean): EntityMenus {
...
export function EntityMenusToJSON(value?: EntityMenus | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
