 ...
 * @export
 * @interface AtmAllOfAddress
 */
export interface AtmAllOfAddress {
    /**
...
export function AtmAllOfAddressFromJSON(json: any): AtmAllOfAddress {
    return AtmAllOfAddressFromJSONTyped(json, false);
}

export function AtmAllOfAddressFromJSONTyped(json: any, ignoreDiscriminator: boolean): AtmAllOfAddress {
...
export function AtmAllOfAddressToJSON(value?: AtmAllOfAddress | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
