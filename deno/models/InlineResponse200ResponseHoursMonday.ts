 ...
 * @export
 * @interface InlineResponse200ResponseHoursMonday
 */
export interface InlineResponse200ResponseHoursMonday {
    /**
     * Indicates if the hours of operation are "closed" on Monday.
     * 
     * Filtering Type: `boolean`
     * @type {boolean}
     * @memberof InlineResponse200ResponseHoursMonday
     */
    isClosed?: boolean;
    /**
...
export function InlineResponse200ResponseHoursMondayFromJSON(json: any): InlineResponse200ResponseHoursMonday {
    return InlineResponse200ResponseHoursMondayFromJSONTyped(json, false);
}

export function InlineResponse200ResponseHoursMondayFromJSONTyped(json: any, ignoreDiscriminator: boolean): InlineResponse200ResponseHoursMonday {
...
export function InlineResponse200ResponseHoursMondayToJSON(value?: InlineResponse200ResponseHoursMonday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
