 ...
 * @export
 * @interface EntityHappyHoursThursday
 */
export interface EntityHappyHoursThursday {
    /**
     * Indicates if the happy hours are "closed" on Thursday.
     * 
     * Filtering Type: `boolean`
     * @type {boolean}
     * @memberof EntityHappyHoursThursday
     */
    isClosed?: boolean;
    /**
...
export function EntityHappyHoursThursdayFromJSON(json: any): EntityHappyHoursThursday {
    return EntityHappyHoursThursdayFromJSONTyped(json, false);
}

export function EntityHappyHoursThursdayFromJSONTyped(json: any, ignoreDiscriminator: boolean): EntityHappyHoursThursday {
...
export function EntityHappyHoursThursdayToJSON(value?: EntityHappyHoursThursday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
