 ...
 * 
 * @export
 * @interface LocationWriteAllOfDeliveryHoursHolidayHours
 */
export interface LocationWriteAllOfDeliveryHoursHolidayHours {
    /**
     ...
     * @type {Date}
     * @memberof LocationWriteAllOfDeliveryHoursHolidayHours
     */
    date: Date;
    /**
...
export function LocationWriteAllOfDeliveryHoursHolidayHoursFromJSON(json: any): LocationWriteAllOfDeliveryHoursHolidayHours {
    return LocationWriteAllOfDeliveryHoursHolidayHoursFromJSONTyped(json, false);
}

export function LocationWriteAllOfDeliveryHoursHolidayHoursFromJSONTyped(json: any, ignoreDiscriminator: boolean): LocationWriteAllOfDeliveryHoursHolidayHours {
...
export function LocationWriteAllOfDeliveryHoursHolidayHoursToJSON(value?: LocationWriteAllOfDeliveryHoursHolidayHours | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
