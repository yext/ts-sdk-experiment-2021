 ...
 * @export
 * @interface EntityOnlineServiceHoursTuesday
 */
export interface EntityOnlineServiceHoursTuesday {
    /**
     * Indicates if the online service hours are "closed" on Tuesday.
     * 
     * Filtering Type: `boolean`
     * @type {boolean}
     * @memberof EntityOnlineServiceHoursTuesday
     */
    isClosed?: boolean;
    /**
...
export function EntityOnlineServiceHoursTuesdayFromJSON(json: any): EntityOnlineServiceHoursTuesday {
    return EntityOnlineServiceHoursTuesdayFromJSONTyped(json, false);
}

export function EntityOnlineServiceHoursTuesdayFromJSONTyped(json: any, ignoreDiscriminator: boolean): EntityOnlineServiceHoursTuesday {
...
export function EntityOnlineServiceHoursTuesdayToJSON(value?: EntityOnlineServiceHoursTuesday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
