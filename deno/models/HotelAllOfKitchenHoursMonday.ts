 ...
 * 
 * @export
 * @interface HotelAllOfKitchenHoursMonday
 */
export interface HotelAllOfKitchenHoursMonday {
    /**
     * Indicates if the kitchen hours are "closed" on Monday.
     * @type {boolean}
     * @memberof HotelAllOfKitchenHoursMonday
     */
    isClosed?: boolean;
    /**
...
export function HotelAllOfKitchenHoursMondayFromJSON(json: any): HotelAllOfKitchenHoursMonday {
    return HotelAllOfKitchenHoursMondayFromJSONTyped(json, false);
}

export function HotelAllOfKitchenHoursMondayFromJSONTyped(json: any, ignoreDiscriminator: boolean): HotelAllOfKitchenHoursMonday {
...
export function HotelAllOfKitchenHoursMondayToJSON(value?: HotelAllOfKitchenHoursMonday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
