 ...
 * 
 * @export
 * @interface AtmAllOfDriveThroughHoursThursday
 */
export interface AtmAllOfDriveThroughHoursThursday {
    /**
     * Indicates if the drive-through hours are "closed" on Thursday.
     * @type {boolean}
     * @memberof AtmAllOfDriveThroughHoursThursday
     */
    isClosed?: boolean;
    /**
...
export function AtmAllOfDriveThroughHoursThursdayFromJSON(json: any): AtmAllOfDriveThroughHoursThursday {
    return AtmAllOfDriveThroughHoursThursdayFromJSONTyped(json, false);
}

export function AtmAllOfDriveThroughHoursThursdayFromJSONTyped(json: any, ignoreDiscriminator: boolean): AtmAllOfDriveThroughHoursThursday {
...
export function AtmAllOfDriveThroughHoursThursdayToJSON(value?: AtmAllOfDriveThroughHoursThursday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
