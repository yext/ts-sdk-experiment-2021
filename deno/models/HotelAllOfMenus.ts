 ...
 * @export
 * @interface HotelAllOfMenus
 */
export interface HotelAllOfMenus {
    /**
...
export function HotelAllOfMenusFromJSON(json: any): HotelAllOfMenus {
    return HotelAllOfMenusFromJSONTyped(json, false);
}

export function HotelAllOfMenusFromJSONTyped(json: any, ignoreDiscriminator: boolean): HotelAllOfMenus {
...
export function HotelAllOfMenusToJSON(value?: HotelAllOfMenus | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
