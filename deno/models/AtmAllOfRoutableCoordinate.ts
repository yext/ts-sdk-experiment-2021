 ...
 * @export
 * @interface AtmAllOfRoutableCoordinate
 */
export interface AtmAllOfRoutableCoordinate {
    /**
     * 
     * @type {number}
     * @memberof AtmAllOfRoutableCoordinate
     */
    latitude?: number;
    /**
     * 
...
export function AtmAllOfRoutableCoordinateFromJSON(json: any): AtmAllOfRoutableCoordinate {
    return AtmAllOfRoutableCoordinateFromJSONTyped(json, false);
}

export function AtmAllOfRoutableCoordinateFromJSONTyped(json: any, ignoreDiscriminator: boolean): AtmAllOfRoutableCoordinate {
...
export function AtmAllOfRoutableCoordinateToJSON(value?: AtmAllOfRoutableCoordinate | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
