 ...
 * 
 * @export
 * @interface HealthcareFacilityAllOfOnlineServiceHoursSaturday
 */
export interface HealthcareFacilityAllOfOnlineServiceHoursSaturday {
    /**
     * Indicates if the online service hours are "closed" on Saturday.
     * @type {boolean}
     * @memberof HealthcareFacilityAllOfOnlineServiceHoursSaturday
     */
    isClosed?: boolean;
    /**
...
export function HealthcareFacilityAllOfOnlineServiceHoursSaturdayFromJSON(json: any): HealthcareFacilityAllOfOnlineServiceHoursSaturday {
    return HealthcareFacilityAllOfOnlineServiceHoursSaturdayFromJSONTyped(json, false);
}

export function HealthcareFacilityAllOfOnlineServiceHoursSaturdayFromJSONTyped(json: any, ignoreDiscriminator: boolean): HealthcareFacilityAllOfOnlineServiceHoursSaturday {
...
export function HealthcareFacilityAllOfOnlineServiceHoursSaturdayToJSON(value?: HealthcareFacilityAllOfOnlineServiceHoursSaturday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
