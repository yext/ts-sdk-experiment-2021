 ...
 * @export
 * @interface InlineResponse200ResponseTakeoutHoursWednesday
 */
export interface InlineResponse200ResponseTakeoutHoursWednesday {
    /**
     * Indicates if the takeout hours are "closed" on Wednesday.
     * 
     * Filtering Type: `boolean`
     * @type {boolean}
     * @memberof InlineResponse200ResponseTakeoutHoursWednesday
     */
    isClosed?: boolean;
    /**
...
export function InlineResponse200ResponseTakeoutHoursWednesdayFromJSON(json: any): InlineResponse200ResponseTakeoutHoursWednesday {
    return InlineResponse200ResponseTakeoutHoursWednesdayFromJSONTyped(json, false);
}

export function InlineResponse200ResponseTakeoutHoursWednesdayFromJSONTyped(json: any, ignoreDiscriminator: boolean): InlineResponse200ResponseTakeoutHoursWednesday {
...
export function InlineResponse200ResponseTakeoutHoursWednesdayToJSON(value?: InlineResponse200ResponseTakeoutHoursWednesday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
