 ...
 * 
 * @export
 * @interface LocationWriteAllOfSeniorHoursSaturday
 */
export interface LocationWriteAllOfSeniorHoursSaturday {
    /**
     * Indicates if the senior hours are "closed" on Saturday.
     * @type {boolean}
     * @memberof LocationWriteAllOfSeniorHoursSaturday
     */
    isClosed?: boolean;
    /**
...
export function LocationWriteAllOfSeniorHoursSaturdayFromJSON(json: any): LocationWriteAllOfSeniorHoursSaturday {
    return LocationWriteAllOfSeniorHoursSaturdayFromJSONTyped(json, false);
}

export function LocationWriteAllOfSeniorHoursSaturdayFromJSONTyped(json: any, ignoreDiscriminator: boolean): LocationWriteAllOfSeniorHoursSaturday {
...
export function LocationWriteAllOfSeniorHoursSaturdayToJSON(value?: LocationWriteAllOfSeniorHoursSaturday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
