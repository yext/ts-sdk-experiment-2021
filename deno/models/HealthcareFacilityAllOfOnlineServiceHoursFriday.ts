 ...
 * 
 * @export
 * @interface HealthcareFacilityAllOfOnlineServiceHoursFriday
 */
export interface HealthcareFacilityAllOfOnlineServiceHoursFriday {
    /**
     * Indicates if the online service hours are "closed" on Friday.
     * @type {boolean}
     * @memberof HealthcareFacilityAllOfOnlineServiceHoursFriday
     */
    isClosed?: boolean;
    /**
...
export function HealthcareFacilityAllOfOnlineServiceHoursFridayFromJSON(json: any): HealthcareFacilityAllOfOnlineServiceHoursFriday {
    return HealthcareFacilityAllOfOnlineServiceHoursFridayFromJSONTyped(json, false);
}

export function HealthcareFacilityAllOfOnlineServiceHoursFridayFromJSONTyped(json: any, ignoreDiscriminator: boolean): HealthcareFacilityAllOfOnlineServiceHoursFriday {
...
export function HealthcareFacilityAllOfOnlineServiceHoursFridayToJSON(value?: HealthcareFacilityAllOfOnlineServiceHoursFriday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
