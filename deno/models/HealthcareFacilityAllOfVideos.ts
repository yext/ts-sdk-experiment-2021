...
import {
    HealthcareFacilityAllOfVideo,
    HealthcareFacilityAllOfVideoFromJSON,
    HealthcareFacilityAllOfVideoFromJSONTyped,
    HealthcareFacilityAllOfVideoToJSON,
} from './index.ts';

/**
 * 
 * @export
 * @interface HealthcareFacilityAllOfVideos
 */
export interface HealthcareFacilityAllOfVideos {
    /**
     * 
     * Cannot Include:
     * * HTML markup
     * @type {string}
     * @memberof HealthcareFacilityAllOfVideos
     */
    description?: string;
    /**
     * 
     * @type {HealthcareFacilityAllOfVideo}
     * @memberof HealthcareFacilityAllOfVideos
     */
    video: HealthcareFacilityAllOfVideo;
}

export function HealthcareFacilityAllOfVideosFromJSON(json: any): HealthcareFacilityAllOfVideos {
    return HealthcareFacilityAllOfVideosFromJSONTyped(json, false);
}

export function HealthcareFacilityAllOfVideosFromJSONTyped(json: any, ignoreDiscriminator: boolean): HealthcareFacilityAllOfVideos {
    ...
    return {
        ...
        'video': HealthcareFacilityAllOfVideoFromJSON(json['video']),
    };
}

export function HealthcareFacilityAllOfVideosToJSON(value?: HealthcareFacilityAllOfVideos | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'video': HealthcareFacilityAllOfVideoToJSON(value.video),
    };
}
