 ...
 * ```
 * @export
 * @interface EntityFacebookCallToAction
 */
export interface EntityFacebookCallToAction {
    /**
     * The action the consumer is being prompted to take by the button's text
     * 
     * Filtering Type: `option`
     * @type {string}
     * @memberof EntityFacebookCallToAction
     */
    type: EntityFacebookCallToActionTypeEnum;
    /**
...
* @enum {string}
*/
export enum EntityFacebookCallToActionTypeEnum {
    None = 'NONE',
    BookNow = 'BOOK_NOW',
    CallNow = 'CALL_NOW',
...
export function EntityFacebookCallToActionFromJSON(json: any): EntityFacebookCallToAction {
    return EntityFacebookCallToActionFromJSONTyped(json, false);
}

export function EntityFacebookCallToActionFromJSONTyped(json: any, ignoreDiscriminator: boolean): EntityFacebookCallToAction {
...
export function EntityFacebookCallToActionToJSON(value?: EntityFacebookCallToAction | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
