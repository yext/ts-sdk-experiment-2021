 ...
 * @export
 * @interface EntityOnlineServiceHoursWednesday
 */
export interface EntityOnlineServiceHoursWednesday {
    /**
     * Indicates if the online service hours are "closed" on Wednesday.
     * 
     * Filtering Type: `boolean`
     * @type {boolean}
     * @memberof EntityOnlineServiceHoursWednesday
     */
    isClosed?: boolean;
    /**
...
export function EntityOnlineServiceHoursWednesdayFromJSON(json: any): EntityOnlineServiceHoursWednesday {
    return EntityOnlineServiceHoursWednesdayFromJSONTyped(json, false);
}

export function EntityOnlineServiceHoursWednesdayFromJSONTyped(json: any, ignoreDiscriminator: boolean): EntityOnlineServiceHoursWednesday {
...
export function EntityOnlineServiceHoursWednesdayToJSON(value?: EntityOnlineServiceHoursWednesday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
