 ...
 * 
 * @export
 * @interface HotelAllOfKitchenHoursWednesday
 */
export interface HotelAllOfKitchenHoursWednesday {
    /**
     * Indicates if the kitchen hours are "closed" on Wednesday.
     * @type {boolean}
     * @memberof HotelAllOfKitchenHoursWednesday
     */
    isClosed?: boolean;
    /**
...
export function HotelAllOfKitchenHoursWednesdayFromJSON(json: any): HotelAllOfKitchenHoursWednesday {
    return HotelAllOfKitchenHoursWednesdayFromJSONTyped(json, false);
}

export function HotelAllOfKitchenHoursWednesdayFromJSONTyped(json: any, ignoreDiscriminator: boolean): HotelAllOfKitchenHoursWednesday {
...
export function HotelAllOfKitchenHoursWednesdayToJSON(value?: HotelAllOfKitchenHoursWednesday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
