 ...
 * ```
 * @export
 * @interface EntityYextRoutableCoordinate
 */
export interface EntityYextRoutableCoordinate {
    /**
     * Filtering Type: `float`
     * @type {number}
     * @memberof EntityYextRoutableCoordinate
     */
    latitude?: number;
    /**
     * Filtering Type: `float`
...
export function EntityYextRoutableCoordinateFromJSON(json: any): EntityYextRoutableCoordinate {
    return EntityYextRoutableCoordinateFromJSONTyped(json, false);
}

export function EntityYextRoutableCoordinateFromJSONTyped(json: any, ignoreDiscriminator: boolean): EntityYextRoutableCoordinate {
...
export function EntityYextRoutableCoordinateToJSON(value?: EntityYextRoutableCoordinate | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
