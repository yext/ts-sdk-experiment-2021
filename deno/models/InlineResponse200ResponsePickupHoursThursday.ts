 ...
 * @export
 * @interface InlineResponse200ResponsePickupHoursThursday
 */
export interface InlineResponse200ResponsePickupHoursThursday {
    /**
     * Indicates if the pickup hours are "closed" on Thursday.
     * 
     * Filtering Type: `boolean`
     * @type {boolean}
     * @memberof InlineResponse200ResponsePickupHoursThursday
     */
    isClosed?: boolean;
    /**
...
export function InlineResponse200ResponsePickupHoursThursdayFromJSON(json: any): InlineResponse200ResponsePickupHoursThursday {
    return InlineResponse200ResponsePickupHoursThursdayFromJSONTyped(json, false);
}

export function InlineResponse200ResponsePickupHoursThursdayFromJSONTyped(json: any, ignoreDiscriminator: boolean): InlineResponse200ResponsePickupHoursThursday {
...
export function InlineResponse200ResponsePickupHoursThursdayToJSON(value?: InlineResponse200ResponsePickupHoursThursday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
