 ...
 * @export
 * @interface LocationPhotoDerivatives
 */
export interface LocationPhotoDerivatives {
    /**
     ...
     * @type {string}
     * @memberof LocationPhotoDerivatives
     */
    readonly url?: string;
    /**
...
export function LocationPhotoDerivativesFromJSON(json: any): LocationPhotoDerivatives {
    return LocationPhotoDerivativesFromJSONTyped(json, false);
}

export function LocationPhotoDerivativesFromJSONTyped(json: any, ignoreDiscriminator: boolean): LocationPhotoDerivatives {
...
export function LocationPhotoDerivativesToJSON(value?: LocationPhotoDerivatives | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
