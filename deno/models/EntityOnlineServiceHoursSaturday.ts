 ...
 * @export
 * @interface EntityOnlineServiceHoursSaturday
 */
export interface EntityOnlineServiceHoursSaturday {
    /**
     * Indicates if the online service hours are "closed" on Saturday.
     * 
     * Filtering Type: `boolean`
     * @type {boolean}
     * @memberof EntityOnlineServiceHoursSaturday
     */
    isClosed?: boolean;
    /**
...
export function EntityOnlineServiceHoursSaturdayFromJSON(json: any): EntityOnlineServiceHoursSaturday {
    return EntityOnlineServiceHoursSaturdayFromJSONTyped(json, false);
}

export function EntityOnlineServiceHoursSaturdayFromJSONTyped(json: any, ignoreDiscriminator: boolean): EntityOnlineServiceHoursSaturday {
...
export function EntityOnlineServiceHoursSaturdayToJSON(value?: EntityOnlineServiceHoursSaturday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
