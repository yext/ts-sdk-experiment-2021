 ...
 * @export
 * @interface InlineResponse200ResponseSeniorHoursMonday
 */
export interface InlineResponse200ResponseSeniorHoursMonday {
    /**
     * Indicates if the senior hours are "closed" on Monday.
     * 
     * Filtering Type: `boolean`
     * @type {boolean}
     * @memberof InlineResponse200ResponseSeniorHoursMonday
     */
    isClosed?: boolean;
    /**
...
export function InlineResponse200ResponseSeniorHoursMondayFromJSON(json: any): InlineResponse200ResponseSeniorHoursMonday {
    return InlineResponse200ResponseSeniorHoursMondayFromJSONTyped(json, false);
}

export function InlineResponse200ResponseSeniorHoursMondayFromJSONTyped(json: any, ignoreDiscriminator: boolean): InlineResponse200ResponseSeniorHoursMonday {
...
export function InlineResponse200ResponseSeniorHoursMondayToJSON(value?: InlineResponse200ResponseSeniorHoursMonday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
