...
export interface LanguageProfilesResponseResponse {
     ...
     */
    languageProfiles?: Array<LocationLegacy>;
}
...
export function LanguageProfilesResponseResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): LanguageProfilesResponseResponse {
    ...
    return {
        ...
        'languageProfiles': !exists(json, 'languageProfiles') ? undefined : ((json['languageProfiles'] as Array<any>).map(LocationLegacyFromJSON)),
    };
}
...
export function LanguageProfilesResponseResponseToJSON(value?: LanguageProfilesResponseResponse | null): any {
    ...
    return {
        ...
        'languageProfiles': value.languageProfiles === undefined ? undefined : ((value.languageProfiles as Array<any>).map(LocationLegacyToJSON)),
    };
}
