 ...
 * @export
 * @interface EntityDriveThroughHoursThursday
 */
export interface EntityDriveThroughHoursThursday {
    /**
     * Indicates if the drive-through hours are "closed" on Thursday.
     * 
     * Filtering Type: `boolean`
     * @type {boolean}
     * @memberof EntityDriveThroughHoursThursday
     */
    isClosed?: boolean;
    /**
...
export function EntityDriveThroughHoursThursdayFromJSON(json: any): EntityDriveThroughHoursThursday {
    return EntityDriveThroughHoursThursdayFromJSONTyped(json, false);
}

export function EntityDriveThroughHoursThursdayFromJSONTyped(json: any, ignoreDiscriminator: boolean): EntityDriveThroughHoursThursday {
...
export function EntityDriveThroughHoursThursdayToJSON(value?: EntityDriveThroughHoursThursday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
