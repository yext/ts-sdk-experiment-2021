 ...
 * 
 * @export
 * @interface LocationLegacyGoogleAttributes
 */
export interface LocationLegacyGoogleAttributes {
    /**
     ...
     * @type {string}
     * @memberof LocationLegacyGoogleAttributes
     */
    id?: string;
    /**
...
export function LocationLegacyGoogleAttributesFromJSON(json: any): LocationLegacyGoogleAttributes {
    return LocationLegacyGoogleAttributesFromJSONTyped(json, false);
}

export function LocationLegacyGoogleAttributesFromJSONTyped(json: any, ignoreDiscriminator: boolean): LocationLegacyGoogleAttributes {
...
export function LocationLegacyGoogleAttributesToJSON(value?: LocationLegacyGoogleAttributes | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
