 ...
 * @export
 * @interface AtmAllOfFacebookCoverPhoto
 */
export interface AtmAllOfFacebookCoverPhoto {
    /**
     * 
     * @type {string}
     * @memberof AtmAllOfFacebookCoverPhoto
     */
...
export function AtmAllOfFacebookCoverPhotoFromJSON(json: any): AtmAllOfFacebookCoverPhoto {
    return AtmAllOfFacebookCoverPhotoFromJSONTyped(json, false);
}

export function AtmAllOfFacebookCoverPhotoFromJSONTyped(json: any, ignoreDiscriminator: boolean): AtmAllOfFacebookCoverPhoto {
...
export function AtmAllOfFacebookCoverPhotoToJSON(value?: AtmAllOfFacebookCoverPhoto | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
