 ...
 * @export
 * @interface InlineResponse200ResponseAccessHoursHolidayHours
 */
export interface InlineResponse200ResponseAccessHoursHolidayHours {
    /**
     ...
     * Filtering Type: `date`
     * @type {Date}
     * @memberof InlineResponse200ResponseAccessHoursHolidayHours
     */
    date: Date;
    /**
...
export function InlineResponse200ResponseAccessHoursHolidayHoursFromJSON(json: any): InlineResponse200ResponseAccessHoursHolidayHours {
    return InlineResponse200ResponseAccessHoursHolidayHoursFromJSONTyped(json, false);
}

export function InlineResponse200ResponseAccessHoursHolidayHoursFromJSONTyped(json: any, ignoreDiscriminator: boolean): InlineResponse200ResponseAccessHoursHolidayHours {
...
export function InlineResponse200ResponseAccessHoursHolidayHoursToJSON(value?: InlineResponse200ResponseAccessHoursHolidayHours | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
