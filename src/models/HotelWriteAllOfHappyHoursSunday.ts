 ...
 * 
 * @export
 * @interface HotelWriteAllOfHappyHoursSunday
 */
export interface HotelWriteAllOfHappyHoursSunday {
    /**
     * Indicates if the happy hours are "closed" on Sunday.
     * @type {boolean}
     * @memberof HotelWriteAllOfHappyHoursSunday
     */
    isClosed?: boolean;
    /**
...
export function HotelWriteAllOfHappyHoursSundayFromJSON(json: any): HotelWriteAllOfHappyHoursSunday {
    return HotelWriteAllOfHappyHoursSundayFromJSONTyped(json, false);
}

export function HotelWriteAllOfHappyHoursSundayFromJSONTyped(json: any, ignoreDiscriminator: boolean): HotelWriteAllOfHappyHoursSunday {
...
export function HotelWriteAllOfHappyHoursSundayToJSON(value?: HotelWriteAllOfHappyHoursSunday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
