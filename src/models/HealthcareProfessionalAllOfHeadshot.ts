 ...
 * @export
 * @interface HealthcareProfessionalAllOfHeadshot
 */
export interface HealthcareProfessionalAllOfHeadshot {
    /**
     * 
     * @type {string}
     * @memberof HealthcareProfessionalAllOfHeadshot
     */
...
export function HealthcareProfessionalAllOfHeadshotFromJSON(json: any): HealthcareProfessionalAllOfHeadshot {
    return HealthcareProfessionalAllOfHeadshotFromJSONTyped(json, false);
}

export function HealthcareProfessionalAllOfHeadshotFromJSONTyped(json: any, ignoreDiscriminator: boolean): HealthcareProfessionalAllOfHeadshot {
...
export function HealthcareProfessionalAllOfHeadshotToJSON(value?: HealthcareProfessionalAllOfHeadshot | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
