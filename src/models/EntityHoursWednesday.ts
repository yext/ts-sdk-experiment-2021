 ...
 * @export
 * @interface EntityHoursWednesday
 */
export interface EntityHoursWednesday {
    /**
     * Indicates if the hours of operation are "closed" on Wednesday.
     * 
     * Filtering Type: `boolean`
     * @type {boolean}
     * @memberof EntityHoursWednesday
     */
    isClosed?: boolean;
    /**
...
export function EntityHoursWednesdayFromJSON(json: any): EntityHoursWednesday {
    return EntityHoursWednesdayFromJSONTyped(json, false);
}

export function EntityHoursWednesdayFromJSONTyped(json: any, ignoreDiscriminator: boolean): EntityHoursWednesday {
...
export function EntityHoursWednesdayToJSON(value?: EntityHoursWednesday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
