 ...
 * ```
 * @export
 * @interface EntityRoutableCoordinate
 */
export interface EntityRoutableCoordinate {
    /**
     * Filtering Type: `float`
     * @type {number}
     * @memberof EntityRoutableCoordinate
     */
    latitude?: number;
    /**
     * Filtering Type: `float`
...
export function EntityRoutableCoordinateFromJSON(json: any): EntityRoutableCoordinate {
    return EntityRoutableCoordinateFromJSONTyped(json, false);
}

export function EntityRoutableCoordinateFromJSONTyped(json: any, ignoreDiscriminator: boolean): EntityRoutableCoordinate {
...
export function EntityRoutableCoordinateToJSON(value?: EntityRoutableCoordinate | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
