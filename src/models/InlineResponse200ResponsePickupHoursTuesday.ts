 ...
 * @export
 * @interface InlineResponse200ResponsePickupHoursTuesday
 */
export interface InlineResponse200ResponsePickupHoursTuesday {
    /**
     * Indicates if the pickup hours are "closed" on Tuesday.
     * 
     * Filtering Type: `boolean`
     * @type {boolean}
     * @memberof InlineResponse200ResponsePickupHoursTuesday
     */
    isClosed?: boolean;
    /**
...
export function InlineResponse200ResponsePickupHoursTuesdayFromJSON(json: any): InlineResponse200ResponsePickupHoursTuesday {
    return InlineResponse200ResponsePickupHoursTuesdayFromJSONTyped(json, false);
}

export function InlineResponse200ResponsePickupHoursTuesdayFromJSONTyped(json: any, ignoreDiscriminator: boolean): InlineResponse200ResponsePickupHoursTuesday {
...
export function InlineResponse200ResponsePickupHoursTuesdayToJSON(value?: InlineResponse200ResponsePickupHoursTuesday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
