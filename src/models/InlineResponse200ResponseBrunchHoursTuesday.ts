 ...
 * @export
 * @interface InlineResponse200ResponseBrunchHoursTuesday
 */
export interface InlineResponse200ResponseBrunchHoursTuesday {
    /**
     * Indicates if the brunch hours are "closed" on Tuesday.
     * 
     * Filtering Type: `boolean`
     * @type {boolean}
     * @memberof InlineResponse200ResponseBrunchHoursTuesday
     */
    isClosed?: boolean;
    /**
...
export function InlineResponse200ResponseBrunchHoursTuesdayFromJSON(json: any): InlineResponse200ResponseBrunchHoursTuesday {
    return InlineResponse200ResponseBrunchHoursTuesdayFromJSONTyped(json, false);
}

export function InlineResponse200ResponseBrunchHoursTuesdayFromJSONTyped(json: any, ignoreDiscriminator: boolean): InlineResponse200ResponseBrunchHoursTuesday {
...
export function InlineResponse200ResponseBrunchHoursTuesdayToJSON(value?: InlineResponse200ResponseBrunchHoursTuesday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
