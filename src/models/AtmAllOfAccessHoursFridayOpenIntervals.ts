 ...
 * 
 * @export
 * @interface AtmAllOfAccessHoursFridayOpenIntervals
 */
export interface AtmAllOfAccessHoursFridayOpenIntervals {
    /**
     * The end time of the interval in `hh:mm` format (e.g., `"06:30"`, `"17:00"`).
     * @type {string}
     * @memberof AtmAllOfAccessHoursFridayOpenIntervals
     */
    end?: string;
    /**
...
export function AtmAllOfAccessHoursFridayOpenIntervalsFromJSON(json: any): AtmAllOfAccessHoursFridayOpenIntervals {
    return AtmAllOfAccessHoursFridayOpenIntervalsFromJSONTyped(json, false);
}

export function AtmAllOfAccessHoursFridayOpenIntervalsFromJSONTyped(json: any, ignoreDiscriminator: boolean): AtmAllOfAccessHoursFridayOpenIntervals {
...
export function AtmAllOfAccessHoursFridayOpenIntervalsToJSON(value?: AtmAllOfAccessHoursFridayOpenIntervals | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
