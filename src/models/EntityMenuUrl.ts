 ...
 * ```
 * @export
 * @interface EntityMenuUrl
 */
export interface EntityMenuUrl {
    /**
...
export function EntityMenuUrlFromJSON(json: any): EntityMenuUrl {
    return EntityMenuUrlFromJSONTyped(json, false);
}

export function EntityMenuUrlFromJSONTyped(json: any, ignoreDiscriminator: boolean): EntityMenuUrl {
...
export function EntityMenuUrlToJSON(value?: EntityMenuUrl | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
