 ...
 * @export
 * @interface AtmAllOfFacebookProfilePhoto
 */
export interface AtmAllOfFacebookProfilePhoto {
    /**
     * 
     * @type {string}
     * @memberof AtmAllOfFacebookProfilePhoto
     */
...
export function AtmAllOfFacebookProfilePhotoFromJSON(json: any): AtmAllOfFacebookProfilePhoto {
    return AtmAllOfFacebookProfilePhotoFromJSONTyped(json, false);
}

export function AtmAllOfFacebookProfilePhotoFromJSONTyped(json: any, ignoreDiscriminator: boolean): AtmAllOfFacebookProfilePhoto {
...
export function AtmAllOfFacebookProfilePhotoToJSON(value?: AtmAllOfFacebookProfilePhoto | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
