 ...
 * @export
 * @interface EntityOnlineServiceHoursThursday
 */
export interface EntityOnlineServiceHoursThursday {
    /**
     * Indicates if the online service hours are "closed" on Thursday.
     * 
     * Filtering Type: `boolean`
     * @type {boolean}
     * @memberof EntityOnlineServiceHoursThursday
     */
    isClosed?: boolean;
    /**
...
export function EntityOnlineServiceHoursThursdayFromJSON(json: any): EntityOnlineServiceHoursThursday {
    return EntityOnlineServiceHoursThursdayFromJSONTyped(json, false);
}

export function EntityOnlineServiceHoursThursdayFromJSONTyped(json: any, ignoreDiscriminator: boolean): EntityOnlineServiceHoursThursday {
...
export function EntityOnlineServiceHoursThursdayToJSON(value?: EntityOnlineServiceHoursThursday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
