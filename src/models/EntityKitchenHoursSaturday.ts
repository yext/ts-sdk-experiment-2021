 ...
 * @export
 * @interface EntityKitchenHoursSaturday
 */
export interface EntityKitchenHoursSaturday {
    /**
     * Indicates if the kitchen hours are "closed" on Saturday.
     * 
     * Filtering Type: `boolean`
     * @type {boolean}
     * @memberof EntityKitchenHoursSaturday
     */
    isClosed?: boolean;
    /**
...
export function EntityKitchenHoursSaturdayFromJSON(json: any): EntityKitchenHoursSaturday {
    return EntityKitchenHoursSaturdayFromJSONTyped(json, false);
}

export function EntityKitchenHoursSaturdayFromJSONTyped(json: any, ignoreDiscriminator: boolean): EntityKitchenHoursSaturday {
...
export function EntityKitchenHoursSaturdayToJSON(value?: EntityKitchenHoursSaturday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
