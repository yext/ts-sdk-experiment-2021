 ...
 * 
 * @export
 * @interface AtmAllOfHoursFriday
 */
export interface AtmAllOfHoursFriday {
    /**
     * Indicates if the hours of operation are "closed" on Friday.
     * @type {boolean}
     * @memberof AtmAllOfHoursFriday
     */
    isClosed?: boolean;
    /**
...
export function AtmAllOfHoursFridayFromJSON(json: any): AtmAllOfHoursFriday {
    return AtmAllOfHoursFridayFromJSONTyped(json, false);
}

export function AtmAllOfHoursFridayFromJSONTyped(json: any, ignoreDiscriminator: boolean): AtmAllOfHoursFriday {
...
export function AtmAllOfHoursFridayToJSON(value?: AtmAllOfHoursFriday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
