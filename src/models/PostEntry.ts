...
export interface PostEntry {
    ...
    publisherId?: string;
    /**
     * If this is an original Post, the parentId will be null.
     * 
     * If this PostEntry is in response to another PostEntry, this is the ID of the parent PostEntry.
     * @type {string}
     * @memberof PostEntry
     */
    parentId?: string;
    /**
     * Timestamp this PostEntry was created, as reported by the publisher (milliseconds since epoch).
     * @type {number}
     * @memberof PostEntry
     */
    timestamp?: number;
...
* @enum {string}
*/
export enum PostEntryStatusEnum {
    NotPosted = 'NOT_POSTED',
    Live = 'LIVE',
    Deleted = 'DELETED'
}

export function PostEntryFromJSON(json: any): PostEntry {
    return PostEntryFromJSONTyped(json, false);
}

export function PostEntryFromJSONTyped(json: any, ignoreDiscriminator: boolean): PostEntry {
...
export function PostEntryToJSON(value?: PostEntry | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
