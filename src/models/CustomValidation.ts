...
export interface CustomValidation {
     ...
     * @memberof CustomValidation
     */
    aspectRatio?: CustomValidationAspectRatioEnum;
    /**
     ...
     * @memberof CustomValidation
     */
    entityTypes?: Array<CustomEntityTypes>;
    /**
     * if **`type`** is `RICH_TEXT`, the types of text formats that the field can contain.
     * @type {Set<string>}
     * @memberof CustomValidation
     */
    richTextFormats?: Set<CustomValidationRichTextFormatsEnum>;
}
...
* @enum {string}
*/
export enum CustomValidationAspectRatioEnum {
...
* @enum {string}
*/
export enum CustomValidationRichTextFormatsEnum {
    Bold = 'bold',
    Italics = 'italics',
    Underline = 'underline',
...
export function CustomValidationFromJSON(json: any): CustomValidation {
    return CustomValidationFromJSONTyped(json, false);
}

export function CustomValidationFromJSONTyped(json: any, ignoreDiscriminator: boolean): CustomValidation {
    ...
    return {
        ...
        'entityTypes': !exists(json, 'entityTypes') ? undefined : ((json['entityTypes'] as Array<any>).map(CustomEntityTypesFromJSON)),
        'richTextFormats': !exists(json, 'richTextFormats') ? undefined : json['richTextFormats'],
    };
}

export function CustomValidationToJSON(value?: CustomValidation | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'entityTypes': value.entityTypes === undefined ? undefined : ((value.entityTypes as Array<any>).map(CustomEntityTypesToJSON)),
