...
import {
    HotelAllOfKitchenHoursFriday,
    HotelAllOfKitchenHoursFridayFromJSON,
    HotelAllOfKitchenHoursFridayFromJSONTyped,
    HotelAllOfKitchenHoursFridayToJSON,
    HotelAllOfKitchenHoursHolidayHours,
    HotelAllOfKitchenHoursHolidayHoursFromJSON,
    HotelAllOfKitchenHoursHolidayHoursFromJSONTyped,
    HotelAllOfKitchenHoursHolidayHoursToJSON,
    HotelAllOfKitchenHoursMonday,
    HotelAllOfKitchenHoursMondayFromJSON,
    HotelAllOfKitchenHoursMondayFromJSONTyped,
    HotelAllOfKitchenHoursMondayToJSON,
    HotelAllOfKitchenHoursSaturday,
    HotelAllOfKitchenHoursSaturdayFromJSON,
    HotelAllOfKitchenHoursSaturdayFromJSONTyped,
    HotelAllOfKitchenHoursSaturdayToJSON,
    HotelAllOfKitchenHoursSunday,
    HotelAllOfKitchenHoursSundayFromJSON,
    HotelAllOfKitchenHoursSundayFromJSONTyped,
    HotelAllOfKitchenHoursSundayToJSON,
    HotelAllOfKitchenHoursThursday,
    HotelAllOfKitchenHoursThursdayFromJSON,
    HotelAllOfKitchenHoursThursdayFromJSONTyped,
    HotelAllOfKitchenHoursThursdayToJSON,
    HotelAllOfKitchenHoursTuesday,
    HotelAllOfKitchenHoursTuesdayFromJSON,
    HotelAllOfKitchenHoursTuesdayFromJSONTyped,
    HotelAllOfKitchenHoursTuesdayToJSON,
    HotelAllOfKitchenHoursWednesday,
    HotelAllOfKitchenHoursWednesdayFromJSON,
    HotelAllOfKitchenHoursWednesdayFromJSONTyped,
    HotelAllOfKitchenHoursWednesdayToJSON,
} from './';
 ...
 * @export
 * @interface HotelAllOfKitchenHours
 */
export interface HotelAllOfKitchenHours {
    /**
     * 
     * @type {HotelAllOfKitchenHoursFriday}
     * @memberof HotelAllOfKitchenHours
     */
    friday?: HotelAllOfKitchenHoursFriday;
    /**
     * 
     ...
     * @type {Set<HotelAllOfKitchenHoursHolidayHours>}
     * @memberof HotelAllOfKitchenHours
     */
    holidayHours?: Set<HotelAllOfKitchenHoursHolidayHours>;
    /**
     * 
     * @type {HotelAllOfKitchenHoursMonday}
     * @memberof HotelAllOfKitchenHours
     */
    monday?: HotelAllOfKitchenHoursMonday;
    /**
     * 
    ...
    /**
     * 
     * @type {HotelAllOfKitchenHoursSaturday}
     * @memberof HotelAllOfKitchenHours
     */
    saturday?: HotelAllOfKitchenHoursSaturday;
    /**
     * 
     * @type {HotelAllOfKitchenHoursSunday}
     * @memberof HotelAllOfKitchenHours
     */
    sunday?: HotelAllOfKitchenHoursSunday;
    /**
     * 
     * @type {HotelAllOfKitchenHoursThursday}
     * @memberof HotelAllOfKitchenHours
     */
    thursday?: HotelAllOfKitchenHoursThursday;
    /**
     * 
     * @type {HotelAllOfKitchenHoursTuesday}
     * @memberof HotelAllOfKitchenHours
     */
    tuesday?: HotelAllOfKitchenHoursTuesday;
    /**
     * 
     * @type {HotelAllOfKitchenHoursWednesday}
     * @memberof HotelAllOfKitchenHours
     */
    wednesday?: HotelAllOfKitchenHoursWednesday;
}

export function HotelAllOfKitchenHoursFromJSON(json: any): HotelAllOfKitchenHours {
    return HotelAllOfKitchenHoursFromJSONTyped(json, false);
}

export function HotelAllOfKitchenHoursFromJSONTyped(json: any, ignoreDiscriminator: boolean): HotelAllOfKitchenHours {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'friday': !exists(json, 'friday') ? undefined : HotelAllOfKitchenHoursFridayFromJSON(json['friday']),
        'holidayHours': !exists(json, 'holidayHours') ? undefined : (new Set((json['holidayHours'] as Array<any>).map(HotelAllOfKitchenHoursHolidayHoursFromJSON))),
        'monday': !exists(json, 'monday') ? undefined : HotelAllOfKitchenHoursMondayFromJSON(json['monday']),
        'reopenDate': !exists(json, 'reopenDate') ? undefined : (new Date(json['reopenDate'])),
        'saturday': !exists(json, 'saturday') ? undefined : HotelAllOfKitchenHoursSaturdayFromJSON(json['saturday']),
        'sunday': !exists(json, 'sunday') ? undefined : HotelAllOfKitchenHoursSundayFromJSON(json['sunday']),
        'thursday': !exists(json, 'thursday') ? undefined : HotelAllOfKitchenHoursThursdayFromJSON(json['thursday']),
        'tuesday': !exists(json, 'tuesday') ? undefined : HotelAllOfKitchenHoursTuesdayFromJSON(json['tuesday']),
        'wednesday': !exists(json, 'wednesday') ? undefined : HotelAllOfKitchenHoursWednesdayFromJSON(json['wednesday']),
    };
}

export function HotelAllOfKitchenHoursToJSON(value?: HotelAllOfKitchenHours | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'friday': HotelAllOfKitchenHoursFridayToJSON(value.friday),
        'holidayHours': value.holidayHours === undefined ? undefined : (Array.from(value.holidayHours as Set<any>).map(HotelAllOfKitchenHoursHolidayHoursToJSON)),
        'monday': HotelAllOfKitchenHoursMondayToJSON(value.monday),
        'reopenDate': value.reopenDate === undefined ? undefined : (value.reopenDate.toISOString().substr(0,10)),
        'saturday': HotelAllOfKitchenHoursSaturdayToJSON(value.saturday),
        'sunday': HotelAllOfKitchenHoursSundayToJSON(value.sunday),
        'thursday': HotelAllOfKitchenHoursThursdayToJSON(value.thursday),
        'tuesday': HotelAllOfKitchenHoursTuesdayToJSON(value.tuesday),
        'wednesday': HotelAllOfKitchenHoursWednesdayToJSON(value.wednesday),
    };
}
