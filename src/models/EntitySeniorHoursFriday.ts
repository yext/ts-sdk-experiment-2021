 ...
 * @export
 * @interface EntitySeniorHoursFriday
 */
export interface EntitySeniorHoursFriday {
    /**
     * Indicates if the senior hours are "closed" on Friday.
     * 
     * Filtering Type: `boolean`
     * @type {boolean}
     * @memberof EntitySeniorHoursFriday
     */
    isClosed?: boolean;
    /**
...
export function EntitySeniorHoursFridayFromJSON(json: any): EntitySeniorHoursFriday {
    return EntitySeniorHoursFridayFromJSONTyped(json, false);
}

export function EntitySeniorHoursFridayFromJSONTyped(json: any, ignoreDiscriminator: boolean): EntitySeniorHoursFriday {
...
export function EntitySeniorHoursFridayToJSON(value?: EntitySeniorHoursFriday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
