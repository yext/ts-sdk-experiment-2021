 ...
 * 
 * @export
 * @interface LocationAllOfDeliveryHoursHolidayHours
 */
export interface LocationAllOfDeliveryHoursHolidayHours {
    /**
     ...
     * @type {Date}
     * @memberof LocationAllOfDeliveryHoursHolidayHours
     */
    date: Date;
    /**
...
export function LocationAllOfDeliveryHoursHolidayHoursFromJSON(json: any): LocationAllOfDeliveryHoursHolidayHours {
    return LocationAllOfDeliveryHoursHolidayHoursFromJSONTyped(json, false);
}

export function LocationAllOfDeliveryHoursHolidayHoursFromJSONTyped(json: any, ignoreDiscriminator: boolean): LocationAllOfDeliveryHoursHolidayHours {
...
export function LocationAllOfDeliveryHoursHolidayHoursToJSON(value?: LocationAllOfDeliveryHoursHolidayHours | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
