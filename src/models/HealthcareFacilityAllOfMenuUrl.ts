 ...
 * @export
 * @interface HealthcareFacilityAllOfMenuUrl
 */
export interface HealthcareFacilityAllOfMenuUrl {
    /**
     ...
     * @type {string}
     * @memberof HealthcareFacilityAllOfMenuUrl
     */
    displayUrl?: string;
    /**
...
export function HealthcareFacilityAllOfMenuUrlFromJSON(json: any): HealthcareFacilityAllOfMenuUrl {
    return HealthcareFacilityAllOfMenuUrlFromJSONTyped(json, false);
}

export function HealthcareFacilityAllOfMenuUrlFromJSONTyped(json: any, ignoreDiscriminator: boolean): HealthcareFacilityAllOfMenuUrl {
...
export function HealthcareFacilityAllOfMenuUrlToJSON(value?: HealthcareFacilityAllOfMenuUrl | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
