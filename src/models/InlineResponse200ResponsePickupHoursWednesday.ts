 ...
 * @export
 * @interface InlineResponse200ResponsePickupHoursWednesday
 */
export interface InlineResponse200ResponsePickupHoursWednesday {
    /**
     * Indicates if the pickup hours are "closed" on Wednesday.
     * 
     * Filtering Type: `boolean`
     * @type {boolean}
     * @memberof InlineResponse200ResponsePickupHoursWednesday
     */
    isClosed?: boolean;
    /**
...
export function InlineResponse200ResponsePickupHoursWednesdayFromJSON(json: any): InlineResponse200ResponsePickupHoursWednesday {
    return InlineResponse200ResponsePickupHoursWednesdayFromJSONTyped(json, false);
}

export function InlineResponse200ResponsePickupHoursWednesdayFromJSONTyped(json: any, ignoreDiscriminator: boolean): InlineResponse200ResponsePickupHoursWednesday {
...
export function InlineResponse200ResponsePickupHoursWednesdayToJSON(value?: InlineResponse200ResponsePickupHoursWednesday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
