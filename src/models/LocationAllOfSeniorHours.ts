...
import {
    LocationAllOfSeniorHoursFriday,
    LocationAllOfSeniorHoursFridayFromJSON,
    LocationAllOfSeniorHoursFridayFromJSONTyped,
    LocationAllOfSeniorHoursFridayToJSON,
    LocationAllOfSeniorHoursHolidayHours,
    LocationAllOfSeniorHoursHolidayHoursFromJSON,
    LocationAllOfSeniorHoursHolidayHoursFromJSONTyped,
    LocationAllOfSeniorHoursHolidayHoursToJSON,
    LocationAllOfSeniorHoursMonday,
    LocationAllOfSeniorHoursMondayFromJSON,
    LocationAllOfSeniorHoursMondayFromJSONTyped,
    LocationAllOfSeniorHoursMondayToJSON,
    LocationAllOfSeniorHoursSaturday,
    LocationAllOfSeniorHoursSaturdayFromJSON,
    LocationAllOfSeniorHoursSaturdayFromJSONTyped,
    LocationAllOfSeniorHoursSaturdayToJSON,
    LocationAllOfSeniorHoursSunday,
    LocationAllOfSeniorHoursSundayFromJSON,
    LocationAllOfSeniorHoursSundayFromJSONTyped,
    LocationAllOfSeniorHoursSundayToJSON,
    LocationAllOfSeniorHoursThursday,
    LocationAllOfSeniorHoursThursdayFromJSON,
    LocationAllOfSeniorHoursThursdayFromJSONTyped,
    LocationAllOfSeniorHoursThursdayToJSON,
    LocationAllOfSeniorHoursTuesday,
    LocationAllOfSeniorHoursTuesdayFromJSON,
    LocationAllOfSeniorHoursTuesdayFromJSONTyped,
    LocationAllOfSeniorHoursTuesdayToJSON,
    LocationAllOfSeniorHoursWednesday,
    LocationAllOfSeniorHoursWednesdayFromJSON,
    LocationAllOfSeniorHoursWednesdayFromJSONTyped,
    LocationAllOfSeniorHoursWednesdayToJSON,
} from './';
 ...
 * @export
 * @interface LocationAllOfSeniorHours
 */
export interface LocationAllOfSeniorHours {
    /**
     * 
     * @type {LocationAllOfSeniorHoursFriday}
     * @memberof LocationAllOfSeniorHours
     */
    friday?: LocationAllOfSeniorHoursFriday;
    /**
     * 
     ...
     * @type {Set<LocationAllOfSeniorHoursHolidayHours>}
     * @memberof LocationAllOfSeniorHours
     */
    holidayHours?: Set<LocationAllOfSeniorHoursHolidayHours>;
    /**
     * 
     * @type {LocationAllOfSeniorHoursMonday}
     * @memberof LocationAllOfSeniorHours
     */
    monday?: LocationAllOfSeniorHoursMonday;
    /**
     * 
    ...
    /**
     * 
     * @type {LocationAllOfSeniorHoursSaturday}
     * @memberof LocationAllOfSeniorHours
     */
    saturday?: LocationAllOfSeniorHoursSaturday;
    /**
     * 
     * @type {LocationAllOfSeniorHoursSunday}
     * @memberof LocationAllOfSeniorHours
     */
    sunday?: LocationAllOfSeniorHoursSunday;
    /**
     * 
     * @type {LocationAllOfSeniorHoursThursday}
     * @memberof LocationAllOfSeniorHours
     */
    thursday?: LocationAllOfSeniorHoursThursday;
    /**
     * 
     * @type {LocationAllOfSeniorHoursTuesday}
     * @memberof LocationAllOfSeniorHours
     */
    tuesday?: LocationAllOfSeniorHoursTuesday;
    /**
     * 
     * @type {LocationAllOfSeniorHoursWednesday}
     * @memberof LocationAllOfSeniorHours
     */
    wednesday?: LocationAllOfSeniorHoursWednesday;
}

export function LocationAllOfSeniorHoursFromJSON(json: any): LocationAllOfSeniorHours {
    return LocationAllOfSeniorHoursFromJSONTyped(json, false);
}

export function LocationAllOfSeniorHoursFromJSONTyped(json: any, ignoreDiscriminator: boolean): LocationAllOfSeniorHours {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'friday': !exists(json, 'friday') ? undefined : LocationAllOfSeniorHoursFridayFromJSON(json['friday']),
        'holidayHours': !exists(json, 'holidayHours') ? undefined : (new Set((json['holidayHours'] as Array<any>).map(LocationAllOfSeniorHoursHolidayHoursFromJSON))),
        'monday': !exists(json, 'monday') ? undefined : LocationAllOfSeniorHoursMondayFromJSON(json['monday']),
        'reopenDate': !exists(json, 'reopenDate') ? undefined : (new Date(json['reopenDate'])),
        'saturday': !exists(json, 'saturday') ? undefined : LocationAllOfSeniorHoursSaturdayFromJSON(json['saturday']),
        'sunday': !exists(json, 'sunday') ? undefined : LocationAllOfSeniorHoursSundayFromJSON(json['sunday']),
        'thursday': !exists(json, 'thursday') ? undefined : LocationAllOfSeniorHoursThursdayFromJSON(json['thursday']),
        'tuesday': !exists(json, 'tuesday') ? undefined : LocationAllOfSeniorHoursTuesdayFromJSON(json['tuesday']),
        'wednesday': !exists(json, 'wednesday') ? undefined : LocationAllOfSeniorHoursWednesdayFromJSON(json['wednesday']),
    };
}

export function LocationAllOfSeniorHoursToJSON(value?: LocationAllOfSeniorHours | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'friday': LocationAllOfSeniorHoursFridayToJSON(value.friday),
        'holidayHours': value.holidayHours === undefined ? undefined : (Array.from(value.holidayHours as Set<any>).map(LocationAllOfSeniorHoursHolidayHoursToJSON)),
        'monday': LocationAllOfSeniorHoursMondayToJSON(value.monday),
        'reopenDate': value.reopenDate === undefined ? undefined : (value.reopenDate.toISOString().substr(0,10)),
        'saturday': LocationAllOfSeniorHoursSaturdayToJSON(value.saturday),
        'sunday': LocationAllOfSeniorHoursSundayToJSON(value.sunday),
        'thursday': LocationAllOfSeniorHoursThursdayToJSON(value.thursday),
        'tuesday': LocationAllOfSeniorHoursTuesdayToJSON(value.tuesday),
        'wednesday': LocationAllOfSeniorHoursWednesdayToJSON(value.wednesday),
    };
}
