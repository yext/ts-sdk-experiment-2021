 ...
 * 
 * @export
 * @interface LocationAllOfTakeoutHoursTuesday
 */
export interface LocationAllOfTakeoutHoursTuesday {
    /**
     * Indicates if the takeout hours are "closed" on Tuesday.
     * @type {boolean}
     * @memberof LocationAllOfTakeoutHoursTuesday
     */
    isClosed?: boolean;
    /**
...
export function LocationAllOfTakeoutHoursTuesdayFromJSON(json: any): LocationAllOfTakeoutHoursTuesday {
    return LocationAllOfTakeoutHoursTuesdayFromJSONTyped(json, false);
}

export function LocationAllOfTakeoutHoursTuesdayFromJSONTyped(json: any, ignoreDiscriminator: boolean): LocationAllOfTakeoutHoursTuesday {
...
export function LocationAllOfTakeoutHoursTuesdayToJSON(value?: LocationAllOfTakeoutHoursTuesday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
