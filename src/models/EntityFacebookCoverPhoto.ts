 ...
 * ```
 * @export
 * @interface EntityFacebookCoverPhoto
 */
export interface EntityFacebookCoverPhoto {
    /**
     * Filtering Type: `text`
     * @type {string}
     * @memberof EntityFacebookCoverPhoto
     */
...
export function EntityFacebookCoverPhotoFromJSON(json: any): EntityFacebookCoverPhoto {
    return EntityFacebookCoverPhotoFromJSONTyped(json, false);
}

export function EntityFacebookCoverPhotoFromJSONTyped(json: any, ignoreDiscriminator: boolean): EntityFacebookCoverPhoto {
...
export function EntityFacebookCoverPhotoToJSON(value?: EntityFacebookCoverPhoto | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
