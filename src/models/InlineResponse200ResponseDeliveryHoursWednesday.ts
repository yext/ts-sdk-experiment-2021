 ...
 * @export
 * @interface InlineResponse200ResponseDeliveryHoursWednesday
 */
export interface InlineResponse200ResponseDeliveryHoursWednesday {
    /**
     * Indicates if the delivery hours are "closed" on Wednesday.
     * 
     * Filtering Type: `boolean`
     * @type {boolean}
     * @memberof InlineResponse200ResponseDeliveryHoursWednesday
     */
    isClosed?: boolean;
    /**
...
export function InlineResponse200ResponseDeliveryHoursWednesdayFromJSON(json: any): InlineResponse200ResponseDeliveryHoursWednesday {
    return InlineResponse200ResponseDeliveryHoursWednesdayFromJSONTyped(json, false);
}

export function InlineResponse200ResponseDeliveryHoursWednesdayFromJSONTyped(json: any, ignoreDiscriminator: boolean): InlineResponse200ResponseDeliveryHoursWednesday {
...
export function InlineResponse200ResponseDeliveryHoursWednesdayToJSON(value?: InlineResponse200ResponseDeliveryHoursWednesday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
