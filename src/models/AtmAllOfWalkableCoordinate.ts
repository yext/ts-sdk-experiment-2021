 ...
 * @export
 * @interface AtmAllOfWalkableCoordinate
 */
export interface AtmAllOfWalkableCoordinate {
    /**
     * 
     * @type {number}
     * @memberof AtmAllOfWalkableCoordinate
     */
    latitude?: number;
    /**
     * 
...
export function AtmAllOfWalkableCoordinateFromJSON(json: any): AtmAllOfWalkableCoordinate {
    return AtmAllOfWalkableCoordinateFromJSONTyped(json, false);
}

export function AtmAllOfWalkableCoordinateFromJSONTyped(json: any, ignoreDiscriminator: boolean): AtmAllOfWalkableCoordinate {
...
export function AtmAllOfWalkableCoordinateToJSON(value?: AtmAllOfWalkableCoordinate | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
