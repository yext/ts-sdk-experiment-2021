 ...
 * ```
 * @export
 * @interface EntityCalendars
 */
export interface EntityCalendars {
    /**
...
export function EntityCalendarsFromJSON(json: any): EntityCalendars {
    return EntityCalendarsFromJSONTyped(json, false);
}

export function EntityCalendarsFromJSONTyped(json: any, ignoreDiscriminator: boolean): EntityCalendars {
...
export function EntityCalendarsToJSON(value?: EntityCalendars | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
