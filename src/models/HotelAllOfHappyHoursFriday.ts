 ...
 * 
 * @export
 * @interface HotelAllOfHappyHoursFriday
 */
export interface HotelAllOfHappyHoursFriday {
    /**
     * Indicates if the happy hours are "closed" on Friday.
     * @type {boolean}
     * @memberof HotelAllOfHappyHoursFriday
     */
    isClosed?: boolean;
    /**
...
export function HotelAllOfHappyHoursFridayFromJSON(json: any): HotelAllOfHappyHoursFriday {
    return HotelAllOfHappyHoursFridayFromJSONTyped(json, false);
}

export function HotelAllOfHappyHoursFridayFromJSONTyped(json: any, ignoreDiscriminator: boolean): HotelAllOfHappyHoursFriday {
...
export function HotelAllOfHappyHoursFridayToJSON(value?: HotelAllOfHappyHoursFriday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
