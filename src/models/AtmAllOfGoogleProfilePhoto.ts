 ...
 * @export
 * @interface AtmAllOfGoogleProfilePhoto
 */
export interface AtmAllOfGoogleProfilePhoto {
    /**
     * 
     * @type {string}
     * @memberof AtmAllOfGoogleProfilePhoto
     */
...
export function AtmAllOfGoogleProfilePhotoFromJSON(json: any): AtmAllOfGoogleProfilePhoto {
    return AtmAllOfGoogleProfilePhotoFromJSONTyped(json, false);
}

export function AtmAllOfGoogleProfilePhotoFromJSONTyped(json: any, ignoreDiscriminator: boolean): AtmAllOfGoogleProfilePhoto {
...
export function AtmAllOfGoogleProfilePhotoToJSON(value?: AtmAllOfGoogleProfilePhoto | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
