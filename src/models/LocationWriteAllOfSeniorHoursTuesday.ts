 ...
 * 
 * @export
 * @interface LocationWriteAllOfSeniorHoursTuesday
 */
export interface LocationWriteAllOfSeniorHoursTuesday {
    /**
     * Indicates if the senior hours are "closed" on Tuesday.
     * @type {boolean}
     * @memberof LocationWriteAllOfSeniorHoursTuesday
     */
    isClosed?: boolean;
    /**
...
export function LocationWriteAllOfSeniorHoursTuesdayFromJSON(json: any): LocationWriteAllOfSeniorHoursTuesday {
    return LocationWriteAllOfSeniorHoursTuesdayFromJSONTyped(json, false);
}

export function LocationWriteAllOfSeniorHoursTuesdayFromJSONTyped(json: any, ignoreDiscriminator: boolean): LocationWriteAllOfSeniorHoursTuesday {
...
export function LocationWriteAllOfSeniorHoursTuesdayToJSON(value?: LocationWriteAllOfSeniorHoursTuesday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
