 ...
 * @export
 * @interface EntityTakeoutHoursTuesday
 */
export interface EntityTakeoutHoursTuesday {
    /**
     * Indicates if the takeout hours are "closed" on Tuesday.
     * 
     * Filtering Type: `boolean`
     * @type {boolean}
     * @memberof EntityTakeoutHoursTuesday
     */
    isClosed?: boolean;
    /**
...
export function EntityTakeoutHoursTuesdayFromJSON(json: any): EntityTakeoutHoursTuesday {
    return EntityTakeoutHoursTuesdayFromJSONTyped(json, false);
}

export function EntityTakeoutHoursTuesdayFromJSONTyped(json: any, ignoreDiscriminator: boolean): EntityTakeoutHoursTuesday {
...
export function EntityTakeoutHoursTuesdayToJSON(value?: EntityTakeoutHoursTuesday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
