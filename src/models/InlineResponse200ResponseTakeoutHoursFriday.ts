 ...
 * @export
 * @interface InlineResponse200ResponseTakeoutHoursFriday
 */
export interface InlineResponse200ResponseTakeoutHoursFriday {
    /**
     * Indicates if the takeout hours are "closed" on Friday.
     * 
     * Filtering Type: `boolean`
     * @type {boolean}
     * @memberof InlineResponse200ResponseTakeoutHoursFriday
     */
    isClosed?: boolean;
    /**
...
export function InlineResponse200ResponseTakeoutHoursFridayFromJSON(json: any): InlineResponse200ResponseTakeoutHoursFriday {
    return InlineResponse200ResponseTakeoutHoursFridayFromJSONTyped(json, false);
}

export function InlineResponse200ResponseTakeoutHoursFridayFromJSONTyped(json: any, ignoreDiscriminator: boolean): InlineResponse200ResponseTakeoutHoursFriday {
...
export function InlineResponse200ResponseTakeoutHoursFridayToJSON(value?: InlineResponse200ResponseTakeoutHoursFriday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
