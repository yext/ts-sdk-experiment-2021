 ...
 * 
 * @export
 * @interface HotelWriteAllOfKitchenHoursWednesday
 */
export interface HotelWriteAllOfKitchenHoursWednesday {
    /**
     * Indicates if the kitchen hours are "closed" on Wednesday.
     * @type {boolean}
     * @memberof HotelWriteAllOfKitchenHoursWednesday
     */
    isClosed?: boolean;
    /**
...
export function HotelWriteAllOfKitchenHoursWednesdayFromJSON(json: any): HotelWriteAllOfKitchenHoursWednesday {
    return HotelWriteAllOfKitchenHoursWednesdayFromJSONTyped(json, false);
}

export function HotelWriteAllOfKitchenHoursWednesdayFromJSONTyped(json: any, ignoreDiscriminator: boolean): HotelWriteAllOfKitchenHoursWednesday {
...
export function HotelWriteAllOfKitchenHoursWednesdayToJSON(value?: HotelWriteAllOfKitchenHoursWednesday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
