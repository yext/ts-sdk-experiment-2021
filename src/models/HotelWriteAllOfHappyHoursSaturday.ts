 ...
 * 
 * @export
 * @interface HotelWriteAllOfHappyHoursSaturday
 */
export interface HotelWriteAllOfHappyHoursSaturday {
    /**
     * Indicates if the happy hours are "closed" on Saturday.
     * @type {boolean}
     * @memberof HotelWriteAllOfHappyHoursSaturday
     */
    isClosed?: boolean;
    /**
...
export function HotelWriteAllOfHappyHoursSaturdayFromJSON(json: any): HotelWriteAllOfHappyHoursSaturday {
    return HotelWriteAllOfHappyHoursSaturdayFromJSONTyped(json, false);
}

export function HotelWriteAllOfHappyHoursSaturdayFromJSONTyped(json: any, ignoreDiscriminator: boolean): HotelWriteAllOfHappyHoursSaturday {
...
export function HotelWriteAllOfHappyHoursSaturdayToJSON(value?: HotelWriteAllOfHappyHoursSaturday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
