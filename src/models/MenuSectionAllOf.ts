 ...
 * 
 * @export
 * @interface MenuSectionAllOf
 */
export interface MenuSectionAllOf {
    /**
     * Section Items.
     * @type {Array<MenuItem>}
     * @memberof MenuSectionAllOf
     */
    items?: Array<MenuItem>;
}

export function MenuSectionAllOfFromJSON(json: any): MenuSectionAllOf {
    return MenuSectionAllOfFromJSONTyped(json, false);
}

export function MenuSectionAllOfFromJSONTyped(json: any, ignoreDiscriminator: boolean): MenuSectionAllOf {
...
export function MenuSectionAllOfToJSON(value?: MenuSectionAllOf | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
