 ...
 * 
 * @export
 * @interface AtmWriteAllOfHoursSunday
 */
export interface AtmWriteAllOfHoursSunday {
    /**
     * Indicates if the hours of operation are "closed" on Sunday.
     * @type {boolean}
     * @memberof AtmWriteAllOfHoursSunday
     */
    isClosed?: boolean;
    /**
...
export function AtmWriteAllOfHoursSundayFromJSON(json: any): AtmWriteAllOfHoursSunday {
    return AtmWriteAllOfHoursSundayFromJSONTyped(json, false);
}

export function AtmWriteAllOfHoursSundayFromJSONTyped(json: any, ignoreDiscriminator: boolean): AtmWriteAllOfHoursSunday {
...
export function AtmWriteAllOfHoursSundayToJSON(value?: AtmWriteAllOfHoursSunday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
