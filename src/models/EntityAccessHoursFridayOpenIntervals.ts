 ...
 * @export
 * @interface EntityAccessHoursFridayOpenIntervals
 */
export interface EntityAccessHoursFridayOpenIntervals {
    /**
     * The end time of the interval in `hh:mm` format (e.g., `"06:30"`, `"17:00"`).
     * 
     * Filtering Type: `time`
     * @type {string}
     * @memberof EntityAccessHoursFridayOpenIntervals
     */
    end?: string;
    /**
...
export function EntityAccessHoursFridayOpenIntervalsFromJSON(json: any): EntityAccessHoursFridayOpenIntervals {
    return EntityAccessHoursFridayOpenIntervalsFromJSONTyped(json, false);
}

export function EntityAccessHoursFridayOpenIntervalsFromJSONTyped(json: any, ignoreDiscriminator: boolean): EntityAccessHoursFridayOpenIntervals {
...
export function EntityAccessHoursFridayOpenIntervalsToJSON(value?: EntityAccessHoursFridayOpenIntervals | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
