...
import {
    ...
    ReviewLabelToJSON,
    ReviewRequestAllOf,
    ReviewRequestAllOfFromJSON,
    ReviewRequestAllOfFromJSONTyped,
    ReviewRequestAllOfToJSON,
} from './';
...
export interface ReviewRequest {
     ...
     * @memberof ReviewRequest
     */
    flagStatus?: ReviewRequestFlagStatusEnum;
    /**
     ...
     * @memberof ReviewRequest
     */
    readonly reviewType?: ReviewRequestReviewTypeEnum;
    /**
     * If the **`v`** parameter is before `20181002`: Not present.
     * 
     ...
     * @memberof ReviewRequest
     */
    readonly recommendation?: ReviewRequestRecommendationEnum;
    /**
...
* @enum {string}
*/
export enum ReviewRequestFlagStatusEnum {
...
* @enum {string}
*/
export enum ReviewRequestReviewTypeEnum {
    Rating = 'Rating',
...
* @enum {string}
*/
export enum ReviewRequestRecommendationEnum {
