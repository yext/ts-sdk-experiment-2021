 ...
 * @export
 * @interface EntityTakeoutHoursSunday
 */
export interface EntityTakeoutHoursSunday {
    /**
     * Indicates if the takeout hours are "closed" on Sunday.
     * 
     * Filtering Type: `boolean`
     * @type {boolean}
     * @memberof EntityTakeoutHoursSunday
     */
    isClosed?: boolean;
    /**
...
export function EntityTakeoutHoursSundayFromJSON(json: any): EntityTakeoutHoursSunday {
    return EntityTakeoutHoursSundayFromJSONTyped(json, false);
}

export function EntityTakeoutHoursSundayFromJSONTyped(json: any, ignoreDiscriminator: boolean): EntityTakeoutHoursSunday {
...
export function EntityTakeoutHoursSundayToJSON(value?: EntityTakeoutHoursSunday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
