 ...
 * 
 * @export
 * @interface HotelAllOfKitchenHoursHolidayHours
 */
export interface HotelAllOfKitchenHoursHolidayHours {
    /**
     ...
     * @type {Date}
     * @memberof HotelAllOfKitchenHoursHolidayHours
     */
    date: Date;
    /**
...
export function HotelAllOfKitchenHoursHolidayHoursFromJSON(json: any): HotelAllOfKitchenHoursHolidayHours {
    return HotelAllOfKitchenHoursHolidayHoursFromJSONTyped(json, false);
}

export function HotelAllOfKitchenHoursHolidayHoursFromJSONTyped(json: any, ignoreDiscriminator: boolean): HotelAllOfKitchenHoursHolidayHours {
...
export function HotelAllOfKitchenHoursHolidayHoursToJSON(value?: HotelAllOfKitchenHoursHolidayHours | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
