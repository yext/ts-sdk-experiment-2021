 ...
 * 
 * @export
 * @interface AtmAllOfAccessHoursWednesday
 */
export interface AtmAllOfAccessHoursWednesday {
    /**
     * Indicates if the access hours are "closed" on Wednesday.
     * @type {boolean}
     * @memberof AtmAllOfAccessHoursWednesday
     */
    isClosed?: boolean;
    /**
...
export function AtmAllOfAccessHoursWednesdayFromJSON(json: any): AtmAllOfAccessHoursWednesday {
    return AtmAllOfAccessHoursWednesdayFromJSONTyped(json, false);
}

export function AtmAllOfAccessHoursWednesdayFromJSONTyped(json: any, ignoreDiscriminator: boolean): AtmAllOfAccessHoursWednesday {
...
export function AtmAllOfAccessHoursWednesdayToJSON(value?: AtmAllOfAccessHoursWednesday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
