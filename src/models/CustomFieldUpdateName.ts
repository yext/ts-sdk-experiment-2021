 ...
 * }
 * @export
 * @interface CustomFieldUpdateName
 */
export interface CustomFieldUpdateName {
    /**
     * The field's default name.
     * @type {string}
     * @memberof CustomFieldUpdateName
     */
    value?: string;
    /**
...
export function CustomFieldUpdateNameFromJSON(json: any): CustomFieldUpdateName {
    return CustomFieldUpdateNameFromJSONTyped(json, false);
}

export function CustomFieldUpdateNameFromJSONTyped(json: any, ignoreDiscriminator: boolean): CustomFieldUpdateName {
...
export function CustomFieldUpdateNameToJSON(value?: CustomFieldUpdateName | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
