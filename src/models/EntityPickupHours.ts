...
import {
    EntityPickupHoursFriday,
    EntityPickupHoursFridayFromJSON,
    EntityPickupHoursFridayFromJSONTyped,
    EntityPickupHoursFridayToJSON,
    EntityPickupHoursHolidayHours,
    EntityPickupHoursHolidayHoursFromJSON,
    EntityPickupHoursHolidayHoursFromJSONTyped,
    EntityPickupHoursHolidayHoursToJSON,
    EntityPickupHoursMonday,
    EntityPickupHoursMondayFromJSON,
    EntityPickupHoursMondayFromJSONTyped,
    EntityPickupHoursMondayToJSON,
    EntityPickupHoursSaturday,
    EntityPickupHoursSaturdayFromJSON,
    EntityPickupHoursSaturdayFromJSONTyped,
    EntityPickupHoursSaturdayToJSON,
    EntityPickupHoursSunday,
    EntityPickupHoursSundayFromJSON,
    EntityPickupHoursSundayFromJSONTyped,
    EntityPickupHoursSundayToJSON,
    EntityPickupHoursThursday,
    EntityPickupHoursThursdayFromJSON,
    EntityPickupHoursThursdayFromJSONTyped,
    EntityPickupHoursThursdayToJSON,
    EntityPickupHoursTuesday,
    EntityPickupHoursTuesdayFromJSON,
    EntityPickupHoursTuesdayFromJSONTyped,
    EntityPickupHoursTuesdayToJSON,
    EntityPickupHoursWednesday,
    EntityPickupHoursWednesdayFromJSON,
    EntityPickupHoursWednesdayFromJSONTyped,
    EntityPickupHoursWednesdayToJSON,
} from './';
 ...
 * ```
 * @export
 * @interface EntityPickupHours
 */
export interface EntityPickupHours {
    /**
     * 
     * @type {EntityPickupHoursFriday}
     * @memberof EntityPickupHours
     */
    friday?: EntityPickupHoursFriday;
    /**
     * 
     ...
     * @type {Set<EntityPickupHoursHolidayHours>}
     * @memberof EntityPickupHours
     */
    holidayHours?: Set<EntityPickupHoursHolidayHours>;
    /**
     * 
     * @type {EntityPickupHoursMonday}
     * @memberof EntityPickupHours
     */
    monday?: EntityPickupHoursMonday;
    /**
     * 
    ...
    /**
     * 
     * @type {EntityPickupHoursSaturday}
     * @memberof EntityPickupHours
     */
    saturday?: EntityPickupHoursSaturday;
    /**
     * 
     * @type {EntityPickupHoursSunday}
     * @memberof EntityPickupHours
     */
    sunday?: EntityPickupHoursSunday;
    /**
     * 
     * @type {EntityPickupHoursThursday}
     * @memberof EntityPickupHours
     */
    thursday?: EntityPickupHoursThursday;
    /**
     * 
     * @type {EntityPickupHoursTuesday}
     * @memberof EntityPickupHours
     */
    tuesday?: EntityPickupHoursTuesday;
    /**
     * 
     * @type {EntityPickupHoursWednesday}
     * @memberof EntityPickupHours
     */
    wednesday?: EntityPickupHoursWednesday;
}

export function EntityPickupHoursFromJSON(json: any): EntityPickupHours {
    return EntityPickupHoursFromJSONTyped(json, false);
}

export function EntityPickupHoursFromJSONTyped(json: any, ignoreDiscriminator: boolean): EntityPickupHours {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'friday': !exists(json, 'friday') ? undefined : EntityPickupHoursFridayFromJSON(json['friday']),
        'holidayHours': !exists(json, 'holidayHours') ? undefined : (new Set((json['holidayHours'] as Array<any>).map(EntityPickupHoursHolidayHoursFromJSON))),
        'monday': !exists(json, 'monday') ? undefined : EntityPickupHoursMondayFromJSON(json['monday']),
        'reopenDate': !exists(json, 'reopenDate') ? undefined : (new Date(json['reopenDate'])),
        'saturday': !exists(json, 'saturday') ? undefined : EntityPickupHoursSaturdayFromJSON(json['saturday']),
        'sunday': !exists(json, 'sunday') ? undefined : EntityPickupHoursSundayFromJSON(json['sunday']),
        'thursday': !exists(json, 'thursday') ? undefined : EntityPickupHoursThursdayFromJSON(json['thursday']),
        'tuesday': !exists(json, 'tuesday') ? undefined : EntityPickupHoursTuesdayFromJSON(json['tuesday']),
        'wednesday': !exists(json, 'wednesday') ? undefined : EntityPickupHoursWednesdayFromJSON(json['wednesday']),
    };
}

export function EntityPickupHoursToJSON(value?: EntityPickupHours | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'friday': EntityPickupHoursFridayToJSON(value.friday),
        'holidayHours': value.holidayHours === undefined ? undefined : (Array.from(value.holidayHours as Set<any>).map(EntityPickupHoursHolidayHoursToJSON)),
        'monday': EntityPickupHoursMondayToJSON(value.monday),
        'reopenDate': value.reopenDate === undefined ? undefined : (value.reopenDate.toISOString().substr(0,10)),
        'saturday': EntityPickupHoursSaturdayToJSON(value.saturday),
        'sunday': EntityPickupHoursSundayToJSON(value.sunday),
        'thursday': EntityPickupHoursThursdayToJSON(value.thursday),
        'tuesday': EntityPickupHoursTuesdayToJSON(value.tuesday),
        'wednesday': EntityPickupHoursWednesdayToJSON(value.wednesday),
    };
}
