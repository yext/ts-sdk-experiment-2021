 ...
 * @export
 * @interface HealthcareFacilityAllOfOrderUrl
 */
export interface HealthcareFacilityAllOfOrderUrl {
    /**
     ...
     * @type {string}
     * @memberof HealthcareFacilityAllOfOrderUrl
     */
    displayUrl?: string;
    /**
...
export function HealthcareFacilityAllOfOrderUrlFromJSON(json: any): HealthcareFacilityAllOfOrderUrl {
    return HealthcareFacilityAllOfOrderUrlFromJSONTyped(json, false);
}

export function HealthcareFacilityAllOfOrderUrlFromJSONTyped(json: any, ignoreDiscriminator: boolean): HealthcareFacilityAllOfOrderUrl {
...
export function HealthcareFacilityAllOfOrderUrlToJSON(value?: HealthcareFacilityAllOfOrderUrl | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
