 ...
 * 
 * @export
 * @interface AtmAllOfHoursHolidayHours
 */
export interface AtmAllOfHoursHolidayHours {
    /**
     ...
     * @type {Date}
     * @memberof AtmAllOfHoursHolidayHours
     */
    date: Date;
    /**
...
export function AtmAllOfHoursHolidayHoursFromJSON(json: any): AtmAllOfHoursHolidayHours {
    return AtmAllOfHoursHolidayHoursFromJSONTyped(json, false);
}

export function AtmAllOfHoursHolidayHoursFromJSONTyped(json: any, ignoreDiscriminator: boolean): AtmAllOfHoursHolidayHours {
...
export function AtmAllOfHoursHolidayHoursToJSON(value?: AtmAllOfHoursHolidayHours | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
