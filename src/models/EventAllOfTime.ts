...
export function EventAllOfTimeFromJSON(json: any): EventAllOfTime {
    return EventAllOfTimeFromJSONTyped(json, false);
}

export function EventAllOfTimeFromJSONTyped(json: any, ignoreDiscriminator: boolean): EventAllOfTime {
...
export function EventAllOfTimeToJSON(value?: EventAllOfTime | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
