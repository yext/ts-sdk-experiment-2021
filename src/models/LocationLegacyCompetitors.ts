 ...
 * 
 * @export
 * @interface LocationLegacyCompetitors
 */
export interface LocationLegacyCompetitors {
    /**
     * The competitor's name
     * @type {string}
     * @memberof LocationLegacyCompetitors
     */
    name?: string;
    /**
...
export function LocationLegacyCompetitorsFromJSON(json: any): LocationLegacyCompetitors {
    return LocationLegacyCompetitorsFromJSONTyped(json, false);
}

export function LocationLegacyCompetitorsFromJSONTyped(json: any, ignoreDiscriminator: boolean): LocationLegacyCompetitors {
...
export function LocationLegacyCompetitorsToJSON(value?: LocationLegacyCompetitors | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
