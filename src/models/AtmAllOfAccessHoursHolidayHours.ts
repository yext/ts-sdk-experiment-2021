 ...
 * 
 * @export
 * @interface AtmAllOfAccessHoursHolidayHours
 */
export interface AtmAllOfAccessHoursHolidayHours {
    /**
     ...
     * @type {Date}
     * @memberof AtmAllOfAccessHoursHolidayHours
     */
    date: Date;
    /**
...
export function AtmAllOfAccessHoursHolidayHoursFromJSON(json: any): AtmAllOfAccessHoursHolidayHours {
    return AtmAllOfAccessHoursHolidayHoursFromJSONTyped(json, false);
}

export function AtmAllOfAccessHoursHolidayHoursFromJSONTyped(json: any, ignoreDiscriminator: boolean): AtmAllOfAccessHoursHolidayHours {
...
export function AtmAllOfAccessHoursHolidayHoursToJSON(value?: AtmAllOfAccessHoursHolidayHours | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
