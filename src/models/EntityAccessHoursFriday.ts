 ...
 * @export
 * @interface EntityAccessHoursFriday
 */
export interface EntityAccessHoursFriday {
    /**
     * Indicates if the access hours are "closed" on Friday.
     * 
     * Filtering Type: `boolean`
     * @type {boolean}
     * @memberof EntityAccessHoursFriday
     */
    isClosed?: boolean;
    /**
...
export function EntityAccessHoursFridayFromJSON(json: any): EntityAccessHoursFriday {
    return EntityAccessHoursFridayFromJSONTyped(json, false);
}

export function EntityAccessHoursFridayFromJSONTyped(json: any, ignoreDiscriminator: boolean): EntityAccessHoursFriday {
...
export function EntityAccessHoursFridayToJSON(value?: EntityAccessHoursFriday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
