 ...
 * @export
 * @interface EntityPickupHoursTuesday
 */
export interface EntityPickupHoursTuesday {
    /**
     * Indicates if the pickup hours are "closed" on Tuesday.
     * 
     * Filtering Type: `boolean`
     * @type {boolean}
     * @memberof EntityPickupHoursTuesday
     */
    isClosed?: boolean;
    /**
...
export function EntityPickupHoursTuesdayFromJSON(json: any): EntityPickupHoursTuesday {
    return EntityPickupHoursTuesdayFromJSONTyped(json, false);
}

export function EntityPickupHoursTuesdayFromJSONTyped(json: any, ignoreDiscriminator: boolean): EntityPickupHoursTuesday {
...
export function EntityPickupHoursTuesdayToJSON(value?: EntityPickupHoursTuesday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
