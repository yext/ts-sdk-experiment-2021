 ...
 * @export
 * @interface InlineResponse200ResponseBrunchHoursWednesday
 */
export interface InlineResponse200ResponseBrunchHoursWednesday {
    /**
     * Indicates if the brunch hours are "closed" on Wednesday.
     * 
     * Filtering Type: `boolean`
     * @type {boolean}
     * @memberof InlineResponse200ResponseBrunchHoursWednesday
     */
    isClosed?: boolean;
    /**
...
export function InlineResponse200ResponseBrunchHoursWednesdayFromJSON(json: any): InlineResponse200ResponseBrunchHoursWednesday {
    return InlineResponse200ResponseBrunchHoursWednesdayFromJSONTyped(json, false);
}

export function InlineResponse200ResponseBrunchHoursWednesdayFromJSONTyped(json: any, ignoreDiscriminator: boolean): InlineResponse200ResponseBrunchHoursWednesday {
...
export function InlineResponse200ResponseBrunchHoursWednesdayToJSON(value?: InlineResponse200ResponseBrunchHoursWednesday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
