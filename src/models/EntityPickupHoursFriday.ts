 ...
 * @export
 * @interface EntityPickupHoursFriday
 */
export interface EntityPickupHoursFriday {
    /**
     * Indicates if the pickup hours are "closed" on Friday.
     * 
     * Filtering Type: `boolean`
     * @type {boolean}
     * @memberof EntityPickupHoursFriday
     */
    isClosed?: boolean;
    /**
...
export function EntityPickupHoursFridayFromJSON(json: any): EntityPickupHoursFriday {
    return EntityPickupHoursFridayFromJSONTyped(json, false);
}

export function EntityPickupHoursFridayFromJSONTyped(json: any, ignoreDiscriminator: boolean): EntityPickupHoursFriday {
...
export function EntityPickupHoursFridayToJSON(value?: EntityPickupHoursFriday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
