 ...
 * @export
 * @interface EntityDeliveryHoursFriday
 */
export interface EntityDeliveryHoursFriday {
    /**
     * Indicates if the delivery hours are "closed" on Friday.
     * 
     * Filtering Type: `boolean`
     * @type {boolean}
     * @memberof EntityDeliveryHoursFriday
     */
    isClosed?: boolean;
    /**
...
export function EntityDeliveryHoursFridayFromJSON(json: any): EntityDeliveryHoursFriday {
    return EntityDeliveryHoursFridayFromJSONTyped(json, false);
}

export function EntityDeliveryHoursFridayFromJSONTyped(json: any, ignoreDiscriminator: boolean): EntityDeliveryHoursFriday {
...
export function EntityDeliveryHoursFridayToJSON(value?: EntityDeliveryHoursFriday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
