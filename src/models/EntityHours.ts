...
import {
    EntityHoursFriday,
    EntityHoursFridayFromJSON,
    EntityHoursFridayFromJSONTyped,
    EntityHoursFridayToJSON,
    EntityHoursHolidayHours,
    EntityHoursHolidayHoursFromJSON,
    EntityHoursHolidayHoursFromJSONTyped,
    EntityHoursHolidayHoursToJSON,
    EntityHoursMonday,
    EntityHoursMondayFromJSON,
    EntityHoursMondayFromJSONTyped,
    EntityHoursMondayToJSON,
    EntityHoursSaturday,
    EntityHoursSaturdayFromJSON,
    EntityHoursSaturdayFromJSONTyped,
    EntityHoursSaturdayToJSON,
    EntityHoursSunday,
    EntityHoursSundayFromJSON,
    EntityHoursSundayFromJSONTyped,
    EntityHoursSundayToJSON,
    EntityHoursThursday,
    EntityHoursThursdayFromJSON,
    EntityHoursThursdayFromJSONTyped,
    EntityHoursThursdayToJSON,
    EntityHoursTuesday,
    EntityHoursTuesdayFromJSON,
    EntityHoursTuesdayFromJSONTyped,
    EntityHoursTuesdayToJSON,
    EntityHoursWednesday,
    EntityHoursWednesdayFromJSON,
    EntityHoursWednesdayFromJSONTyped,
    EntityHoursWednesdayToJSON,
} from './';
 ...
 * ```
 * @export
 * @interface EntityHours
 */
export interface EntityHours {
    /**
     * 
     * @type {EntityHoursFriday}
     * @memberof EntityHours
     */
    friday?: EntityHoursFriday;
    /**
     * 
     ...
     * @type {Set<EntityHoursHolidayHours>}
     * @memberof EntityHours
     */
    holidayHours?: Set<EntityHoursHolidayHours>;
    /**
     * 
     * @type {EntityHoursMonday}
     * @memberof EntityHours
     */
    monday?: EntityHoursMonday;
    /**
     * 
    ...
    /**
     * 
     * @type {EntityHoursSaturday}
     * @memberof EntityHours
     */
    saturday?: EntityHoursSaturday;
    /**
     * 
     * @type {EntityHoursSunday}
     * @memberof EntityHours
     */
    sunday?: EntityHoursSunday;
    /**
     * 
     * @type {EntityHoursThursday}
     * @memberof EntityHours
     */
    thursday?: EntityHoursThursday;
    /**
     * 
     * @type {EntityHoursTuesday}
     * @memberof EntityHours
     */
    tuesday?: EntityHoursTuesday;
    /**
     * 
     * @type {EntityHoursWednesday}
     * @memberof EntityHours
     */
    wednesday?: EntityHoursWednesday;
}

export function EntityHoursFromJSON(json: any): EntityHours {
    return EntityHoursFromJSONTyped(json, false);
}

export function EntityHoursFromJSONTyped(json: any, ignoreDiscriminator: boolean): EntityHours {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'friday': !exists(json, 'friday') ? undefined : EntityHoursFridayFromJSON(json['friday']),
        'holidayHours': !exists(json, 'holidayHours') ? undefined : (new Set((json['holidayHours'] as Array<any>).map(EntityHoursHolidayHoursFromJSON))),
        'monday': !exists(json, 'monday') ? undefined : EntityHoursMondayFromJSON(json['monday']),
        'reopenDate': !exists(json, 'reopenDate') ? undefined : (new Date(json['reopenDate'])),
        'saturday': !exists(json, 'saturday') ? undefined : EntityHoursSaturdayFromJSON(json['saturday']),
        'sunday': !exists(json, 'sunday') ? undefined : EntityHoursSundayFromJSON(json['sunday']),
        'thursday': !exists(json, 'thursday') ? undefined : EntityHoursThursdayFromJSON(json['thursday']),
        'tuesday': !exists(json, 'tuesday') ? undefined : EntityHoursTuesdayFromJSON(json['tuesday']),
        'wednesday': !exists(json, 'wednesday') ? undefined : EntityHoursWednesdayFromJSON(json['wednesday']),
    };
}

export function EntityHoursToJSON(value?: EntityHours | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'friday': EntityHoursFridayToJSON(value.friday),
        'holidayHours': value.holidayHours === undefined ? undefined : (Array.from(value.holidayHours as Set<any>).map(EntityHoursHolidayHoursToJSON)),
        'monday': EntityHoursMondayToJSON(value.monday),
        'reopenDate': value.reopenDate === undefined ? undefined : (value.reopenDate.toISOString().substr(0,10)),
        'saturday': EntityHoursSaturdayToJSON(value.saturday),
        'sunday': EntityHoursSundayToJSON(value.sunday),
        'thursday': EntityHoursThursdayToJSON(value.thursday),
        'tuesday': EntityHoursTuesdayToJSON(value.tuesday),
        'wednesday': EntityHoursWednesdayToJSON(value.wednesday),
    };
}
