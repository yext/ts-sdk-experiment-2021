 ...
 * @export
 * @interface EntityBrunchHoursSunday
 */
export interface EntityBrunchHoursSunday {
    /**
     * Indicates if the brunch hours are "closed" on Sunday.
     * 
     * Filtering Type: `boolean`
     * @type {boolean}
     * @memberof EntityBrunchHoursSunday
     */
    isClosed?: boolean;
    /**
...
export function EntityBrunchHoursSundayFromJSON(json: any): EntityBrunchHoursSunday {
    return EntityBrunchHoursSundayFromJSONTyped(json, false);
}

export function EntityBrunchHoursSundayFromJSONTyped(json: any, ignoreDiscriminator: boolean): EntityBrunchHoursSunday {
...
export function EntityBrunchHoursSundayToJSON(value?: EntityBrunchHoursSunday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
