 ...
 * 
 * @export
 * @interface AtmAllOfAccessHoursTuesday
 */
export interface AtmAllOfAccessHoursTuesday {
    /**
     * Indicates if the access hours are "closed" on Tuesday.
     * @type {boolean}
     * @memberof AtmAllOfAccessHoursTuesday
     */
    isClosed?: boolean;
    /**
...
export function AtmAllOfAccessHoursTuesdayFromJSON(json: any): AtmAllOfAccessHoursTuesday {
    return AtmAllOfAccessHoursTuesdayFromJSONTyped(json, false);
}

export function AtmAllOfAccessHoursTuesdayFromJSONTyped(json: any, ignoreDiscriminator: boolean): AtmAllOfAccessHoursTuesday {
...
export function AtmAllOfAccessHoursTuesdayToJSON(value?: AtmAllOfAccessHoursTuesday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
