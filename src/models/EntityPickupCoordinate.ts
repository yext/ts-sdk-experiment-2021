 ...
 * ```
 * @export
 * @interface EntityPickupCoordinate
 */
export interface EntityPickupCoordinate {
    /**
     * Filtering Type: `float`
     * @type {number}
     * @memberof EntityPickupCoordinate
     */
    latitude?: number;
    /**
     * Filtering Type: `float`
...
export function EntityPickupCoordinateFromJSON(json: any): EntityPickupCoordinate {
    return EntityPickupCoordinateFromJSONTyped(json, false);
}

export function EntityPickupCoordinateFromJSONTyped(json: any, ignoreDiscriminator: boolean): EntityPickupCoordinate {
...
export function EntityPickupCoordinateToJSON(value?: EntityPickupCoordinate | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
