 ...
 * @export
 * @interface EntityDriveThroughHoursSunday
 */
export interface EntityDriveThroughHoursSunday {
    /**
     * Indicates if the drive-through hours are "closed" on Sunday.
     * 
     * Filtering Type: `boolean`
     * @type {boolean}
     * @memberof EntityDriveThroughHoursSunday
     */
    isClosed?: boolean;
    /**
...
export function EntityDriveThroughHoursSundayFromJSON(json: any): EntityDriveThroughHoursSunday {
    return EntityDriveThroughHoursSundayFromJSONTyped(json, false);
}

export function EntityDriveThroughHoursSundayFromJSONTyped(json: any, ignoreDiscriminator: boolean): EntityDriveThroughHoursSunday {
...
export function EntityDriveThroughHoursSundayToJSON(value?: EntityDriveThroughHoursSunday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
