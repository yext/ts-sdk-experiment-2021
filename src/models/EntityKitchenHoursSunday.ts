 ...
 * @export
 * @interface EntityKitchenHoursSunday
 */
export interface EntityKitchenHoursSunday {
    /**
     * Indicates if the kitchen hours are "closed" on Sunday.
     * 
     * Filtering Type: `boolean`
     * @type {boolean}
     * @memberof EntityKitchenHoursSunday
     */
    isClosed?: boolean;
    /**
...
export function EntityKitchenHoursSundayFromJSON(json: any): EntityKitchenHoursSunday {
    return EntityKitchenHoursSundayFromJSONTyped(json, false);
}

export function EntityKitchenHoursSundayFromJSONTyped(json: any, ignoreDiscriminator: boolean): EntityKitchenHoursSunday {
...
export function EntityKitchenHoursSundayToJSON(value?: EntityKitchenHoursSunday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
