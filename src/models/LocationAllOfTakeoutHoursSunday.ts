 ...
 * 
 * @export
 * @interface LocationAllOfTakeoutHoursSunday
 */
export interface LocationAllOfTakeoutHoursSunday {
    /**
     * Indicates if the takeout hours are "closed" on Sunday.
     * @type {boolean}
     * @memberof LocationAllOfTakeoutHoursSunday
     */
    isClosed?: boolean;
    /**
...
export function LocationAllOfTakeoutHoursSundayFromJSON(json: any): LocationAllOfTakeoutHoursSunday {
    return LocationAllOfTakeoutHoursSundayFromJSONTyped(json, false);
}

export function LocationAllOfTakeoutHoursSundayFromJSONTyped(json: any, ignoreDiscriminator: boolean): LocationAllOfTakeoutHoursSunday {
...
export function LocationAllOfTakeoutHoursSundayToJSON(value?: LocationAllOfTakeoutHoursSunday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
