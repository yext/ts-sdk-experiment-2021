...
import {
    EntityHappyHoursFriday,
    EntityHappyHoursFridayFromJSON,
    EntityHappyHoursFridayFromJSONTyped,
    EntityHappyHoursFridayToJSON,
    EntityHappyHoursHolidayHours,
    EntityHappyHoursHolidayHoursFromJSON,
    EntityHappyHoursHolidayHoursFromJSONTyped,
    EntityHappyHoursHolidayHoursToJSON,
    EntityHappyHoursMonday,
    EntityHappyHoursMondayFromJSON,
    EntityHappyHoursMondayFromJSONTyped,
    EntityHappyHoursMondayToJSON,
    EntityHappyHoursSaturday,
    EntityHappyHoursSaturdayFromJSON,
    EntityHappyHoursSaturdayFromJSONTyped,
    EntityHappyHoursSaturdayToJSON,
    EntityHappyHoursSunday,
    EntityHappyHoursSundayFromJSON,
    EntityHappyHoursSundayFromJSONTyped,
    EntityHappyHoursSundayToJSON,
    EntityHappyHoursThursday,
    EntityHappyHoursThursdayFromJSON,
    EntityHappyHoursThursdayFromJSONTyped,
    EntityHappyHoursThursdayToJSON,
    EntityHappyHoursTuesday,
    EntityHappyHoursTuesdayFromJSON,
    EntityHappyHoursTuesdayFromJSONTyped,
    EntityHappyHoursTuesdayToJSON,
    EntityHappyHoursWednesday,
    EntityHappyHoursWednesdayFromJSON,
    EntityHappyHoursWednesdayFromJSONTyped,
    EntityHappyHoursWednesdayToJSON,
} from './';
 ...
 * ```
 * @export
 * @interface EntityHappyHours
 */
export interface EntityHappyHours {
    /**
     * 
     * @type {EntityHappyHoursFriday}
     * @memberof EntityHappyHours
     */
    friday?: EntityHappyHoursFriday;
    /**
     * 
     ...
     * @type {Set<EntityHappyHoursHolidayHours>}
     * @memberof EntityHappyHours
     */
    holidayHours?: Set<EntityHappyHoursHolidayHours>;
    /**
     * 
     * @type {EntityHappyHoursMonday}
     * @memberof EntityHappyHours
     */
    monday?: EntityHappyHoursMonday;
    /**
     * 
    ...
    /**
     * 
     * @type {EntityHappyHoursSaturday}
     * @memberof EntityHappyHours
     */
    saturday?: EntityHappyHoursSaturday;
    /**
     * 
     * @type {EntityHappyHoursSunday}
     * @memberof EntityHappyHours
     */
    sunday?: EntityHappyHoursSunday;
    /**
     * 
     * @type {EntityHappyHoursThursday}
     * @memberof EntityHappyHours
     */
    thursday?: EntityHappyHoursThursday;
    /**
     * 
     * @type {EntityHappyHoursTuesday}
     * @memberof EntityHappyHours
     */
    tuesday?: EntityHappyHoursTuesday;
    /**
     * 
     * @type {EntityHappyHoursWednesday}
     * @memberof EntityHappyHours
     */
    wednesday?: EntityHappyHoursWednesday;
}

export function EntityHappyHoursFromJSON(json: any): EntityHappyHours {
    return EntityHappyHoursFromJSONTyped(json, false);
}

export function EntityHappyHoursFromJSONTyped(json: any, ignoreDiscriminator: boolean): EntityHappyHours {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'friday': !exists(json, 'friday') ? undefined : EntityHappyHoursFridayFromJSON(json['friday']),
        'holidayHours': !exists(json, 'holidayHours') ? undefined : (new Set((json['holidayHours'] as Array<any>).map(EntityHappyHoursHolidayHoursFromJSON))),
        'monday': !exists(json, 'monday') ? undefined : EntityHappyHoursMondayFromJSON(json['monday']),
        'reopenDate': !exists(json, 'reopenDate') ? undefined : (new Date(json['reopenDate'])),
        'saturday': !exists(json, 'saturday') ? undefined : EntityHappyHoursSaturdayFromJSON(json['saturday']),
        'sunday': !exists(json, 'sunday') ? undefined : EntityHappyHoursSundayFromJSON(json['sunday']),
        'thursday': !exists(json, 'thursday') ? undefined : EntityHappyHoursThursdayFromJSON(json['thursday']),
        'tuesday': !exists(json, 'tuesday') ? undefined : EntityHappyHoursTuesdayFromJSON(json['tuesday']),
        'wednesday': !exists(json, 'wednesday') ? undefined : EntityHappyHoursWednesdayFromJSON(json['wednesday']),
    };
}

export function EntityHappyHoursToJSON(value?: EntityHappyHours | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'friday': EntityHappyHoursFridayToJSON(value.friday),
        'holidayHours': value.holidayHours === undefined ? undefined : (Array.from(value.holidayHours as Set<any>).map(EntityHappyHoursHolidayHoursToJSON)),
        'monday': EntityHappyHoursMondayToJSON(value.monday),
        'reopenDate': value.reopenDate === undefined ? undefined : (value.reopenDate.toISOString().substr(0,10)),
        'saturday': EntityHappyHoursSaturdayToJSON(value.saturday),
        'sunday': EntityHappyHoursSundayToJSON(value.sunday),
        'thursday': EntityHappyHoursThursdayToJSON(value.thursday),
        'tuesday': EntityHappyHoursTuesdayToJSON(value.tuesday),
        'wednesday': EntityHappyHoursWednesdayToJSON(value.wednesday),
    };
}
