 ...
 * 
 * @export
 * @interface AtmAllOfHoursThursday
 */
export interface AtmAllOfHoursThursday {
    /**
     * Indicates if the hours of operation are "closed" on Thursday.
     * @type {boolean}
     * @memberof AtmAllOfHoursThursday
     */
    isClosed?: boolean;
    /**
...
export function AtmAllOfHoursThursdayFromJSON(json: any): AtmAllOfHoursThursday {
    return AtmAllOfHoursThursdayFromJSONTyped(json, false);
}

export function AtmAllOfHoursThursdayFromJSONTyped(json: any, ignoreDiscriminator: boolean): AtmAllOfHoursThursday {
...
export function AtmAllOfHoursThursdayToJSON(value?: AtmAllOfHoursThursday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
