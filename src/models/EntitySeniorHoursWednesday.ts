 ...
 * @export
 * @interface EntitySeniorHoursWednesday
 */
export interface EntitySeniorHoursWednesday {
    /**
     * Indicates if the senior hours are "closed" on Wednesday.
     * 
     * Filtering Type: `boolean`
     * @type {boolean}
     * @memberof EntitySeniorHoursWednesday
     */
    isClosed?: boolean;
    /**
...
export function EntitySeniorHoursWednesdayFromJSON(json: any): EntitySeniorHoursWednesday {
    return EntitySeniorHoursWednesdayFromJSONTyped(json, false);
}

export function EntitySeniorHoursWednesdayFromJSONTyped(json: any, ignoreDiscriminator: boolean): EntitySeniorHoursWednesday {
...
export function EntitySeniorHoursWednesdayToJSON(value?: EntitySeniorHoursWednesday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
