 ...
 * @export
 * @interface EntityBrunchHoursFriday
 */
export interface EntityBrunchHoursFriday {
    /**
     * Indicates if the brunch hours are "closed" on Friday.
     * 
     * Filtering Type: `boolean`
     * @type {boolean}
     * @memberof EntityBrunchHoursFriday
     */
    isClosed?: boolean;
    /**
...
export function EntityBrunchHoursFridayFromJSON(json: any): EntityBrunchHoursFriday {
    return EntityBrunchHoursFridayFromJSONTyped(json, false);
}

export function EntityBrunchHoursFridayFromJSONTyped(json: any, ignoreDiscriminator: boolean): EntityBrunchHoursFriday {
...
export function EntityBrunchHoursFridayToJSON(value?: EntityBrunchHoursFriday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
