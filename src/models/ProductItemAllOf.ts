...
import {
    ...
    ContentListPhoto,
    ContentListPhotoFromJSON,
    ContentListPhotoFromJSONTyped,
    ContentListPhotoToJSON,
} from './';
...
export interface ProductItemAllOf {
     ...
     * @type {Array<ContentListPhoto>}
     * @memberof ProductItemAllOf
     */
    photos?: Array<ContentListPhoto>;
    /**
     * 
...
export function ProductItemAllOfFromJSONTyped(json: any, ignoreDiscriminator: boolean): ProductItemAllOf {
    ...
    return {
        ...
        'photos': !exists(json, 'photos') ? undefined : ((json['photos'] as Array<any>).map(ContentListPhotoFromJSON)),
...
export function ProductItemAllOfToJSON(value?: ProductItemAllOf | null): any {
    ...
    return {
        ...
        'photos': value.photos === undefined ? undefined : ((value.photos as Array<any>).map(ContentListPhotoToJSON)),
