 ...
 * @export
 * @interface EntityPickupHoursWednesday
 */
export interface EntityPickupHoursWednesday {
    /**
     * Indicates if the pickup hours are "closed" on Wednesday.
     * 
     * Filtering Type: `boolean`
     * @type {boolean}
     * @memberof EntityPickupHoursWednesday
     */
    isClosed?: boolean;
    /**
...
export function EntityPickupHoursWednesdayFromJSON(json: any): EntityPickupHoursWednesday {
    return EntityPickupHoursWednesdayFromJSONTyped(json, false);
}

export function EntityPickupHoursWednesdayFromJSONTyped(json: any, ignoreDiscriminator: boolean): EntityPickupHoursWednesday {
...
export function EntityPickupHoursWednesdayToJSON(value?: EntityPickupHoursWednesday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
