...
export function EntityAddressFromJSON(json: any): EntityAddress {
    return EntityAddressFromJSONTyped(json, false);
}

export function EntityAddressFromJSONTyped(json: any, ignoreDiscriminator: boolean): EntityAddress {
...
export function EntityAddressToJSON(value?: EntityAddress | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
