 ...
 * 
 * @export
 * @interface HealthcareFacilityAllOfPickupHoursSaturday
 */
export interface HealthcareFacilityAllOfPickupHoursSaturday {
    /**
     * Indicates if the pickup hours are "closed" on Saturday.
     * @type {boolean}
     * @memberof HealthcareFacilityAllOfPickupHoursSaturday
     */
    isClosed?: boolean;
    /**
...
export function HealthcareFacilityAllOfPickupHoursSaturdayFromJSON(json: any): HealthcareFacilityAllOfPickupHoursSaturday {
    return HealthcareFacilityAllOfPickupHoursSaturdayFromJSONTyped(json, false);
}

export function HealthcareFacilityAllOfPickupHoursSaturdayFromJSONTyped(json: any, ignoreDiscriminator: boolean): HealthcareFacilityAllOfPickupHoursSaturday {
...
export function HealthcareFacilityAllOfPickupHoursSaturdayToJSON(value?: HealthcareFacilityAllOfPickupHoursSaturday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
