 ...
 * @export
 * @interface EntityKitchenHoursFriday
 */
export interface EntityKitchenHoursFriday {
    /**
     * Indicates if the kitchen hours are "closed" on Friday.
     * 
     * Filtering Type: `boolean`
     * @type {boolean}
     * @memberof EntityKitchenHoursFriday
     */
    isClosed?: boolean;
    /**
...
export function EntityKitchenHoursFridayFromJSON(json: any): EntityKitchenHoursFriday {
    return EntityKitchenHoursFridayFromJSONTyped(json, false);
}

export function EntityKitchenHoursFridayFromJSONTyped(json: any, ignoreDiscriminator: boolean): EntityKitchenHoursFriday {
...
export function EntityKitchenHoursFridayToJSON(value?: EntityKitchenHoursFriday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
