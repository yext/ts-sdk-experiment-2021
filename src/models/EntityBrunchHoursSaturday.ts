 ...
 * @export
 * @interface EntityBrunchHoursSaturday
 */
export interface EntityBrunchHoursSaturday {
    /**
     * Indicates if the brunch hours are "closed" on Saturday.
     * 
     * Filtering Type: `boolean`
     * @type {boolean}
     * @memberof EntityBrunchHoursSaturday
     */
    isClosed?: boolean;
    /**
...
export function EntityBrunchHoursSaturdayFromJSON(json: any): EntityBrunchHoursSaturday {
    return EntityBrunchHoursSaturdayFromJSONTyped(json, false);
}

export function EntityBrunchHoursSaturdayFromJSONTyped(json: any, ignoreDiscriminator: boolean): EntityBrunchHoursSaturday {
...
export function EntityBrunchHoursSaturdayToJSON(value?: EntityBrunchHoursSaturday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
