 ...
 * @export
 * @interface InlineResponse200ResponseDeliveryHoursSunday
 */
export interface InlineResponse200ResponseDeliveryHoursSunday {
    /**
     * Indicates if the delivery hours are "closed" on Sunday.
     * 
     * Filtering Type: `boolean`
     * @type {boolean}
     * @memberof InlineResponse200ResponseDeliveryHoursSunday
     */
    isClosed?: boolean;
    /**
...
export function InlineResponse200ResponseDeliveryHoursSundayFromJSON(json: any): InlineResponse200ResponseDeliveryHoursSunday {
    return InlineResponse200ResponseDeliveryHoursSundayFromJSONTyped(json, false);
}

export function InlineResponse200ResponseDeliveryHoursSundayFromJSONTyped(json: any, ignoreDiscriminator: boolean): InlineResponse200ResponseDeliveryHoursSunday {
...
export function InlineResponse200ResponseDeliveryHoursSundayToJSON(value?: InlineResponse200ResponseDeliveryHoursSunday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
