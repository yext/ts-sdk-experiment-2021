 ...
 * ```
 * @export
 * @interface EntityHeadshot
 */
export interface EntityHeadshot {
    /**
     * Filtering Type: `text`
     * @type {string}
     * @memberof EntityHeadshot
     */
...
export function EntityHeadshotFromJSON(json: any): EntityHeadshot {
    return EntityHeadshotFromJSONTyped(json, false);
}

export function EntityHeadshotFromJSONTyped(json: any, ignoreDiscriminator: boolean): EntityHeadshot {
...
export function EntityHeadshotToJSON(value?: EntityHeadshot | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
