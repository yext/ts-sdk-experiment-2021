 ...
 * 
 * @export
 * @interface AtmAllOfDriveThroughHoursTuesday
 */
export interface AtmAllOfDriveThroughHoursTuesday {
    /**
     * Indicates if the drive-through hours are "closed" on Tuesday.
     * @type {boolean}
     * @memberof AtmAllOfDriveThroughHoursTuesday
     */
    isClosed?: boolean;
    /**
...
export function AtmAllOfDriveThroughHoursTuesdayFromJSON(json: any): AtmAllOfDriveThroughHoursTuesday {
    return AtmAllOfDriveThroughHoursTuesdayFromJSONTyped(json, false);
}

export function AtmAllOfDriveThroughHoursTuesdayFromJSONTyped(json: any, ignoreDiscriminator: boolean): AtmAllOfDriveThroughHoursTuesday {
...
export function AtmAllOfDriveThroughHoursTuesdayToJSON(value?: AtmAllOfDriveThroughHoursTuesday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
