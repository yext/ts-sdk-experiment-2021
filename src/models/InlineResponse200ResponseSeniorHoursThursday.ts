 ...
 * @export
 * @interface InlineResponse200ResponseSeniorHoursThursday
 */
export interface InlineResponse200ResponseSeniorHoursThursday {
    /**
     * Indicates if the senior hours are "closed" on Thursday.
     * 
     * Filtering Type: `boolean`
     * @type {boolean}
     * @memberof InlineResponse200ResponseSeniorHoursThursday
     */
    isClosed?: boolean;
    /**
...
export function InlineResponse200ResponseSeniorHoursThursdayFromJSON(json: any): InlineResponse200ResponseSeniorHoursThursday {
    return InlineResponse200ResponseSeniorHoursThursdayFromJSONTyped(json, false);
}

export function InlineResponse200ResponseSeniorHoursThursdayFromJSONTyped(json: any, ignoreDiscriminator: boolean): InlineResponse200ResponseSeniorHoursThursday {
...
export function InlineResponse200ResponseSeniorHoursThursdayToJSON(value?: InlineResponse200ResponseSeniorHoursThursday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
