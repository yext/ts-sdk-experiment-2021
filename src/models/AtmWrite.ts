...
import {
    AtmWriteAllOf,
    AtmWriteAllOfFromJSON,
    AtmWriteAllOfFromJSONTyped,
    AtmWriteAllOfToJSON,
 ...
 * @interface AtmWrite
 */
export interface AtmWrite extends EntityWrite {
    /**
     * 
     ...
     * @memberof AtmWrite
     */
    locationType?: AtmWriteLocationTypeEnum;
    /**
     * 
     ...
     * @memberof AtmWrite
     */
    priceRange?: AtmWritePriceRangeEnum;
    /**
     ...
     * @memberof AtmWrite
     */
    rankTrackingFrequency?: AtmWriteRankTrackingFrequencyEnum;
    /**
     ...
     * @memberof AtmWrite
     */
    rankTrackingQueryTemplates?: Set<AtmWriteRankTrackingQueryTemplatesEnum>;
    /**
     * The search engines that we will use to track your performance
     * @type {Set<string>}
     * @memberof AtmWrite
     */
    rankTrackingSites?: Set<AtmWriteRankTrackingSitesEnum>;
    /**
...
* @enum {string}
*/
export enum AtmWriteLocationTypeEnum {
    Location = 'LOCATION',
...
* @enum {string}
*/
export enum AtmWritePriceRangeEnum {
...
* @enum {string}
*/
export enum AtmWriteRankTrackingFrequencyEnum {
    Weekly = 'WEEKLY',
    Monthly = 'MONTHLY',
    Quarterly = 'QUARTERLY'
}/**
...
* @enum {string}
*/
export enum AtmWriteRankTrackingQueryTemplatesEnum {
    Keyword = 'KEYWORD',
...
* @enum {string}
*/
export enum AtmWriteRankTrackingSitesEnum {
...
export function AtmWriteFromJSON(json: any): AtmWrite {
    return AtmWriteFromJSONTyped(json, false);
}

export function AtmWriteFromJSONTyped(json: any, ignoreDiscriminator: boolean): AtmWrite {
...
export function AtmWriteToJSON(value?: AtmWrite | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
