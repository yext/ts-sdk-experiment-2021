 ...
 * ```
 * @export
 * @interface EntityUberTripBranding
 */
export interface EntityUberTripBranding {
    /**
     ...
     * Filtering Type: `text`
     * @type {string}
     * @memberof EntityUberTripBranding
     */
    description: string;
    /**
...
export function EntityUberTripBrandingFromJSON(json: any): EntityUberTripBranding {
    return EntityUberTripBrandingFromJSONTyped(json, false);
}

export function EntityUberTripBrandingFromJSONTyped(json: any, ignoreDiscriminator: boolean): EntityUberTripBranding {
...
export function EntityUberTripBrandingToJSON(value?: EntityUberTripBranding | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
