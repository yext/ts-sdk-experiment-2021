 ...
 * @export
 * @interface InlineResponse200ResponseKitchenHoursHolidayHours
 */
export interface InlineResponse200ResponseKitchenHoursHolidayHours {
    /**
     ...
     * Filtering Type: `date`
     * @type {Date}
     * @memberof InlineResponse200ResponseKitchenHoursHolidayHours
     */
    date: Date;
    /**
...
export function InlineResponse200ResponseKitchenHoursHolidayHoursFromJSON(json: any): InlineResponse200ResponseKitchenHoursHolidayHours {
    return InlineResponse200ResponseKitchenHoursHolidayHoursFromJSONTyped(json, false);
}

export function InlineResponse200ResponseKitchenHoursHolidayHoursFromJSONTyped(json: any, ignoreDiscriminator: boolean): InlineResponse200ResponseKitchenHoursHolidayHours {
...
export function InlineResponse200ResponseKitchenHoursHolidayHoursToJSON(value?: InlineResponse200ResponseKitchenHoursHolidayHours | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
