 ...
 * @export
 * @interface EntityLogoImage
 */
export interface EntityLogoImage {
    /**
     * Filtering Type: `text`
     * @type {string}
     * @memberof EntityLogoImage
     */
...
export function EntityLogoImageFromJSON(json: any): EntityLogoImage {
    return EntityLogoImageFromJSONTyped(json, false);
}

export function EntityLogoImageFromJSONTyped(json: any, ignoreDiscriminator: boolean): EntityLogoImage {
...
export function EntityLogoImageToJSON(value?: EntityLogoImage | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
