 ...
 * @export
 * @interface EntityFrequentlyAskedQuestions
 */
export interface EntityFrequentlyAskedQuestions {
    /**
     * Filtering Type: `text`
     * @type {string}
     * @memberof EntityFrequentlyAskedQuestions
     */
    answer?: string;
    /**
     * Filtering Type: `text`
...
export function EntityFrequentlyAskedQuestionsFromJSON(json: any): EntityFrequentlyAskedQuestions {
    return EntityFrequentlyAskedQuestionsFromJSONTyped(json, false);
}

export function EntityFrequentlyAskedQuestionsFromJSONTyped(json: any, ignoreDiscriminator: boolean): EntityFrequentlyAskedQuestions {
...
export function EntityFrequentlyAskedQuestionsToJSON(value?: EntityFrequentlyAskedQuestions | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
