 ...
 * @export
 * @interface EntityDriveThroughHoursHolidayHours
 */
export interface EntityDriveThroughHoursHolidayHours {
    /**
     ...
     * Filtering Type: `date`
     * @type {Date}
     * @memberof EntityDriveThroughHoursHolidayHours
     */
    date: Date;
    /**
...
export function EntityDriveThroughHoursHolidayHoursFromJSON(json: any): EntityDriveThroughHoursHolidayHours {
    return EntityDriveThroughHoursHolidayHoursFromJSONTyped(json, false);
}

export function EntityDriveThroughHoursHolidayHoursFromJSONTyped(json: any, ignoreDiscriminator: boolean): EntityDriveThroughHoursHolidayHours {
...
export function EntityDriveThroughHoursHolidayHoursToJSON(value?: EntityDriveThroughHoursHolidayHours | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
