 ...
 * @export
 * @interface InlineResponse200ResponseDriveThroughHoursWednesday
 */
export interface InlineResponse200ResponseDriveThroughHoursWednesday {
    /**
     * Indicates if the drive-through hours are "closed" on Wednesday.
     * 
     * Filtering Type: `boolean`
     * @type {boolean}
     * @memberof InlineResponse200ResponseDriveThroughHoursWednesday
     */
    isClosed?: boolean;
    /**
...
export function InlineResponse200ResponseDriveThroughHoursWednesdayFromJSON(json: any): InlineResponse200ResponseDriveThroughHoursWednesday {
    return InlineResponse200ResponseDriveThroughHoursWednesdayFromJSONTyped(json, false);
}

export function InlineResponse200ResponseDriveThroughHoursWednesdayFromJSONTyped(json: any, ignoreDiscriminator: boolean): InlineResponse200ResponseDriveThroughHoursWednesday {
...
export function InlineResponse200ResponseDriveThroughHoursWednesdayToJSON(value?: InlineResponse200ResponseDriveThroughHoursWednesday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
