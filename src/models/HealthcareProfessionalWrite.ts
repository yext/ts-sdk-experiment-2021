...
import {
    ...
    HealthcareProfessionalWriteAllOf,
    HealthcareProfessionalWriteAllOfFromJSON,
    HealthcareProfessionalWriteAllOfFromJSONTyped,
    HealthcareProfessionalWriteAllOfToJSON,
 ...
 * 
 * @export
 * @interface HealthcareProfessionalWrite
 */
export interface HealthcareProfessionalWrite extends EntityWrite {
    /**
     * 
     * @type {AtmWriteAllOfMeta}
     * @memberof HealthcareProfessionalWrite
     */
     ...
     * @memberof HealthcareProfessionalWrite
     */
    degrees?: Set<HealthcareProfessionalWriteDegreesEnum>;
    /**
     ...
     * @memberof HealthcareProfessionalWrite
     */
    gender?: HealthcareProfessionalWriteGenderEnum;
    /**
     ...
     * @memberof HealthcareProfessionalWrite
     */
    locationType?: HealthcareProfessionalWriteLocationTypeEnum;
    /**
     * 
     ...
     * @memberof HealthcareProfessionalWrite
     */
    paymentOptions?: Set<HealthcareProfessionalWritePaymentOptionsEnum>;
    /**
     * 
     ...
     * @memberof HealthcareProfessionalWrite
     */
    priceRange?: HealthcareProfessionalWritePriceRangeEnum;
    /**
     ...
     * @memberof HealthcareProfessionalWrite
     */
    rankTrackingFrequency?: HealthcareProfessionalWriteRankTrackingFrequencyEnum;
    /**
     ...
     * @memberof HealthcareProfessionalWrite
     */
    rankTrackingQueryTemplates?: Set<HealthcareProfessionalWriteRankTrackingQueryTemplatesEnum>;
    /**
     * The search engines that we will use to track your performance
     * @type {Set<string>}
     * @memberof HealthcareProfessionalWrite
     */
    rankTrackingSites?: Set<HealthcareProfessionalWriteRankTrackingSitesEnum>;
    /**
     * 
...
* @enum {string}
*/
export enum HealthcareProfessionalWriteDegreesEnum {
    Anp = 'ANP',
    Apn = 'APN',
    Aprn = 'APRN',
    Arnp = 'ARNP',
...
* @enum {string}
*/
export enum HealthcareProfessionalWriteGenderEnum {
...
* @enum {string}
*/
export enum HealthcareProfessionalWriteLocationTypeEnum {
    Location = 'LOCATION',
...
* @enum {string}
*/
export enum HealthcareProfessionalWritePaymentOptionsEnum {
    Alipay = 'ALIPAY',
...
* @enum {string}
*/
export enum HealthcareProfessionalWritePriceRangeEnum {
    Unspecified = 'UNSPECIFIED',
    One = 'ONE',
    Two = 'TWO',
    Three = 'THREE',
...
* @enum {string}
*/
export enum HealthcareProfessionalWriteRankTrackingFrequencyEnum {
    Weekly = 'WEEKLY',
    Monthly = 'MONTHLY',
    Quarterly = 'QUARTERLY'
}/**
...
* @enum {string}
*/
export enum HealthcareProfessionalWriteRankTrackingQueryTemplatesEnum {
    Keyword = 'KEYWORD',
...
* @enum {string}
*/
export enum HealthcareProfessionalWriteRankTrackingSitesEnum {
...
export function HealthcareProfessionalWriteFromJSON(json: any): HealthcareProfessionalWrite {
    return HealthcareProfessionalWriteFromJSONTyped(json, false);
}

export function HealthcareProfessionalWriteFromJSONTyped(json: any, ignoreDiscriminator: boolean): HealthcareProfessionalWrite {
...
export function HealthcareProfessionalWriteToJSON(value?: HealthcareProfessionalWrite | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
