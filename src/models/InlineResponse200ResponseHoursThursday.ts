 ...
 * @export
 * @interface InlineResponse200ResponseHoursThursday
 */
export interface InlineResponse200ResponseHoursThursday {
    /**
     * Indicates if the hours of operation are "closed" on Thursday.
     * 
     * Filtering Type: `boolean`
     * @type {boolean}
     * @memberof InlineResponse200ResponseHoursThursday
     */
    isClosed?: boolean;
    /**
...
export function InlineResponse200ResponseHoursThursdayFromJSON(json: any): InlineResponse200ResponseHoursThursday {
    return InlineResponse200ResponseHoursThursdayFromJSONTyped(json, false);
}

export function InlineResponse200ResponseHoursThursdayFromJSONTyped(json: any, ignoreDiscriminator: boolean): InlineResponse200ResponseHoursThursday {
...
export function InlineResponse200ResponseHoursThursdayToJSON(value?: InlineResponse200ResponseHoursThursday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
