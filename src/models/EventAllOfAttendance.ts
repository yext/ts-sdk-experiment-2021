 ...
 * @export
 * @interface EventAllOfAttendance
 */
export interface EventAllOfAttendance {
    /**
     * 
     * @type {string}
     * @memberof EventAllOfAttendance
     */
    attendanceMode: EventAllOfAttendanceAttendanceModeEnum;
    /**
     * 
     * @type {string}
     * @memberof EventAllOfAttendance
...
* @enum {string}
*/
export enum EventAllOfAttendanceAttendanceModeEnum {
    Offline = 'OFFLINE',
    Online = 'ONLINE',
    Mixed = 'MIXED'
}

export function EventAllOfAttendanceFromJSON(json: any): EventAllOfAttendance {
    return EventAllOfAttendanceFromJSONTyped(json, false);
}

export function EventAllOfAttendanceFromJSONTyped(json: any, ignoreDiscriminator: boolean): EventAllOfAttendance {
...
export function EventAllOfAttendanceToJSON(value?: EventAllOfAttendance | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
