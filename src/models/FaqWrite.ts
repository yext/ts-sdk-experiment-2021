...
import {
    ...
    EntityWriteToJSON,
    FaqWriteAllOf,
    FaqWriteAllOfFromJSON,
    FaqWriteAllOfFromJSONTyped,
    FaqWriteAllOfToJSON,
} from './';
 ...
 * @interface FaqWrite
 */
export interface FaqWrite extends EntityWrite {
    /**
     * 
...
export function FaqWriteFromJSON(json: any): FaqWrite {
    return FaqWriteFromJSONTyped(json, false);
}

export function FaqWriteFromJSONTyped(json: any, ignoreDiscriminator: boolean): FaqWrite {
...
export function FaqWriteToJSON(value?: FaqWrite | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
