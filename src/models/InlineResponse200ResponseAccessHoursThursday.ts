 ...
 * @export
 * @interface InlineResponse200ResponseAccessHoursThursday
 */
export interface InlineResponse200ResponseAccessHoursThursday {
    /**
     * Indicates if the access hours are "closed" on Thursday.
     * 
     * Filtering Type: `boolean`
     * @type {boolean}
     * @memberof InlineResponse200ResponseAccessHoursThursday
     */
    isClosed?: boolean;
    /**
...
export function InlineResponse200ResponseAccessHoursThursdayFromJSON(json: any): InlineResponse200ResponseAccessHoursThursday {
    return InlineResponse200ResponseAccessHoursThursdayFromJSONTyped(json, false);
}

export function InlineResponse200ResponseAccessHoursThursdayFromJSONTyped(json: any, ignoreDiscriminator: boolean): InlineResponse200ResponseAccessHoursThursday {
...
export function InlineResponse200ResponseAccessHoursThursdayToJSON(value?: InlineResponse200ResponseAccessHoursThursday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
