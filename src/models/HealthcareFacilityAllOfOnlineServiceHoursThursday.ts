 ...
 * 
 * @export
 * @interface HealthcareFacilityAllOfOnlineServiceHoursThursday
 */
export interface HealthcareFacilityAllOfOnlineServiceHoursThursday {
    /**
     * Indicates if the online service hours are "closed" on Thursday.
     * @type {boolean}
     * @memberof HealthcareFacilityAllOfOnlineServiceHoursThursday
     */
    isClosed?: boolean;
    /**
...
export function HealthcareFacilityAllOfOnlineServiceHoursThursdayFromJSON(json: any): HealthcareFacilityAllOfOnlineServiceHoursThursday {
    return HealthcareFacilityAllOfOnlineServiceHoursThursdayFromJSONTyped(json, false);
}

export function HealthcareFacilityAllOfOnlineServiceHoursThursdayFromJSONTyped(json: any, ignoreDiscriminator: boolean): HealthcareFacilityAllOfOnlineServiceHoursThursday {
...
export function HealthcareFacilityAllOfOnlineServiceHoursThursdayToJSON(value?: HealthcareFacilityAllOfOnlineServiceHoursThursday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
