 ...
 * @export
 * @interface EntityDeliveryHoursHolidayHours
 */
export interface EntityDeliveryHoursHolidayHours {
    /**
     ...
     * Filtering Type: `date`
     * @type {Date}
     * @memberof EntityDeliveryHoursHolidayHours
     */
    date: Date;
    /**
...
export function EntityDeliveryHoursHolidayHoursFromJSON(json: any): EntityDeliveryHoursHolidayHours {
    return EntityDeliveryHoursHolidayHoursFromJSONTyped(json, false);
}

export function EntityDeliveryHoursHolidayHoursFromJSONTyped(json: any, ignoreDiscriminator: boolean): EntityDeliveryHoursHolidayHours {
...
export function EntityDeliveryHoursHolidayHoursToJSON(value?: EntityDeliveryHoursHolidayHours | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
