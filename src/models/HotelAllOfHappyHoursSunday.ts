 ...
 * 
 * @export
 * @interface HotelAllOfHappyHoursSunday
 */
export interface HotelAllOfHappyHoursSunday {
    /**
     * Indicates if the happy hours are "closed" on Sunday.
     * @type {boolean}
     * @memberof HotelAllOfHappyHoursSunday
     */
    isClosed?: boolean;
    /**
...
export function HotelAllOfHappyHoursSundayFromJSON(json: any): HotelAllOfHappyHoursSunday {
    return HotelAllOfHappyHoursSundayFromJSONTyped(json, false);
}

export function HotelAllOfHappyHoursSundayFromJSONTyped(json: any, ignoreDiscriminator: boolean): HotelAllOfHappyHoursSunday {
...
export function HotelAllOfHappyHoursSundayToJSON(value?: HotelAllOfHappyHoursSunday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
