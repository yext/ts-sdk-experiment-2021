 ...
 * @export
 * @interface EventAllOfImage
 */
export interface EventAllOfImage {
    /**
     * 
     * @type {string}
     * @memberof EventAllOfImage
     */
...
export function EventAllOfImageFromJSON(json: any): EventAllOfImage {
    return EventAllOfImageFromJSONTyped(json, false);
}

export function EventAllOfImageFromJSONTyped(json: any, ignoreDiscriminator: boolean): EventAllOfImage {
...
export function EventAllOfImageToJSON(value?: EventAllOfImage | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
