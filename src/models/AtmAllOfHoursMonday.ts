 ...
 * 
 * @export
 * @interface AtmAllOfHoursMonday
 */
export interface AtmAllOfHoursMonday {
    /**
     * Indicates if the hours of operation are "closed" on Monday.
     * @type {boolean}
     * @memberof AtmAllOfHoursMonday
     */
    isClosed?: boolean;
    /**
...
export function AtmAllOfHoursMondayFromJSON(json: any): AtmAllOfHoursMonday {
    return AtmAllOfHoursMondayFromJSONTyped(json, false);
}

export function AtmAllOfHoursMondayFromJSONTyped(json: any, ignoreDiscriminator: boolean): AtmAllOfHoursMonday {
...
export function AtmAllOfHoursMondayToJSON(value?: AtmAllOfHoursMonday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
