 ...
 * @export
 * @interface InlineResponse200ResponseTakeoutHoursSaturday
 */
export interface InlineResponse200ResponseTakeoutHoursSaturday {
    /**
     * Indicates if the takeout hours are "closed" on Saturday.
     * 
     * Filtering Type: `boolean`
     * @type {boolean}
     * @memberof InlineResponse200ResponseTakeoutHoursSaturday
     */
    isClosed?: boolean;
    /**
...
export function InlineResponse200ResponseTakeoutHoursSaturdayFromJSON(json: any): InlineResponse200ResponseTakeoutHoursSaturday {
    return InlineResponse200ResponseTakeoutHoursSaturdayFromJSONTyped(json, false);
}

export function InlineResponse200ResponseTakeoutHoursSaturdayFromJSONTyped(json: any, ignoreDiscriminator: boolean): InlineResponse200ResponseTakeoutHoursSaturday {
...
export function InlineResponse200ResponseTakeoutHoursSaturdayToJSON(value?: InlineResponse200ResponseTakeoutHoursSaturday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
