...
export interface VerificationAdmin {
     ...
     * @memberof VerificationAdmin
     */
    role?: VerificationAdminRoleEnum;
    /**
...
* @enum {string}
*/
export enum VerificationAdminRoleEnum {
...
export function VerificationAdminFromJSON(json: any): VerificationAdmin {
    return VerificationAdminFromJSONTyped(json, false);
}

export function VerificationAdminFromJSONTyped(json: any, ignoreDiscriminator: boolean): VerificationAdmin {
...
export function VerificationAdminToJSON(value?: VerificationAdmin | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
