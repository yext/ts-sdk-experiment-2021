 ...
 * @export
 * @interface LocationLegacyClosed
 */
export interface LocationLegacyClosed {
    /**
     * Indicates whether the location is closed
     * @type {boolean}
     * @memberof LocationLegacyClosed
     */
    isClosed?: boolean;
}

export function LocationLegacyClosedFromJSON(json: any): LocationLegacyClosed {
    return LocationLegacyClosedFromJSONTyped(json, false);
}

export function LocationLegacyClosedFromJSONTyped(json: any, ignoreDiscriminator: boolean): LocationLegacyClosed {
...
export function LocationLegacyClosedToJSON(value?: LocationLegacyClosed | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
