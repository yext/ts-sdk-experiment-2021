 ...
 * @export
 * @interface EntityDriveThroughHoursMonday
 */
export interface EntityDriveThroughHoursMonday {
    /**
     * Indicates if the drive-through hours are "closed" on Monday.
     * 
     * Filtering Type: `boolean`
     * @type {boolean}
     * @memberof EntityDriveThroughHoursMonday
     */
    isClosed?: boolean;
    /**
...
export function EntityDriveThroughHoursMondayFromJSON(json: any): EntityDriveThroughHoursMonday {
    return EntityDriveThroughHoursMondayFromJSONTyped(json, false);
}

export function EntityDriveThroughHoursMondayFromJSONTyped(json: any, ignoreDiscriminator: boolean): EntityDriveThroughHoursMonday {
...
export function EntityDriveThroughHoursMondayToJSON(value?: EntityDriveThroughHoursMonday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
