...
import {
    LocationAllOfDeliveryHoursFriday,
    LocationAllOfDeliveryHoursFridayFromJSON,
    LocationAllOfDeliveryHoursFridayFromJSONTyped,
    LocationAllOfDeliveryHoursFridayToJSON,
    LocationAllOfDeliveryHoursHolidayHours,
    LocationAllOfDeliveryHoursHolidayHoursFromJSON,
    LocationAllOfDeliveryHoursHolidayHoursFromJSONTyped,
    LocationAllOfDeliveryHoursHolidayHoursToJSON,
    LocationAllOfDeliveryHoursMonday,
    LocationAllOfDeliveryHoursMondayFromJSON,
    LocationAllOfDeliveryHoursMondayFromJSONTyped,
    LocationAllOfDeliveryHoursMondayToJSON,
    LocationAllOfDeliveryHoursSaturday,
    LocationAllOfDeliveryHoursSaturdayFromJSON,
    LocationAllOfDeliveryHoursSaturdayFromJSONTyped,
    LocationAllOfDeliveryHoursSaturdayToJSON,
    LocationAllOfDeliveryHoursSunday,
    LocationAllOfDeliveryHoursSundayFromJSON,
    LocationAllOfDeliveryHoursSundayFromJSONTyped,
    LocationAllOfDeliveryHoursSundayToJSON,
    LocationAllOfDeliveryHoursThursday,
    LocationAllOfDeliveryHoursThursdayFromJSON,
    LocationAllOfDeliveryHoursThursdayFromJSONTyped,
    LocationAllOfDeliveryHoursThursdayToJSON,
    LocationAllOfDeliveryHoursTuesday,
    LocationAllOfDeliveryHoursTuesdayFromJSON,
    LocationAllOfDeliveryHoursTuesdayFromJSONTyped,
    LocationAllOfDeliveryHoursTuesdayToJSON,
    LocationAllOfDeliveryHoursWednesday,
    LocationAllOfDeliveryHoursWednesdayFromJSON,
    LocationAllOfDeliveryHoursWednesdayFromJSONTyped,
    LocationAllOfDeliveryHoursWednesdayToJSON,
} from './';
 ...
 * @export
 * @interface LocationAllOfDeliveryHours
 */
export interface LocationAllOfDeliveryHours {
    /**
     * 
     * @type {LocationAllOfDeliveryHoursFriday}
     * @memberof LocationAllOfDeliveryHours
     */
    friday?: LocationAllOfDeliveryHoursFriday;
    /**
     * 
     ...
     * @type {Set<LocationAllOfDeliveryHoursHolidayHours>}
     * @memberof LocationAllOfDeliveryHours
     */
    holidayHours?: Set<LocationAllOfDeliveryHoursHolidayHours>;
    /**
     * 
     * @type {LocationAllOfDeliveryHoursMonday}
     * @memberof LocationAllOfDeliveryHours
     */
    monday?: LocationAllOfDeliveryHoursMonday;
    /**
     * 
    ...
    /**
     * 
     * @type {LocationAllOfDeliveryHoursSaturday}
     * @memberof LocationAllOfDeliveryHours
     */
    saturday?: LocationAllOfDeliveryHoursSaturday;
    /**
     * 
     * @type {LocationAllOfDeliveryHoursSunday}
     * @memberof LocationAllOfDeliveryHours
     */
    sunday?: LocationAllOfDeliveryHoursSunday;
    /**
     * 
     * @type {LocationAllOfDeliveryHoursThursday}
     * @memberof LocationAllOfDeliveryHours
     */
    thursday?: LocationAllOfDeliveryHoursThursday;
    /**
     * 
     * @type {LocationAllOfDeliveryHoursTuesday}
     * @memberof LocationAllOfDeliveryHours
     */
    tuesday?: LocationAllOfDeliveryHoursTuesday;
    /**
     * 
     * @type {LocationAllOfDeliveryHoursWednesday}
     * @memberof LocationAllOfDeliveryHours
     */
    wednesday?: LocationAllOfDeliveryHoursWednesday;
}

export function LocationAllOfDeliveryHoursFromJSON(json: any): LocationAllOfDeliveryHours {
    return LocationAllOfDeliveryHoursFromJSONTyped(json, false);
}

export function LocationAllOfDeliveryHoursFromJSONTyped(json: any, ignoreDiscriminator: boolean): LocationAllOfDeliveryHours {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'friday': !exists(json, 'friday') ? undefined : LocationAllOfDeliveryHoursFridayFromJSON(json['friday']),
        'holidayHours': !exists(json, 'holidayHours') ? undefined : (new Set((json['holidayHours'] as Array<any>).map(LocationAllOfDeliveryHoursHolidayHoursFromJSON))),
        'monday': !exists(json, 'monday') ? undefined : LocationAllOfDeliveryHoursMondayFromJSON(json['monday']),
        'reopenDate': !exists(json, 'reopenDate') ? undefined : (new Date(json['reopenDate'])),
        'saturday': !exists(json, 'saturday') ? undefined : LocationAllOfDeliveryHoursSaturdayFromJSON(json['saturday']),
        'sunday': !exists(json, 'sunday') ? undefined : LocationAllOfDeliveryHoursSundayFromJSON(json['sunday']),
        'thursday': !exists(json, 'thursday') ? undefined : LocationAllOfDeliveryHoursThursdayFromJSON(json['thursday']),
        'tuesday': !exists(json, 'tuesday') ? undefined : LocationAllOfDeliveryHoursTuesdayFromJSON(json['tuesday']),
        'wednesday': !exists(json, 'wednesday') ? undefined : LocationAllOfDeliveryHoursWednesdayFromJSON(json['wednesday']),
    };
}

export function LocationAllOfDeliveryHoursToJSON(value?: LocationAllOfDeliveryHours | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'friday': LocationAllOfDeliveryHoursFridayToJSON(value.friday),
        'holidayHours': value.holidayHours === undefined ? undefined : (Array.from(value.holidayHours as Set<any>).map(LocationAllOfDeliveryHoursHolidayHoursToJSON)),
        'monday': LocationAllOfDeliveryHoursMondayToJSON(value.monday),
        'reopenDate': value.reopenDate === undefined ? undefined : (value.reopenDate.toISOString().substr(0,10)),
        'saturday': LocationAllOfDeliveryHoursSaturdayToJSON(value.saturday),
        'sunday': LocationAllOfDeliveryHoursSundayToJSON(value.sunday),
        'thursday': LocationAllOfDeliveryHoursThursdayToJSON(value.thursday),
        'tuesday': LocationAllOfDeliveryHoursTuesdayToJSON(value.tuesday),
        'wednesday': LocationAllOfDeliveryHoursWednesdayToJSON(value.wednesday),
    };
}
