...
import {
    EntityBrunchHoursFriday,
    EntityBrunchHoursFridayFromJSON,
    EntityBrunchHoursFridayFromJSONTyped,
    EntityBrunchHoursFridayToJSON,
    EntityBrunchHoursHolidayHours,
    EntityBrunchHoursHolidayHoursFromJSON,
    EntityBrunchHoursHolidayHoursFromJSONTyped,
    EntityBrunchHoursHolidayHoursToJSON,
    EntityBrunchHoursMonday,
    EntityBrunchHoursMondayFromJSON,
    EntityBrunchHoursMondayFromJSONTyped,
    EntityBrunchHoursMondayToJSON,
    EntityBrunchHoursSaturday,
    EntityBrunchHoursSaturdayFromJSON,
    EntityBrunchHoursSaturdayFromJSONTyped,
    EntityBrunchHoursSaturdayToJSON,
    EntityBrunchHoursSunday,
    EntityBrunchHoursSundayFromJSON,
    EntityBrunchHoursSundayFromJSONTyped,
    EntityBrunchHoursSundayToJSON,
    EntityBrunchHoursThursday,
    EntityBrunchHoursThursdayFromJSON,
    EntityBrunchHoursThursdayFromJSONTyped,
    EntityBrunchHoursThursdayToJSON,
    EntityBrunchHoursTuesday,
    EntityBrunchHoursTuesdayFromJSON,
    EntityBrunchHoursTuesdayFromJSONTyped,
    EntityBrunchHoursTuesdayToJSON,
    EntityBrunchHoursWednesday,
    EntityBrunchHoursWednesdayFromJSON,
    EntityBrunchHoursWednesdayFromJSONTyped,
    EntityBrunchHoursWednesdayToJSON,
} from './';
 ...
 * ```
 * @export
 * @interface EntityBrunchHours
 */
export interface EntityBrunchHours {
    /**
     * 
     * @type {EntityBrunchHoursFriday}
     * @memberof EntityBrunchHours
     */
    friday?: EntityBrunchHoursFriday;
    /**
     * 
     ...
     * @type {Set<EntityBrunchHoursHolidayHours>}
     * @memberof EntityBrunchHours
     */
    holidayHours?: Set<EntityBrunchHoursHolidayHours>;
    /**
     * 
     * @type {EntityBrunchHoursMonday}
     * @memberof EntityBrunchHours
     */
    monday?: EntityBrunchHoursMonday;
    /**
     * 
    ...
    /**
     * 
     * @type {EntityBrunchHoursSaturday}
     * @memberof EntityBrunchHours
     */
    saturday?: EntityBrunchHoursSaturday;
    /**
     * 
     * @type {EntityBrunchHoursSunday}
     * @memberof EntityBrunchHours
     */
    sunday?: EntityBrunchHoursSunday;
    /**
     * 
     * @type {EntityBrunchHoursThursday}
     * @memberof EntityBrunchHours
     */
    thursday?: EntityBrunchHoursThursday;
    /**
     * 
     * @type {EntityBrunchHoursTuesday}
     * @memberof EntityBrunchHours
     */
    tuesday?: EntityBrunchHoursTuesday;
    /**
     * 
     * @type {EntityBrunchHoursWednesday}
     * @memberof EntityBrunchHours
     */
    wednesday?: EntityBrunchHoursWednesday;
}

export function EntityBrunchHoursFromJSON(json: any): EntityBrunchHours {
    return EntityBrunchHoursFromJSONTyped(json, false);
}

export function EntityBrunchHoursFromJSONTyped(json: any, ignoreDiscriminator: boolean): EntityBrunchHours {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'friday': !exists(json, 'friday') ? undefined : EntityBrunchHoursFridayFromJSON(json['friday']),
        'holidayHours': !exists(json, 'holidayHours') ? undefined : (new Set((json['holidayHours'] as Array<any>).map(EntityBrunchHoursHolidayHoursFromJSON))),
        'monday': !exists(json, 'monday') ? undefined : EntityBrunchHoursMondayFromJSON(json['monday']),
        'reopenDate': !exists(json, 'reopenDate') ? undefined : (new Date(json['reopenDate'])),
        'saturday': !exists(json, 'saturday') ? undefined : EntityBrunchHoursSaturdayFromJSON(json['saturday']),
        'sunday': !exists(json, 'sunday') ? undefined : EntityBrunchHoursSundayFromJSON(json['sunday']),
        'thursday': !exists(json, 'thursday') ? undefined : EntityBrunchHoursThursdayFromJSON(json['thursday']),
        'tuesday': !exists(json, 'tuesday') ? undefined : EntityBrunchHoursTuesdayFromJSON(json['tuesday']),
        'wednesday': !exists(json, 'wednesday') ? undefined : EntityBrunchHoursWednesdayFromJSON(json['wednesday']),
    };
}

export function EntityBrunchHoursToJSON(value?: EntityBrunchHours | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'friday': EntityBrunchHoursFridayToJSON(value.friday),
        'holidayHours': value.holidayHours === undefined ? undefined : (Array.from(value.holidayHours as Set<any>).map(EntityBrunchHoursHolidayHoursToJSON)),
        'monday': EntityBrunchHoursMondayToJSON(value.monday),
        'reopenDate': value.reopenDate === undefined ? undefined : (value.reopenDate.toISOString().substr(0,10)),
        'saturday': EntityBrunchHoursSaturdayToJSON(value.saturday),
        'sunday': EntityBrunchHoursSundayToJSON(value.sunday),
        'thursday': EntityBrunchHoursThursdayToJSON(value.thursday),
        'tuesday': EntityBrunchHoursTuesdayToJSON(value.tuesday),
        'wednesday': EntityBrunchHoursWednesdayToJSON(value.wednesday),
    };
}
