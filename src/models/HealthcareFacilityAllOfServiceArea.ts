 ...
 * @export
 * @interface HealthcareFacilityAllOfServiceArea
 */
export interface HealthcareFacilityAllOfServiceArea {
    /**
     ...
     * @type {Set<string>}
     * @memberof HealthcareFacilityAllOfServiceArea
     */
    places?: Set<string>;
}

export function HealthcareFacilityAllOfServiceAreaFromJSON(json: any): HealthcareFacilityAllOfServiceArea {
    return HealthcareFacilityAllOfServiceAreaFromJSONTyped(json, false);
}

export function HealthcareFacilityAllOfServiceAreaFromJSONTyped(json: any, ignoreDiscriminator: boolean): HealthcareFacilityAllOfServiceArea {
...
export function HealthcareFacilityAllOfServiceAreaToJSON(value?: HealthcareFacilityAllOfServiceArea | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
