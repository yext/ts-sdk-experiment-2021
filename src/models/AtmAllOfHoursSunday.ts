 ...
 * 
 * @export
 * @interface AtmAllOfHoursSunday
 */
export interface AtmAllOfHoursSunday {
    /**
     * Indicates if the hours of operation are "closed" on Sunday.
     * @type {boolean}
     * @memberof AtmAllOfHoursSunday
     */
    isClosed?: boolean;
    /**
...
export function AtmAllOfHoursSundayFromJSON(json: any): AtmAllOfHoursSunday {
    return AtmAllOfHoursSundayFromJSONTyped(json, false);
}

export function AtmAllOfHoursSundayFromJSONTyped(json: any, ignoreDiscriminator: boolean): AtmAllOfHoursSunday {
...
export function AtmAllOfHoursSundayToJSON(value?: AtmAllOfHoursSunday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
