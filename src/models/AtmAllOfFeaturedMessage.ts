 ...
 * @export
 * @interface AtmAllOfFeaturedMessage
 */
export interface AtmAllOfFeaturedMessage {
    /**
     ...
     * * HTML markup
     * @type {string}
     * @memberof AtmAllOfFeaturedMessage
     */
    description?: string;
    /**
...
export function AtmAllOfFeaturedMessageFromJSON(json: any): AtmAllOfFeaturedMessage {
    return AtmAllOfFeaturedMessageFromJSONTyped(json, false);
}

export function AtmAllOfFeaturedMessageFromJSONTyped(json: any, ignoreDiscriminator: boolean): AtmAllOfFeaturedMessage {
...
export function AtmAllOfFeaturedMessageToJSON(value?: AtmAllOfFeaturedMessage | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
