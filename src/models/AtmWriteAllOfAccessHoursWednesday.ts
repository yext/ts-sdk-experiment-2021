 ...
 * 
 * @export
 * @interface AtmWriteAllOfAccessHoursWednesday
 */
export interface AtmWriteAllOfAccessHoursWednesday {
    /**
     * Indicates if the access hours are "closed" on Wednesday.
     * @type {boolean}
     * @memberof AtmWriteAllOfAccessHoursWednesday
     */
    isClosed?: boolean;
    /**
...
export function AtmWriteAllOfAccessHoursWednesdayFromJSON(json: any): AtmWriteAllOfAccessHoursWednesday {
    return AtmWriteAllOfAccessHoursWednesdayFromJSONTyped(json, false);
}

export function AtmWriteAllOfAccessHoursWednesdayFromJSONTyped(json: any, ignoreDiscriminator: boolean): AtmWriteAllOfAccessHoursWednesday {
...
export function AtmWriteAllOfAccessHoursWednesdayToJSON(value?: AtmWriteAllOfAccessHoursWednesday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
