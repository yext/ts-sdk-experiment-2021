 ...
 * @export
 * @interface EntityKitchenHoursMonday
 */
export interface EntityKitchenHoursMonday {
    /**
     * Indicates if the kitchen hours are "closed" on Monday.
     * 
     * Filtering Type: `boolean`
     * @type {boolean}
     * @memberof EntityKitchenHoursMonday
     */
    isClosed?: boolean;
    /**
...
export function EntityKitchenHoursMondayFromJSON(json: any): EntityKitchenHoursMonday {
    return EntityKitchenHoursMondayFromJSONTyped(json, false);
}

export function EntityKitchenHoursMondayFromJSONTyped(json: any, ignoreDiscriminator: boolean): EntityKitchenHoursMonday {
...
export function EntityKitchenHoursMondayToJSON(value?: EntityKitchenHoursMonday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
