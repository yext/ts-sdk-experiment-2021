 ...
 * @export
 * @interface InlineResponse200ResponseOnlineServiceHoursHolidayHours
 */
export interface InlineResponse200ResponseOnlineServiceHoursHolidayHours {
    /**
     ...
     * Filtering Type: `date`
     * @type {Date}
     * @memberof InlineResponse200ResponseOnlineServiceHoursHolidayHours
     */
    date: Date;
    /**
...
export function InlineResponse200ResponseOnlineServiceHoursHolidayHoursFromJSON(json: any): InlineResponse200ResponseOnlineServiceHoursHolidayHours {
    return InlineResponse200ResponseOnlineServiceHoursHolidayHoursFromJSONTyped(json, false);
}

export function InlineResponse200ResponseOnlineServiceHoursHolidayHoursFromJSONTyped(json: any, ignoreDiscriminator: boolean): InlineResponse200ResponseOnlineServiceHoursHolidayHours {
...
export function InlineResponse200ResponseOnlineServiceHoursHolidayHoursToJSON(value?: InlineResponse200ResponseOnlineServiceHoursHolidayHours | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
