 ...
 * 
 * @export
 * @interface HotelAllOfBrunchHoursTuesday
 */
export interface HotelAllOfBrunchHoursTuesday {
    /**
     * Indicates if the brunch hours are "closed" on Tuesday.
     * @type {boolean}
     * @memberof HotelAllOfBrunchHoursTuesday
     */
    isClosed?: boolean;
    /**
...
export function HotelAllOfBrunchHoursTuesdayFromJSON(json: any): HotelAllOfBrunchHoursTuesday {
    return HotelAllOfBrunchHoursTuesdayFromJSONTyped(json, false);
}

export function HotelAllOfBrunchHoursTuesdayFromJSONTyped(json: any, ignoreDiscriminator: boolean): HotelAllOfBrunchHoursTuesday {
...
export function HotelAllOfBrunchHoursTuesdayToJSON(value?: HotelAllOfBrunchHoursTuesday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
