...
import {
    EntityKitchenHoursFriday,
    EntityKitchenHoursFridayFromJSON,
    EntityKitchenHoursFridayFromJSONTyped,
    EntityKitchenHoursFridayToJSON,
    EntityKitchenHoursHolidayHours,
    EntityKitchenHoursHolidayHoursFromJSON,
    EntityKitchenHoursHolidayHoursFromJSONTyped,
    EntityKitchenHoursHolidayHoursToJSON,
    EntityKitchenHoursMonday,
    EntityKitchenHoursMondayFromJSON,
    EntityKitchenHoursMondayFromJSONTyped,
    EntityKitchenHoursMondayToJSON,
    EntityKitchenHoursSaturday,
    EntityKitchenHoursSaturdayFromJSON,
    EntityKitchenHoursSaturdayFromJSONTyped,
    EntityKitchenHoursSaturdayToJSON,
    EntityKitchenHoursSunday,
    EntityKitchenHoursSundayFromJSON,
    EntityKitchenHoursSundayFromJSONTyped,
    EntityKitchenHoursSundayToJSON,
    EntityKitchenHoursThursday,
    EntityKitchenHoursThursdayFromJSON,
    EntityKitchenHoursThursdayFromJSONTyped,
    EntityKitchenHoursThursdayToJSON,
    EntityKitchenHoursTuesday,
    EntityKitchenHoursTuesdayFromJSON,
    EntityKitchenHoursTuesdayFromJSONTyped,
    EntityKitchenHoursTuesdayToJSON,
    EntityKitchenHoursWednesday,
    EntityKitchenHoursWednesdayFromJSON,
    EntityKitchenHoursWednesdayFromJSONTyped,
    EntityKitchenHoursWednesdayToJSON,
} from './';
 ...
 * ```
 * @export
 * @interface EntityKitchenHours
 */
export interface EntityKitchenHours {
    /**
     * 
     * @type {EntityKitchenHoursFriday}
     * @memberof EntityKitchenHours
     */
    friday?: EntityKitchenHoursFriday;
    /**
     * 
     ...
     * @type {Set<EntityKitchenHoursHolidayHours>}
     * @memberof EntityKitchenHours
     */
    holidayHours?: Set<EntityKitchenHoursHolidayHours>;
    /**
     * 
     * @type {EntityKitchenHoursMonday}
     * @memberof EntityKitchenHours
     */
    monday?: EntityKitchenHoursMonday;
    /**
     * 
    ...
    /**
     * 
     * @type {EntityKitchenHoursSaturday}
     * @memberof EntityKitchenHours
     */
    saturday?: EntityKitchenHoursSaturday;
    /**
     * 
     * @type {EntityKitchenHoursSunday}
     * @memberof EntityKitchenHours
     */
    sunday?: EntityKitchenHoursSunday;
    /**
     * 
     * @type {EntityKitchenHoursThursday}
     * @memberof EntityKitchenHours
     */
    thursday?: EntityKitchenHoursThursday;
    /**
     * 
     * @type {EntityKitchenHoursTuesday}
     * @memberof EntityKitchenHours
     */
    tuesday?: EntityKitchenHoursTuesday;
    /**
     * 
     * @type {EntityKitchenHoursWednesday}
     * @memberof EntityKitchenHours
     */
    wednesday?: EntityKitchenHoursWednesday;
}

export function EntityKitchenHoursFromJSON(json: any): EntityKitchenHours {
    return EntityKitchenHoursFromJSONTyped(json, false);
}

export function EntityKitchenHoursFromJSONTyped(json: any, ignoreDiscriminator: boolean): EntityKitchenHours {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'friday': !exists(json, 'friday') ? undefined : EntityKitchenHoursFridayFromJSON(json['friday']),
        'holidayHours': !exists(json, 'holidayHours') ? undefined : (new Set((json['holidayHours'] as Array<any>).map(EntityKitchenHoursHolidayHoursFromJSON))),
        'monday': !exists(json, 'monday') ? undefined : EntityKitchenHoursMondayFromJSON(json['monday']),
        'reopenDate': !exists(json, 'reopenDate') ? undefined : (new Date(json['reopenDate'])),
        'saturday': !exists(json, 'saturday') ? undefined : EntityKitchenHoursSaturdayFromJSON(json['saturday']),
        'sunday': !exists(json, 'sunday') ? undefined : EntityKitchenHoursSundayFromJSON(json['sunday']),
        'thursday': !exists(json, 'thursday') ? undefined : EntityKitchenHoursThursdayFromJSON(json['thursday']),
        'tuesday': !exists(json, 'tuesday') ? undefined : EntityKitchenHoursTuesdayFromJSON(json['tuesday']),
        'wednesday': !exists(json, 'wednesday') ? undefined : EntityKitchenHoursWednesdayFromJSON(json['wednesday']),
    };
}

export function EntityKitchenHoursToJSON(value?: EntityKitchenHours | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'friday': EntityKitchenHoursFridayToJSON(value.friday),
        'holidayHours': value.holidayHours === undefined ? undefined : (Array.from(value.holidayHours as Set<any>).map(EntityKitchenHoursHolidayHoursToJSON)),
        'monday': EntityKitchenHoursMondayToJSON(value.monday),
        'reopenDate': value.reopenDate === undefined ? undefined : (value.reopenDate.toISOString().substr(0,10)),
        'saturday': EntityKitchenHoursSaturdayToJSON(value.saturday),
        'sunday': EntityKitchenHoursSundayToJSON(value.sunday),
        'thursday': EntityKitchenHoursThursdayToJSON(value.thursday),
        'tuesday': EntityKitchenHoursTuesdayToJSON(value.tuesday),
        'wednesday': EntityKitchenHoursWednesdayToJSON(value.wednesday),
    };
}
