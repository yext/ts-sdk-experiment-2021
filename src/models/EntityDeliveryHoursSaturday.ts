 ...
 * @export
 * @interface EntityDeliveryHoursSaturday
 */
export interface EntityDeliveryHoursSaturday {
    /**
     * Indicates if the delivery hours are "closed" on Saturday.
     * 
     * Filtering Type: `boolean`
     * @type {boolean}
     * @memberof EntityDeliveryHoursSaturday
     */
    isClosed?: boolean;
    /**
...
export function EntityDeliveryHoursSaturdayFromJSON(json: any): EntityDeliveryHoursSaturday {
    return EntityDeliveryHoursSaturdayFromJSONTyped(json, false);
}

export function EntityDeliveryHoursSaturdayFromJSONTyped(json: any, ignoreDiscriminator: boolean): EntityDeliveryHoursSaturday {
...
export function EntityDeliveryHoursSaturdayToJSON(value?: EntityDeliveryHoursSaturday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
