 ...
 * 
 * @export
 * @interface AtmAllOfHoursWednesday
 */
export interface AtmAllOfHoursWednesday {
    /**
     * Indicates if the hours of operation are "closed" on Wednesday.
     * @type {boolean}
     * @memberof AtmAllOfHoursWednesday
     */
    isClosed?: boolean;
    /**
...
export function AtmAllOfHoursWednesdayFromJSON(json: any): AtmAllOfHoursWednesday {
    return AtmAllOfHoursWednesdayFromJSONTyped(json, false);
}

export function AtmAllOfHoursWednesdayFromJSONTyped(json: any, ignoreDiscriminator: boolean): AtmAllOfHoursWednesday {
...
export function AtmAllOfHoursWednesdayToJSON(value?: AtmAllOfHoursWednesday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
