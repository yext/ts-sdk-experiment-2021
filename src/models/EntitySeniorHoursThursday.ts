 ...
 * @export
 * @interface EntitySeniorHoursThursday
 */
export interface EntitySeniorHoursThursday {
    /**
     * Indicates if the senior hours are "closed" on Thursday.
     * 
     * Filtering Type: `boolean`
     * @type {boolean}
     * @memberof EntitySeniorHoursThursday
     */
    isClosed?: boolean;
    /**
...
export function EntitySeniorHoursThursdayFromJSON(json: any): EntitySeniorHoursThursday {
    return EntitySeniorHoursThursdayFromJSONTyped(json, false);
}

export function EntitySeniorHoursThursdayFromJSONTyped(json: any, ignoreDiscriminator: boolean): EntitySeniorHoursThursday {
...
export function EntitySeniorHoursThursdayToJSON(value?: EntitySeniorHoursThursday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
