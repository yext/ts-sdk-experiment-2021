 ...
 * ```
 * @export
 * @interface EntityDisplayCoordinate
 */
export interface EntityDisplayCoordinate {
    /**
     * Filtering Type: `float`
     * @type {number}
     * @memberof EntityDisplayCoordinate
     */
    latitude?: number;
    /**
     * Filtering Type: `float`
...
export function EntityDisplayCoordinateFromJSON(json: any): EntityDisplayCoordinate {
    return EntityDisplayCoordinateFromJSONTyped(json, false);
}

export function EntityDisplayCoordinateFromJSONTyped(json: any, ignoreDiscriminator: boolean): EntityDisplayCoordinate {
...
export function EntityDisplayCoordinateToJSON(value?: EntityDisplayCoordinate | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
