 ...
 * @export
 * @interface InlineResponse200ResponseHappyHoursHolidayHours
 */
export interface InlineResponse200ResponseHappyHoursHolidayHours {
    /**
     ...
     * Filtering Type: `date`
     * @type {Date}
     * @memberof InlineResponse200ResponseHappyHoursHolidayHours
     */
    date: Date;
    /**
...
export function InlineResponse200ResponseHappyHoursHolidayHoursFromJSON(json: any): InlineResponse200ResponseHappyHoursHolidayHours {
    return InlineResponse200ResponseHappyHoursHolidayHoursFromJSONTyped(json, false);
}

export function InlineResponse200ResponseHappyHoursHolidayHoursFromJSONTyped(json: any, ignoreDiscriminator: boolean): InlineResponse200ResponseHappyHoursHolidayHours {
...
export function InlineResponse200ResponseHappyHoursHolidayHoursToJSON(value?: InlineResponse200ResponseHappyHoursHolidayHours | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
