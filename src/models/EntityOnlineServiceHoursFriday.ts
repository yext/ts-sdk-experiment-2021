 ...
 * @export
 * @interface EntityOnlineServiceHoursFriday
 */
export interface EntityOnlineServiceHoursFriday {
    /**
     * Indicates if the online service hours are "closed" on Friday.
     * 
     * Filtering Type: `boolean`
     * @type {boolean}
     * @memberof EntityOnlineServiceHoursFriday
     */
    isClosed?: boolean;
    /**
...
export function EntityOnlineServiceHoursFridayFromJSON(json: any): EntityOnlineServiceHoursFriday {
    return EntityOnlineServiceHoursFridayFromJSONTyped(json, false);
}

export function EntityOnlineServiceHoursFridayFromJSONTyped(json: any, ignoreDiscriminator: boolean): EntityOnlineServiceHoursFriday {
...
export function EntityOnlineServiceHoursFridayToJSON(value?: EntityOnlineServiceHoursFriday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
