 ...
 * 
 * @export
 * @interface BioSectionAllOf
 */
export interface BioSectionAllOf {
    /**
     * Section Items.
     * @type {Array<BioItem>}
     * @memberof BioSectionAllOf
     */
    items?: Array<BioItem>;
}

export function BioSectionAllOfFromJSON(json: any): BioSectionAllOf {
    return BioSectionAllOfFromJSONTyped(json, false);
}

export function BioSectionAllOfFromJSONTyped(json: any, ignoreDiscriminator: boolean): BioSectionAllOf {
...
export function BioSectionAllOfToJSON(value?: BioSectionAllOf | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
