 ...
 * @export
 * @interface InlineResponse200ResponseSeniorHoursHolidayHours
 */
export interface InlineResponse200ResponseSeniorHoursHolidayHours {
    /**
     ...
     * Filtering Type: `date`
     * @type {Date}
     * @memberof InlineResponse200ResponseSeniorHoursHolidayHours
     */
    date: Date;
    /**
...
export function InlineResponse200ResponseSeniorHoursHolidayHoursFromJSON(json: any): InlineResponse200ResponseSeniorHoursHolidayHours {
    return InlineResponse200ResponseSeniorHoursHolidayHoursFromJSONTyped(json, false);
}

export function InlineResponse200ResponseSeniorHoursHolidayHoursFromJSONTyped(json: any, ignoreDiscriminator: boolean): InlineResponse200ResponseSeniorHoursHolidayHours {
...
export function InlineResponse200ResponseSeniorHoursHolidayHoursToJSON(value?: InlineResponse200ResponseSeniorHoursHolidayHours | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
