...
import {
    ...
    EntityWriteToJSON,
    JobWriteAllOf,
    JobWriteAllOfFromJSON,
    JobWriteAllOfFromJSONTyped,
    JobWriteAllOfToJSON,
 ...
 * @interface JobWrite
 */
export interface JobWrite extends EntityWrite {
    /**
     * 
     ...
     * @memberof JobWrite
     */
    employmentType?: JobWriteEmploymentTypeEnum;
    /**
...
* @enum {string}
*/
export enum JobWriteEmploymentTypeEnum {
    FullTime = 'FULL_TIME',
    PartTime = 'PART_TIME',
...
export function JobWriteToJSON(value?: JobWrite | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
