...
import {
    EntityDriveThroughHoursFriday,
    EntityDriveThroughHoursFridayFromJSON,
    EntityDriveThroughHoursFridayFromJSONTyped,
    EntityDriveThroughHoursFridayToJSON,
    EntityDriveThroughHoursHolidayHours,
    EntityDriveThroughHoursHolidayHoursFromJSON,
    EntityDriveThroughHoursHolidayHoursFromJSONTyped,
    EntityDriveThroughHoursHolidayHoursToJSON,
    EntityDriveThroughHoursMonday,
    EntityDriveThroughHoursMondayFromJSON,
    EntityDriveThroughHoursMondayFromJSONTyped,
    EntityDriveThroughHoursMondayToJSON,
    EntityDriveThroughHoursSaturday,
    EntityDriveThroughHoursSaturdayFromJSON,
    EntityDriveThroughHoursSaturdayFromJSONTyped,
    EntityDriveThroughHoursSaturdayToJSON,
    EntityDriveThroughHoursSunday,
    EntityDriveThroughHoursSundayFromJSON,
    EntityDriveThroughHoursSundayFromJSONTyped,
    EntityDriveThroughHoursSundayToJSON,
    EntityDriveThroughHoursThursday,
    EntityDriveThroughHoursThursdayFromJSON,
    EntityDriveThroughHoursThursdayFromJSONTyped,
    EntityDriveThroughHoursThursdayToJSON,
    EntityDriveThroughHoursTuesday,
    EntityDriveThroughHoursTuesdayFromJSON,
    EntityDriveThroughHoursTuesdayFromJSONTyped,
    EntityDriveThroughHoursTuesdayToJSON,
    EntityDriveThroughHoursWednesday,
    EntityDriveThroughHoursWednesdayFromJSON,
    EntityDriveThroughHoursWednesdayFromJSONTyped,
    EntityDriveThroughHoursWednesdayToJSON,
} from './';
 ...
 * ```
 * @export
 * @interface EntityDriveThroughHours
 */
export interface EntityDriveThroughHours {
    /**
     * 
     * @type {EntityDriveThroughHoursFriday}
     * @memberof EntityDriveThroughHours
     */
    friday?: EntityDriveThroughHoursFriday;
    /**
     * 
     ...
     * @type {Set<EntityDriveThroughHoursHolidayHours>}
     * @memberof EntityDriveThroughHours
     */
    holidayHours?: Set<EntityDriveThroughHoursHolidayHours>;
    /**
     * 
     * @type {EntityDriveThroughHoursMonday}
     * @memberof EntityDriveThroughHours
     */
    monday?: EntityDriveThroughHoursMonday;
    /**
     * 
    ...
    /**
     * 
     * @type {EntityDriveThroughHoursSaturday}
     * @memberof EntityDriveThroughHours
     */
    saturday?: EntityDriveThroughHoursSaturday;
    /**
     * 
     * @type {EntityDriveThroughHoursSunday}
     * @memberof EntityDriveThroughHours
     */
    sunday?: EntityDriveThroughHoursSunday;
    /**
     * 
     * @type {EntityDriveThroughHoursThursday}
     * @memberof EntityDriveThroughHours
     */
    thursday?: EntityDriveThroughHoursThursday;
    /**
     * 
     * @type {EntityDriveThroughHoursTuesday}
     * @memberof EntityDriveThroughHours
     */
    tuesday?: EntityDriveThroughHoursTuesday;
    /**
     * 
     * @type {EntityDriveThroughHoursWednesday}
     * @memberof EntityDriveThroughHours
     */
    wednesday?: EntityDriveThroughHoursWednesday;
}

export function EntityDriveThroughHoursFromJSON(json: any): EntityDriveThroughHours {
    return EntityDriveThroughHoursFromJSONTyped(json, false);
}

export function EntityDriveThroughHoursFromJSONTyped(json: any, ignoreDiscriminator: boolean): EntityDriveThroughHours {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'friday': !exists(json, 'friday') ? undefined : EntityDriveThroughHoursFridayFromJSON(json['friday']),
        'holidayHours': !exists(json, 'holidayHours') ? undefined : (new Set((json['holidayHours'] as Array<any>).map(EntityDriveThroughHoursHolidayHoursFromJSON))),
        'monday': !exists(json, 'monday') ? undefined : EntityDriveThroughHoursMondayFromJSON(json['monday']),
        'reopenDate': !exists(json, 'reopenDate') ? undefined : (new Date(json['reopenDate'])),
        'saturday': !exists(json, 'saturday') ? undefined : EntityDriveThroughHoursSaturdayFromJSON(json['saturday']),
        'sunday': !exists(json, 'sunday') ? undefined : EntityDriveThroughHoursSundayFromJSON(json['sunday']),
        'thursday': !exists(json, 'thursday') ? undefined : EntityDriveThroughHoursThursdayFromJSON(json['thursday']),
        'tuesday': !exists(json, 'tuesday') ? undefined : EntityDriveThroughHoursTuesdayFromJSON(json['tuesday']),
        'wednesday': !exists(json, 'wednesday') ? undefined : EntityDriveThroughHoursWednesdayFromJSON(json['wednesday']),
    };
}

export function EntityDriveThroughHoursToJSON(value?: EntityDriveThroughHours | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'friday': EntityDriveThroughHoursFridayToJSON(value.friday),
        'holidayHours': value.holidayHours === undefined ? undefined : (Array.from(value.holidayHours as Set<any>).map(EntityDriveThroughHoursHolidayHoursToJSON)),
        'monday': EntityDriveThroughHoursMondayToJSON(value.monday),
        'reopenDate': value.reopenDate === undefined ? undefined : (value.reopenDate.toISOString().substr(0,10)),
        'saturday': EntityDriveThroughHoursSaturdayToJSON(value.saturday),
        'sunday': EntityDriveThroughHoursSundayToJSON(value.sunday),
        'thursday': EntityDriveThroughHoursThursdayToJSON(value.thursday),
        'tuesday': EntityDriveThroughHoursTuesdayToJSON(value.tuesday),
        'wednesday': EntityDriveThroughHoursWednesdayToJSON(value.wednesday),
    };
}
