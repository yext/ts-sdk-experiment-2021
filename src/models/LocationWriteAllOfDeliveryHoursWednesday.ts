 ...
 * 
 * @export
 * @interface LocationWriteAllOfDeliveryHoursWednesday
 */
export interface LocationWriteAllOfDeliveryHoursWednesday {
    /**
     * Indicates if the delivery hours are "closed" on Wednesday.
     * @type {boolean}
     * @memberof LocationWriteAllOfDeliveryHoursWednesday
     */
    isClosed?: boolean;
    /**
...
export function LocationWriteAllOfDeliveryHoursWednesdayFromJSON(json: any): LocationWriteAllOfDeliveryHoursWednesday {
    return LocationWriteAllOfDeliveryHoursWednesdayFromJSONTyped(json, false);
}

export function LocationWriteAllOfDeliveryHoursWednesdayFromJSONTyped(json: any, ignoreDiscriminator: boolean): LocationWriteAllOfDeliveryHoursWednesday {
...
export function LocationWriteAllOfDeliveryHoursWednesdayToJSON(value?: LocationWriteAllOfDeliveryHoursWednesday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
