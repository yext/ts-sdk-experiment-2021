 ...
 * ```
 * @export
 * @interface EntityServiceArea
 */
export interface EntityServiceArea {
    /**
     ...
     * @type {Set<string>}
     * @memberof EntityServiceArea
     */
    places?: Set<string>;
}

export function EntityServiceAreaFromJSON(json: any): EntityServiceArea {
    return EntityServiceAreaFromJSONTyped(json, false);
}

export function EntityServiceAreaFromJSONTyped(json: any, ignoreDiscriminator: boolean): EntityServiceArea {
...
export function EntityServiceAreaToJSON(value?: EntityServiceArea | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
