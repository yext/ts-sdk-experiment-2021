 ...
 * 
 * @export
 * @interface LocationAllOfDeliveryHoursTuesday
 */
export interface LocationAllOfDeliveryHoursTuesday {
    /**
     * Indicates if the delivery hours are "closed" on Tuesday.
     * @type {boolean}
     * @memberof LocationAllOfDeliveryHoursTuesday
     */
    isClosed?: boolean;
    /**
...
export function LocationAllOfDeliveryHoursTuesdayFromJSON(json: any): LocationAllOfDeliveryHoursTuesday {
    return LocationAllOfDeliveryHoursTuesdayFromJSONTyped(json, false);
}

export function LocationAllOfDeliveryHoursTuesdayFromJSONTyped(json: any, ignoreDiscriminator: boolean): LocationAllOfDeliveryHoursTuesday {
...
export function LocationAllOfDeliveryHoursTuesdayToJSON(value?: LocationAllOfDeliveryHoursTuesday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
