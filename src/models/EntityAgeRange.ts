...
export function EntityAgeRangeFromJSON(json: any): EntityAgeRange {
    return EntityAgeRangeFromJSONTyped(json, false);
}

export function EntityAgeRangeFromJSONTyped(json: any, ignoreDiscriminator: boolean): EntityAgeRange {
...
export function EntityAgeRangeToJSON(value?: EntityAgeRange | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
