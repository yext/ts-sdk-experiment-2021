 ...
 * @export
 * @interface InlineResponse200ResponseDriveThroughHoursTuesday
 */
export interface InlineResponse200ResponseDriveThroughHoursTuesday {
    /**
     * Indicates if the drive-through hours are "closed" on Tuesday.
     * 
     * Filtering Type: `boolean`
     * @type {boolean}
     * @memberof InlineResponse200ResponseDriveThroughHoursTuesday
     */
    isClosed?: boolean;
    /**
...
export function InlineResponse200ResponseDriveThroughHoursTuesdayFromJSON(json: any): InlineResponse200ResponseDriveThroughHoursTuesday {
    return InlineResponse200ResponseDriveThroughHoursTuesdayFromJSONTyped(json, false);
}

export function InlineResponse200ResponseDriveThroughHoursTuesdayFromJSONTyped(json: any, ignoreDiscriminator: boolean): InlineResponse200ResponseDriveThroughHoursTuesday {
...
export function InlineResponse200ResponseDriveThroughHoursTuesdayToJSON(value?: InlineResponse200ResponseDriveThroughHoursTuesday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
