 ...
 * @export
 * @interface EntityAccessHoursSunday
 */
export interface EntityAccessHoursSunday {
    /**
     * Indicates if the access hours are "closed" on Sunday.
     * 
     * Filtering Type: `boolean`
     * @type {boolean}
     * @memberof EntityAccessHoursSunday
     */
    isClosed?: boolean;
    /**
...
export function EntityAccessHoursSundayFromJSON(json: any): EntityAccessHoursSunday {
    return EntityAccessHoursSundayFromJSONTyped(json, false);
}

export function EntityAccessHoursSundayFromJSONTyped(json: any, ignoreDiscriminator: boolean): EntityAccessHoursSunday {
...
export function EntityAccessHoursSundayToJSON(value?: EntityAccessHoursSunday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
