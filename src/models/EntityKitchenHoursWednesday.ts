 ...
 * @export
 * @interface EntityKitchenHoursWednesday
 */
export interface EntityKitchenHoursWednesday {
    /**
     * Indicates if the kitchen hours are "closed" on Wednesday.
     * 
     * Filtering Type: `boolean`
     * @type {boolean}
     * @memberof EntityKitchenHoursWednesday
     */
    isClosed?: boolean;
    /**
...
export function EntityKitchenHoursWednesdayFromJSON(json: any): EntityKitchenHoursWednesday {
    return EntityKitchenHoursWednesdayFromJSONTyped(json, false);
}

export function EntityKitchenHoursWednesdayFromJSONTyped(json: any, ignoreDiscriminator: boolean): EntityKitchenHoursWednesday {
...
export function EntityKitchenHoursWednesdayToJSON(value?: EntityKitchenHoursWednesday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
