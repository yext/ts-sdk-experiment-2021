...
import {
    AtmAllOfHoursFriday,
    AtmAllOfHoursFridayFromJSON,
    AtmAllOfHoursFridayFromJSONTyped,
    AtmAllOfHoursFridayToJSON,
    AtmAllOfHoursHolidayHours,
    AtmAllOfHoursHolidayHoursFromJSON,
    AtmAllOfHoursHolidayHoursFromJSONTyped,
    AtmAllOfHoursHolidayHoursToJSON,
    AtmAllOfHoursMonday,
    AtmAllOfHoursMondayFromJSON,
    AtmAllOfHoursMondayFromJSONTyped,
    AtmAllOfHoursMondayToJSON,
    AtmAllOfHoursSaturday,
    AtmAllOfHoursSaturdayFromJSON,
    AtmAllOfHoursSaturdayFromJSONTyped,
    AtmAllOfHoursSaturdayToJSON,
    AtmAllOfHoursSunday,
    AtmAllOfHoursSundayFromJSON,
    AtmAllOfHoursSundayFromJSONTyped,
    AtmAllOfHoursSundayToJSON,
    AtmAllOfHoursThursday,
    AtmAllOfHoursThursdayFromJSON,
    AtmAllOfHoursThursdayFromJSONTyped,
    AtmAllOfHoursThursdayToJSON,
    AtmAllOfHoursTuesday,
    AtmAllOfHoursTuesdayFromJSON,
    AtmAllOfHoursTuesdayFromJSONTyped,
    AtmAllOfHoursTuesdayToJSON,
    AtmAllOfHoursWednesday,
    AtmAllOfHoursWednesdayFromJSON,
    AtmAllOfHoursWednesdayFromJSONTyped,
    AtmAllOfHoursWednesdayToJSON,
} from './';
 ...
 * @export
 * @interface AtmAllOfHours
 */
export interface AtmAllOfHours {
    /**
     * 
     * @type {AtmAllOfHoursFriday}
     * @memberof AtmAllOfHours
     */
    friday?: AtmAllOfHoursFriday;
    /**
     * 
     ...
     * @type {Set<AtmAllOfHoursHolidayHours>}
     * @memberof AtmAllOfHours
     */
    holidayHours?: Set<AtmAllOfHoursHolidayHours>;
    /**
     * 
     * @type {AtmAllOfHoursMonday}
     * @memberof AtmAllOfHours
     */
    monday?: AtmAllOfHoursMonday;
    /**
     * 
    ...
    /**
     * 
     * @type {AtmAllOfHoursSaturday}
     * @memberof AtmAllOfHours
     */
    saturday?: AtmAllOfHoursSaturday;
    /**
     * 
     * @type {AtmAllOfHoursSunday}
     * @memberof AtmAllOfHours
     */
    sunday?: AtmAllOfHoursSunday;
    /**
     * 
     * @type {AtmAllOfHoursThursday}
     * @memberof AtmAllOfHours
     */
    thursday?: AtmAllOfHoursThursday;
    /**
     * 
     * @type {AtmAllOfHoursTuesday}
     * @memberof AtmAllOfHours
     */
    tuesday?: AtmAllOfHoursTuesday;
    /**
     * 
     * @type {AtmAllOfHoursWednesday}
     * @memberof AtmAllOfHours
     */
    wednesday?: AtmAllOfHoursWednesday;
}

export function AtmAllOfHoursFromJSON(json: any): AtmAllOfHours {
    return AtmAllOfHoursFromJSONTyped(json, false);
}

export function AtmAllOfHoursFromJSONTyped(json: any, ignoreDiscriminator: boolean): AtmAllOfHours {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'friday': !exists(json, 'friday') ? undefined : AtmAllOfHoursFridayFromJSON(json['friday']),
        'holidayHours': !exists(json, 'holidayHours') ? undefined : (new Set((json['holidayHours'] as Array<any>).map(AtmAllOfHoursHolidayHoursFromJSON))),
        'monday': !exists(json, 'monday') ? undefined : AtmAllOfHoursMondayFromJSON(json['monday']),
        'reopenDate': !exists(json, 'reopenDate') ? undefined : (new Date(json['reopenDate'])),
        'saturday': !exists(json, 'saturday') ? undefined : AtmAllOfHoursSaturdayFromJSON(json['saturday']),
        'sunday': !exists(json, 'sunday') ? undefined : AtmAllOfHoursSundayFromJSON(json['sunday']),
        'thursday': !exists(json, 'thursday') ? undefined : AtmAllOfHoursThursdayFromJSON(json['thursday']),
        'tuesday': !exists(json, 'tuesday') ? undefined : AtmAllOfHoursTuesdayFromJSON(json['tuesday']),
        'wednesday': !exists(json, 'wednesday') ? undefined : AtmAllOfHoursWednesdayFromJSON(json['wednesday']),
    };
}

export function AtmAllOfHoursToJSON(value?: AtmAllOfHours | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'friday': AtmAllOfHoursFridayToJSON(value.friday),
        'holidayHours': value.holidayHours === undefined ? undefined : (Array.from(value.holidayHours as Set<any>).map(AtmAllOfHoursHolidayHoursToJSON)),
        'monday': AtmAllOfHoursMondayToJSON(value.monday),
        'reopenDate': value.reopenDate === undefined ? undefined : (value.reopenDate.toISOString().substr(0,10)),
        'saturday': AtmAllOfHoursSaturdayToJSON(value.saturday),
        'sunday': AtmAllOfHoursSundayToJSON(value.sunday),
        'thursday': AtmAllOfHoursThursdayToJSON(value.thursday),
        'tuesday': AtmAllOfHoursTuesdayToJSON(value.tuesday),
        'wednesday': AtmAllOfHoursWednesdayToJSON(value.wednesday),
    };
}
