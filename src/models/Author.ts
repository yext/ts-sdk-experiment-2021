...
/**
 * Metadata about the PostEntry’s author.
 * @export
 * @interface Author
 */
export interface Author {
    /**
     * The name of the person who wrote the PostEntry.
     * @type {string}
     * @memberof Author
     */
    name?: string;
    /**
     * The URL of the user profile of the person who wrote the PostEntry
     * @type {string}
     * @memberof Author
     */
    profileUrl?: string;
    /**
     * The URL of the profile photo of the PostEntry’s author.
     * @type {string}
     * @memberof Author
     */
    photoUrl?: string;
