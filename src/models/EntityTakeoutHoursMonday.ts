 ...
 * @export
 * @interface EntityTakeoutHoursMonday
 */
export interface EntityTakeoutHoursMonday {
    /**
     * Indicates if the takeout hours are "closed" on Monday.
     * 
     * Filtering Type: `boolean`
     * @type {boolean}
     * @memberof EntityTakeoutHoursMonday
     */
    isClosed?: boolean;
    /**
...
export function EntityTakeoutHoursMondayFromJSON(json: any): EntityTakeoutHoursMonday {
    return EntityTakeoutHoursMondayFromJSONTyped(json, false);
}

export function EntityTakeoutHoursMondayFromJSONTyped(json: any, ignoreDiscriminator: boolean): EntityTakeoutHoursMonday {
...
export function EntityTakeoutHoursMondayToJSON(value?: EntityTakeoutHoursMonday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
