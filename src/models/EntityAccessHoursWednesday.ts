 ...
 * @export
 * @interface EntityAccessHoursWednesday
 */
export interface EntityAccessHoursWednesday {
    /**
     * Indicates if the access hours are "closed" on Wednesday.
     * 
     * Filtering Type: `boolean`
     * @type {boolean}
     * @memberof EntityAccessHoursWednesday
     */
    isClosed?: boolean;
    /**
...
export function EntityAccessHoursWednesdayFromJSON(json: any): EntityAccessHoursWednesday {
    return EntityAccessHoursWednesdayFromJSONTyped(json, false);
}

export function EntityAccessHoursWednesdayFromJSONTyped(json: any, ignoreDiscriminator: boolean): EntityAccessHoursWednesday {
...
export function EntityAccessHoursWednesdayToJSON(value?: EntityAccessHoursWednesday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
