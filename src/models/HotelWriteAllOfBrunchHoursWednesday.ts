 ...
 * 
 * @export
 * @interface HotelWriteAllOfBrunchHoursWednesday
 */
export interface HotelWriteAllOfBrunchHoursWednesday {
    /**
     * Indicates if the brunch hours are "closed" on Wednesday.
     * @type {boolean}
     * @memberof HotelWriteAllOfBrunchHoursWednesday
     */
    isClosed?: boolean;
    /**
...
export function HotelWriteAllOfBrunchHoursWednesdayFromJSON(json: any): HotelWriteAllOfBrunchHoursWednesday {
    return HotelWriteAllOfBrunchHoursWednesdayFromJSONTyped(json, false);
}

export function HotelWriteAllOfBrunchHoursWednesdayFromJSONTyped(json: any, ignoreDiscriminator: boolean): HotelWriteAllOfBrunchHoursWednesday {
...
export function HotelWriteAllOfBrunchHoursWednesdayToJSON(value?: HotelWriteAllOfBrunchHoursWednesday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
