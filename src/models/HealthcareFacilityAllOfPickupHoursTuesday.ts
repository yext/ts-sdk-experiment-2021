 ...
 * 
 * @export
 * @interface HealthcareFacilityAllOfPickupHoursTuesday
 */
export interface HealthcareFacilityAllOfPickupHoursTuesday {
    /**
     * Indicates if the pickup hours are "closed" on Tuesday.
     * @type {boolean}
     * @memberof HealthcareFacilityAllOfPickupHoursTuesday
     */
    isClosed?: boolean;
    /**
...
export function HealthcareFacilityAllOfPickupHoursTuesdayFromJSON(json: any): HealthcareFacilityAllOfPickupHoursTuesday {
    return HealthcareFacilityAllOfPickupHoursTuesdayFromJSONTyped(json, false);
}

export function HealthcareFacilityAllOfPickupHoursTuesdayFromJSONTyped(json: any, ignoreDiscriminator: boolean): HealthcareFacilityAllOfPickupHoursTuesday {
...
export function HealthcareFacilityAllOfPickupHoursTuesdayToJSON(value?: HealthcareFacilityAllOfPickupHoursTuesday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
