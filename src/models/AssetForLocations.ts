 ...
 * 
 * @export
 * @interface AssetForLocations
 */
export interface AssetForLocations {
    /**
     * The type of asset-to-location mapping:
     * 
     * * ``NO_LOCATIONS``: Not available to any location.
     * * ``ALL_LOCATIONS``: Available to all locations.
     * * ``FOLDER``: Available to all locations in a specified folder.
     * * ``LOCATIONS``: Available to a list of locations.
     * @type {string}
     * @memberof AssetForLocations
     */
    mappingType: string;
    /**
     * The **external** folder ID for the locations this asset can be used for.
     * 
     * Optional - can only be set if **`mappingType`** is ``FOLDER``.
     * @type {string}
     * @memberof AssetForLocations
     */
    folderId?: string;
    /**
     * The list of **external** IDs for the locations this asset can be used for.
     * 
     * Optional - can only be set if **`mappingType`** is ``LOCATIONS``.
     * @type {Array<string>}
     * @memberof AssetForLocations
     */
    locationIds?: Array<string>;
    /**
     * The list of **external** IDs of the labels applied to the locations this asset can be used for.
     * 
     * Optional - can only be set if **`mappingType`** is ``FOLDER`` or ``ALL_LOCATIONS``.
     * @type {Array<string>}
     * @memberof AssetForLocations
     */
    labelIds?: Array<string>;
    /**
     * The operator on the IDs in **`labelIds`** - indicates whether the list includes any of (``OR``) or all of (``AND``) the IDs.
     * 
     * Optional - can only be set if **`mappingType`** is ``FOLDER`` or ``ALL_LOCATIONS``.
     * @type {string}
     * @memberof AssetForLocations
     */
    labelOperator?: AssetForLocationsLabelOperatorEnum;
}
...
* @enum {string}
*/
export enum AssetForLocationsLabelOperatorEnum {
    And = 'AND',
    Or = 'OR'
}

export function AssetForLocationsFromJSON(json: any): AssetForLocations {
    return AssetForLocationsFromJSONTyped(json, false);
}

export function AssetForLocationsFromJSONTyped(json: any, ignoreDiscriminator: boolean): AssetForLocations {
...
export function AssetForLocationsToJSON(value?: AssetForLocations | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
