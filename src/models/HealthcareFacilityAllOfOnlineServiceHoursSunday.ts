 ...
 * 
 * @export
 * @interface HealthcareFacilityAllOfOnlineServiceHoursSunday
 */
export interface HealthcareFacilityAllOfOnlineServiceHoursSunday {
    /**
     * Indicates if the online service hours are "closed" on Sunday.
     * @type {boolean}
     * @memberof HealthcareFacilityAllOfOnlineServiceHoursSunday
     */
    isClosed?: boolean;
    /**
...
export function HealthcareFacilityAllOfOnlineServiceHoursSundayFromJSON(json: any): HealthcareFacilityAllOfOnlineServiceHoursSunday {
    return HealthcareFacilityAllOfOnlineServiceHoursSundayFromJSONTyped(json, false);
}

export function HealthcareFacilityAllOfOnlineServiceHoursSundayFromJSONTyped(json: any, ignoreDiscriminator: boolean): HealthcareFacilityAllOfOnlineServiceHoursSunday {
...
export function HealthcareFacilityAllOfOnlineServiceHoursSundayToJSON(value?: HealthcareFacilityAllOfOnlineServiceHoursSunday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
