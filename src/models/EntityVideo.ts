...
export interface EntityVideo {
     ...
     * Filtering Type: `text`
     * @type {string}
     * @memberof EntityVideo
     */
    url: string;
}

export function EntityVideoFromJSON(json: any): EntityVideo {
    return EntityVideoFromJSONTyped(json, false);
}

export function EntityVideoFromJSONTyped(json: any, ignoreDiscriminator: boolean): EntityVideo {
...
export function EntityVideoToJSON(value?: EntityVideo | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
