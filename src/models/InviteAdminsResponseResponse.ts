...
import {
    VerificationAdmin,
    VerificationAdminFromJSON,
    VerificationAdminFromJSONTyped,
    VerificationAdminToJSON,
} from './';
...
export interface InviteAdminsResponseResponse {
    ...
    /**
     * 
     * @type {Array<VerificationAdmin>}
     * @memberof InviteAdminsResponseResponse
     */
    admins?: Array<VerificationAdmin>;
}
...
export function InviteAdminsResponseResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): InviteAdminsResponseResponse {
    ...
    return {
        ...
        'admins': !exists(json, 'admins') ? undefined : ((json['admins'] as Array<any>).map(VerificationAdminFromJSON)),
    };
}
...
export function InviteAdminsResponseResponseToJSON(value?: InviteAdminsResponseResponse | null): any {
    ...
    return {
        ...
        'count': value.count,
        'admins': value.admins === undefined ? undefined : ((value.admins as Array<any>).map(VerificationAdminToJSON)),
    };
}
