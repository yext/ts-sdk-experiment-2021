 ...
 * @export
 * @interface InlineResponse200ResponseHappyHoursFriday
 */
export interface InlineResponse200ResponseHappyHoursFriday {
    /**
     * Indicates if the happy hours are "closed" on Friday.
     * 
     * Filtering Type: `boolean`
     * @type {boolean}
     * @memberof InlineResponse200ResponseHappyHoursFriday
     */
    isClosed?: boolean;
    /**
...
export function InlineResponse200ResponseHappyHoursFridayFromJSON(json: any): InlineResponse200ResponseHappyHoursFriday {
    return InlineResponse200ResponseHappyHoursFridayFromJSONTyped(json, false);
}

export function InlineResponse200ResponseHappyHoursFridayFromJSONTyped(json: any, ignoreDiscriminator: boolean): InlineResponse200ResponseHappyHoursFriday {
...
export function InlineResponse200ResponseHappyHoursFridayToJSON(value?: InlineResponse200ResponseHappyHoursFriday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
