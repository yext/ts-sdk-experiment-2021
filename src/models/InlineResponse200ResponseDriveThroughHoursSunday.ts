 ...
 * @export
 * @interface InlineResponse200ResponseDriveThroughHoursSunday
 */
export interface InlineResponse200ResponseDriveThroughHoursSunday {
    /**
     * Indicates if the drive-through hours are "closed" on Sunday.
     * 
     * Filtering Type: `boolean`
     * @type {boolean}
     * @memberof InlineResponse200ResponseDriveThroughHoursSunday
     */
    isClosed?: boolean;
    /**
...
export function InlineResponse200ResponseDriveThroughHoursSundayFromJSON(json: any): InlineResponse200ResponseDriveThroughHoursSunday {
    return InlineResponse200ResponseDriveThroughHoursSundayFromJSONTyped(json, false);
}

export function InlineResponse200ResponseDriveThroughHoursSundayFromJSONTyped(json: any, ignoreDiscriminator: boolean): InlineResponse200ResponseDriveThroughHoursSunday {
...
export function InlineResponse200ResponseDriveThroughHoursSundayToJSON(value?: InlineResponse200ResponseDriveThroughHoursSunday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
