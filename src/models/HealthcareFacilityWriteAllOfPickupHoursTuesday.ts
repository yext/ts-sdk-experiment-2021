 ...
 * 
 * @export
 * @interface HealthcareFacilityWriteAllOfPickupHoursTuesday
 */
export interface HealthcareFacilityWriteAllOfPickupHoursTuesday {
    /**
     * Indicates if the pickup hours are "closed" on Tuesday.
     * @type {boolean}
     * @memberof HealthcareFacilityWriteAllOfPickupHoursTuesday
     */
    isClosed?: boolean;
    /**
...
export function HealthcareFacilityWriteAllOfPickupHoursTuesdayFromJSON(json: any): HealthcareFacilityWriteAllOfPickupHoursTuesday {
    return HealthcareFacilityWriteAllOfPickupHoursTuesdayFromJSONTyped(json, false);
}

export function HealthcareFacilityWriteAllOfPickupHoursTuesdayFromJSONTyped(json: any, ignoreDiscriminator: boolean): HealthcareFacilityWriteAllOfPickupHoursTuesday {
...
export function HealthcareFacilityWriteAllOfPickupHoursTuesdayToJSON(value?: HealthcareFacilityWriteAllOfPickupHoursTuesday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
