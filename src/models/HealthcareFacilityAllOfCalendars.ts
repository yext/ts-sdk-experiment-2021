 ...
 * @export
 * @interface HealthcareFacilityAllOfCalendars
 */
export interface HealthcareFacilityAllOfCalendars {
    /**
     ...
     * @type {Set<string>}
     * @memberof HealthcareFacilityAllOfCalendars
     */
    ids?: Set<string>;
    /**
...
export function HealthcareFacilityAllOfCalendarsFromJSON(json: any): HealthcareFacilityAllOfCalendars {
    return HealthcareFacilityAllOfCalendarsFromJSONTyped(json, false);
}

export function HealthcareFacilityAllOfCalendarsFromJSONTyped(json: any, ignoreDiscriminator: boolean): HealthcareFacilityAllOfCalendars {
...
export function HealthcareFacilityAllOfCalendarsToJSON(value?: HealthcareFacilityAllOfCalendars | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
