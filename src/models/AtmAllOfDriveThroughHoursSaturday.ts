 ...
 * 
 * @export
 * @interface AtmAllOfDriveThroughHoursSaturday
 */
export interface AtmAllOfDriveThroughHoursSaturday {
    /**
     * Indicates if the drive-through hours are "closed" on Saturday.
     * @type {boolean}
     * @memberof AtmAllOfDriveThroughHoursSaturday
     */
    isClosed?: boolean;
    /**
...
export function AtmAllOfDriveThroughHoursSaturdayFromJSON(json: any): AtmAllOfDriveThroughHoursSaturday {
    return AtmAllOfDriveThroughHoursSaturdayFromJSONTyped(json, false);
}

export function AtmAllOfDriveThroughHoursSaturdayFromJSONTyped(json: any, ignoreDiscriminator: boolean): AtmAllOfDriveThroughHoursSaturday {
...
export function AtmAllOfDriveThroughHoursSaturdayToJSON(value?: AtmAllOfDriveThroughHoursSaturday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
