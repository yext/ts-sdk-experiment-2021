 ...
 * @export
 * @interface EntityPickupHoursHolidayHours
 */
export interface EntityPickupHoursHolidayHours {
    /**
     ...
     * Filtering Type: `date`
     * @type {Date}
     * @memberof EntityPickupHoursHolidayHours
     */
    date: Date;
    /**
...
export function EntityPickupHoursHolidayHoursFromJSON(json: any): EntityPickupHoursHolidayHours {
    return EntityPickupHoursHolidayHoursFromJSONTyped(json, false);
}

export function EntityPickupHoursHolidayHoursFromJSONTyped(json: any, ignoreDiscriminator: boolean): EntityPickupHoursHolidayHours {
...
export function EntityPickupHoursHolidayHoursToJSON(value?: EntityPickupHoursHolidayHours | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
