 ...
 * @export
 * @interface JobAllOfLocation
 */
export interface JobAllOfLocation {
    /**
     * A location entity referenced by Yext ID or Entity ID where this job opening exists
     * @type {string}
     * @memberof JobAllOfLocation
     */
...
export function JobAllOfLocationFromJSON(json: any): JobAllOfLocation {
    return JobAllOfLocationFromJSONTyped(json, false);
}

export function JobAllOfLocationFromJSONTyped(json: any, ignoreDiscriminator: boolean): JobAllOfLocation {
...
export function JobAllOfLocationToJSON(value?: JobAllOfLocation | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
