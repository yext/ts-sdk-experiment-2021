 ...
 * 
 * @export
 * @interface HotelWriteAllOfHappyHoursHolidayHours
 */
export interface HotelWriteAllOfHappyHoursHolidayHours {
    /**
     ...
     * @type {Date}
     * @memberof HotelWriteAllOfHappyHoursHolidayHours
     */
    date: Date;
    /**
...
export function HotelWriteAllOfHappyHoursHolidayHoursFromJSON(json: any): HotelWriteAllOfHappyHoursHolidayHours {
    return HotelWriteAllOfHappyHoursHolidayHoursFromJSONTyped(json, false);
}

export function HotelWriteAllOfHappyHoursHolidayHoursFromJSONTyped(json: any, ignoreDiscriminator: boolean): HotelWriteAllOfHappyHoursHolidayHours {
...
export function HotelWriteAllOfHappyHoursHolidayHoursToJSON(value?: HotelWriteAllOfHappyHoursHolidayHours | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
