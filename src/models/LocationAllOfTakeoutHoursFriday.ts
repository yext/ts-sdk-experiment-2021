 ...
 * 
 * @export
 * @interface LocationAllOfTakeoutHoursFriday
 */
export interface LocationAllOfTakeoutHoursFriday {
    /**
     * Indicates if the takeout hours are "closed" on Friday.
     * @type {boolean}
     * @memberof LocationAllOfTakeoutHoursFriday
     */
    isClosed?: boolean;
    /**
...
export function LocationAllOfTakeoutHoursFridayFromJSON(json: any): LocationAllOfTakeoutHoursFriday {
    return LocationAllOfTakeoutHoursFridayFromJSONTyped(json, false);
}

export function LocationAllOfTakeoutHoursFridayFromJSONTyped(json: any, ignoreDiscriminator: boolean): LocationAllOfTakeoutHoursFriday {
...
export function LocationAllOfTakeoutHoursFridayToJSON(value?: LocationAllOfTakeoutHoursFriday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
