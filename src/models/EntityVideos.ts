 ...
 * @export
 * @interface EntityVideos
 */
export interface EntityVideos {
    /**
     * 
     * Cannot Include:
     * * HTML markup
...
export function EntityVideosFromJSON(json: any): EntityVideos {
    return EntityVideosFromJSONTyped(json, false);
}

export function EntityVideosFromJSONTyped(json: any, ignoreDiscriminator: boolean): EntityVideos {
    ...
    return {
        ...
        'video': EntityVideoFromJSON(json['video']),
    };
}

export function EntityVideosToJSON(value?: EntityVideos | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'video': EntityVideoToJSON(value.video),
    };
}
