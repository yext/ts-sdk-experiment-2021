 ...
 * @export
 * @interface EntityHoursThursday
 */
export interface EntityHoursThursday {
    /**
     * Indicates if the hours of operation are "closed" on Thursday.
     * 
     * Filtering Type: `boolean`
     * @type {boolean}
     * @memberof EntityHoursThursday
     */
    isClosed?: boolean;
    /**
...
export function EntityHoursThursdayFromJSON(json: any): EntityHoursThursday {
    return EntityHoursThursdayFromJSONTyped(json, false);
}

export function EntityHoursThursdayFromJSONTyped(json: any, ignoreDiscriminator: boolean): EntityHoursThursday {
...
export function EntityHoursThursdayToJSON(value?: EntityHoursThursday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
