...
import {
    ProductSection,
    ProductSectionFromJSON,
    ProductSectionFromJSONTyped,
    ProductSectionToJSON,
} from './';
...
export function ProductAllOfFromJSONTyped(json: any, ignoreDiscriminator: boolean): ProductAllOf {
    ...
    return {
        ...
        'sections': !exists(json, 'sections') ? undefined : ((json['sections'] as Array<any>).map(ProductSectionFromJSON)),
    };
}
...
export function ProductAllOfToJSON(value?: ProductAllOf | null): any {
    ...
    return {
        ...
        'sections': value.sections === undefined ? undefined : ((value.sections as Array<any>).map(ProductSectionToJSON)),
    };
}
