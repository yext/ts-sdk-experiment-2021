 ...
 * @interface Atm
 */
export interface Atm extends EntityWrite {
    /**
     * 
     * @type {AtmAllOfMeta}
     * @memberof Atm
     ...
     * @memberof Atm
     */
    locationType?: AtmLocationTypeEnum;
    /**
     * 
     * @type {AtmAllOfLogo}
     * @memberof Atm
     ...
     * @memberof Atm
     */
    rankTrackingFrequency?: AtmRankTrackingFrequencyEnum;
    /**
     ...
     * @memberof Atm
     */
    rankTrackingQueryTemplates?: Set<AtmRankTrackingQueryTemplatesEnum>;
    /**
     * The search engines that we will use to track your performance
     * @type {Set<string>}
     * @memberof Atm
     */
    rankTrackingSites?: Set<AtmRankTrackingSitesEnum>;
    /**
...
* @enum {string}
*/
export enum AtmLocationTypeEnum {
    Location = 'LOCATION',
...
* @enum {string}
*/
export enum AtmRankTrackingFrequencyEnum {
    Weekly = 'WEEKLY',
    Monthly = 'MONTHLY',
    Quarterly = 'QUARTERLY'
}/**
...
* @enum {string}
*/
export enum AtmRankTrackingQueryTemplatesEnum {
    Keyword = 'KEYWORD',
...
* @enum {string}
*/
export enum AtmRankTrackingSitesEnum {
...
export function AtmFromJSON(json: any): Atm {
    return AtmFromJSONTyped(json, false);
}

export function AtmFromJSONTyped(json: any, ignoreDiscriminator: boolean): Atm {
...
export function AtmToJSON(value?: Atm | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
