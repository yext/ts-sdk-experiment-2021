...
export function EntityLocationFromJSON(json: any): EntityLocation {
    return EntityLocationFromJSONTyped(json, false);
}

export function EntityLocationFromJSONTyped(json: any, ignoreDiscriminator: boolean): EntityLocation {
...
export function EntityLocationToJSON(value?: EntityLocation | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
