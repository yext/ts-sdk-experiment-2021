 ...
 * @export
 * @interface InlineResponse200ResponsePickupHoursFriday
 */
export interface InlineResponse200ResponsePickupHoursFriday {
    /**
     * Indicates if the pickup hours are "closed" on Friday.
     * 
     * Filtering Type: `boolean`
     * @type {boolean}
     * @memberof InlineResponse200ResponsePickupHoursFriday
     */
    isClosed?: boolean;
    /**
...
export function InlineResponse200ResponsePickupHoursFridayFromJSON(json: any): InlineResponse200ResponsePickupHoursFriday {
    return InlineResponse200ResponsePickupHoursFridayFromJSONTyped(json, false);
}

export function InlineResponse200ResponsePickupHoursFridayFromJSONTyped(json: any, ignoreDiscriminator: boolean): InlineResponse200ResponsePickupHoursFriday {
...
export function InlineResponse200ResponsePickupHoursFridayToJSON(value?: InlineResponse200ResponsePickupHoursFriday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
