...
import {
    AtmAllOfLogoImage,
    AtmAllOfLogoImageFromJSON,
    AtmAllOfLogoImageFromJSONTyped,
    AtmAllOfLogoImageToJSON,
} from './';
 ...
 * @export
 * @interface AtmAllOfLogo
 */
export interface AtmAllOfLogo {
    /**
     * 
     * @type {string}
     * @memberof AtmAllOfLogo
     */
    ...
    /**
     * 
     * @type {AtmAllOfLogoImage}
     * @memberof AtmAllOfLogo
     */
    image: AtmAllOfLogoImage;
}

export function AtmAllOfLogoFromJSON(json: any): AtmAllOfLogo {
    return AtmAllOfLogoFromJSONTyped(json, false);
}

export function AtmAllOfLogoFromJSONTyped(json: any, ignoreDiscriminator: boolean): AtmAllOfLogo {
    ...
    return {
        ...
        'image': AtmAllOfLogoImageFromJSON(json['image']),
    };
}

export function AtmAllOfLogoToJSON(value?: AtmAllOfLogo | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'image': AtmAllOfLogoImageToJSON(value.image),
    };
}
