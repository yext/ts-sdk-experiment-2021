 ...
 * @export
 * @interface HealthcareFacilityAllOfBios
 */
export interface HealthcareFacilityAllOfBios {
    /**
     ...
     * @type {Set<string>}
     * @memberof HealthcareFacilityAllOfBios
     */
    ids?: Set<string>;
    /**
...
export function HealthcareFacilityAllOfBiosFromJSON(json: any): HealthcareFacilityAllOfBios {
    return HealthcareFacilityAllOfBiosFromJSONTyped(json, false);
}

export function HealthcareFacilityAllOfBiosFromJSONTyped(json: any, ignoreDiscriminator: boolean): HealthcareFacilityAllOfBios {
...
export function HealthcareFacilityAllOfBiosToJSON(value?: HealthcareFacilityAllOfBios | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
