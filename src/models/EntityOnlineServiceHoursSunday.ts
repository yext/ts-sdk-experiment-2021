 ...
 * @export
 * @interface EntityOnlineServiceHoursSunday
 */
export interface EntityOnlineServiceHoursSunday {
    /**
     * Indicates if the online service hours are "closed" on Sunday.
     * 
     * Filtering Type: `boolean`
     * @type {boolean}
     * @memberof EntityOnlineServiceHoursSunday
     */
    isClosed?: boolean;
    /**
...
export function EntityOnlineServiceHoursSundayFromJSON(json: any): EntityOnlineServiceHoursSunday {
    return EntityOnlineServiceHoursSundayFromJSONTyped(json, false);
}

export function EntityOnlineServiceHoursSundayFromJSONTyped(json: any, ignoreDiscriminator: boolean): EntityOnlineServiceHoursSunday {
...
export function EntityOnlineServiceHoursSundayToJSON(value?: EntityOnlineServiceHoursSunday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
