 ...
 * ```
 * @export
 * @interface EntityProductLists
 */
export interface EntityProductLists {
    /**
...
export function EntityProductListsFromJSON(json: any): EntityProductLists {
    return EntityProductListsFromJSONTyped(json, false);
}

export function EntityProductListsFromJSONTyped(json: any, ignoreDiscriminator: boolean): EntityProductLists {
...
export function EntityProductListsToJSON(value?: EntityProductLists | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
