 ...
 * @export
 * @interface InlineResponse200ResponseHappyHoursTuesday
 */
export interface InlineResponse200ResponseHappyHoursTuesday {
    /**
     * Indicates if the happy hours are "closed" on Tuesday.
     * 
     * Filtering Type: `boolean`
     * @type {boolean}
     * @memberof InlineResponse200ResponseHappyHoursTuesday
     */
    isClosed?: boolean;
    /**
...
export function InlineResponse200ResponseHappyHoursTuesdayFromJSON(json: any): InlineResponse200ResponseHappyHoursTuesday {
    return InlineResponse200ResponseHappyHoursTuesdayFromJSONTyped(json, false);
}

export function InlineResponse200ResponseHappyHoursTuesdayFromJSONTyped(json: any, ignoreDiscriminator: boolean): InlineResponse200ResponseHappyHoursTuesday {
...
export function InlineResponse200ResponseHappyHoursTuesdayToJSON(value?: InlineResponse200ResponseHappyHoursTuesday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
