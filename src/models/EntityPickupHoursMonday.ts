 ...
 * @export
 * @interface EntityPickupHoursMonday
 */
export interface EntityPickupHoursMonday {
    /**
     * Indicates if the pickup hours are "closed" on Monday.
     * 
     * Filtering Type: `boolean`
     * @type {boolean}
     * @memberof EntityPickupHoursMonday
     */
    isClosed?: boolean;
    /**
...
export function EntityPickupHoursMondayFromJSON(json: any): EntityPickupHoursMonday {
    return EntityPickupHoursMondayFromJSONTyped(json, false);
}

export function EntityPickupHoursMondayFromJSONTyped(json: any, ignoreDiscriminator: boolean): EntityPickupHoursMonday {
...
export function EntityPickupHoursMondayToJSON(value?: EntityPickupHoursMonday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
