 ...
 * 
 * @export
 * @interface HotelWriteAllOfBrunchHoursMonday
 */
export interface HotelWriteAllOfBrunchHoursMonday {
    /**
     * Indicates if the brunch hours are "closed" on Monday.
     * @type {boolean}
     * @memberof HotelWriteAllOfBrunchHoursMonday
     */
    isClosed?: boolean;
    /**
...
export function HotelWriteAllOfBrunchHoursMondayFromJSON(json: any): HotelWriteAllOfBrunchHoursMonday {
    return HotelWriteAllOfBrunchHoursMondayFromJSONTyped(json, false);
}

export function HotelWriteAllOfBrunchHoursMondayFromJSONTyped(json: any, ignoreDiscriminator: boolean): HotelWriteAllOfBrunchHoursMonday {
...
export function HotelWriteAllOfBrunchHoursMondayToJSON(value?: HotelWriteAllOfBrunchHoursMonday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
