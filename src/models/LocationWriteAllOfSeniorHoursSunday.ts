 ...
 * 
 * @export
 * @interface LocationWriteAllOfSeniorHoursSunday
 */
export interface LocationWriteAllOfSeniorHoursSunday {
    /**
     * Indicates if the senior hours are "closed" on Sunday.
     * @type {boolean}
     * @memberof LocationWriteAllOfSeniorHoursSunday
     */
    isClosed?: boolean;
    /**
...
export function LocationWriteAllOfSeniorHoursSundayFromJSON(json: any): LocationWriteAllOfSeniorHoursSunday {
    return LocationWriteAllOfSeniorHoursSundayFromJSONTyped(json, false);
}

export function LocationWriteAllOfSeniorHoursSundayFromJSONTyped(json: any, ignoreDiscriminator: boolean): LocationWriteAllOfSeniorHoursSunday {
...
export function LocationWriteAllOfSeniorHoursSundayToJSON(value?: LocationWriteAllOfSeniorHoursSunday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
