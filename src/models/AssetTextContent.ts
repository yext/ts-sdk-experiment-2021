 ...
 * 
 * @export
 * @interface AssetTextContent
 */
export interface AssetTextContent {
    /**
     * The Text content.
     * @type {string}
     * @memberof AssetTextContent
     */
    content: string;
    /**
     * The Text content locale.
     * @type {string}
     * @memberof AssetTextContent
     */
    locale: string;
...
export function AssetTextContentFromJSON(json: any): AssetTextContent {
    return AssetTextContentFromJSONTyped(json, false);
}

export function AssetTextContentFromJSONTyped(json: any, ignoreDiscriminator: boolean): AssetTextContent {
...
export function AssetTextContentToJSON(value?: AssetTextContent | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
