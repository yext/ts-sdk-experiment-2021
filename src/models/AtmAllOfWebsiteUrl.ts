 ...
 * @export
 * @interface AtmAllOfWebsiteUrl
 */
export interface AtmAllOfWebsiteUrl {
    /**
...
export function AtmAllOfWebsiteUrlFromJSON(json: any): AtmAllOfWebsiteUrl {
    return AtmAllOfWebsiteUrlFromJSONTyped(json, false);
}

export function AtmAllOfWebsiteUrlFromJSONTyped(json: any, ignoreDiscriminator: boolean): AtmAllOfWebsiteUrl {
...
export function AtmAllOfWebsiteUrlToJSON(value?: AtmAllOfWebsiteUrl | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
