 ...
 * @export
 * @interface EventAllOfAgeRange
 */
export interface EventAllOfAgeRange {
    /**
     * Maximum age for the event
     * @type {number}
     * @memberof EventAllOfAgeRange
     */
    maxValue?: number;
    /**
...
export function EventAllOfAgeRangeFromJSON(json: any): EventAllOfAgeRange {
    return EventAllOfAgeRangeFromJSONTyped(json, false);
}

export function EventAllOfAgeRangeFromJSONTyped(json: any, ignoreDiscriminator: boolean): EventAllOfAgeRange {
...
export function EventAllOfAgeRangeToJSON(value?: EventAllOfAgeRange | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
