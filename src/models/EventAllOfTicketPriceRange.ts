 ...
 * @export
 * @interface EventAllOfTicketPriceRange
 */
export interface EventAllOfTicketPriceRange {
    /**
     * Three letter currency code (ISO standard)
     * @type {string}
     * @memberof EventAllOfTicketPriceRange
     */
    currencyCode?: string;
    /**
...
export function EventAllOfTicketPriceRangeFromJSON(json: any): EventAllOfTicketPriceRange {
    return EventAllOfTicketPriceRangeFromJSONTyped(json, false);
}

export function EventAllOfTicketPriceRangeFromJSONTyped(json: any, ignoreDiscriminator: boolean): EventAllOfTicketPriceRange {
...
export function EventAllOfTicketPriceRangeToJSON(value?: EventAllOfTicketPriceRange | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
