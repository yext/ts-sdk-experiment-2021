...
import {
    EntityAccessHoursFridayOpenIntervals,
    EntityAccessHoursFridayOpenIntervalsFromJSON,
    EntityAccessHoursFridayOpenIntervalsFromJSONTyped,
    EntityAccessHoursFridayOpenIntervalsToJSON,
} from './';

/**
 * Filtering Type: `object`
 * @export
 * @interface EntityOnlineServiceHoursHolidayHours
 */
export interface EntityOnlineServiceHoursHolidayHours {
    /**
     ...
     * Filtering Type: `date`
     * @type {Date}
     * @memberof EntityOnlineServiceHoursHolidayHours
     */
    date: Date;
    /**
     ...
     * @type {Array<EntityAccessHoursFridayOpenIntervals>}
     * @memberof EntityOnlineServiceHoursHolidayHours
     */
    openIntervals?: Array<EntityAccessHoursFridayOpenIntervals>;
}

export function EntityOnlineServiceHoursHolidayHoursFromJSON(json: any): EntityOnlineServiceHoursHolidayHours {
    return EntityOnlineServiceHoursHolidayHoursFromJSONTyped(json, false);
}

export function EntityOnlineServiceHoursHolidayHoursFromJSONTyped(json: any, ignoreDiscriminator: boolean): EntityOnlineServiceHoursHolidayHours {
    ...
    return {
        ...
        'openIntervals': !exists(json, 'openIntervals') ? undefined : ((json['openIntervals'] as Array<any>).map(EntityAccessHoursFridayOpenIntervalsFromJSON)),
    };
}

export function EntityOnlineServiceHoursHolidayHoursToJSON(value?: EntityOnlineServiceHoursHolidayHours | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'openIntervals': value.openIntervals === undefined ? undefined : ((value.openIntervals as Array<any>).map(EntityAccessHoursFridayOpenIntervalsToJSON)),
    };
}
