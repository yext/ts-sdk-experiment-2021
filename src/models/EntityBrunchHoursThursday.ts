 ...
 * @export
 * @interface EntityBrunchHoursThursday
 */
export interface EntityBrunchHoursThursday {
    /**
     * Indicates if the brunch hours are "closed" on Thursday.
     * 
     * Filtering Type: `boolean`
     * @type {boolean}
     * @memberof EntityBrunchHoursThursday
     */
    isClosed?: boolean;
    /**
...
export function EntityBrunchHoursThursdayFromJSON(json: any): EntityBrunchHoursThursday {
    return EntityBrunchHoursThursdayFromJSONTyped(json, false);
}

export function EntityBrunchHoursThursdayFromJSONTyped(json: any, ignoreDiscriminator: boolean): EntityBrunchHoursThursday {
...
export function EntityBrunchHoursThursdayToJSON(value?: EntityBrunchHoursThursday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
