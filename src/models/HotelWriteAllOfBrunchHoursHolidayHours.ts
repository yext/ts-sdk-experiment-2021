 ...
 * 
 * @export
 * @interface HotelWriteAllOfBrunchHoursHolidayHours
 */
export interface HotelWriteAllOfBrunchHoursHolidayHours {
    /**
     ...
     * @type {Date}
     * @memberof HotelWriteAllOfBrunchHoursHolidayHours
     */
    date: Date;
    /**
...
export function HotelWriteAllOfBrunchHoursHolidayHoursFromJSON(json: any): HotelWriteAllOfBrunchHoursHolidayHours {
    return HotelWriteAllOfBrunchHoursHolidayHoursFromJSONTyped(json, false);
}

export function HotelWriteAllOfBrunchHoursHolidayHoursFromJSONTyped(json: any, ignoreDiscriminator: boolean): HotelWriteAllOfBrunchHoursHolidayHours {
...
export function HotelWriteAllOfBrunchHoursHolidayHoursToJSON(value?: HotelWriteAllOfBrunchHoursHolidayHours | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
