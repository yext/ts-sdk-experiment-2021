 ...
 * ```
 * @export
 * @interface EntityReservationUrl
 */
export interface EntityReservationUrl {
    /**
...
export function EntityReservationUrlFromJSON(json: any): EntityReservationUrl {
    return EntityReservationUrlFromJSONTyped(json, false);
}

export function EntityReservationUrlFromJSONTyped(json: any, ignoreDiscriminator: boolean): EntityReservationUrl {
...
export function EntityReservationUrlToJSON(value?: EntityReservationUrl | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
