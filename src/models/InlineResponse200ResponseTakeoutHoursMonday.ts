 ...
 * @export
 * @interface InlineResponse200ResponseTakeoutHoursMonday
 */
export interface InlineResponse200ResponseTakeoutHoursMonday {
    /**
     * Indicates if the takeout hours are "closed" on Monday.
     * 
     * Filtering Type: `boolean`
     * @type {boolean}
     * @memberof InlineResponse200ResponseTakeoutHoursMonday
     */
    isClosed?: boolean;
    /**
...
export function InlineResponse200ResponseTakeoutHoursMondayFromJSON(json: any): InlineResponse200ResponseTakeoutHoursMonday {
    return InlineResponse200ResponseTakeoutHoursMondayFromJSONTyped(json, false);
}

export function InlineResponse200ResponseTakeoutHoursMondayFromJSONTyped(json: any, ignoreDiscriminator: boolean): InlineResponse200ResponseTakeoutHoursMonday {
...
export function InlineResponse200ResponseTakeoutHoursMondayToJSON(value?: InlineResponse200ResponseTakeoutHoursMonday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
