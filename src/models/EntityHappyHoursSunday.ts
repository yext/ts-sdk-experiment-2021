 ...
 * @export
 * @interface EntityHappyHoursSunday
 */
export interface EntityHappyHoursSunday {
    /**
     * Indicates if the happy hours are "closed" on Sunday.
     * 
     * Filtering Type: `boolean`
     * @type {boolean}
     * @memberof EntityHappyHoursSunday
     */
    isClosed?: boolean;
    /**
...
export function EntityHappyHoursSundayFromJSON(json: any): EntityHappyHoursSunday {
    return EntityHappyHoursSundayFromJSONTyped(json, false);
}

export function EntityHappyHoursSundayFromJSONTyped(json: any, ignoreDiscriminator: boolean): EntityHappyHoursSunday {
...
export function EntityHappyHoursSundayToJSON(value?: EntityHappyHoursSunday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
