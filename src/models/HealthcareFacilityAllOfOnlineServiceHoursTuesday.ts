 ...
 * 
 * @export
 * @interface HealthcareFacilityAllOfOnlineServiceHoursTuesday
 */
export interface HealthcareFacilityAllOfOnlineServiceHoursTuesday {
    /**
     * Indicates if the online service hours are "closed" on Tuesday.
     * @type {boolean}
     * @memberof HealthcareFacilityAllOfOnlineServiceHoursTuesday
     */
    isClosed?: boolean;
    /**
...
export function HealthcareFacilityAllOfOnlineServiceHoursTuesdayFromJSON(json: any): HealthcareFacilityAllOfOnlineServiceHoursTuesday {
    return HealthcareFacilityAllOfOnlineServiceHoursTuesdayFromJSONTyped(json, false);
}

export function HealthcareFacilityAllOfOnlineServiceHoursTuesdayFromJSONTyped(json: any, ignoreDiscriminator: boolean): HealthcareFacilityAllOfOnlineServiceHoursTuesday {
...
export function HealthcareFacilityAllOfOnlineServiceHoursTuesdayToJSON(value?: HealthcareFacilityAllOfOnlineServiceHoursTuesday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
