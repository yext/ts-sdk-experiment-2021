...
import {
     ...
     EventFromJSONTyped,
     FaqFromJSONTyped,
     HealthcareFacilityFromJSONTyped,
     HealthcareProfessionalFromJSONTyped,
     HotelFromJSONTyped,
     JobFromJSONTyped,
...
export function EntityWriteFromJSONTyped(json: any, ignoreDiscriminator: boolean): EntityWrite {
    ...
    if (!ignoreDiscriminator) {
        if (json['entityType'] === 'atm') {
            return AtmFromJSONTyped(json, true);
        }
        if (json['entityType'] === 'event') {
            return EventFromJSONTyped(json, true);
        }
        if (json['entityType'] === 'faq') {
            return FaqFromJSONTyped(json, true);
        }
        if (json['entityType'] === 'healthcareFacility') {
            return HealthcareFacilityFromJSONTyped(json, true);
        }
        if (json['entityType'] === 'healthcareProfessional') {
            return HealthcareProfessionalFromJSONTyped(json, true);
        }
        if (json['entityType'] === 'hotel') {
            return HotelFromJSONTyped(json, true);
        }
        if (json['entityType'] === 'job') {
            return JobFromJSONTyped(json, true);
        }
        if (json['entityType'] === 'location') {
            return LocationFromJSONTyped(json, true);
        }
