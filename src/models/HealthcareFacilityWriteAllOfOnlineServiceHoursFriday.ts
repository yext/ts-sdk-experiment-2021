 ...
 * 
 * @export
 * @interface HealthcareFacilityWriteAllOfOnlineServiceHoursFriday
 */
export interface HealthcareFacilityWriteAllOfOnlineServiceHoursFriday {
    /**
     * Indicates if the online service hours are "closed" on Friday.
     * @type {boolean}
     * @memberof HealthcareFacilityWriteAllOfOnlineServiceHoursFriday
     */
    isClosed?: boolean;
    /**
...
export function HealthcareFacilityWriteAllOfOnlineServiceHoursFridayFromJSON(json: any): HealthcareFacilityWriteAllOfOnlineServiceHoursFriday {
    return HealthcareFacilityWriteAllOfOnlineServiceHoursFridayFromJSONTyped(json, false);
}

export function HealthcareFacilityWriteAllOfOnlineServiceHoursFridayFromJSONTyped(json: any, ignoreDiscriminator: boolean): HealthcareFacilityWriteAllOfOnlineServiceHoursFriday {
...
export function HealthcareFacilityWriteAllOfOnlineServiceHoursFridayToJSON(value?: HealthcareFacilityWriteAllOfOnlineServiceHoursFriday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
