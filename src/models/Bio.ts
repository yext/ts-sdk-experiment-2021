...
export function BioFromJSONTyped(json: any, ignoreDiscriminator: boolean): Bio {
    ...
    return {
        ...
        'sections': !exists(json, 'sections') ? undefined : ((json['sections'] as Array<any>).map(BioSectionFromJSON)),
    };
}
...
export function BioToJSON(value?: Bio | null): any {
    ...
    return {
        ...
        'sections': value.sections === undefined ? undefined : ((value.sections as Array<any>).map(BioSectionToJSON)),
    };
}
