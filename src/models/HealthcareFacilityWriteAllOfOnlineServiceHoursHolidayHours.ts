 ...
 * 
 * @export
 * @interface HealthcareFacilityWriteAllOfOnlineServiceHoursHolidayHours
 */
export interface HealthcareFacilityWriteAllOfOnlineServiceHoursHolidayHours {
    /**
     ...
     * @type {Date}
     * @memberof HealthcareFacilityWriteAllOfOnlineServiceHoursHolidayHours
     */
    date: Date;
    /**
...
export function HealthcareFacilityWriteAllOfOnlineServiceHoursHolidayHoursFromJSON(json: any): HealthcareFacilityWriteAllOfOnlineServiceHoursHolidayHours {
    return HealthcareFacilityWriteAllOfOnlineServiceHoursHolidayHoursFromJSONTyped(json, false);
}

export function HealthcareFacilityWriteAllOfOnlineServiceHoursHolidayHoursFromJSONTyped(json: any, ignoreDiscriminator: boolean): HealthcareFacilityWriteAllOfOnlineServiceHoursHolidayHours {
...
export function HealthcareFacilityWriteAllOfOnlineServiceHoursHolidayHoursToJSON(value?: HealthcareFacilityWriteAllOfOnlineServiceHoursHolidayHours | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
