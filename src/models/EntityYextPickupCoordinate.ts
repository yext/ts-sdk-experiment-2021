 ...
 * ```
 * @export
 * @interface EntityYextPickupCoordinate
 */
export interface EntityYextPickupCoordinate {
    /**
     * Filtering Type: `float`
     * @type {number}
     * @memberof EntityYextPickupCoordinate
     */
    latitude?: number;
    /**
     * Filtering Type: `float`
...
export function EntityYextPickupCoordinateFromJSON(json: any): EntityYextPickupCoordinate {
    return EntityYextPickupCoordinateFromJSONTyped(json, false);
}

export function EntityYextPickupCoordinateFromJSONTyped(json: any, ignoreDiscriminator: boolean): EntityYextPickupCoordinate {
...
export function EntityYextPickupCoordinateToJSON(value?: EntityYextPickupCoordinate | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
