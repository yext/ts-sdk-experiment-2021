 ...
 * 
 * @export
 * @interface HealthcareFacilityWriteAllOf
 */
export interface HealthcareFacilityWriteAllOf {
    /**
     * 
     * @type {AtmWriteAllOfMeta}
     * @memberof HealthcareFacilityWriteAllOf
     */
     ...
     * @memberof HealthcareFacilityWriteAllOf
     */
    locationType?: HealthcareFacilityWriteAllOfLocationTypeEnum;
    /**
     * 
     ...
     * @memberof HealthcareFacilityWriteAllOf
     */
    paymentOptions?: Set<HealthcareFacilityWriteAllOfPaymentOptionsEnum>;
    /**
     * 
     ...
     * @memberof HealthcareFacilityWriteAllOf
     */
    priceRange?: HealthcareFacilityWriteAllOfPriceRangeEnum;
    /**
     ...
     * @memberof HealthcareFacilityWriteAllOf
     */
    rankTrackingFrequency?: HealthcareFacilityWriteAllOfRankTrackingFrequencyEnum;
    /**
     ...
     * @memberof HealthcareFacilityWriteAllOf
     */
    rankTrackingQueryTemplates?: Set<HealthcareFacilityWriteAllOfRankTrackingQueryTemplatesEnum>;
    /**
     * The search engines that we will use to track your performance
     * @type {Set<string>}
     * @memberof HealthcareFacilityWriteAllOf
     */
    rankTrackingSites?: Set<HealthcareFacilityWriteAllOfRankTrackingSitesEnum>;
    /**
     * 
...
* @enum {string}
*/
export enum HealthcareFacilityWriteAllOfLocationTypeEnum {
    Location = 'LOCATION',
...
* @enum {string}
*/
export enum HealthcareFacilityWriteAllOfPaymentOptionsEnum {
    Alipay = 'ALIPAY',
...
* @enum {string}
*/
export enum HealthcareFacilityWriteAllOfPriceRangeEnum {
...
* @enum {string}
*/
export enum HealthcareFacilityWriteAllOfRankTrackingFrequencyEnum {
    Weekly = 'WEEKLY',
    Monthly = 'MONTHLY',
    Quarterly = 'QUARTERLY'
}/**
...
* @enum {string}
*/
export enum HealthcareFacilityWriteAllOfRankTrackingQueryTemplatesEnum {
    Keyword = 'KEYWORD',
...
* @enum {string}
*/
export enum HealthcareFacilityWriteAllOfRankTrackingSitesEnum {
...
export function HealthcareFacilityWriteAllOfFromJSON(json: any): HealthcareFacilityWriteAllOf {
    return HealthcareFacilityWriteAllOfFromJSONTyped(json, false);
}

export function HealthcareFacilityWriteAllOfFromJSONTyped(json: any, ignoreDiscriminator: boolean): HealthcareFacilityWriteAllOf {
...
export function HealthcareFacilityWriteAllOfToJSON(value?: HealthcareFacilityWriteAllOf | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
