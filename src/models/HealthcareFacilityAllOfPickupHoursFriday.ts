 ...
 * 
 * @export
 * @interface HealthcareFacilityAllOfPickupHoursFriday
 */
export interface HealthcareFacilityAllOfPickupHoursFriday {
    /**
     * Indicates if the pickup hours are "closed" on Friday.
     * @type {boolean}
     * @memberof HealthcareFacilityAllOfPickupHoursFriday
     */
    isClosed?: boolean;
    /**
...
export function HealthcareFacilityAllOfPickupHoursFridayFromJSON(json: any): HealthcareFacilityAllOfPickupHoursFriday {
    return HealthcareFacilityAllOfPickupHoursFridayFromJSONTyped(json, false);
}

export function HealthcareFacilityAllOfPickupHoursFridayFromJSONTyped(json: any, ignoreDiscriminator: boolean): HealthcareFacilityAllOfPickupHoursFriday {
...
export function HealthcareFacilityAllOfPickupHoursFridayToJSON(value?: HealthcareFacilityAllOfPickupHoursFriday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
