 ...
 * 
 * @export
 * @interface LocationAllOfDeliveryHoursSaturday
 */
export interface LocationAllOfDeliveryHoursSaturday {
    /**
     * Indicates if the delivery hours are "closed" on Saturday.
     * @type {boolean}
     * @memberof LocationAllOfDeliveryHoursSaturday
     */
    isClosed?: boolean;
    /**
...
export function LocationAllOfDeliveryHoursSaturdayFromJSON(json: any): LocationAllOfDeliveryHoursSaturday {
    return LocationAllOfDeliveryHoursSaturdayFromJSONTyped(json, false);
}

export function LocationAllOfDeliveryHoursSaturdayFromJSONTyped(json: any, ignoreDiscriminator: boolean): LocationAllOfDeliveryHoursSaturday {
...
export function LocationAllOfDeliveryHoursSaturdayToJSON(value?: LocationAllOfDeliveryHoursSaturday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
