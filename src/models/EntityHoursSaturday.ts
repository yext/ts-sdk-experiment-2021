 ...
 * @export
 * @interface EntityHoursSaturday
 */
export interface EntityHoursSaturday {
    /**
     * Indicates if the hours of operation are "closed" on Saturday.
     * 
     * Filtering Type: `boolean`
     * @type {boolean}
     * @memberof EntityHoursSaturday
     */
    isClosed?: boolean;
    /**
...
export function EntityHoursSaturdayFromJSON(json: any): EntityHoursSaturday {
    return EntityHoursSaturdayFromJSONTyped(json, false);
}

export function EntityHoursSaturdayFromJSONTyped(json: any, ignoreDiscriminator: boolean): EntityHoursSaturday {
...
export function EntityHoursSaturdayToJSON(value?: EntityHoursSaturday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
