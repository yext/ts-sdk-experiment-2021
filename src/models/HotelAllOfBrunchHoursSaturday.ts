 ...
 * 
 * @export
 * @interface HotelAllOfBrunchHoursSaturday
 */
export interface HotelAllOfBrunchHoursSaturday {
    /**
     * Indicates if the brunch hours are "closed" on Saturday.
     * @type {boolean}
     * @memberof HotelAllOfBrunchHoursSaturday
     */
    isClosed?: boolean;
    /**
...
export function HotelAllOfBrunchHoursSaturdayFromJSON(json: any): HotelAllOfBrunchHoursSaturday {
    return HotelAllOfBrunchHoursSaturdayFromJSONTyped(json, false);
}

export function HotelAllOfBrunchHoursSaturdayFromJSONTyped(json: any, ignoreDiscriminator: boolean): HotelAllOfBrunchHoursSaturday {
...
export function HotelAllOfBrunchHoursSaturdayToJSON(value?: HotelAllOfBrunchHoursSaturday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
