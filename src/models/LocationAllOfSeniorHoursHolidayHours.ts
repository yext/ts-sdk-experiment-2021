 ...
 * 
 * @export
 * @interface LocationAllOfSeniorHoursHolidayHours
 */
export interface LocationAllOfSeniorHoursHolidayHours {
    /**
     ...
     * @type {Date}
     * @memberof LocationAllOfSeniorHoursHolidayHours
     */
    date: Date;
    /**
...
export function LocationAllOfSeniorHoursHolidayHoursFromJSON(json: any): LocationAllOfSeniorHoursHolidayHours {
    return LocationAllOfSeniorHoursHolidayHoursFromJSONTyped(json, false);
}

export function LocationAllOfSeniorHoursHolidayHoursFromJSONTyped(json: any, ignoreDiscriminator: boolean): LocationAllOfSeniorHoursHolidayHours {
...
export function LocationAllOfSeniorHoursHolidayHoursToJSON(value?: LocationAllOfSeniorHoursHolidayHours | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
