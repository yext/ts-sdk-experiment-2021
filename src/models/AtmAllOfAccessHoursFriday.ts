 ...
 * 
 * @export
 * @interface AtmAllOfAccessHoursFriday
 */
export interface AtmAllOfAccessHoursFriday {
    /**
     * Indicates if the access hours are "closed" on Friday.
     * @type {boolean}
     * @memberof AtmAllOfAccessHoursFriday
     */
    isClosed?: boolean;
    /**
...
export function AtmAllOfAccessHoursFridayFromJSON(json: any): AtmAllOfAccessHoursFriday {
    return AtmAllOfAccessHoursFridayFromJSONTyped(json, false);
}

export function AtmAllOfAccessHoursFridayFromJSONTyped(json: any, ignoreDiscriminator: boolean): AtmAllOfAccessHoursFriday {
...
export function AtmAllOfAccessHoursFridayToJSON(value?: AtmAllOfAccessHoursFriday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
