 ...
 * 
 * @export
 * @interface LocationAllOfSeniorHoursFriday
 */
export interface LocationAllOfSeniorHoursFriday {
    /**
     * Indicates if the senior hours are "closed" on Friday.
     * @type {boolean}
     * @memberof LocationAllOfSeniorHoursFriday
     */
    isClosed?: boolean;
    /**
...
export function LocationAllOfSeniorHoursFridayFromJSON(json: any): LocationAllOfSeniorHoursFriday {
    return LocationAllOfSeniorHoursFridayFromJSONTyped(json, false);
}

export function LocationAllOfSeniorHoursFridayFromJSONTyped(json: any, ignoreDiscriminator: boolean): LocationAllOfSeniorHoursFriday {
...
export function LocationAllOfSeniorHoursFridayToJSON(value?: LocationAllOfSeniorHoursFriday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
