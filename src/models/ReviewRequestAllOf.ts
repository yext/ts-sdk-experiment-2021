 ...
 * 
 * @export
 * @interface ReviewRequestAllOf
 */
export interface ReviewRequestAllOf {
    /**
     ...
     * @type {Date}
     * @memberof ReviewRequestAllOf
     */
    date?: Date;
    /**
     * The current flag status of the review; only settable for First Party reviews.
     * @type {string}
     * @memberof ReviewRequestAllOf
     */
    flagStatus?: ReviewRequestAllOfFlagStatusEnum;
}
...
* @enum {string}
*/
export enum ReviewRequestAllOfFlagStatusEnum {
...
export function ReviewRequestAllOfFromJSON(json: any): ReviewRequestAllOf {
    return ReviewRequestAllOfFromJSONTyped(json, false);
}

export function ReviewRequestAllOfFromJSONTyped(json: any, ignoreDiscriminator: boolean): ReviewRequestAllOf {
...
export function ReviewRequestAllOfToJSON(value?: ReviewRequestAllOf | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
