 ...
 * 
 * @export
 * @interface HotelAllOfBrunchHoursFriday
 */
export interface HotelAllOfBrunchHoursFriday {
    /**
     * Indicates if the brunch hours are "closed" on Friday.
     * @type {boolean}
     * @memberof HotelAllOfBrunchHoursFriday
     */
    isClosed?: boolean;
    /**
...
export function HotelAllOfBrunchHoursFridayFromJSON(json: any): HotelAllOfBrunchHoursFriday {
    return HotelAllOfBrunchHoursFridayFromJSONTyped(json, false);
}

export function HotelAllOfBrunchHoursFridayFromJSONTyped(json: any, ignoreDiscriminator: boolean): HotelAllOfBrunchHoursFriday {
...
export function HotelAllOfBrunchHoursFridayToJSON(value?: HotelAllOfBrunchHoursFriday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
