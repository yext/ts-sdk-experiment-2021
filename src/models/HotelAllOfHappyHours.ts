...
import {
    HotelAllOfHappyHoursFriday,
    HotelAllOfHappyHoursFridayFromJSON,
    HotelAllOfHappyHoursFridayFromJSONTyped,
    HotelAllOfHappyHoursFridayToJSON,
    HotelAllOfHappyHoursHolidayHours,
    HotelAllOfHappyHoursHolidayHoursFromJSON,
    HotelAllOfHappyHoursHolidayHoursFromJSONTyped,
    HotelAllOfHappyHoursHolidayHoursToJSON,
    HotelAllOfHappyHoursMonday,
    HotelAllOfHappyHoursMondayFromJSON,
    HotelAllOfHappyHoursMondayFromJSONTyped,
    HotelAllOfHappyHoursMondayToJSON,
    HotelAllOfHappyHoursSaturday,
    HotelAllOfHappyHoursSaturdayFromJSON,
    HotelAllOfHappyHoursSaturdayFromJSONTyped,
    HotelAllOfHappyHoursSaturdayToJSON,
    HotelAllOfHappyHoursSunday,
    HotelAllOfHappyHoursSundayFromJSON,
    HotelAllOfHappyHoursSundayFromJSONTyped,
    HotelAllOfHappyHoursSundayToJSON,
    HotelAllOfHappyHoursThursday,
    HotelAllOfHappyHoursThursdayFromJSON,
    HotelAllOfHappyHoursThursdayFromJSONTyped,
    HotelAllOfHappyHoursThursdayToJSON,
    HotelAllOfHappyHoursTuesday,
    HotelAllOfHappyHoursTuesdayFromJSON,
    HotelAllOfHappyHoursTuesdayFromJSONTyped,
    HotelAllOfHappyHoursTuesdayToJSON,
    HotelAllOfHappyHoursWednesday,
    HotelAllOfHappyHoursWednesdayFromJSON,
    HotelAllOfHappyHoursWednesdayFromJSONTyped,
    HotelAllOfHappyHoursWednesdayToJSON,
} from './';
 ...
 * @export
 * @interface HotelAllOfHappyHours
 */
export interface HotelAllOfHappyHours {
    /**
     * 
     * @type {HotelAllOfHappyHoursFriday}
     * @memberof HotelAllOfHappyHours
     */
    friday?: HotelAllOfHappyHoursFriday;
    /**
     * 
     ...
     * @type {Set<HotelAllOfHappyHoursHolidayHours>}
     * @memberof HotelAllOfHappyHours
     */
    holidayHours?: Set<HotelAllOfHappyHoursHolidayHours>;
    /**
     * 
     * @type {HotelAllOfHappyHoursMonday}
     * @memberof HotelAllOfHappyHours
     */
    monday?: HotelAllOfHappyHoursMonday;
    /**
     * 
    ...
    /**
     * 
     * @type {HotelAllOfHappyHoursSaturday}
     * @memberof HotelAllOfHappyHours
     */
    saturday?: HotelAllOfHappyHoursSaturday;
    /**
     * 
     * @type {HotelAllOfHappyHoursSunday}
     * @memberof HotelAllOfHappyHours
     */
    sunday?: HotelAllOfHappyHoursSunday;
    /**
     * 
     * @type {HotelAllOfHappyHoursThursday}
     * @memberof HotelAllOfHappyHours
     */
    thursday?: HotelAllOfHappyHoursThursday;
    /**
     * 
     * @type {HotelAllOfHappyHoursTuesday}
     * @memberof HotelAllOfHappyHours
     */
    tuesday?: HotelAllOfHappyHoursTuesday;
    /**
     * 
     * @type {HotelAllOfHappyHoursWednesday}
     * @memberof HotelAllOfHappyHours
     */
    wednesday?: HotelAllOfHappyHoursWednesday;
}

export function HotelAllOfHappyHoursFromJSON(json: any): HotelAllOfHappyHours {
    return HotelAllOfHappyHoursFromJSONTyped(json, false);
}

export function HotelAllOfHappyHoursFromJSONTyped(json: any, ignoreDiscriminator: boolean): HotelAllOfHappyHours {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'friday': !exists(json, 'friday') ? undefined : HotelAllOfHappyHoursFridayFromJSON(json['friday']),
        'holidayHours': !exists(json, 'holidayHours') ? undefined : (new Set((json['holidayHours'] as Array<any>).map(HotelAllOfHappyHoursHolidayHoursFromJSON))),
        'monday': !exists(json, 'monday') ? undefined : HotelAllOfHappyHoursMondayFromJSON(json['monday']),
        'reopenDate': !exists(json, 'reopenDate') ? undefined : (new Date(json['reopenDate'])),
        'saturday': !exists(json, 'saturday') ? undefined : HotelAllOfHappyHoursSaturdayFromJSON(json['saturday']),
        'sunday': !exists(json, 'sunday') ? undefined : HotelAllOfHappyHoursSundayFromJSON(json['sunday']),
        'thursday': !exists(json, 'thursday') ? undefined : HotelAllOfHappyHoursThursdayFromJSON(json['thursday']),
        'tuesday': !exists(json, 'tuesday') ? undefined : HotelAllOfHappyHoursTuesdayFromJSON(json['tuesday']),
        'wednesday': !exists(json, 'wednesday') ? undefined : HotelAllOfHappyHoursWednesdayFromJSON(json['wednesday']),
    };
}

export function HotelAllOfHappyHoursToJSON(value?: HotelAllOfHappyHours | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'friday': HotelAllOfHappyHoursFridayToJSON(value.friday),
        'holidayHours': value.holidayHours === undefined ? undefined : (Array.from(value.holidayHours as Set<any>).map(HotelAllOfHappyHoursHolidayHoursToJSON)),
        'monday': HotelAllOfHappyHoursMondayToJSON(value.monday),
        'reopenDate': value.reopenDate === undefined ? undefined : (value.reopenDate.toISOString().substr(0,10)),
        'saturday': HotelAllOfHappyHoursSaturdayToJSON(value.saturday),
        'sunday': HotelAllOfHappyHoursSundayToJSON(value.sunday),
        'thursday': HotelAllOfHappyHoursThursdayToJSON(value.thursday),
        'tuesday': HotelAllOfHappyHoursTuesdayToJSON(value.tuesday),
        'wednesday': HotelAllOfHappyHoursWednesdayToJSON(value.wednesday),
    };
}
