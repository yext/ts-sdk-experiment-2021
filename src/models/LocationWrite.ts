...
import {
    ...
    LocationWriteAllOf,
    LocationWriteAllOfFromJSON,
    LocationWriteAllOfFromJSONTyped,
    LocationWriteAllOfToJSON,
 ...
 */
export interface LocationWrite extends EntityWrite {
    /**
     * 
     * @type {AtmWriteAllOfMeta}
     * @memberof LocationWrite
     */
     ...
     * @memberof LocationWrite
     */
    locationType?: LocationWriteLocationTypeEnum;
    /**
     * 
     ...
     * @memberof LocationWrite
     */
    paymentOptions?: Set<LocationWritePaymentOptionsEnum>;
    /**
     * 
     ...
     * @memberof LocationWrite
     */
    priceRange?: LocationWritePriceRangeEnum;
    /**
     ...
     * @memberof LocationWrite
     */
    rankTrackingFrequency?: LocationWriteRankTrackingFrequencyEnum;
    /**
     ...
     * @memberof LocationWrite
     */
    rankTrackingQueryTemplates?: Set<LocationWriteRankTrackingQueryTemplatesEnum>;
    /**
     * The search engines that we will use to track your performance
     * @type {Set<string>}
     * @memberof LocationWrite
     */
    rankTrackingSites?: Set<LocationWriteRankTrackingSitesEnum>;
    /**
     * 
...
* @enum {string}
*/
export enum LocationWriteLocationTypeEnum {
    Location = 'LOCATION',
...
* @enum {string}
*/
export enum LocationWritePaymentOptionsEnum {
    Alipay = 'ALIPAY',
...
* @enum {string}
*/
export enum LocationWritePriceRangeEnum {
...
* @enum {string}
*/
export enum LocationWriteRankTrackingFrequencyEnum {
    Weekly = 'WEEKLY',
    Monthly = 'MONTHLY',
    Quarterly = 'QUARTERLY'
}/**
...
* @enum {string}
*/
export enum LocationWriteRankTrackingQueryTemplatesEnum {
    Keyword = 'KEYWORD',
...
* @enum {string}
*/
export enum LocationWriteRankTrackingSitesEnum {
...
export function LocationWriteFromJSON(json: any): LocationWrite {
    return LocationWriteFromJSONTyped(json, false);
}

export function LocationWriteFromJSONTyped(json: any, ignoreDiscriminator: boolean): LocationWrite {
...
export function LocationWriteToJSON(value?: LocationWrite | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
