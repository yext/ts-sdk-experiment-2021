 ...
 * 
 * @export
 * @interface LocationWriteAllOfTakeoutHoursSunday
 */
export interface LocationWriteAllOfTakeoutHoursSunday {
    /**
     * Indicates if the takeout hours are "closed" on Sunday.
     * @type {boolean}
     * @memberof LocationWriteAllOfTakeoutHoursSunday
     */
    isClosed?: boolean;
    /**
...
export function LocationWriteAllOfTakeoutHoursSundayFromJSON(json: any): LocationWriteAllOfTakeoutHoursSunday {
    return LocationWriteAllOfTakeoutHoursSundayFromJSONTyped(json, false);
}

export function LocationWriteAllOfTakeoutHoursSundayFromJSONTyped(json: any, ignoreDiscriminator: boolean): LocationWriteAllOfTakeoutHoursSunday {
...
export function LocationWriteAllOfTakeoutHoursSundayToJSON(value?: LocationWriteAllOfTakeoutHoursSunday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
