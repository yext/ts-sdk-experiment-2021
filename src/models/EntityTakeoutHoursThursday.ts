 ...
 * @export
 * @interface EntityTakeoutHoursThursday
 */
export interface EntityTakeoutHoursThursday {
    /**
     * Indicates if the takeout hours are "closed" on Thursday.
     * 
     * Filtering Type: `boolean`
     * @type {boolean}
     * @memberof EntityTakeoutHoursThursday
     */
    isClosed?: boolean;
    /**
...
export function EntityTakeoutHoursThursdayFromJSON(json: any): EntityTakeoutHoursThursday {
    return EntityTakeoutHoursThursdayFromJSONTyped(json, false);
}

export function EntityTakeoutHoursThursdayFromJSONTyped(json: any, ignoreDiscriminator: boolean): EntityTakeoutHoursThursday {
...
export function EntityTakeoutHoursThursdayToJSON(value?: EntityTakeoutHoursThursday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
