 ...
 * 
 * @export
 * @interface AtmAllOfDriveThroughHoursFriday
 */
export interface AtmAllOfDriveThroughHoursFriday {
    /**
     * Indicates if the drive-through hours are "closed" on Friday.
     * @type {boolean}
     * @memberof AtmAllOfDriveThroughHoursFriday
     */
    isClosed?: boolean;
    /**
...
export function AtmAllOfDriveThroughHoursFridayFromJSON(json: any): AtmAllOfDriveThroughHoursFriday {
    return AtmAllOfDriveThroughHoursFridayFromJSONTyped(json, false);
}

export function AtmAllOfDriveThroughHoursFridayFromJSONTyped(json: any, ignoreDiscriminator: boolean): AtmAllOfDriveThroughHoursFriday {
...
export function AtmAllOfDriveThroughHoursFridayToJSON(value?: AtmAllOfDriveThroughHoursFriday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
