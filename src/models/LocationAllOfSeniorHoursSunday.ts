 ...
 * 
 * @export
 * @interface LocationAllOfSeniorHoursSunday
 */
export interface LocationAllOfSeniorHoursSunday {
    /**
     * Indicates if the senior hours are "closed" on Sunday.
     * @type {boolean}
     * @memberof LocationAllOfSeniorHoursSunday
     */
    isClosed?: boolean;
    /**
...
export function LocationAllOfSeniorHoursSundayFromJSON(json: any): LocationAllOfSeniorHoursSunday {
    return LocationAllOfSeniorHoursSundayFromJSONTyped(json, false);
}

export function LocationAllOfSeniorHoursSundayFromJSONTyped(json: any, ignoreDiscriminator: boolean): LocationAllOfSeniorHoursSunday {
...
export function LocationAllOfSeniorHoursSundayToJSON(value?: LocationAllOfSeniorHoursSunday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
