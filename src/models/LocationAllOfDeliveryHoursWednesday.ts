 ...
 * 
 * @export
 * @interface LocationAllOfDeliveryHoursWednesday
 */
export interface LocationAllOfDeliveryHoursWednesday {
    /**
     * Indicates if the delivery hours are "closed" on Wednesday.
     * @type {boolean}
     * @memberof LocationAllOfDeliveryHoursWednesday
     */
    isClosed?: boolean;
    /**
...
export function LocationAllOfDeliveryHoursWednesdayFromJSON(json: any): LocationAllOfDeliveryHoursWednesday {
    return LocationAllOfDeliveryHoursWednesdayFromJSONTyped(json, false);
}

export function LocationAllOfDeliveryHoursWednesdayFromJSONTyped(json: any, ignoreDiscriminator: boolean): LocationAllOfDeliveryHoursWednesday {
...
export function LocationAllOfDeliveryHoursWednesdayToJSON(value?: LocationAllOfDeliveryHoursWednesday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
