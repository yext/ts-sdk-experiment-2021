 ...
 * @export
 * @interface EntityPickupHoursSaturday
 */
export interface EntityPickupHoursSaturday {
    /**
     * Indicates if the pickup hours are "closed" on Saturday.
     * 
     * Filtering Type: `boolean`
     * @type {boolean}
     * @memberof EntityPickupHoursSaturday
     */
    isClosed?: boolean;
    /**
...
export function EntityPickupHoursSaturdayFromJSON(json: any): EntityPickupHoursSaturday {
    return EntityPickupHoursSaturdayFromJSONTyped(json, false);
}

export function EntityPickupHoursSaturdayFromJSONTyped(json: any, ignoreDiscriminator: boolean): EntityPickupHoursSaturday {
...
export function EntityPickupHoursSaturdayToJSON(value?: EntityPickupHoursSaturday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
