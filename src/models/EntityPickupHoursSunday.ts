 ...
 * @export
 * @interface EntityPickupHoursSunday
 */
export interface EntityPickupHoursSunday {
    /**
     * Indicates if the pickup hours are "closed" on Sunday.
     * 
     * Filtering Type: `boolean`
     * @type {boolean}
     * @memberof EntityPickupHoursSunday
     */
    isClosed?: boolean;
    /**
...
export function EntityPickupHoursSundayFromJSON(json: any): EntityPickupHoursSunday {
    return EntityPickupHoursSundayFromJSONTyped(json, false);
}

export function EntityPickupHoursSundayFromJSONTyped(json: any, ignoreDiscriminator: boolean): EntityPickupHoursSunday {
...
export function EntityPickupHoursSundayToJSON(value?: EntityPickupHoursSunday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
