 ...
 * 
 * @export
 * @interface LocationWriteAllOfDeliveryHoursFriday
 */
export interface LocationWriteAllOfDeliveryHoursFriday {
    /**
     * Indicates if the delivery hours are "closed" on Friday.
     * @type {boolean}
     * @memberof LocationWriteAllOfDeliveryHoursFriday
     */
    isClosed?: boolean;
    /**
...
export function LocationWriteAllOfDeliveryHoursFridayFromJSON(json: any): LocationWriteAllOfDeliveryHoursFriday {
    return LocationWriteAllOfDeliveryHoursFridayFromJSONTyped(json, false);
}

export function LocationWriteAllOfDeliveryHoursFridayFromJSONTyped(json: any, ignoreDiscriminator: boolean): LocationWriteAllOfDeliveryHoursFriday {
...
export function LocationWriteAllOfDeliveryHoursFridayToJSON(value?: LocationWriteAllOfDeliveryHoursFriday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
