...
import {
    EntitySeniorHoursFriday,
    EntitySeniorHoursFridayFromJSON,
    EntitySeniorHoursFridayFromJSONTyped,
    EntitySeniorHoursFridayToJSON,
    EntitySeniorHoursHolidayHours,
    EntitySeniorHoursHolidayHoursFromJSON,
    EntitySeniorHoursHolidayHoursFromJSONTyped,
    EntitySeniorHoursHolidayHoursToJSON,
    EntitySeniorHoursMonday,
    EntitySeniorHoursMondayFromJSON,
    EntitySeniorHoursMondayFromJSONTyped,
    EntitySeniorHoursMondayToJSON,
    EntitySeniorHoursSaturday,
    EntitySeniorHoursSaturdayFromJSON,
    EntitySeniorHoursSaturdayFromJSONTyped,
    EntitySeniorHoursSaturdayToJSON,
    EntitySeniorHoursSunday,
    EntitySeniorHoursSundayFromJSON,
    EntitySeniorHoursSundayFromJSONTyped,
    EntitySeniorHoursSundayToJSON,
    EntitySeniorHoursThursday,
    EntitySeniorHoursThursdayFromJSON,
    EntitySeniorHoursThursdayFromJSONTyped,
    EntitySeniorHoursThursdayToJSON,
    EntitySeniorHoursTuesday,
    EntitySeniorHoursTuesdayFromJSON,
    EntitySeniorHoursTuesdayFromJSONTyped,
    EntitySeniorHoursTuesdayToJSON,
    EntitySeniorHoursWednesday,
    EntitySeniorHoursWednesdayFromJSON,
    EntitySeniorHoursWednesdayFromJSONTyped,
    EntitySeniorHoursWednesdayToJSON,
} from './';
 ...
 * ```
 * @export
 * @interface EntitySeniorHours
 */
export interface EntitySeniorHours {
    /**
     * 
     * @type {EntitySeniorHoursFriday}
     * @memberof EntitySeniorHours
     */
     ...
     * @type {Set<EntitySeniorHoursHolidayHours>}
     * @memberof EntitySeniorHours
     */
    holidayHours?: Set<EntitySeniorHoursHolidayHours>;
    /**
     * 
     * @type {EntitySeniorHoursMonday}
     * @memberof EntitySeniorHours
     */
    ...
    /**
     * 
     * @type {EntitySeniorHoursSaturday}
     * @memberof EntitySeniorHours
     */
    saturday?: EntitySeniorHoursSaturday;
    /**
     * 
     * @type {EntitySeniorHoursSunday}
     * @memberof EntitySeniorHours
     */
    sunday?: EntitySeniorHoursSunday;
    /**
     * 
     * @type {EntitySeniorHoursThursday}
     * @memberof EntitySeniorHours
     */
    thursday?: EntitySeniorHoursThursday;
    /**
     * 
     * @type {EntitySeniorHoursTuesday}
     * @memberof EntitySeniorHours
     */
    tuesday?: EntitySeniorHoursTuesday;
    /**
     * 
     * @type {EntitySeniorHoursWednesday}
     * @memberof EntitySeniorHours
     */
    wednesday?: EntitySeniorHoursWednesday;
}

export function EntitySeniorHoursFromJSON(json: any): EntitySeniorHours {
    return EntitySeniorHoursFromJSONTyped(json, false);
}

export function EntitySeniorHoursFromJSONTyped(json: any, ignoreDiscriminator: boolean): EntitySeniorHours {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'friday': !exists(json, 'friday') ? undefined : EntitySeniorHoursFridayFromJSON(json['friday']),
        'holidayHours': !exists(json, 'holidayHours') ? undefined : (new Set((json['holidayHours'] as Array<any>).map(EntitySeniorHoursHolidayHoursFromJSON))),
        'monday': !exists(json, 'monday') ? undefined : EntitySeniorHoursMondayFromJSON(json['monday']),
        'reopenDate': !exists(json, 'reopenDate') ? undefined : (new Date(json['reopenDate'])),
        'saturday': !exists(json, 'saturday') ? undefined : EntitySeniorHoursSaturdayFromJSON(json['saturday']),
        'sunday': !exists(json, 'sunday') ? undefined : EntitySeniorHoursSundayFromJSON(json['sunday']),
        'thursday': !exists(json, 'thursday') ? undefined : EntitySeniorHoursThursdayFromJSON(json['thursday']),
        'tuesday': !exists(json, 'tuesday') ? undefined : EntitySeniorHoursTuesdayFromJSON(json['tuesday']),
        'wednesday': !exists(json, 'wednesday') ? undefined : EntitySeniorHoursWednesdayFromJSON(json['wednesday']),
    };
}

export function EntitySeniorHoursToJSON(value?: EntitySeniorHours | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'friday': EntitySeniorHoursFridayToJSON(value.friday),
        'holidayHours': value.holidayHours === undefined ? undefined : (Array.from(value.holidayHours as Set<any>).map(EntitySeniorHoursHolidayHoursToJSON)),
        'monday': EntitySeniorHoursMondayToJSON(value.monday),
        'reopenDate': value.reopenDate === undefined ? undefined : (value.reopenDate.toISOString().substr(0,10)),
        'saturday': EntitySeniorHoursSaturdayToJSON(value.saturday),
        'sunday': EntitySeniorHoursSundayToJSON(value.sunday),
        'thursday': EntitySeniorHoursThursdayToJSON(value.thursday),
        'tuesday': EntitySeniorHoursTuesdayToJSON(value.tuesday),
        'wednesday': EntitySeniorHoursWednesdayToJSON(value.wednesday),
    };
}
