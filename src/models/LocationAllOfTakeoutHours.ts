...
import {
    LocationAllOfTakeoutHoursFriday,
    LocationAllOfTakeoutHoursFridayFromJSON,
    LocationAllOfTakeoutHoursFridayFromJSONTyped,
    LocationAllOfTakeoutHoursFridayToJSON,
    LocationAllOfTakeoutHoursHolidayHours,
    LocationAllOfTakeoutHoursHolidayHoursFromJSON,
    LocationAllOfTakeoutHoursHolidayHoursFromJSONTyped,
    LocationAllOfTakeoutHoursHolidayHoursToJSON,
    LocationAllOfTakeoutHoursMonday,
    LocationAllOfTakeoutHoursMondayFromJSON,
    LocationAllOfTakeoutHoursMondayFromJSONTyped,
    LocationAllOfTakeoutHoursMondayToJSON,
    LocationAllOfTakeoutHoursSaturday,
    LocationAllOfTakeoutHoursSaturdayFromJSON,
    LocationAllOfTakeoutHoursSaturdayFromJSONTyped,
    LocationAllOfTakeoutHoursSaturdayToJSON,
    LocationAllOfTakeoutHoursSunday,
    LocationAllOfTakeoutHoursSundayFromJSON,
    LocationAllOfTakeoutHoursSundayFromJSONTyped,
    LocationAllOfTakeoutHoursSundayToJSON,
    LocationAllOfTakeoutHoursThursday,
    LocationAllOfTakeoutHoursThursdayFromJSON,
    LocationAllOfTakeoutHoursThursdayFromJSONTyped,
    LocationAllOfTakeoutHoursThursdayToJSON,
    LocationAllOfTakeoutHoursTuesday,
    LocationAllOfTakeoutHoursTuesdayFromJSON,
    LocationAllOfTakeoutHoursTuesdayFromJSONTyped,
    LocationAllOfTakeoutHoursTuesdayToJSON,
    LocationAllOfTakeoutHoursWednesday,
    LocationAllOfTakeoutHoursWednesdayFromJSON,
    LocationAllOfTakeoutHoursWednesdayFromJSONTyped,
    LocationAllOfTakeoutHoursWednesdayToJSON,
} from './';
 ...
 * @export
 * @interface LocationAllOfTakeoutHours
 */
export interface LocationAllOfTakeoutHours {
    /**
     * 
     * @type {LocationAllOfTakeoutHoursFriday}
     * @memberof LocationAllOfTakeoutHours
     */
    friday?: LocationAllOfTakeoutHoursFriday;
    /**
     * 
     ...
     * @type {Set<LocationAllOfTakeoutHoursHolidayHours>}
     * @memberof LocationAllOfTakeoutHours
     */
    holidayHours?: Set<LocationAllOfTakeoutHoursHolidayHours>;
    /**
     * 
     * @type {LocationAllOfTakeoutHoursMonday}
     * @memberof LocationAllOfTakeoutHours
     */
    monday?: LocationAllOfTakeoutHoursMonday;
    /**
     * 
    ...
    /**
     * 
     * @type {LocationAllOfTakeoutHoursSaturday}
     * @memberof LocationAllOfTakeoutHours
     */
    saturday?: LocationAllOfTakeoutHoursSaturday;
    /**
     * 
     * @type {LocationAllOfTakeoutHoursSunday}
     * @memberof LocationAllOfTakeoutHours
     */
    sunday?: LocationAllOfTakeoutHoursSunday;
    /**
     * 
     * @type {LocationAllOfTakeoutHoursThursday}
     * @memberof LocationAllOfTakeoutHours
     */
    thursday?: LocationAllOfTakeoutHoursThursday;
    /**
     * 
     * @type {LocationAllOfTakeoutHoursTuesday}
     * @memberof LocationAllOfTakeoutHours
     */
    tuesday?: LocationAllOfTakeoutHoursTuesday;
    /**
     * 
     * @type {LocationAllOfTakeoutHoursWednesday}
     * @memberof LocationAllOfTakeoutHours
     */
    wednesday?: LocationAllOfTakeoutHoursWednesday;
}

export function LocationAllOfTakeoutHoursFromJSON(json: any): LocationAllOfTakeoutHours {
    return LocationAllOfTakeoutHoursFromJSONTyped(json, false);
}

export function LocationAllOfTakeoutHoursFromJSONTyped(json: any, ignoreDiscriminator: boolean): LocationAllOfTakeoutHours {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'friday': !exists(json, 'friday') ? undefined : LocationAllOfTakeoutHoursFridayFromJSON(json['friday']),
        'holidayHours': !exists(json, 'holidayHours') ? undefined : (new Set((json['holidayHours'] as Array<any>).map(LocationAllOfTakeoutHoursHolidayHoursFromJSON))),
        'monday': !exists(json, 'monday') ? undefined : LocationAllOfTakeoutHoursMondayFromJSON(json['monday']),
        'reopenDate': !exists(json, 'reopenDate') ? undefined : (new Date(json['reopenDate'])),
        'saturday': !exists(json, 'saturday') ? undefined : LocationAllOfTakeoutHoursSaturdayFromJSON(json['saturday']),
        'sunday': !exists(json, 'sunday') ? undefined : LocationAllOfTakeoutHoursSundayFromJSON(json['sunday']),
        'thursday': !exists(json, 'thursday') ? undefined : LocationAllOfTakeoutHoursThursdayFromJSON(json['thursday']),
        'tuesday': !exists(json, 'tuesday') ? undefined : LocationAllOfTakeoutHoursTuesdayFromJSON(json['tuesday']),
        'wednesday': !exists(json, 'wednesday') ? undefined : LocationAllOfTakeoutHoursWednesdayFromJSON(json['wednesday']),
    };
}

export function LocationAllOfTakeoutHoursToJSON(value?: LocationAllOfTakeoutHours | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'friday': LocationAllOfTakeoutHoursFridayToJSON(value.friday),
        'holidayHours': value.holidayHours === undefined ? undefined : (Array.from(value.holidayHours as Set<any>).map(LocationAllOfTakeoutHoursHolidayHoursToJSON)),
        'monday': LocationAllOfTakeoutHoursMondayToJSON(value.monday),
        'reopenDate': value.reopenDate === undefined ? undefined : (value.reopenDate.toISOString().substr(0,10)),
        'saturday': LocationAllOfTakeoutHoursSaturdayToJSON(value.saturday),
        'sunday': LocationAllOfTakeoutHoursSundayToJSON(value.sunday),
        'thursday': LocationAllOfTakeoutHoursThursdayToJSON(value.thursday),
        'tuesday': LocationAllOfTakeoutHoursTuesdayToJSON(value.tuesday),
        'wednesday': LocationAllOfTakeoutHoursWednesdayToJSON(value.wednesday),
    };
}
