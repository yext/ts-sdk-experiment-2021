...
export function EntityImageFromJSON(json: any): EntityImage {
    return EntityImageFromJSONTyped(json, false);
}

export function EntityImageFromJSONTyped(json: any, ignoreDiscriminator: boolean): EntityImage {
...
export function EntityImageToJSON(value?: EntityImage | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
