 ...
 * 
 * @export
 * @interface AtmAllOfHoursTuesday
 */
export interface AtmAllOfHoursTuesday {
    /**
     * Indicates if the hours of operation are "closed" on Tuesday.
     * @type {boolean}
     * @memberof AtmAllOfHoursTuesday
     */
    isClosed?: boolean;
    /**
...
export function AtmAllOfHoursTuesdayFromJSON(json: any): AtmAllOfHoursTuesday {
    return AtmAllOfHoursTuesdayFromJSONTyped(json, false);
}

export function AtmAllOfHoursTuesdayFromJSONTyped(json: any, ignoreDiscriminator: boolean): AtmAllOfHoursTuesday {
...
export function AtmAllOfHoursTuesdayToJSON(value?: AtmAllOfHoursTuesday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
