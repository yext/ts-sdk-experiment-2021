 ...
 * 
 * @export
 * @interface HotelAllOfKitchenHoursFriday
 */
export interface HotelAllOfKitchenHoursFriday {
    /**
     * Indicates if the kitchen hours are "closed" on Friday.
     * @type {boolean}
     * @memberof HotelAllOfKitchenHoursFriday
     */
    isClosed?: boolean;
    /**
...
export function HotelAllOfKitchenHoursFridayFromJSON(json: any): HotelAllOfKitchenHoursFriday {
    return HotelAllOfKitchenHoursFridayFromJSONTyped(json, false);
}

export function HotelAllOfKitchenHoursFridayFromJSONTyped(json: any, ignoreDiscriminator: boolean): HotelAllOfKitchenHoursFriday {
...
export function HotelAllOfKitchenHoursFridayToJSON(value?: HotelAllOfKitchenHoursFriday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
