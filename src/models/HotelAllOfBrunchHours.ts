...
import {
    HotelAllOfBrunchHoursFriday,
    HotelAllOfBrunchHoursFridayFromJSON,
    HotelAllOfBrunchHoursFridayFromJSONTyped,
    HotelAllOfBrunchHoursFridayToJSON,
    HotelAllOfBrunchHoursHolidayHours,
    HotelAllOfBrunchHoursHolidayHoursFromJSON,
    HotelAllOfBrunchHoursHolidayHoursFromJSONTyped,
    HotelAllOfBrunchHoursHolidayHoursToJSON,
    HotelAllOfBrunchHoursMonday,
    HotelAllOfBrunchHoursMondayFromJSON,
    HotelAllOfBrunchHoursMondayFromJSONTyped,
    HotelAllOfBrunchHoursMondayToJSON,
    HotelAllOfBrunchHoursSaturday,
    HotelAllOfBrunchHoursSaturdayFromJSON,
    HotelAllOfBrunchHoursSaturdayFromJSONTyped,
    HotelAllOfBrunchHoursSaturdayToJSON,
    HotelAllOfBrunchHoursSunday,
    HotelAllOfBrunchHoursSundayFromJSON,
    HotelAllOfBrunchHoursSundayFromJSONTyped,
    HotelAllOfBrunchHoursSundayToJSON,
    HotelAllOfBrunchHoursThursday,
    HotelAllOfBrunchHoursThursdayFromJSON,
    HotelAllOfBrunchHoursThursdayFromJSONTyped,
    HotelAllOfBrunchHoursThursdayToJSON,
    HotelAllOfBrunchHoursTuesday,
    HotelAllOfBrunchHoursTuesdayFromJSON,
    HotelAllOfBrunchHoursTuesdayFromJSONTyped,
    HotelAllOfBrunchHoursTuesdayToJSON,
    HotelAllOfBrunchHoursWednesday,
    HotelAllOfBrunchHoursWednesdayFromJSON,
    HotelAllOfBrunchHoursWednesdayFromJSONTyped,
    HotelAllOfBrunchHoursWednesdayToJSON,
} from './';
 ...
 * @export
 * @interface HotelAllOfBrunchHours
 */
export interface HotelAllOfBrunchHours {
    /**
     * 
     * @type {HotelAllOfBrunchHoursFriday}
     * @memberof HotelAllOfBrunchHours
     */
    friday?: HotelAllOfBrunchHoursFriday;
    /**
     * 
     ...
     * @type {Set<HotelAllOfBrunchHoursHolidayHours>}
     * @memberof HotelAllOfBrunchHours
     */
    holidayHours?: Set<HotelAllOfBrunchHoursHolidayHours>;
    /**
     * 
     * @type {HotelAllOfBrunchHoursMonday}
     * @memberof HotelAllOfBrunchHours
     */
    monday?: HotelAllOfBrunchHoursMonday;
    /**
     * 
    ...
    /**
     * 
     * @type {HotelAllOfBrunchHoursSaturday}
     * @memberof HotelAllOfBrunchHours
     */
    saturday?: HotelAllOfBrunchHoursSaturday;
    /**
     * 
     * @type {HotelAllOfBrunchHoursSunday}
     * @memberof HotelAllOfBrunchHours
     */
    sunday?: HotelAllOfBrunchHoursSunday;
    /**
     * 
     * @type {HotelAllOfBrunchHoursThursday}
     * @memberof HotelAllOfBrunchHours
     */
    thursday?: HotelAllOfBrunchHoursThursday;
    /**
     * 
     * @type {HotelAllOfBrunchHoursTuesday}
     * @memberof HotelAllOfBrunchHours
     */
    tuesday?: HotelAllOfBrunchHoursTuesday;
    /**
     * 
     * @type {HotelAllOfBrunchHoursWednesday}
     * @memberof HotelAllOfBrunchHours
     */
    wednesday?: HotelAllOfBrunchHoursWednesday;
}

export function HotelAllOfBrunchHoursFromJSON(json: any): HotelAllOfBrunchHours {
    return HotelAllOfBrunchHoursFromJSONTyped(json, false);
}

export function HotelAllOfBrunchHoursFromJSONTyped(json: any, ignoreDiscriminator: boolean): HotelAllOfBrunchHours {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'friday': !exists(json, 'friday') ? undefined : HotelAllOfBrunchHoursFridayFromJSON(json['friday']),
        'holidayHours': !exists(json, 'holidayHours') ? undefined : (new Set((json['holidayHours'] as Array<any>).map(HotelAllOfBrunchHoursHolidayHoursFromJSON))),
        'monday': !exists(json, 'monday') ? undefined : HotelAllOfBrunchHoursMondayFromJSON(json['monday']),
        'reopenDate': !exists(json, 'reopenDate') ? undefined : (new Date(json['reopenDate'])),
        'saturday': !exists(json, 'saturday') ? undefined : HotelAllOfBrunchHoursSaturdayFromJSON(json['saturday']),
        'sunday': !exists(json, 'sunday') ? undefined : HotelAllOfBrunchHoursSundayFromJSON(json['sunday']),
        'thursday': !exists(json, 'thursday') ? undefined : HotelAllOfBrunchHoursThursdayFromJSON(json['thursday']),
        'tuesday': !exists(json, 'tuesday') ? undefined : HotelAllOfBrunchHoursTuesdayFromJSON(json['tuesday']),
        'wednesday': !exists(json, 'wednesday') ? undefined : HotelAllOfBrunchHoursWednesdayFromJSON(json['wednesday']),
    };
}

export function HotelAllOfBrunchHoursToJSON(value?: HotelAllOfBrunchHours | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'friday': HotelAllOfBrunchHoursFridayToJSON(value.friday),
        'holidayHours': value.holidayHours === undefined ? undefined : (Array.from(value.holidayHours as Set<any>).map(HotelAllOfBrunchHoursHolidayHoursToJSON)),
        'monday': HotelAllOfBrunchHoursMondayToJSON(value.monday),
        'reopenDate': value.reopenDate === undefined ? undefined : (value.reopenDate.toISOString().substr(0,10)),
        'saturday': HotelAllOfBrunchHoursSaturdayToJSON(value.saturday),
        'sunday': HotelAllOfBrunchHoursSundayToJSON(value.sunday),
        'thursday': HotelAllOfBrunchHoursThursdayToJSON(value.thursday),
        'tuesday': HotelAllOfBrunchHoursTuesdayToJSON(value.tuesday),
        'wednesday': HotelAllOfBrunchHoursWednesdayToJSON(value.wednesday),
    };
}
