 ...
 * ```
 * @export
 * @interface EntityOrderUrl
 */
export interface EntityOrderUrl {
    /**
...
export function EntityOrderUrlFromJSON(json: any): EntityOrderUrl {
    return EntityOrderUrlFromJSONTyped(json, false);
}

export function EntityOrderUrlFromJSONTyped(json: any, ignoreDiscriminator: boolean): EntityOrderUrl {
...
export function EntityOrderUrlToJSON(value?: EntityOrderUrl | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
