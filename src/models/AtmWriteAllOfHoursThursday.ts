 ...
 * 
 * @export
 * @interface AtmWriteAllOfHoursThursday
 */
export interface AtmWriteAllOfHoursThursday {
    /**
     * Indicates if the hours of operation are "closed" on Thursday.
     * @type {boolean}
     * @memberof AtmWriteAllOfHoursThursday
     */
    isClosed?: boolean;
    /**
...
export function AtmWriteAllOfHoursThursdayFromJSON(json: any): AtmWriteAllOfHoursThursday {
    return AtmWriteAllOfHoursThursdayFromJSONTyped(json, false);
}

export function AtmWriteAllOfHoursThursdayFromJSONTyped(json: any, ignoreDiscriminator: boolean): AtmWriteAllOfHoursThursday {
...
export function AtmWriteAllOfHoursThursdayToJSON(value?: AtmWriteAllOfHoursThursday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
