 ...
 * @export
 * @interface EntityAccessHoursThursday
 */
export interface EntityAccessHoursThursday {
    /**
     * Indicates if the access hours are "closed" on Thursday.
     * 
     * Filtering Type: `boolean`
     * @type {boolean}
     * @memberof EntityAccessHoursThursday
     */
    isClosed?: boolean;
    /**
...
export function EntityAccessHoursThursdayFromJSON(json: any): EntityAccessHoursThursday {
    return EntityAccessHoursThursdayFromJSONTyped(json, false);
}

export function EntityAccessHoursThursdayFromJSONTyped(json: any, ignoreDiscriminator: boolean): EntityAccessHoursThursday {
...
export function EntityAccessHoursThursdayToJSON(value?: EntityAccessHoursThursday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
