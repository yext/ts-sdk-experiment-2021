 ...
 * 
 * @export
 * @interface HealthcareFacilityAllOfServiceAreaPlaces
 */
export interface HealthcareFacilityAllOfServiceAreaPlaces {
    /**
     * 
     * @type {string}
     * @memberof HealthcareFacilityAllOfServiceAreaPlaces
     */
    name?: string;
    /**
     * 
     ...
     * @memberof HealthcareFacilityAllOfServiceAreaPlaces
     */
    type?: HealthcareFacilityAllOfServiceAreaPlacesTypeEnum;
}
...
* @enum {string}
*/
export enum HealthcareFacilityAllOfServiceAreaPlacesTypeEnum {
...
export function HealthcareFacilityAllOfServiceAreaPlacesFromJSON(json: any): HealthcareFacilityAllOfServiceAreaPlaces {
    return HealthcareFacilityAllOfServiceAreaPlacesFromJSONTyped(json, false);
}

export function HealthcareFacilityAllOfServiceAreaPlacesFromJSONTyped(json: any, ignoreDiscriminator: boolean): HealthcareFacilityAllOfServiceAreaPlaces {
...
export function HealthcareFacilityAllOfServiceAreaPlacesToJSON(value?: HealthcareFacilityAllOfServiceAreaPlaces | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
