 ...
 * @export
 * @interface InlineResponse200ResponsePickupHoursMonday
 */
export interface InlineResponse200ResponsePickupHoursMonday {
    /**
     * Indicates if the pickup hours are "closed" on Monday.
     * 
     * Filtering Type: `boolean`
     * @type {boolean}
     * @memberof InlineResponse200ResponsePickupHoursMonday
     */
    isClosed?: boolean;
    /**
...
export function InlineResponse200ResponsePickupHoursMondayFromJSON(json: any): InlineResponse200ResponsePickupHoursMonday {
    return InlineResponse200ResponsePickupHoursMondayFromJSONTyped(json, false);
}

export function InlineResponse200ResponsePickupHoursMondayFromJSONTyped(json: any, ignoreDiscriminator: boolean): InlineResponse200ResponsePickupHoursMonday {
...
export function InlineResponse200ResponsePickupHoursMondayToJSON(value?: InlineResponse200ResponsePickupHoursMonday | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
