...
export class ConnectorsApi extends runtime.BaseAPI {
    ...
    async pushDataRaw(requestParameters: PushDataRequest): Promise<runtime.ApiResponse<PushDataResponse>> {
        ...
        if (requestParameters.connectorData === null || requestParameters.connectorData === undefined) {
            throw new runtime.RequiredError('connectorData','Required parameter requestParameters.connectorData was null or undefined when calling pushData.');
        }
        ...
        const response = await this.request({
            ...
            body: requestParameters.connectorData as any,
        });
